...
export interface SampleRecord18Panel01Props {
  facilityId: string;
  title?: string;
...
/**
 * SampleRecord18Panel01 — operational panel for samples domain slice 18/01.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function SampleRecord18Panel01({ facilityId, title = 'SampleRecord18 Workspace', onSelect }: SampleRecord18Panel01Props) {
  ...
  return (
    <section className="lis-panel lis-panel--samples" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} samples records (slice 18-01)
      </footer>
    </section>
  );
}

export default SampleRecord18Panel01;
