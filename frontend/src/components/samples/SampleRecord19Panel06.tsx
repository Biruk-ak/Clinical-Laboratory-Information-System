...
export interface SampleRecord19Panel06Props {
  facilityId: string;
  title?: string;
...
/**
 * SampleRecord19Panel06 — operational panel for samples domain slice 19/06.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function SampleRecord19Panel06({ facilityId, title = 'SampleRecord19 Workspace', onSelect }: SampleRecord19Panel06Props) {
  ...
  return (
    <section className="lis-panel lis-panel--samples" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} samples records (slice 19-06)
      </footer>
    </section>
  );
}

export default SampleRecord19Panel06;
