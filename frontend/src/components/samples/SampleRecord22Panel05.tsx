...
export interface SampleRecord22Panel05Props {
  facilityId: string;
  title?: string;
...
/**
 * SampleRecord22Panel05 — operational panel for samples domain slice 22/05.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function SampleRecord22Panel05({ facilityId, title = 'SampleRecord22 Workspace', onSelect }: SampleRecord22Panel05Props) {
  ...
  return (
    <section className="lis-panel lis-panel--samples" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} samples records (slice 22-05)
      </footer>
    </section>
  );
}

export default SampleRecord22Panel05;
