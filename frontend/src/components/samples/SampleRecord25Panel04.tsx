...
export interface SampleRecord25Panel04Props {
  facilityId: string;
  title?: string;
...
/**
 * SampleRecord25Panel04 — operational panel for samples domain slice 25/04.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function SampleRecord25Panel04({ facilityId, title = 'SampleRecord25 Workspace', onSelect }: SampleRecord25Panel04Props) {
  ...
  return (
    <section className="lis-panel lis-panel--samples" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} samples records (slice 25-04)
      </footer>
    </section>
  );
}

export default SampleRecord25Panel04;
