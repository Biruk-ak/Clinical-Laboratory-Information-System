...
export interface SampleRecord27Panel04Props {
  facilityId: string;
  title?: string;
...
/**
 * SampleRecord27Panel04 — operational panel for samples domain slice 27/04.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function SampleRecord27Panel04({ facilityId, title = 'SampleRecord27 Workspace', onSelect }: SampleRecord27Panel04Props) {
  ...
  return (
    <section className="lis-panel lis-panel--samples" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} samples records (slice 27-04)
      </footer>
    </section>
  );
}

export default SampleRecord27Panel04;
