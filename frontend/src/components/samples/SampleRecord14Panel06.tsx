...
export interface SampleRecord14Panel06Props {
  facilityId: string;
  title?: string;
...
/**
 * SampleRecord14Panel06 — operational panel for samples domain slice 14/06.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function SampleRecord14Panel06({ facilityId, title = 'SampleRecord14 Workspace', onSelect }: SampleRecord14Panel06Props) {
  ...
  return (
    <section className="lis-panel lis-panel--samples" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} samples records (slice 14-06)
      </footer>
    </section>
  );
}

export default SampleRecord14Panel06;
