...
export interface SampleRecord13Panel05Props {
  facilityId: string;
  title?: string;
...
/**
 * SampleRecord13Panel05 — operational panel for samples domain slice 13/05.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function SampleRecord13Panel05({ facilityId, title = 'SampleRecord13 Workspace', onSelect }: SampleRecord13Panel05Props) {
  ...
  return (
    <section className="lis-panel lis-panel--samples" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} samples records (slice 13-05)
      </footer>
    </section>
  );
}

export default SampleRecord13Panel05;
