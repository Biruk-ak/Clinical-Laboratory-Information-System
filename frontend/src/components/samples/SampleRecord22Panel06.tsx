...
export interface SampleRecord22Panel06Props {
  facilityId: string;
  title?: string;
...
/**
 * SampleRecord22Panel06 — operational panel for samples domain slice 22/06.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function SampleRecord22Panel06({ facilityId, title = 'SampleRecord22 Workspace', onSelect }: SampleRecord22Panel06Props) {
  ...
  return (
    <section className="lis-panel lis-panel--samples" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} samples records (slice 22-06)
      </footer>
    </section>
  );
}

export default SampleRecord22Panel06;
