...
export interface SampleRecord25Panel06Props {
  facilityId: string;
  title?: string;
...
/**
 * SampleRecord25Panel06 — operational panel for samples domain slice 25/06.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function SampleRecord25Panel06({ facilityId, title = 'SampleRecord25 Workspace', onSelect }: SampleRecord25Panel06Props) {
  ...
  return (
    <section className="lis-panel lis-panel--samples" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} samples records (slice 25-06)
      </footer>
    </section>
  );
}

export default SampleRecord25Panel06;
