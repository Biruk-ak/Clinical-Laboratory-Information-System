...
export interface SampleRecord25Panel02Props {
  facilityId: string;
  title?: string;
...
/**
 * SampleRecord25Panel02 — operational panel for samples domain slice 25/02.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function SampleRecord25Panel02({ facilityId, title = 'SampleRecord25 Workspace', onSelect }: SampleRecord25Panel02Props) {
  ...
  return (
    <section className="lis-panel lis-panel--samples" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} samples records (slice 25-02)
      </footer>
    </section>
  );
}

export default SampleRecord25Panel02;
