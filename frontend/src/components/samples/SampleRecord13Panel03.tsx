...
export interface SampleRecord13Panel03Props {
  facilityId: string;
  title?: string;
...
/**
 * SampleRecord13Panel03 — operational panel for samples domain slice 13/03.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function SampleRecord13Panel03({ facilityId, title = 'SampleRecord13 Workspace', onSelect }: SampleRecord13Panel03Props) {
  ...
  return (
    <section className="lis-panel lis-panel--samples" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} samples records (slice 13-03)
      </footer>
    </section>
  );
}

export default SampleRecord13Panel03;
