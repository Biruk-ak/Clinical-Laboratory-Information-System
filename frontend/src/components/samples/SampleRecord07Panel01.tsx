...
export interface SampleRecord07Panel01Props {
  facilityId: string;
  title?: string;
...
/**
 * SampleRecord07Panel01 — operational panel for samples domain slice 07/01.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function SampleRecord07Panel01({ facilityId, title = 'SampleRecord07 Workspace', onSelect }: SampleRecord07Panel01Props) {
  ...
  return (
    <section className="lis-panel lis-panel--samples" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} samples records (slice 07-01)
      </footer>
    </section>
  );
}

export default SampleRecord07Panel01;
