...
export interface SampleRecord05Panel06Props {
  facilityId: string;
  title?: string;
...
/**
 * SampleRecord05Panel06 — operational panel for samples domain slice 05/06.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function SampleRecord05Panel06({ facilityId, title = 'SampleRecord05 Workspace', onSelect }: SampleRecord05Panel06Props) {
  ...
  return (
    <section className="lis-panel lis-panel--samples" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} samples records (slice 05-06)
      </footer>
    </section>
  );
}

export default SampleRecord05Panel06;
