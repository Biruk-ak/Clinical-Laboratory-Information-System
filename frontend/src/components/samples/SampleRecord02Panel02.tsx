...
export interface SampleRecord02Panel02Props {
  facilityId: string;
  title?: string;
...
/**
 * SampleRecord02Panel02 — operational panel for samples domain slice 02/02.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function SampleRecord02Panel02({ facilityId, title = 'SampleRecord02 Workspace', onSelect }: SampleRecord02Panel02Props) {
  ...
  return (
    <section className="lis-panel lis-panel--samples" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} samples records (slice 02-02)
      </footer>
    </section>
  );
}

export default SampleRecord02Panel02;
