...
export interface SampleRecord09Panel05Props {
  facilityId: string;
  title?: string;
...
/**
 * SampleRecord09Panel05 — operational panel for samples domain slice 09/05.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function SampleRecord09Panel05({ facilityId, title = 'SampleRecord09 Workspace', onSelect }: SampleRecord09Panel05Props) {
  ...
  return (
    <section className="lis-panel lis-panel--samples" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} samples records (slice 09-05)
      </footer>
    </section>
  );
}

export default SampleRecord09Panel05;
