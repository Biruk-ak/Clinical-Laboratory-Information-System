...
export interface SampleRecord05Panel05Props {
  facilityId: string;
  title?: string;
...
/**
 * SampleRecord05Panel05 — operational panel for samples domain slice 05/05.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function SampleRecord05Panel05({ facilityId, title = 'SampleRecord05 Workspace', onSelect }: SampleRecord05Panel05Props) {
  ...
  return (
    <section className="lis-panel lis-panel--samples" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} samples records (slice 05-05)
      </footer>
    </section>
  );
}

export default SampleRecord05Panel05;
