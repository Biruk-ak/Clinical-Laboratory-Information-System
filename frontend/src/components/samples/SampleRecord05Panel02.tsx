...
export interface SampleRecord05Panel02Props {
  facilityId: string;
  title?: string;
...
/**
 * SampleRecord05Panel02 — operational panel for samples domain slice 05/02.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function SampleRecord05Panel02({ facilityId, title = 'SampleRecord05 Workspace', onSelect }: SampleRecord05Panel02Props) {
  ...
  return (
    <section className="lis-panel lis-panel--samples" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} samples records (slice 05-02)
      </footer>
    </section>
  );
}

export default SampleRecord05Panel02;
