...
export interface SampleRecord15Panel03Props {
  facilityId: string;
  title?: string;
...
/**
 * SampleRecord15Panel03 — operational panel for samples domain slice 15/03.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function SampleRecord15Panel03({ facilityId, title = 'SampleRecord15 Workspace', onSelect }: SampleRecord15Panel03Props) {
  ...
  return (
    <section className="lis-panel lis-panel--samples" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} samples records (slice 15-03)
      </footer>
    </section>
  );
}

export default SampleRecord15Panel03;
