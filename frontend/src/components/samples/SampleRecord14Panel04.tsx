...
export interface SampleRecord14Panel04Props {
  facilityId: string;
  title?: string;
...
/**
 * SampleRecord14Panel04 — operational panel for samples domain slice 14/04.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function SampleRecord14Panel04({ facilityId, title = 'SampleRecord14 Workspace', onSelect }: SampleRecord14Panel04Props) {
  ...
  return (
    <section className="lis-panel lis-panel--samples" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} samples records (slice 14-04)
      </footer>
    </section>
  );
}

export default SampleRecord14Panel04;
