...
export interface SampleRecord19Panel01Props {
  facilityId: string;
  title?: string;
...
/**
 * SampleRecord19Panel01 — operational panel for samples domain slice 19/01.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function SampleRecord19Panel01({ facilityId, title = 'SampleRecord19 Workspace', onSelect }: SampleRecord19Panel01Props) {
  ...
  return (
    <section className="lis-panel lis-panel--samples" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} samples records (slice 19-01)
      </footer>
    </section>
  );
}

export default SampleRecord19Panel01;
