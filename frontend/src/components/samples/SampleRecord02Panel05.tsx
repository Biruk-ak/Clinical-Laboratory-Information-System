...
export interface SampleRecord02Panel05Props {
  facilityId: string;
  title?: string;
...
/**
 * SampleRecord02Panel05 — operational panel for samples domain slice 02/05.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function SampleRecord02Panel05({ facilityId, title = 'SampleRecord02 Workspace', onSelect }: SampleRecord02Panel05Props) {
  ...
  return (
    <section className="lis-panel lis-panel--samples" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} samples records (slice 02-05)
      </footer>
    </section>
  );
}

export default SampleRecord02Panel05;
