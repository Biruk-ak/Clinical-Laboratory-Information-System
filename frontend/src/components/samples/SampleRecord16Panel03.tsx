...
export interface SampleRecord16Panel03Props {
  facilityId: string;
  title?: string;
...
/**
 * SampleRecord16Panel03 — operational panel for samples domain slice 16/03.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function SampleRecord16Panel03({ facilityId, title = 'SampleRecord16 Workspace', onSelect }: SampleRecord16Panel03Props) {
  ...
  return (
    <section className="lis-panel lis-panel--samples" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} samples records (slice 16-03)
      </footer>
    </section>
  );
}

export default SampleRecord16Panel03;
