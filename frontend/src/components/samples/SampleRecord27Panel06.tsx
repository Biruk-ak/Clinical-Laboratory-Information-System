...
export interface SampleRecord27Panel06Props {
  facilityId: string;
  title?: string;
...
/**
 * SampleRecord27Panel06 — operational panel for samples domain slice 27/06.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function SampleRecord27Panel06({ facilityId, title = 'SampleRecord27 Workspace', onSelect }: SampleRecord27Panel06Props) {
  ...
  return (
    <section className="lis-panel lis-panel--samples" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} samples records (slice 27-06)
      </footer>
    </section>
  );
}

export default SampleRecord27Panel06;
