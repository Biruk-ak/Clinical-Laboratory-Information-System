...
export interface SampleRecord07Panel06Props {
  facilityId: string;
  title?: string;
...
/**
 * SampleRecord07Panel06 — operational panel for samples domain slice 07/06.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function SampleRecord07Panel06({ facilityId, title = 'SampleRecord07 Workspace', onSelect }: SampleRecord07Panel06Props) {
  ...
  return (
    <section className="lis-panel lis-panel--samples" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} samples records (slice 07-06)
      </footer>
    </section>
  );
}

export default SampleRecord07Panel06;
