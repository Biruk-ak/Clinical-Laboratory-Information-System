...
export interface SampleRecord03Panel06Props {
  facilityId: string;
  title?: string;
...
/**
 * SampleRecord03Panel06 — operational panel for samples domain slice 03/06.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function SampleRecord03Panel06({ facilityId, title = 'SampleRecord03 Workspace', onSelect }: SampleRecord03Panel06Props) {
  ...
  return (
    <section className="lis-panel lis-panel--samples" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} samples records (slice 03-06)
      </footer>
    </section>
  );
}

export default SampleRecord03Panel06;
