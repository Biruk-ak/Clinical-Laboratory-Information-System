...
export interface SampleRecord14Panel02Props {
  facilityId: string;
  title?: string;
...
/**
 * SampleRecord14Panel02 — operational panel for samples domain slice 14/02.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function SampleRecord14Panel02({ facilityId, title = 'SampleRecord14 Workspace', onSelect }: SampleRecord14Panel02Props) {
  ...
  return (
    <section className="lis-panel lis-panel--samples" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} samples records (slice 14-02)
      </footer>
    </section>
  );
}

export default SampleRecord14Panel02;
