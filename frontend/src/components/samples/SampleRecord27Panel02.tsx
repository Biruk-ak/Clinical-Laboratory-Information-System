...
export interface SampleRecord27Panel02Props {
  facilityId: string;
  title?: string;
...
/**
 * SampleRecord27Panel02 — operational panel for samples domain slice 27/02.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function SampleRecord27Panel02({ facilityId, title = 'SampleRecord27 Workspace', onSelect }: SampleRecord27Panel02Props) {
  ...
  return (
    <section className="lis-panel lis-panel--samples" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} samples records (slice 27-02)
      </footer>
    </section>
  );
}

export default SampleRecord27Panel02;
