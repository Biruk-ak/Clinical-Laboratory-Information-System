...
export interface SampleRecord18Panel04Props {
  facilityId: string;
  title?: string;
...
/**
 * SampleRecord18Panel04 — operational panel for samples domain slice 18/04.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function SampleRecord18Panel04({ facilityId, title = 'SampleRecord18 Workspace', onSelect }: SampleRecord18Panel04Props) {
  ...
  return (
    <section className="lis-panel lis-panel--samples" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} samples records (slice 18-04)
      </footer>
    </section>
  );
}

export default SampleRecord18Panel04;
