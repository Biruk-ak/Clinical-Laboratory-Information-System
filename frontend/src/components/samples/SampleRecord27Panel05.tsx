...
export interface SampleRecord27Panel05Props {
  facilityId: string;
  title?: string;
...
/**
 * SampleRecord27Panel05 — operational panel for samples domain slice 27/05.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function SampleRecord27Panel05({ facilityId, title = 'SampleRecord27 Workspace', onSelect }: SampleRecord27Panel05Props) {
  ...
  return (
    <section className="lis-panel lis-panel--samples" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} samples records (slice 27-05)
      </footer>
    </section>
  );
}

export default SampleRecord27Panel05;
