...
export interface SampleRecord22Panel04Props {
  facilityId: string;
  title?: string;
...
/**
 * SampleRecord22Panel04 — operational panel for samples domain slice 22/04.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function SampleRecord22Panel04({ facilityId, title = 'SampleRecord22 Workspace', onSelect }: SampleRecord22Panel04Props) {
  ...
  return (
    <section className="lis-panel lis-panel--samples" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} samples records (slice 22-04)
      </footer>
    </section>
  );
}

export default SampleRecord22Panel04;
