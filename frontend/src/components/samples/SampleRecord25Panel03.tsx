...
export interface SampleRecord25Panel03Props {
  facilityId: string;
  title?: string;
...
/**
 * SampleRecord25Panel03 — operational panel for samples domain slice 25/03.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function SampleRecord25Panel03({ facilityId, title = 'SampleRecord25 Workspace', onSelect }: SampleRecord25Panel03Props) {
  ...
  return (
    <section className="lis-panel lis-panel--samples" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} samples records (slice 25-03)
      </footer>
    </section>
  );
}

export default SampleRecord25Panel03;
