...
export interface SampleRecord13Panel02Props {
  facilityId: string;
  title?: string;
...
/**
 * SampleRecord13Panel02 — operational panel for samples domain slice 13/02.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function SampleRecord13Panel02({ facilityId, title = 'SampleRecord13 Workspace', onSelect }: SampleRecord13Panel02Props) {
  ...
  return (
    <section className="lis-panel lis-panel--samples" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} samples records (slice 13-02)
      </footer>
    </section>
  );
}

export default SampleRecord13Panel02;
