...
export interface SampleRecord03Panel02Props {
  facilityId: string;
  title?: string;
...
/**
 * SampleRecord03Panel02 — operational panel for samples domain slice 03/02.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function SampleRecord03Panel02({ facilityId, title = 'SampleRecord03 Workspace', onSelect }: SampleRecord03Panel02Props) {
  ...
  return (
    <section className="lis-panel lis-panel--samples" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} samples records (slice 03-02)
      </footer>
    </section>
  );
}

export default SampleRecord03Panel02;
