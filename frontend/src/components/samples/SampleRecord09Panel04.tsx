...
export interface SampleRecord09Panel04Props {
  facilityId: string;
  title?: string;
...
/**
 * SampleRecord09Panel04 — operational panel for samples domain slice 09/04.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function SampleRecord09Panel04({ facilityId, title = 'SampleRecord09 Workspace', onSelect }: SampleRecord09Panel04Props) {
  ...
  return (
    <section className="lis-panel lis-panel--samples" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} samples records (slice 09-04)
      </footer>
    </section>
  );
}

export default SampleRecord09Panel04;
