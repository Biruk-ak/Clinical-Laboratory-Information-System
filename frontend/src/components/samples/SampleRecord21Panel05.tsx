...
export interface SampleRecord21Panel05Props {
  facilityId: string;
  title?: string;
...
/**
 * SampleRecord21Panel05 — operational panel for samples domain slice 21/05.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function SampleRecord21Panel05({ facilityId, title = 'SampleRecord21 Workspace', onSelect }: SampleRecord21Panel05Props) {
  ...
  return (
    <section className="lis-panel lis-panel--samples" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} samples records (slice 21-05)
      </footer>
    </section>
  );
}

export default SampleRecord21Panel05;
