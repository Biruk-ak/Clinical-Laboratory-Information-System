...
export interface SampleRecord05Panel04Props {
  facilityId: string;
  title?: string;
...
/**
 * SampleRecord05Panel04 — operational panel for samples domain slice 05/04.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function SampleRecord05Panel04({ facilityId, title = 'SampleRecord05 Workspace', onSelect }: SampleRecord05Panel04Props) {
  ...
  return (
    <section className="lis-panel lis-panel--samples" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} samples records (slice 05-04)
      </footer>
    </section>
  );
}

export default SampleRecord05Panel04;
