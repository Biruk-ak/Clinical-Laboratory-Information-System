...
export interface SampleRecord02Panel06Props {
  facilityId: string;
  title?: string;
...
/**
 * SampleRecord02Panel06 — operational panel for samples domain slice 02/06.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function SampleRecord02Panel06({ facilityId, title = 'SampleRecord02 Workspace', onSelect }: SampleRecord02Panel06Props) {
  ...
  return (
    <section className="lis-panel lis-panel--samples" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} samples records (slice 02-06)
      </footer>
    </section>
  );
}

export default SampleRecord02Panel06;
