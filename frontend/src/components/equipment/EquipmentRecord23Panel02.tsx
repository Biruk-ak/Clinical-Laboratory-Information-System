...
export interface EquipmentRecord23Panel02Props {
  facilityId: string;
  title?: string;
...
/**
 * EquipmentRecord23Panel02 — operational panel for equipment domain slice 23/02.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function EquipmentRecord23Panel02({ facilityId, title = 'EquipmentRecord23 Workspace', onSelect }: EquipmentRecord23Panel02Props) {
  ...
  return (
    <section className="lis-panel lis-panel--equipment" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} equipment records (slice 23-02)
      </footer>
    </section>
  );
}

export default EquipmentRecord23Panel02;
