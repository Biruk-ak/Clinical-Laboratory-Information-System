...
export interface EquipmentRecord23Panel04Props {
  facilityId: string;
  title?: string;
...
/**
 * EquipmentRecord23Panel04 — operational panel for equipment domain slice 23/04.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function EquipmentRecord23Panel04({ facilityId, title = 'EquipmentRecord23 Workspace', onSelect }: EquipmentRecord23Panel04Props) {
  ...
  return (
    <section className="lis-panel lis-panel--equipment" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} equipment records (slice 23-04)
      </footer>
    </section>
  );
}

export default EquipmentRecord23Panel04;
