...
export interface EquipmentRecord09Panel01Props {
  facilityId: string;
  title?: string;
...
/**
 * EquipmentRecord09Panel01 — operational panel for equipment domain slice 09/01.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function EquipmentRecord09Panel01({ facilityId, title = 'EquipmentRecord09 Workspace', onSelect }: EquipmentRecord09Panel01Props) {
  ...
  return (
    <section className="lis-panel lis-panel--equipment" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} equipment records (slice 09-01)
      </footer>
    </section>
  );
}

export default EquipmentRecord09Panel01;
