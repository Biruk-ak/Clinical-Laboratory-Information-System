...
export interface EquipmentRecord06Panel05Props {
  facilityId: string;
  title?: string;
...
/**
 * EquipmentRecord06Panel05 — operational panel for equipment domain slice 06/05.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function EquipmentRecord06Panel05({ facilityId, title = 'EquipmentRecord06 Workspace', onSelect }: EquipmentRecord06Panel05Props) {
  ...
  return (
    <section className="lis-panel lis-panel--equipment" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} equipment records (slice 06-05)
      </footer>
    </section>
  );
}

export default EquipmentRecord06Panel05;
