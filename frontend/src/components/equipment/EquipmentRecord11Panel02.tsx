...
export interface EquipmentRecord11Panel02Props {
  facilityId: string;
  title?: string;
...
/**
 * EquipmentRecord11Panel02 — operational panel for equipment domain slice 11/02.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function EquipmentRecord11Panel02({ facilityId, title = 'EquipmentRecord11 Workspace', onSelect }: EquipmentRecord11Panel02Props) {
  ...
  return (
    <section className="lis-panel lis-panel--equipment" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} equipment records (slice 11-02)
      </footer>
    </section>
  );
}

export default EquipmentRecord11Panel02;
