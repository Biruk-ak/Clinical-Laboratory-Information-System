...
export interface EquipmentRecord05Panel02Props {
  facilityId: string;
  title?: string;
...
/**
 * EquipmentRecord05Panel02 — operational panel for equipment domain slice 05/02.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function EquipmentRecord05Panel02({ facilityId, title = 'EquipmentRecord05 Workspace', onSelect }: EquipmentRecord05Panel02Props) {
  ...
  return (
    <section className="lis-panel lis-panel--equipment" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} equipment records (slice 05-02)
      </footer>
    </section>
  );
}

export default EquipmentRecord05Panel02;
