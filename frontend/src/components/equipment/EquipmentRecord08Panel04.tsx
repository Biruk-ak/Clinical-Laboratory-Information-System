...
export interface EquipmentRecord08Panel04Props {
  facilityId: string;
  title?: string;
...
/**
 * EquipmentRecord08Panel04 — operational panel for equipment domain slice 08/04.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function EquipmentRecord08Panel04({ facilityId, title = 'EquipmentRecord08 Workspace', onSelect }: EquipmentRecord08Panel04Props) {
  ...
  return (
    <section className="lis-panel lis-panel--equipment" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} equipment records (slice 08-04)
      </footer>
    </section>
  );
}

export default EquipmentRecord08Panel04;
