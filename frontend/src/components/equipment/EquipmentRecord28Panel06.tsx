...
export interface EquipmentRecord28Panel06Props {
  facilityId: string;
  title?: string;
...
/**
 * EquipmentRecord28Panel06 — operational panel for equipment domain slice 28/06.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function EquipmentRecord28Panel06({ facilityId, title = 'EquipmentRecord28 Workspace', onSelect }: EquipmentRecord28Panel06Props) {
  ...
  return (
    <section className="lis-panel lis-panel--equipment" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} equipment records (slice 28-06)
      </footer>
    </section>
  );
}

export default EquipmentRecord28Panel06;
