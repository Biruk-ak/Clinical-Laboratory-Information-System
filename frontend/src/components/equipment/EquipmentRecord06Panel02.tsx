...
export interface EquipmentRecord06Panel02Props {
  facilityId: string;
  title?: string;
...
/**
 * EquipmentRecord06Panel02 — operational panel for equipment domain slice 06/02.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function EquipmentRecord06Panel02({ facilityId, title = 'EquipmentRecord06 Workspace', onSelect }: EquipmentRecord06Panel02Props) {
  ...
  return (
    <section className="lis-panel lis-panel--equipment" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} equipment records (slice 06-02)
      </footer>
    </section>
  );
}

export default EquipmentRecord06Panel02;
