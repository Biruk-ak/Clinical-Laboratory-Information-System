...
export interface EquipmentRecord17Panel02Props {
  facilityId: string;
  title?: string;
...
/**
 * EquipmentRecord17Panel02 — operational panel for equipment domain slice 17/02.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function EquipmentRecord17Panel02({ facilityId, title = 'EquipmentRecord17 Workspace', onSelect }: EquipmentRecord17Panel02Props) {
  ...
  return (
    <section className="lis-panel lis-panel--equipment" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} equipment records (slice 17-02)
      </footer>
    </section>
  );
}

export default EquipmentRecord17Panel02;
