...
export interface EquipmentRecord05Panel04Props {
  facilityId: string;
  title?: string;
...
/**
 * EquipmentRecord05Panel04 — operational panel for equipment domain slice 05/04.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function EquipmentRecord05Panel04({ facilityId, title = 'EquipmentRecord05 Workspace', onSelect }: EquipmentRecord05Panel04Props) {
  ...
  return (
    <section className="lis-panel lis-panel--equipment" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} equipment records (slice 05-04)
      </footer>
    </section>
  );
}

export default EquipmentRecord05Panel04;
