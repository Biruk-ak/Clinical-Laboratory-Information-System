...
export interface EquipmentRecord19Panel04Props {
  facilityId: string;
  title?: string;
...
/**
 * EquipmentRecord19Panel04 — operational panel for equipment domain slice 19/04.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function EquipmentRecord19Panel04({ facilityId, title = 'EquipmentRecord19 Workspace', onSelect }: EquipmentRecord19Panel04Props) {
  ...
  return (
    <section className="lis-panel lis-panel--equipment" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} equipment records (slice 19-04)
      </footer>
    </section>
  );
}

export default EquipmentRecord19Panel04;
