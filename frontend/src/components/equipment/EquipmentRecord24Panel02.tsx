...
export interface EquipmentRecord24Panel02Props {
  facilityId: string;
  title?: string;
...
/**
 * EquipmentRecord24Panel02 — operational panel for equipment domain slice 24/02.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function EquipmentRecord24Panel02({ facilityId, title = 'EquipmentRecord24 Workspace', onSelect }: EquipmentRecord24Panel02Props) {
  ...
  return (
    <section className="lis-panel lis-panel--equipment" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} equipment records (slice 24-02)
      </footer>
    </section>
  );
}

export default EquipmentRecord24Panel02;
