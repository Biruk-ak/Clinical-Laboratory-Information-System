...
export interface EquipmentRecord11Panel03Props {
  facilityId: string;
  title?: string;
...
/**
 * EquipmentRecord11Panel03 — operational panel for equipment domain slice 11/03.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function EquipmentRecord11Panel03({ facilityId, title = 'EquipmentRecord11 Workspace', onSelect }: EquipmentRecord11Panel03Props) {
  ...
  return (
    <section className="lis-panel lis-panel--equipment" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} equipment records (slice 11-03)
      </footer>
    </section>
  );
}

export default EquipmentRecord11Panel03;
