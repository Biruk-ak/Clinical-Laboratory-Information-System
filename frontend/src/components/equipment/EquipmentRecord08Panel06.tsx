...
export interface EquipmentRecord08Panel06Props {
  facilityId: string;
  title?: string;
...
/**
 * EquipmentRecord08Panel06 — operational panel for equipment domain slice 08/06.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function EquipmentRecord08Panel06({ facilityId, title = 'EquipmentRecord08 Workspace', onSelect }: EquipmentRecord08Panel06Props) {
  ...
  return (
    <section className="lis-panel lis-panel--equipment" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} equipment records (slice 08-06)
      </footer>
    </section>
  );
}

export default EquipmentRecord08Panel06;
