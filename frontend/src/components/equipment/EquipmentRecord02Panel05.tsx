...
export interface EquipmentRecord02Panel05Props {
  facilityId: string;
  title?: string;
...
/**
 * EquipmentRecord02Panel05 — operational panel for equipment domain slice 02/05.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function EquipmentRecord02Panel05({ facilityId, title = 'EquipmentRecord02 Workspace', onSelect }: EquipmentRecord02Panel05Props) {
  ...
  return (
    <section className="lis-panel lis-panel--equipment" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} equipment records (slice 02-05)
      </footer>
    </section>
  );
}

export default EquipmentRecord02Panel05;
