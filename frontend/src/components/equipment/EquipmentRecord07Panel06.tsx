...
export interface EquipmentRecord07Panel06Props {
  facilityId: string;
  title?: string;
...
/**
 * EquipmentRecord07Panel06 — operational panel for equipment domain slice 07/06.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function EquipmentRecord07Panel06({ facilityId, title = 'EquipmentRecord07 Workspace', onSelect }: EquipmentRecord07Panel06Props) {
  ...
  return (
    <section className="lis-panel lis-panel--equipment" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} equipment records (slice 07-06)
      </footer>
    </section>
  );
}

export default EquipmentRecord07Panel06;
