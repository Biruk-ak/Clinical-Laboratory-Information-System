...
export interface EquipmentRecord07Panel02Props {
  facilityId: string;
  title?: string;
...
/**
 * EquipmentRecord07Panel02 — operational panel for equipment domain slice 07/02.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function EquipmentRecord07Panel02({ facilityId, title = 'EquipmentRecord07 Workspace', onSelect }: EquipmentRecord07Panel02Props) {
  ...
  return (
    <section className="lis-panel lis-panel--equipment" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} equipment records (slice 07-02)
      </footer>
    </section>
  );
}

export default EquipmentRecord07Panel02;
