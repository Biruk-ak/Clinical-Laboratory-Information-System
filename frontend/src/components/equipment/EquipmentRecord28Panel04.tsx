...
export interface EquipmentRecord28Panel04Props {
  facilityId: string;
  title?: string;
...
/**
 * EquipmentRecord28Panel04 — operational panel for equipment domain slice 28/04.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function EquipmentRecord28Panel04({ facilityId, title = 'EquipmentRecord28 Workspace', onSelect }: EquipmentRecord28Panel04Props) {
  ...
  return (
    <section className="lis-panel lis-panel--equipment" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} equipment records (slice 28-04)
      </footer>
    </section>
  );
}

export default EquipmentRecord28Panel04;
