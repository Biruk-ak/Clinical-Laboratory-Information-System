...
export interface EquipmentRecord09Panel05Props {
  facilityId: string;
  title?: string;
...
/**
 * EquipmentRecord09Panel05 — operational panel for equipment domain slice 09/05.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function EquipmentRecord09Panel05({ facilityId, title = 'EquipmentRecord09 Workspace', onSelect }: EquipmentRecord09Panel05Props) {
  ...
  return (
    <section className="lis-panel lis-panel--equipment" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} equipment records (slice 09-05)
      </footer>
    </section>
  );
}

export default EquipmentRecord09Panel05;
