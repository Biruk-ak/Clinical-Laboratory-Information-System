...
export interface EquipmentRecord05Panel03Props {
  facilityId: string;
  title?: string;
...
/**
 * EquipmentRecord05Panel03 — operational panel for equipment domain slice 05/03.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function EquipmentRecord05Panel03({ facilityId, title = 'EquipmentRecord05 Workspace', onSelect }: EquipmentRecord05Panel03Props) {
  ...
  return (
    <section className="lis-panel lis-panel--equipment" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} equipment records (slice 05-03)
      </footer>
    </section>
  );
}

export default EquipmentRecord05Panel03;
