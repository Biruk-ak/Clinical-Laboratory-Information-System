...
export interface EquipmentRecord06Panel03Props {
  facilityId: string;
  title?: string;
...
/**
 * EquipmentRecord06Panel03 — operational panel for equipment domain slice 06/03.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function EquipmentRecord06Panel03({ facilityId, title = 'EquipmentRecord06 Workspace', onSelect }: EquipmentRecord06Panel03Props) {
  ...
  return (
    <section className="lis-panel lis-panel--equipment" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} equipment records (slice 06-03)
      </footer>
    </section>
  );
}

export default EquipmentRecord06Panel03;
