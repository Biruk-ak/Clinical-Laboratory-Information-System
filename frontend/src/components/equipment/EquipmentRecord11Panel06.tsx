...
export interface EquipmentRecord11Panel06Props {
  facilityId: string;
  title?: string;
...
/**
 * EquipmentRecord11Panel06 — operational panel for equipment domain slice 11/06.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function EquipmentRecord11Panel06({ facilityId, title = 'EquipmentRecord11 Workspace', onSelect }: EquipmentRecord11Panel06Props) {
  ...
  return (
    <section className="lis-panel lis-panel--equipment" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} equipment records (slice 11-06)
      </footer>
    </section>
  );
}

export default EquipmentRecord11Panel06;
