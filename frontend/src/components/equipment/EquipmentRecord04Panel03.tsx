...
export interface EquipmentRecord04Panel03Props {
  facilityId: string;
  title?: string;
...
/**
 * EquipmentRecord04Panel03 — operational panel for equipment domain slice 04/03.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function EquipmentRecord04Panel03({ facilityId, title = 'EquipmentRecord04 Workspace', onSelect }: EquipmentRecord04Panel03Props) {
  ...
  return (
    <section className="lis-panel lis-panel--equipment" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} equipment records (slice 04-03)
      </footer>
    </section>
  );
}

export default EquipmentRecord04Panel03;
