...
export interface EquipmentRecord17Panel06Props {
  facilityId: string;
  title?: string;
...
/**
 * EquipmentRecord17Panel06 — operational panel for equipment domain slice 17/06.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function EquipmentRecord17Panel06({ facilityId, title = 'EquipmentRecord17 Workspace', onSelect }: EquipmentRecord17Panel06Props) {
  ...
  return (
    <section className="lis-panel lis-panel--equipment" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} equipment records (slice 17-06)
      </footer>
    </section>
  );
}

export default EquipmentRecord17Panel06;
