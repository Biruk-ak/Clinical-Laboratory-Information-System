...
export interface EquipmentRecord24Panel01Props {
  facilityId: string;
  title?: string;
...
/**
 * EquipmentRecord24Panel01 — operational panel for equipment domain slice 24/01.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function EquipmentRecord24Panel01({ facilityId, title = 'EquipmentRecord24 Workspace', onSelect }: EquipmentRecord24Panel01Props) {
  ...
  return (
    <section className="lis-panel lis-panel--equipment" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} equipment records (slice 24-01)
      </footer>
    </section>
  );
}

export default EquipmentRecord24Panel01;
