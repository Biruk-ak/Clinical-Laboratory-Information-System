...
export interface EquipmentRecord04Panel06Props {
  facilityId: string;
  title?: string;
...
/**
 * EquipmentRecord04Panel06 — operational panel for equipment domain slice 04/06.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function EquipmentRecord04Panel06({ facilityId, title = 'EquipmentRecord04 Workspace', onSelect }: EquipmentRecord04Panel06Props) {
  ...
  return (
    <section className="lis-panel lis-panel--equipment" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} equipment records (slice 04-06)
      </footer>
    </section>
  );
}

export default EquipmentRecord04Panel06;
