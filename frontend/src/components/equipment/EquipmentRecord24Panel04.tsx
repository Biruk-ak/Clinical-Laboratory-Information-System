...
export interface EquipmentRecord24Panel04Props {
  facilityId: string;
  title?: string;
...
/**
 * EquipmentRecord24Panel04 — operational panel for equipment domain slice 24/04.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function EquipmentRecord24Panel04({ facilityId, title = 'EquipmentRecord24 Workspace', onSelect }: EquipmentRecord24Panel04Props) {
  ...
  return (
    <section className="lis-panel lis-panel--equipment" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} equipment records (slice 24-04)
      </footer>
    </section>
  );
}

export default EquipmentRecord24Panel04;
