...
export interface EquipmentRecord28Panel05Props {
  facilityId: string;
  title?: string;
...
/**
 * EquipmentRecord28Panel05 — operational panel for equipment domain slice 28/05.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function EquipmentRecord28Panel05({ facilityId, title = 'EquipmentRecord28 Workspace', onSelect }: EquipmentRecord28Panel05Props) {
  ...
  return (
    <section className="lis-panel lis-panel--equipment" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} equipment records (slice 28-05)
      </footer>
    </section>
  );
}

export default EquipmentRecord28Panel05;
