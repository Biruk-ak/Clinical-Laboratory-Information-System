...
export interface EquipmentRecord04Panel05Props {
  facilityId: string;
  title?: string;
...
/**
 * EquipmentRecord04Panel05 — operational panel for equipment domain slice 04/05.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function EquipmentRecord04Panel05({ facilityId, title = 'EquipmentRecord04 Workspace', onSelect }: EquipmentRecord04Panel05Props) {
  ...
  return (
    <section className="lis-panel lis-panel--equipment" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} equipment records (slice 04-05)
      </footer>
    </section>
  );
}

export default EquipmentRecord04Panel05;
