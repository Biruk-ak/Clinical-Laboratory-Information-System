...
export interface EquipmentRecord20Panel06Props {
  facilityId: string;
  title?: string;
...
/**
 * EquipmentRecord20Panel06 — operational panel for equipment domain slice 20/06.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function EquipmentRecord20Panel06({ facilityId, title = 'EquipmentRecord20 Workspace', onSelect }: EquipmentRecord20Panel06Props) {
  ...
  return (
    <section className="lis-panel lis-panel--equipment" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} equipment records (slice 20-06)
      </footer>
    </section>
  );
}

export default EquipmentRecord20Panel06;
