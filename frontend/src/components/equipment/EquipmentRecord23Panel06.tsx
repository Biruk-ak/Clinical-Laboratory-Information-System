...
export interface EquipmentRecord23Panel06Props {
  facilityId: string;
  title?: string;
...
/**
 * EquipmentRecord23Panel06 — operational panel for equipment domain slice 23/06.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function EquipmentRecord23Panel06({ facilityId, title = 'EquipmentRecord23 Workspace', onSelect }: EquipmentRecord23Panel06Props) {
  ...
  return (
    <section className="lis-panel lis-panel--equipment" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} equipment records (slice 23-06)
      </footer>
    </section>
  );
}

export default EquipmentRecord23Panel06;
