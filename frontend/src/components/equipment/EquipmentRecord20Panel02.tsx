...
export interface EquipmentRecord20Panel02Props {
  facilityId: string;
  title?: string;
...
/**
 * EquipmentRecord20Panel02 — operational panel for equipment domain slice 20/02.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function EquipmentRecord20Panel02({ facilityId, title = 'EquipmentRecord20 Workspace', onSelect }: EquipmentRecord20Panel02Props) {
  ...
  return (
    <section className="lis-panel lis-panel--equipment" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} equipment records (slice 20-02)
      </footer>
    </section>
  );
}

export default EquipmentRecord20Panel02;
