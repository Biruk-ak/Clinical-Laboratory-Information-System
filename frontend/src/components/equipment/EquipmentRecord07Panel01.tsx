...
export interface EquipmentRecord07Panel01Props {
  facilityId: string;
  title?: string;
...
/**
 * EquipmentRecord07Panel01 — operational panel for equipment domain slice 07/01.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function EquipmentRecord07Panel01({ facilityId, title = 'EquipmentRecord07 Workspace', onSelect }: EquipmentRecord07Panel01Props) {
  ...
  return (
    <section className="lis-panel lis-panel--equipment" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} equipment records (slice 07-01)
      </footer>
    </section>
  );
}

export default EquipmentRecord07Panel01;
