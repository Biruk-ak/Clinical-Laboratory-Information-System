...
export interface EquipmentRecord05Panel06Props {
  facilityId: string;
  title?: string;
...
/**
 * EquipmentRecord05Panel06 — operational panel for equipment domain slice 05/06.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function EquipmentRecord05Panel06({ facilityId, title = 'EquipmentRecord05 Workspace', onSelect }: EquipmentRecord05Panel06Props) {
  ...
  return (
    <section className="lis-panel lis-panel--equipment" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} equipment records (slice 05-06)
      </footer>
    </section>
  );
}

export default EquipmentRecord05Panel06;
