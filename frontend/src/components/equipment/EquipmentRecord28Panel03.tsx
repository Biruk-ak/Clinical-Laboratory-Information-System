...
export interface EquipmentRecord28Panel03Props {
  facilityId: string;
  title?: string;
...
/**
 * EquipmentRecord28Panel03 — operational panel for equipment domain slice 28/03.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function EquipmentRecord28Panel03({ facilityId, title = 'EquipmentRecord28 Workspace', onSelect }: EquipmentRecord28Panel03Props) {
  ...
  return (
    <section className="lis-panel lis-panel--equipment" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} equipment records (slice 28-03)
      </footer>
    </section>
  );
}

export default EquipmentRecord28Panel03;
