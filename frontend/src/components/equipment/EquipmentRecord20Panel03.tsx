...
export interface EquipmentRecord20Panel03Props {
  facilityId: string;
  title?: string;
...
/**
 * EquipmentRecord20Panel03 — operational panel for equipment domain slice 20/03.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function EquipmentRecord20Panel03({ facilityId, title = 'EquipmentRecord20 Workspace', onSelect }: EquipmentRecord20Panel03Props) {
  ...
  return (
    <section className="lis-panel lis-panel--equipment" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} equipment records (slice 20-03)
      </footer>
    </section>
  );
}

export default EquipmentRecord20Panel03;
