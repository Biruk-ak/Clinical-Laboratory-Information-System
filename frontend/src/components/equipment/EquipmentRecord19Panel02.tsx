...
export interface EquipmentRecord19Panel02Props {
  facilityId: string;
  title?: string;
...
/**
 * EquipmentRecord19Panel02 — operational panel for equipment domain slice 19/02.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function EquipmentRecord19Panel02({ facilityId, title = 'EquipmentRecord19 Workspace', onSelect }: EquipmentRecord19Panel02Props) {
  ...
  return (
    <section className="lis-panel lis-panel--equipment" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} equipment records (slice 19-02)
      </footer>
    </section>
  );
}

export default EquipmentRecord19Panel02;
