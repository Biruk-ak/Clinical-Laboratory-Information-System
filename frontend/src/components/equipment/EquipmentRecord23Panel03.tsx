...
export interface EquipmentRecord23Panel03Props {
  facilityId: string;
  title?: string;
...
/**
 * EquipmentRecord23Panel03 — operational panel for equipment domain slice 23/03.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function EquipmentRecord23Panel03({ facilityId, title = 'EquipmentRecord23 Workspace', onSelect }: EquipmentRecord23Panel03Props) {
  ...
  return (
    <section className="lis-panel lis-panel--equipment" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} equipment records (slice 23-03)
      </footer>
    </section>
  );
}

export default EquipmentRecord23Panel03;
