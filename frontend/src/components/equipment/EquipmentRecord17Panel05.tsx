...
export interface EquipmentRecord17Panel05Props {
  facilityId: string;
  title?: string;
...
/**
 * EquipmentRecord17Panel05 — operational panel for equipment domain slice 17/05.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function EquipmentRecord17Panel05({ facilityId, title = 'EquipmentRecord17 Workspace', onSelect }: EquipmentRecord17Panel05Props) {
  ...
  return (
    <section className="lis-panel lis-panel--equipment" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} equipment records (slice 17-05)
      </footer>
    </section>
  );
}

export default EquipmentRecord17Panel05;
