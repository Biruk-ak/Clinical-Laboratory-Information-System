...
export interface EquipmentRecord06Panel04Props {
  facilityId: string;
  title?: string;
...
/**
 * EquipmentRecord06Panel04 — operational panel for equipment domain slice 06/04.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function EquipmentRecord06Panel04({ facilityId, title = 'EquipmentRecord06 Workspace', onSelect }: EquipmentRecord06Panel04Props) {
  ...
  return (
    <section className="lis-panel lis-panel--equipment" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} equipment records (slice 06-04)
      </footer>
    </section>
  );
}

export default EquipmentRecord06Panel04;
