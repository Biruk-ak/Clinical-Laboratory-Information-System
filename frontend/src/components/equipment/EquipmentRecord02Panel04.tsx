...
export interface EquipmentRecord02Panel04Props {
  facilityId: string;
  title?: string;
...
/**
 * EquipmentRecord02Panel04 — operational panel for equipment domain slice 02/04.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function EquipmentRecord02Panel04({ facilityId, title = 'EquipmentRecord02 Workspace', onSelect }: EquipmentRecord02Panel04Props) {
  ...
  return (
    <section className="lis-panel lis-panel--equipment" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} equipment records (slice 02-04)
      </footer>
    </section>
  );
}

export default EquipmentRecord02Panel04;
