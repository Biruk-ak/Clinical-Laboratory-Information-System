...
export interface QualityControlRecord11Panel04Props {
  facilityId: string;
  title?: string;
...
/**
 * QualityControlRecord11Panel04 — operational panel for qualitycontrol domain slice 11/04.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function QualityControlRecord11Panel04({ facilityId, title = 'QualityControlRecord11 Workspace', onSelect }: QualityControlRecord11Panel04Props) {
  ...
  return (
    <section className="lis-panel lis-panel--qualitycontrol" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} qualitycontrol records (slice 11-04)
      </footer>
    </section>
  );
}

export default QualityControlRecord11Panel04;
