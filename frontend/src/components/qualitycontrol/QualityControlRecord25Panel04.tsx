...
export interface QualityControlRecord25Panel04Props {
  facilityId: string;
  title?: string;
...
/**
 * QualityControlRecord25Panel04 — operational panel for qualitycontrol domain slice 25/04.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function QualityControlRecord25Panel04({ facilityId, title = 'QualityControlRecord25 Workspace', onSelect }: QualityControlRecord25Panel04Props) {
  ...
  return (
    <section className="lis-panel lis-panel--qualitycontrol" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} qualitycontrol records (slice 25-04)
      </footer>
    </section>
  );
}

export default QualityControlRecord25Panel04;
