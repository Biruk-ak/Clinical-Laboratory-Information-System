...
export interface QualityControlRecord27Panel04Props {
  facilityId: string;
  title?: string;
...
/**
 * QualityControlRecord27Panel04 — operational panel for qualitycontrol domain slice 27/04.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function QualityControlRecord27Panel04({ facilityId, title = 'QualityControlRecord27 Workspace', onSelect }: QualityControlRecord27Panel04Props) {
  ...
  return (
    <section className="lis-panel lis-panel--qualitycontrol" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} qualitycontrol records (slice 27-04)
      </footer>
    </section>
  );
}

export default QualityControlRecord27Panel04;
