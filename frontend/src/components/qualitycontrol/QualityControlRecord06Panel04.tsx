...
export interface QualityControlRecord06Panel04Props {
  facilityId: string;
  title?: string;
...
/**
 * QualityControlRecord06Panel04 — operational panel for qualitycontrol domain slice 06/04.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function QualityControlRecord06Panel04({ facilityId, title = 'QualityControlRecord06 Workspace', onSelect }: QualityControlRecord06Panel04Props) {
  ...
  return (
    <section className="lis-panel lis-panel--qualitycontrol" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} qualitycontrol records (slice 06-04)
      </footer>
    </section>
  );
}

export default QualityControlRecord06Panel04;
