...
export interface QualityControlRecord17Panel05Props {
  facilityId: string;
  title?: string;
...
/**
 * QualityControlRecord17Panel05 — operational panel for qualitycontrol domain slice 17/05.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function QualityControlRecord17Panel05({ facilityId, title = 'QualityControlRecord17 Workspace', onSelect }: QualityControlRecord17Panel05Props) {
  ...
  return (
    <section className="lis-panel lis-panel--qualitycontrol" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} qualitycontrol records (slice 17-05)
      </footer>
    </section>
  );
}

export default QualityControlRecord17Panel05;
