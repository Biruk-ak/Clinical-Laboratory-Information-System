...
export interface QualityControlRecord10Panel06Props {
  facilityId: string;
  title?: string;
...
/**
 * QualityControlRecord10Panel06 — operational panel for qualitycontrol domain slice 10/06.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function QualityControlRecord10Panel06({ facilityId, title = 'QualityControlRecord10 Workspace', onSelect }: QualityControlRecord10Panel06Props) {
  ...
  return (
    <section className="lis-panel lis-panel--qualitycontrol" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} qualitycontrol records (slice 10-06)
      </footer>
    </section>
  );
}

export default QualityControlRecord10Panel06;
