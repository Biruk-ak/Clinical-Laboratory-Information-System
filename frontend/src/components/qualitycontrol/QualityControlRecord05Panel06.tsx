...
export interface QualityControlRecord05Panel06Props {
  facilityId: string;
  title?: string;
...
/**
 * QualityControlRecord05Panel06 — operational panel for qualitycontrol domain slice 05/06.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function QualityControlRecord05Panel06({ facilityId, title = 'QualityControlRecord05 Workspace', onSelect }: QualityControlRecord05Panel06Props) {
  ...
  return (
    <section className="lis-panel lis-panel--qualitycontrol" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} qualitycontrol records (slice 05-06)
      </footer>
    </section>
  );
}

export default QualityControlRecord05Panel06;
