...
export interface QualityControlRecord24Panel06Props {
  facilityId: string;
  title?: string;
...
/**
 * QualityControlRecord24Panel06 — operational panel for qualitycontrol domain slice 24/06.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function QualityControlRecord24Panel06({ facilityId, title = 'QualityControlRecord24 Workspace', onSelect }: QualityControlRecord24Panel06Props) {
  ...
  return (
    <section className="lis-panel lis-panel--qualitycontrol" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} qualitycontrol records (slice 24-06)
      </footer>
    </section>
  );
}

export default QualityControlRecord24Panel06;
