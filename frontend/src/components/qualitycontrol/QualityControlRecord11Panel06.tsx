...
export interface QualityControlRecord11Panel06Props {
  facilityId: string;
  title?: string;
...
/**
 * QualityControlRecord11Panel06 — operational panel for qualitycontrol domain slice 11/06.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function QualityControlRecord11Panel06({ facilityId, title = 'QualityControlRecord11 Workspace', onSelect }: QualityControlRecord11Panel06Props) {
  ...
  return (
    <section className="lis-panel lis-panel--qualitycontrol" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} qualitycontrol records (slice 11-06)
      </footer>
    </section>
  );
}

export default QualityControlRecord11Panel06;
