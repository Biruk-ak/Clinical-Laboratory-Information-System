...
export interface QualityControlRecord10Panel02Props {
  facilityId: string;
  title?: string;
...
/**
 * QualityControlRecord10Panel02 — operational panel for qualitycontrol domain slice 10/02.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function QualityControlRecord10Panel02({ facilityId, title = 'QualityControlRecord10 Workspace', onSelect }: QualityControlRecord10Panel02Props) {
  ...
  return (
    <section className="lis-panel lis-panel--qualitycontrol" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} qualitycontrol records (slice 10-02)
      </footer>
    </section>
  );
}

export default QualityControlRecord10Panel02;
