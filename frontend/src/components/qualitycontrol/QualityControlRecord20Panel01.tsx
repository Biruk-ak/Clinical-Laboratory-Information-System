...
export interface QualityControlRecord20Panel01Props {
  facilityId: string;
  title?: string;
...
/**
 * QualityControlRecord20Panel01 — operational panel for qualitycontrol domain slice 20/01.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function QualityControlRecord20Panel01({ facilityId, title = 'QualityControlRecord20 Workspace', onSelect }: QualityControlRecord20Panel01Props) {
  ...
  return (
    <section className="lis-panel lis-panel--qualitycontrol" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} qualitycontrol records (slice 20-01)
      </footer>
    </section>
  );
}

export default QualityControlRecord20Panel01;
