...
export interface QualityControlRecord11Panel02Props {
  facilityId: string;
  title?: string;
...
/**
 * QualityControlRecord11Panel02 — operational panel for qualitycontrol domain slice 11/02.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function QualityControlRecord11Panel02({ facilityId, title = 'QualityControlRecord11 Workspace', onSelect }: QualityControlRecord11Panel02Props) {
  ...
  return (
    <section className="lis-panel lis-panel--qualitycontrol" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} qualitycontrol records (slice 11-02)
      </footer>
    </section>
  );
}

export default QualityControlRecord11Panel02;
