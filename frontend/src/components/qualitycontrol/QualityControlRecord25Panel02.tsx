...
export interface QualityControlRecord25Panel02Props {
  facilityId: string;
  title?: string;
...
/**
 * QualityControlRecord25Panel02 — operational panel for qualitycontrol domain slice 25/02.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function QualityControlRecord25Panel02({ facilityId, title = 'QualityControlRecord25 Workspace', onSelect }: QualityControlRecord25Panel02Props) {
  ...
  return (
    <section className="lis-panel lis-panel--qualitycontrol" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} qualitycontrol records (slice 25-02)
      </footer>
    </section>
  );
}

export default QualityControlRecord25Panel02;
