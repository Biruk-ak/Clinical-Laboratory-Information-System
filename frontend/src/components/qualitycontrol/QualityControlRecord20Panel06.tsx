...
export interface QualityControlRecord20Panel06Props {
  facilityId: string;
  title?: string;
...
/**
 * QualityControlRecord20Panel06 — operational panel for qualitycontrol domain slice 20/06.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function QualityControlRecord20Panel06({ facilityId, title = 'QualityControlRecord20 Workspace', onSelect }: QualityControlRecord20Panel06Props) {
  ...
  return (
    <section className="lis-panel lis-panel--qualitycontrol" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} qualitycontrol records (slice 20-06)
      </footer>
    </section>
  );
}

export default QualityControlRecord20Panel06;
