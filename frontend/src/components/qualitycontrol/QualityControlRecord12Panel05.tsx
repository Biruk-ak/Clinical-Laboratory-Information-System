...
export interface QualityControlRecord12Panel05Props {
  facilityId: string;
  title?: string;
...
/**
 * QualityControlRecord12Panel05 — operational panel for qualitycontrol domain slice 12/05.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function QualityControlRecord12Panel05({ facilityId, title = 'QualityControlRecord12 Workspace', onSelect }: QualityControlRecord12Panel05Props) {
  ...
  return (
    <section className="lis-panel lis-panel--qualitycontrol" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} qualitycontrol records (slice 12-05)
      </footer>
    </section>
  );
}

export default QualityControlRecord12Panel05;
