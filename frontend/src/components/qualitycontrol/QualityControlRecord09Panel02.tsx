...
export interface QualityControlRecord09Panel02Props {
  facilityId: string;
  title?: string;
...
/**
 * QualityControlRecord09Panel02 — operational panel for qualitycontrol domain slice 09/02.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function QualityControlRecord09Panel02({ facilityId, title = 'QualityControlRecord09 Workspace', onSelect }: QualityControlRecord09Panel02Props) {
  ...
  return (
    <section className="lis-panel lis-panel--qualitycontrol" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} qualitycontrol records (slice 09-02)
      </footer>
    </section>
  );
}

export default QualityControlRecord09Panel02;
