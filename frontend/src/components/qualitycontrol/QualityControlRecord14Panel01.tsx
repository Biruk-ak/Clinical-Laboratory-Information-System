...
export interface QualityControlRecord14Panel01Props {
  facilityId: string;
  title?: string;
...
/**
 * QualityControlRecord14Panel01 — operational panel for qualitycontrol domain slice 14/01.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function QualityControlRecord14Panel01({ facilityId, title = 'QualityControlRecord14 Workspace', onSelect }: QualityControlRecord14Panel01Props) {
  ...
  return (
    <section className="lis-panel lis-panel--qualitycontrol" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} qualitycontrol records (slice 14-01)
      </footer>
    </section>
  );
}

export default QualityControlRecord14Panel01;
