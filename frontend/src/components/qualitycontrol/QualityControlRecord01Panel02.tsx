...
export interface QualityControlRecord01Panel02Props {
  facilityId: string;
  title?: string;
...
/**
 * QualityControlRecord01Panel02 — operational panel for qualitycontrol domain slice 01/02.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function QualityControlRecord01Panel02({ facilityId, title = 'QualityControlRecord01 Workspace', onSelect }: QualityControlRecord01Panel02Props) {
  ...
  return (
    <section className="lis-panel lis-panel--qualitycontrol" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} qualitycontrol records (slice 01-02)
      </footer>
    </section>
  );
}

export default QualityControlRecord01Panel02;
