...
export interface QualityControlRecord17Panel02Props {
  facilityId: string;
  title?: string;
...
/**
 * QualityControlRecord17Panel02 — operational panel for qualitycontrol domain slice 17/02.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function QualityControlRecord17Panel02({ facilityId, title = 'QualityControlRecord17 Workspace', onSelect }: QualityControlRecord17Panel02Props) {
  ...
  return (
    <section className="lis-panel lis-panel--qualitycontrol" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} qualitycontrol records (slice 17-02)
      </footer>
    </section>
  );
}

export default QualityControlRecord17Panel02;
