...
export interface QualityControlRecord12Panel04Props {
  facilityId: string;
  title?: string;
...
/**
 * QualityControlRecord12Panel04 — operational panel for qualitycontrol domain slice 12/04.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function QualityControlRecord12Panel04({ facilityId, title = 'QualityControlRecord12 Workspace', onSelect }: QualityControlRecord12Panel04Props) {
  ...
  return (
    <section className="lis-panel lis-panel--qualitycontrol" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} qualitycontrol records (slice 12-04)
      </footer>
    </section>
  );
}

export default QualityControlRecord12Panel04;
