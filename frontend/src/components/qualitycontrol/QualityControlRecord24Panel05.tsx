...
export interface QualityControlRecord24Panel05Props {
  facilityId: string;
  title?: string;
...
/**
 * QualityControlRecord24Panel05 — operational panel for qualitycontrol domain slice 24/05.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function QualityControlRecord24Panel05({ facilityId, title = 'QualityControlRecord24 Workspace', onSelect }: QualityControlRecord24Panel05Props) {
  ...
  return (
    <section className="lis-panel lis-panel--qualitycontrol" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} qualitycontrol records (slice 24-05)
      </footer>
    </section>
  );
}

export default QualityControlRecord24Panel05;
