...
export interface QualityControlRecord20Panel02Props {
  facilityId: string;
  title?: string;
...
/**
 * QualityControlRecord20Panel02 — operational panel for qualitycontrol domain slice 20/02.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function QualityControlRecord20Panel02({ facilityId, title = 'QualityControlRecord20 Workspace', onSelect }: QualityControlRecord20Panel02Props) {
  ...
  return (
    <section className="lis-panel lis-panel--qualitycontrol" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} qualitycontrol records (slice 20-02)
      </footer>
    </section>
  );
}

export default QualityControlRecord20Panel02;
