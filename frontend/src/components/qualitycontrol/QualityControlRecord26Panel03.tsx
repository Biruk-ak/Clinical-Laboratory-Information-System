...
export interface QualityControlRecord26Panel03Props {
  facilityId: string;
  title?: string;
...
/**
 * QualityControlRecord26Panel03 — operational panel for qualitycontrol domain slice 26/03.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function QualityControlRecord26Panel03({ facilityId, title = 'QualityControlRecord26 Workspace', onSelect }: QualityControlRecord26Panel03Props) {
  ...
  return (
    <section className="lis-panel lis-panel--qualitycontrol" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} qualitycontrol records (slice 26-03)
      </footer>
    </section>
  );
}

export default QualityControlRecord26Panel03;
