...
export interface QualityControlRecord02Panel03Props {
  facilityId: string;
  title?: string;
...
/**
 * QualityControlRecord02Panel03 — operational panel for qualitycontrol domain slice 02/03.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function QualityControlRecord02Panel03({ facilityId, title = 'QualityControlRecord02 Workspace', onSelect }: QualityControlRecord02Panel03Props) {
  ...
  return (
    <section className="lis-panel lis-panel--qualitycontrol" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} qualitycontrol records (slice 02-03)
      </footer>
    </section>
  );
}

export default QualityControlRecord02Panel03;
