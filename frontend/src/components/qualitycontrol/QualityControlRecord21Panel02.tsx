...
export interface QualityControlRecord21Panel02Props {
  facilityId: string;
  title?: string;
...
/**
 * QualityControlRecord21Panel02 — operational panel for qualitycontrol domain slice 21/02.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function QualityControlRecord21Panel02({ facilityId, title = 'QualityControlRecord21 Workspace', onSelect }: QualityControlRecord21Panel02Props) {
  ...
  return (
    <section className="lis-panel lis-panel--qualitycontrol" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} qualitycontrol records (slice 21-02)
      </footer>
    </section>
  );
}

export default QualityControlRecord21Panel02;
