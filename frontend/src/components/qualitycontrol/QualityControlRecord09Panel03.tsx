...
export interface QualityControlRecord09Panel03Props {
  facilityId: string;
  title?: string;
...
/**
 * QualityControlRecord09Panel03 — operational panel for qualitycontrol domain slice 09/03.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function QualityControlRecord09Panel03({ facilityId, title = 'QualityControlRecord09 Workspace', onSelect }: QualityControlRecord09Panel03Props) {
  ...
  return (
    <section className="lis-panel lis-panel--qualitycontrol" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} qualitycontrol records (slice 09-03)
      </footer>
    </section>
  );
}

export default QualityControlRecord09Panel03;
