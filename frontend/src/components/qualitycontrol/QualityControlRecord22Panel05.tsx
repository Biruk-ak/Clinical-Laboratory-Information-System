...
export interface QualityControlRecord22Panel05Props {
  facilityId: string;
  title?: string;
...
/**
 * QualityControlRecord22Panel05 — operational panel for qualitycontrol domain slice 22/05.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function QualityControlRecord22Panel05({ facilityId, title = 'QualityControlRecord22 Workspace', onSelect }: QualityControlRecord22Panel05Props) {
  ...
  return (
    <section className="lis-panel lis-panel--qualitycontrol" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} qualitycontrol records (slice 22-05)
      </footer>
    </section>
  );
}

export default QualityControlRecord22Panel05;
