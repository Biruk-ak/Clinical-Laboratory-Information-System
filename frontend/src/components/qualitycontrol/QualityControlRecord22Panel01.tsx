...
export interface QualityControlRecord22Panel01Props {
  facilityId: string;
  title?: string;
...
/**
 * QualityControlRecord22Panel01 — operational panel for qualitycontrol domain slice 22/01.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function QualityControlRecord22Panel01({ facilityId, title = 'QualityControlRecord22 Workspace', onSelect }: QualityControlRecord22Panel01Props) {
  ...
  return (
    <section className="lis-panel lis-panel--qualitycontrol" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} qualitycontrol records (slice 22-01)
      </footer>
    </section>
  );
}

export default QualityControlRecord22Panel01;
