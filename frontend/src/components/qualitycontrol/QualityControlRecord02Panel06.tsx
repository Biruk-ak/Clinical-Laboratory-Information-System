...
export interface QualityControlRecord02Panel06Props {
  facilityId: string;
  title?: string;
...
/**
 * QualityControlRecord02Panel06 — operational panel for qualitycontrol domain slice 02/06.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function QualityControlRecord02Panel06({ facilityId, title = 'QualityControlRecord02 Workspace', onSelect }: QualityControlRecord02Panel06Props) {
  ...
  return (
    <section className="lis-panel lis-panel--qualitycontrol" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} qualitycontrol records (slice 02-06)
      </footer>
    </section>
  );
}

export default QualityControlRecord02Panel06;
