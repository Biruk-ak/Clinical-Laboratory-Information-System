...
export interface QualityControlRecord17Panel06Props {
  facilityId: string;
  title?: string;
...
/**
 * QualityControlRecord17Panel06 — operational panel for qualitycontrol domain slice 17/06.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function QualityControlRecord17Panel06({ facilityId, title = 'QualityControlRecord17 Workspace', onSelect }: QualityControlRecord17Panel06Props) {
  ...
  return (
    <section className="lis-panel lis-panel--qualitycontrol" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} qualitycontrol records (slice 17-06)
      </footer>
    </section>
  );
}

export default QualityControlRecord17Panel06;
