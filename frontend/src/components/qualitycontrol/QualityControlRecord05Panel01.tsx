...
export interface QualityControlRecord05Panel01Props {
  facilityId: string;
  title?: string;
...
/**
 * QualityControlRecord05Panel01 — operational panel for qualitycontrol domain slice 05/01.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function QualityControlRecord05Panel01({ facilityId, title = 'QualityControlRecord05 Workspace', onSelect }: QualityControlRecord05Panel01Props) {
  ...
  return (
    <section className="lis-panel lis-panel--qualitycontrol" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} qualitycontrol records (slice 05-01)
      </footer>
    </section>
  );
}

export default QualityControlRecord05Panel01;
