...
export interface QualityControlRecord03Panel04Props {
  facilityId: string;
  title?: string;
...
/**
 * QualityControlRecord03Panel04 — operational panel for qualitycontrol domain slice 03/04.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function QualityControlRecord03Panel04({ facilityId, title = 'QualityControlRecord03 Workspace', onSelect }: QualityControlRecord03Panel04Props) {
  ...
  return (
    <section className="lis-panel lis-panel--qualitycontrol" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} qualitycontrol records (slice 03-04)
      </footer>
    </section>
  );
}

export default QualityControlRecord03Panel04;
