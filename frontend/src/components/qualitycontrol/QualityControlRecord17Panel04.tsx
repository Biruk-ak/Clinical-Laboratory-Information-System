...
export interface QualityControlRecord17Panel04Props {
  facilityId: string;
  title?: string;
...
/**
 * QualityControlRecord17Panel04 — operational panel for qualitycontrol domain slice 17/04.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function QualityControlRecord17Panel04({ facilityId, title = 'QualityControlRecord17 Workspace', onSelect }: QualityControlRecord17Panel04Props) {
  ...
  return (
    <section className="lis-panel lis-panel--qualitycontrol" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} qualitycontrol records (slice 17-04)
      </footer>
    </section>
  );
}

export default QualityControlRecord17Panel04;
