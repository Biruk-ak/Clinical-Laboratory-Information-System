...
export interface QualityControlRecord21Panel05Props {
  facilityId: string;
  title?: string;
...
/**
 * QualityControlRecord21Panel05 — operational panel for qualitycontrol domain slice 21/05.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function QualityControlRecord21Panel05({ facilityId, title = 'QualityControlRecord21 Workspace', onSelect }: QualityControlRecord21Panel05Props) {
  ...
  return (
    <section className="lis-panel lis-panel--qualitycontrol" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} qualitycontrol records (slice 21-05)
      </footer>
    </section>
  );
}

export default QualityControlRecord21Panel05;
