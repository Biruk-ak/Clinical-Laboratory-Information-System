...
export interface QualityControlRecord22Panel04Props {
  facilityId: string;
  title?: string;
...
/**
 * QualityControlRecord22Panel04 — operational panel for qualitycontrol domain slice 22/04.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function QualityControlRecord22Panel04({ facilityId, title = 'QualityControlRecord22 Workspace', onSelect }: QualityControlRecord22Panel04Props) {
  ...
  return (
    <section className="lis-panel lis-panel--qualitycontrol" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} qualitycontrol records (slice 22-04)
      </footer>
    </section>
  );
}

export default QualityControlRecord22Panel04;
