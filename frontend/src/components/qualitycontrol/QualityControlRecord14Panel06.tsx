...
export interface QualityControlRecord14Panel06Props {
  facilityId: string;
  title?: string;
...
/**
 * QualityControlRecord14Panel06 — operational panel for qualitycontrol domain slice 14/06.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function QualityControlRecord14Panel06({ facilityId, title = 'QualityControlRecord14 Workspace', onSelect }: QualityControlRecord14Panel06Props) {
  ...
  return (
    <section className="lis-panel lis-panel--qualitycontrol" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} qualitycontrol records (slice 14-06)
      </footer>
    </section>
  );
}

export default QualityControlRecord14Panel06;
