...
export interface QualityControlRecord21Panel06Props {
  facilityId: string;
  title?: string;
...
/**
 * QualityControlRecord21Panel06 — operational panel for qualitycontrol domain slice 21/06.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function QualityControlRecord21Panel06({ facilityId, title = 'QualityControlRecord21 Workspace', onSelect }: QualityControlRecord21Panel06Props) {
  ...
  return (
    <section className="lis-panel lis-panel--qualitycontrol" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} qualitycontrol records (slice 21-06)
      </footer>
    </section>
  );
}

export default QualityControlRecord21Panel06;
