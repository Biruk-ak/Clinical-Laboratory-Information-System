...
export interface QualityControlRecord03Panel06Props {
  facilityId: string;
  title?: string;
...
/**
 * QualityControlRecord03Panel06 — operational panel for qualitycontrol domain slice 03/06.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function QualityControlRecord03Panel06({ facilityId, title = 'QualityControlRecord03 Workspace', onSelect }: QualityControlRecord03Panel06Props) {
  ...
  return (
    <section className="lis-panel lis-panel--qualitycontrol" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} qualitycontrol records (slice 03-06)
      </footer>
    </section>
  );
}

export default QualityControlRecord03Panel06;
