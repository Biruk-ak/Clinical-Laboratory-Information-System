...
export interface QualityControlRecord25Panel01Props {
  facilityId: string;
  title?: string;
...
/**
 * QualityControlRecord25Panel01 — operational panel for qualitycontrol domain slice 25/01.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function QualityControlRecord25Panel01({ facilityId, title = 'QualityControlRecord25 Workspace', onSelect }: QualityControlRecord25Panel01Props) {
  ...
  return (
    <section className="lis-panel lis-panel--qualitycontrol" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} qualitycontrol records (slice 25-01)
      </footer>
    </section>
  );
}

export default QualityControlRecord25Panel01;
