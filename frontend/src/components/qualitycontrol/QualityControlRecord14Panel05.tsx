...
export interface QualityControlRecord14Panel05Props {
  facilityId: string;
  title?: string;
...
/**
 * QualityControlRecord14Panel05 — operational panel for qualitycontrol domain slice 14/05.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function QualityControlRecord14Panel05({ facilityId, title = 'QualityControlRecord14 Workspace', onSelect }: QualityControlRecord14Panel05Props) {
  ...
  return (
    <section className="lis-panel lis-panel--qualitycontrol" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} qualitycontrol records (slice 14-05)
      </footer>
    </section>
  );
}

export default QualityControlRecord14Panel05;
