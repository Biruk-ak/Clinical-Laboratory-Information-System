...
export interface QualityControlRecord02Panel02Props {
  facilityId: string;
  title?: string;
...
/**
 * QualityControlRecord02Panel02 — operational panel for qualitycontrol domain slice 02/02.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function QualityControlRecord02Panel02({ facilityId, title = 'QualityControlRecord02 Workspace', onSelect }: QualityControlRecord02Panel02Props) {
  ...
  return (
    <section className="lis-panel lis-panel--qualitycontrol" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} qualitycontrol records (slice 02-02)
      </footer>
    </section>
  );
}

export default QualityControlRecord02Panel02;
