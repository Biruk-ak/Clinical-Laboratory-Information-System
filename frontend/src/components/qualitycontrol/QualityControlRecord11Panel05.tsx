...
export interface QualityControlRecord11Panel05Props {
  facilityId: string;
  title?: string;
...
/**
 * QualityControlRecord11Panel05 — operational panel for qualitycontrol domain slice 11/05.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function QualityControlRecord11Panel05({ facilityId, title = 'QualityControlRecord11 Workspace', onSelect }: QualityControlRecord11Panel05Props) {
  ...
  return (
    <section className="lis-panel lis-panel--qualitycontrol" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} qualitycontrol records (slice 11-05)
      </footer>
    </section>
  );
}

export default QualityControlRecord11Panel05;
