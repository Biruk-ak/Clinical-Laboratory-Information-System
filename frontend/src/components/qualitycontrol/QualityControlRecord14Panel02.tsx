...
export interface QualityControlRecord14Panel02Props {
  facilityId: string;
  title?: string;
...
/**
 * QualityControlRecord14Panel02 — operational panel for qualitycontrol domain slice 14/02.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function QualityControlRecord14Panel02({ facilityId, title = 'QualityControlRecord14 Workspace', onSelect }: QualityControlRecord14Panel02Props) {
  ...
  return (
    <section className="lis-panel lis-panel--qualitycontrol" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} qualitycontrol records (slice 14-02)
      </footer>
    </section>
  );
}

export default QualityControlRecord14Panel02;
