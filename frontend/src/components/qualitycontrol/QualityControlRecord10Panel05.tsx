...
export interface QualityControlRecord10Panel05Props {
  facilityId: string;
  title?: string;
...
/**
 * QualityControlRecord10Panel05 — operational panel for qualitycontrol domain slice 10/05.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function QualityControlRecord10Panel05({ facilityId, title = 'QualityControlRecord10 Workspace', onSelect }: QualityControlRecord10Panel05Props) {
  ...
  return (
    <section className="lis-panel lis-panel--qualitycontrol" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} qualitycontrol records (slice 10-05)
      </footer>
    </section>
  );
}

export default QualityControlRecord10Panel05;
