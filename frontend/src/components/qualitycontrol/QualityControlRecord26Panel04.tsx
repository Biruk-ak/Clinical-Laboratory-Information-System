...
export interface QualityControlRecord26Panel04Props {
  facilityId: string;
  title?: string;
...
/**
 * QualityControlRecord26Panel04 — operational panel for qualitycontrol domain slice 26/04.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function QualityControlRecord26Panel04({ facilityId, title = 'QualityControlRecord26 Workspace', onSelect }: QualityControlRecord26Panel04Props) {
  ...
  return (
    <section className="lis-panel lis-panel--qualitycontrol" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} qualitycontrol records (slice 26-04)
      </footer>
    </section>
  );
}

export default QualityControlRecord26Panel04;
