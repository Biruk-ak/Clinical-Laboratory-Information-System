...
export interface OrderRecord15Panel01Props {
  facilityId: string;
  title?: string;
...
/**
 * OrderRecord15Panel01 — operational panel for orders domain slice 15/01.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function OrderRecord15Panel01({ facilityId, title = 'OrderRecord15 Workspace', onSelect }: OrderRecord15Panel01Props) {
  ...
  return (
    <section className="lis-panel lis-panel--orders" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} orders records (slice 15-01)
      </footer>
    </section>
  );
}

export default OrderRecord15Panel01;
