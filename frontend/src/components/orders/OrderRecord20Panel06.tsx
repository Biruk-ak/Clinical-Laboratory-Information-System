...
export interface OrderRecord20Panel06Props {
  facilityId: string;
  title?: string;
...
/**
 * OrderRecord20Panel06 — operational panel for orders domain slice 20/06.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function OrderRecord20Panel06({ facilityId, title = 'OrderRecord20 Workspace', onSelect }: OrderRecord20Panel06Props) {
  ...
  return (
    <section className="lis-panel lis-panel--orders" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} orders records (slice 20-06)
      </footer>
    </section>
  );
}

export default OrderRecord20Panel06;
