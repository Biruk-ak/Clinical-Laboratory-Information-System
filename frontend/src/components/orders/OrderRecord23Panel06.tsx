...
export interface OrderRecord23Panel06Props {
  facilityId: string;
  title?: string;
...
/**
 * OrderRecord23Panel06 — operational panel for orders domain slice 23/06.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function OrderRecord23Panel06({ facilityId, title = 'OrderRecord23 Workspace', onSelect }: OrderRecord23Panel06Props) {
  ...
  return (
    <section className="lis-panel lis-panel--orders" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} orders records (slice 23-06)
      </footer>
    </section>
  );
}

export default OrderRecord23Panel06;
