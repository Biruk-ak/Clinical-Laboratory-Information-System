...
export interface OrderRecord09Panel04Props {
  facilityId: string;
  title?: string;
...
/**
 * OrderRecord09Panel04 — operational panel for orders domain slice 09/04.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function OrderRecord09Panel04({ facilityId, title = 'OrderRecord09 Workspace', onSelect }: OrderRecord09Panel04Props) {
  ...
  return (
    <section className="lis-panel lis-panel--orders" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} orders records (slice 09-04)
      </footer>
    </section>
  );
}

export default OrderRecord09Panel04;
