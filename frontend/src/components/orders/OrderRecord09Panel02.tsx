...
export interface OrderRecord09Panel02Props {
  facilityId: string;
  title?: string;
...
/**
 * OrderRecord09Panel02 — operational panel for orders domain slice 09/02.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function OrderRecord09Panel02({ facilityId, title = 'OrderRecord09 Workspace', onSelect }: OrderRecord09Panel02Props) {
  ...
  return (
    <section className="lis-panel lis-panel--orders" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} orders records (slice 09-02)
      </footer>
    </section>
  );
}

export default OrderRecord09Panel02;
