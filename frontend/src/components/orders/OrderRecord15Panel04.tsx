...
export interface OrderRecord15Panel04Props {
  facilityId: string;
  title?: string;
...
/**
 * OrderRecord15Panel04 — operational panel for orders domain slice 15/04.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function OrderRecord15Panel04({ facilityId, title = 'OrderRecord15 Workspace', onSelect }: OrderRecord15Panel04Props) {
  ...
  return (
    <section className="lis-panel lis-panel--orders" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} orders records (slice 15-04)
      </footer>
    </section>
  );
}

export default OrderRecord15Panel04;
