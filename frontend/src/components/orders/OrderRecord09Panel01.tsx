...
export interface OrderRecord09Panel01Props {
  facilityId: string;
  title?: string;
...
/**
 * OrderRecord09Panel01 — operational panel for orders domain slice 09/01.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function OrderRecord09Panel01({ facilityId, title = 'OrderRecord09 Workspace', onSelect }: OrderRecord09Panel01Props) {
  ...
  return (
    <section className="lis-panel lis-panel--orders" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} orders records (slice 09-01)
      </footer>
    </section>
  );
}

export default OrderRecord09Panel01;
