...
export interface OrderRecord28Panel05Props {
  facilityId: string;
  title?: string;
...
/**
 * OrderRecord28Panel05 — operational panel for orders domain slice 28/05.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function OrderRecord28Panel05({ facilityId, title = 'OrderRecord28 Workspace', onSelect }: OrderRecord28Panel05Props) {
  ...
  return (
    <section className="lis-panel lis-panel--orders" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} orders records (slice 28-05)
      </footer>
    </section>
  );
}

export default OrderRecord28Panel05;
