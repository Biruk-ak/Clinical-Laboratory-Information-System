...
export interface OrderRecord25Panel02Props {
  facilityId: string;
  title?: string;
...
/**
 * OrderRecord25Panel02 — operational panel for orders domain slice 25/02.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function OrderRecord25Panel02({ facilityId, title = 'OrderRecord25 Workspace', onSelect }: OrderRecord25Panel02Props) {
  ...
  return (
    <section className="lis-panel lis-panel--orders" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} orders records (slice 25-02)
      </footer>
    </section>
  );
}

export default OrderRecord25Panel02;
