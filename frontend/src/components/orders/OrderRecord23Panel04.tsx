...
export interface OrderRecord23Panel04Props {
  facilityId: string;
  title?: string;
...
/**
 * OrderRecord23Panel04 — operational panel for orders domain slice 23/04.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function OrderRecord23Panel04({ facilityId, title = 'OrderRecord23 Workspace', onSelect }: OrderRecord23Panel04Props) {
  ...
  return (
    <section className="lis-panel lis-panel--orders" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} orders records (slice 23-04)
      </footer>
    </section>
  );
}

export default OrderRecord23Panel04;
