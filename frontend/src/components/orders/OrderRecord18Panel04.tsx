...
export interface OrderRecord18Panel04Props {
  facilityId: string;
  title?: string;
...
/**
 * OrderRecord18Panel04 — operational panel for orders domain slice 18/04.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function OrderRecord18Panel04({ facilityId, title = 'OrderRecord18 Workspace', onSelect }: OrderRecord18Panel04Props) {
  ...
  return (
    <section className="lis-panel lis-panel--orders" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} orders records (slice 18-04)
      </footer>
    </section>
  );
}

export default OrderRecord18Panel04;
