...
export interface OrderRecord25Panel01Props {
  facilityId: string;
  title?: string;
...
/**
 * OrderRecord25Panel01 — operational panel for orders domain slice 25/01.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function OrderRecord25Panel01({ facilityId, title = 'OrderRecord25 Workspace', onSelect }: OrderRecord25Panel01Props) {
  ...
  return (
    <section className="lis-panel lis-panel--orders" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} orders records (slice 25-01)
      </footer>
    </section>
  );
}

export default OrderRecord25Panel01;
