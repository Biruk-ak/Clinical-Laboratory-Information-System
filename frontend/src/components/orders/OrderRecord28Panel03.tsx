...
export interface OrderRecord28Panel03Props {
  facilityId: string;
  title?: string;
...
/**
 * OrderRecord28Panel03 — operational panel for orders domain slice 28/03.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function OrderRecord28Panel03({ facilityId, title = 'OrderRecord28 Workspace', onSelect }: OrderRecord28Panel03Props) {
  ...
  return (
    <section className="lis-panel lis-panel--orders" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} orders records (slice 28-03)
      </footer>
    </section>
  );
}

export default OrderRecord28Panel03;
