...
export interface OrderRecord19Panel05Props {
  facilityId: string;
  title?: string;
...
/**
 * OrderRecord19Panel05 — operational panel for orders domain slice 19/05.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function OrderRecord19Panel05({ facilityId, title = 'OrderRecord19 Workspace', onSelect }: OrderRecord19Panel05Props) {
  ...
  return (
    <section className="lis-panel lis-panel--orders" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} orders records (slice 19-05)
      </footer>
    </section>
  );
}

export default OrderRecord19Panel05;
