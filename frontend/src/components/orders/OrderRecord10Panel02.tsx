...
export interface OrderRecord10Panel02Props {
  facilityId: string;
  title?: string;
...
/**
 * OrderRecord10Panel02 — operational panel for orders domain slice 10/02.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function OrderRecord10Panel02({ facilityId, title = 'OrderRecord10 Workspace', onSelect }: OrderRecord10Panel02Props) {
  ...
  return (
    <section className="lis-panel lis-panel--orders" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} orders records (slice 10-02)
      </footer>
    </section>
  );
}

export default OrderRecord10Panel02;
