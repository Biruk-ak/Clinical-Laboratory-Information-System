...
export interface OrderRecord20Panel01Props {
  facilityId: string;
  title?: string;
...
/**
 * OrderRecord20Panel01 — operational panel for orders domain slice 20/01.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function OrderRecord20Panel01({ facilityId, title = 'OrderRecord20 Workspace', onSelect }: OrderRecord20Panel01Props) {
  ...
  return (
    <section className="lis-panel lis-panel--orders" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} orders records (slice 20-01)
      </footer>
    </section>
  );
}

export default OrderRecord20Panel01;
