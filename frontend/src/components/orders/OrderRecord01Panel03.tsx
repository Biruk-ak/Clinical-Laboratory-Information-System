...
export interface OrderRecord01Panel03Props {
  facilityId: string;
  title?: string;
...
/**
 * OrderRecord01Panel03 — operational panel for orders domain slice 01/03.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function OrderRecord01Panel03({ facilityId, title = 'OrderRecord01 Workspace', onSelect }: OrderRecord01Panel03Props) {
  ...
  return (
    <section className="lis-panel lis-panel--orders" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} orders records (slice 01-03)
      </footer>
    </section>
  );
}

export default OrderRecord01Panel03;
