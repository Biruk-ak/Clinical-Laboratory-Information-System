...
export interface OrderRecord25Panel06Props {
  facilityId: string;
  title?: string;
...
/**
 * OrderRecord25Panel06 — operational panel for orders domain slice 25/06.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function OrderRecord25Panel06({ facilityId, title = 'OrderRecord25 Workspace', onSelect }: OrderRecord25Panel06Props) {
  ...
  return (
    <section className="lis-panel lis-panel--orders" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} orders records (slice 25-06)
      </footer>
    </section>
  );
}

export default OrderRecord25Panel06;
