...
export interface OrderRecord13Panel06Props {
  facilityId: string;
  title?: string;
...
/**
 * OrderRecord13Panel06 — operational panel for orders domain slice 13/06.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function OrderRecord13Panel06({ facilityId, title = 'OrderRecord13 Workspace', onSelect }: OrderRecord13Panel06Props) {
  ...
  return (
    <section className="lis-panel lis-panel--orders" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} orders records (slice 13-06)
      </footer>
    </section>
  );
}

export default OrderRecord13Panel06;
