...
export interface OrderRecord01Panel06Props {
  facilityId: string;
  title?: string;
...
/**
 * OrderRecord01Panel06 — operational panel for orders domain slice 01/06.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function OrderRecord01Panel06({ facilityId, title = 'OrderRecord01 Workspace', onSelect }: OrderRecord01Panel06Props) {
  ...
  return (
    <section className="lis-panel lis-panel--orders" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} orders records (slice 01-06)
      </footer>
    </section>
  );
}

export default OrderRecord01Panel06;
