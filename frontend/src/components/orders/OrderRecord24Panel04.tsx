...
export interface OrderRecord24Panel04Props {
  facilityId: string;
  title?: string;
...
/**
 * OrderRecord24Panel04 — operational panel for orders domain slice 24/04.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function OrderRecord24Panel04({ facilityId, title = 'OrderRecord24 Workspace', onSelect }: OrderRecord24Panel04Props) {
  ...
  return (
    <section className="lis-panel lis-panel--orders" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} orders records (slice 24-04)
      </footer>
    </section>
  );
}

export default OrderRecord24Panel04;
