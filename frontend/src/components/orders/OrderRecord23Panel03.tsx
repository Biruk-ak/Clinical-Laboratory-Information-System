...
export interface OrderRecord23Panel03Props {
  facilityId: string;
  title?: string;
...
/**
 * OrderRecord23Panel03 — operational panel for orders domain slice 23/03.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function OrderRecord23Panel03({ facilityId, title = 'OrderRecord23 Workspace', onSelect }: OrderRecord23Panel03Props) {
  ...
  return (
    <section className="lis-panel lis-panel--orders" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} orders records (slice 23-03)
      </footer>
    </section>
  );
}

export default OrderRecord23Panel03;
