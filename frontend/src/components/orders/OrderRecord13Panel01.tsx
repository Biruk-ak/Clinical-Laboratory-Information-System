...
export interface OrderRecord13Panel01Props {
  facilityId: string;
  title?: string;
...
/**
 * OrderRecord13Panel01 — operational panel for orders domain slice 13/01.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function OrderRecord13Panel01({ facilityId, title = 'OrderRecord13 Workspace', onSelect }: OrderRecord13Panel01Props) {
  ...
  return (
    <section className="lis-panel lis-panel--orders" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} orders records (slice 13-01)
      </footer>
    </section>
  );
}

export default OrderRecord13Panel01;
