...
export interface OrderRecord03Panel01Props {
  facilityId: string;
  title?: string;
...
/**
 * OrderRecord03Panel01 — operational panel for orders domain slice 03/01.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function OrderRecord03Panel01({ facilityId, title = 'OrderRecord03 Workspace', onSelect }: OrderRecord03Panel01Props) {
  ...
  return (
    <section className="lis-panel lis-panel--orders" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} orders records (slice 03-01)
      </footer>
    </section>
  );
}

export default OrderRecord03Panel01;
