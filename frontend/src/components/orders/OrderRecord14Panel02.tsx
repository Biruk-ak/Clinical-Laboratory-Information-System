...
export interface OrderRecord14Panel02Props {
  facilityId: string;
  title?: string;
...
/**
 * OrderRecord14Panel02 — operational panel for orders domain slice 14/02.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function OrderRecord14Panel02({ facilityId, title = 'OrderRecord14 Workspace', onSelect }: OrderRecord14Panel02Props) {
  ...
  return (
    <section className="lis-panel lis-panel--orders" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} orders records (slice 14-02)
      </footer>
    </section>
  );
}

export default OrderRecord14Panel02;
