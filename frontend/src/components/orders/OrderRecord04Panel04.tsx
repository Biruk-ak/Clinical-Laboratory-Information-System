...
export interface OrderRecord04Panel04Props {
  facilityId: string;
  title?: string;
...
/**
 * OrderRecord04Panel04 — operational panel for orders domain slice 04/04.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function OrderRecord04Panel04({ facilityId, title = 'OrderRecord04 Workspace', onSelect }: OrderRecord04Panel04Props) {
  ...
  return (
    <section className="lis-panel lis-panel--orders" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} orders records (slice 04-04)
      </footer>
    </section>
  );
}

export default OrderRecord04Panel04;
