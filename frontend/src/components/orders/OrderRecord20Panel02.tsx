...
export interface OrderRecord20Panel02Props {
  facilityId: string;
  title?: string;
...
/**
 * OrderRecord20Panel02 — operational panel for orders domain slice 20/02.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function OrderRecord20Panel02({ facilityId, title = 'OrderRecord20 Workspace', onSelect }: OrderRecord20Panel02Props) {
  ...
  return (
    <section className="lis-panel lis-panel--orders" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} orders records (slice 20-02)
      </footer>
    </section>
  );
}

export default OrderRecord20Panel02;
