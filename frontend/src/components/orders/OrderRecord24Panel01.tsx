...
export interface OrderRecord24Panel01Props {
  facilityId: string;
  title?: string;
...
/**
 * OrderRecord24Panel01 — operational panel for orders domain slice 24/01.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function OrderRecord24Panel01({ facilityId, title = 'OrderRecord24 Workspace', onSelect }: OrderRecord24Panel01Props) {
  ...
  return (
    <section className="lis-panel lis-panel--orders" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} orders records (slice 24-01)
      </footer>
    </section>
  );
}

export default OrderRecord24Panel01;
