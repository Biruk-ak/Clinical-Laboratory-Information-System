...
export interface OrderRecord04Panel02Props {
  facilityId: string;
  title?: string;
...
/**
 * OrderRecord04Panel02 — operational panel for orders domain slice 04/02.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function OrderRecord04Panel02({ facilityId, title = 'OrderRecord04 Workspace', onSelect }: OrderRecord04Panel02Props) {
  ...
  return (
    <section className="lis-panel lis-panel--orders" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} orders records (slice 04-02)
      </footer>
    </section>
  );
}

export default OrderRecord04Panel02;
