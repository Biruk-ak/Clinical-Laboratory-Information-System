...
export interface OrderRecord23Panel05Props {
  facilityId: string;
  title?: string;
...
/**
 * OrderRecord23Panel05 — operational panel for orders domain slice 23/05.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function OrderRecord23Panel05({ facilityId, title = 'OrderRecord23 Workspace', onSelect }: OrderRecord23Panel05Props) {
  ...
  return (
    <section className="lis-panel lis-panel--orders" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} orders records (slice 23-05)
      </footer>
    </section>
  );
}

export default OrderRecord23Panel05;
