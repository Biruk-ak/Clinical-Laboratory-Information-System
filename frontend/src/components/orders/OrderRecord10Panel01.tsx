...
export interface OrderRecord10Panel01Props {
  facilityId: string;
  title?: string;
...
/**
 * OrderRecord10Panel01 — operational panel for orders domain slice 10/01.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function OrderRecord10Panel01({ facilityId, title = 'OrderRecord10 Workspace', onSelect }: OrderRecord10Panel01Props) {
  ...
  return (
    <section className="lis-panel lis-panel--orders" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} orders records (slice 10-01)
      </footer>
    </section>
  );
}

export default OrderRecord10Panel01;
