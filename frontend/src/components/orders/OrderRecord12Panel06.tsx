...
export interface OrderRecord12Panel06Props {
  facilityId: string;
  title?: string;
...
/**
 * OrderRecord12Panel06 — operational panel for orders domain slice 12/06.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function OrderRecord12Panel06({ facilityId, title = 'OrderRecord12 Workspace', onSelect }: OrderRecord12Panel06Props) {
  ...
  return (
    <section className="lis-panel lis-panel--orders" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} orders records (slice 12-06)
      </footer>
    </section>
  );
}

export default OrderRecord12Panel06;
