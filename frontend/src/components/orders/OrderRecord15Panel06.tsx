...
export interface OrderRecord15Panel06Props {
  facilityId: string;
  title?: string;
...
/**
 * OrderRecord15Panel06 — operational panel for orders domain slice 15/06.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function OrderRecord15Panel06({ facilityId, title = 'OrderRecord15 Workspace', onSelect }: OrderRecord15Panel06Props) {
  ...
  return (
    <section className="lis-panel lis-panel--orders" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} orders records (slice 15-06)
      </footer>
    </section>
  );
}

export default OrderRecord15Panel06;
