...
export interface OrderRecord19Panel06Props {
  facilityId: string;
  title?: string;
...
/**
 * OrderRecord19Panel06 — operational panel for orders domain slice 19/06.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function OrderRecord19Panel06({ facilityId, title = 'OrderRecord19 Workspace', onSelect }: OrderRecord19Panel06Props) {
  ...
  return (
    <section className="lis-panel lis-panel--orders" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} orders records (slice 19-06)
      </footer>
    </section>
  );
}

export default OrderRecord19Panel06;
