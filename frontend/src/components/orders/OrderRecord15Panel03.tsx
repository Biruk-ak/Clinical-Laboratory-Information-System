...
export interface OrderRecord15Panel03Props {
  facilityId: string;
  title?: string;
...
/**
 * OrderRecord15Panel03 — operational panel for orders domain slice 15/03.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function OrderRecord15Panel03({ facilityId, title = 'OrderRecord15 Workspace', onSelect }: OrderRecord15Panel03Props) {
  ...
  return (
    <section className="lis-panel lis-panel--orders" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} orders records (slice 15-03)
      </footer>
    </section>
  );
}

export default OrderRecord15Panel03;
