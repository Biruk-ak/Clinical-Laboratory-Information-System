...
export interface OrderRecord17Panel05Props {
  facilityId: string;
  title?: string;
...
/**
 * OrderRecord17Panel05 — operational panel for orders domain slice 17/05.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function OrderRecord17Panel05({ facilityId, title = 'OrderRecord17 Workspace', onSelect }: OrderRecord17Panel05Props) {
  ...
  return (
    <section className="lis-panel lis-panel--orders" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} orders records (slice 17-05)
      </footer>
    </section>
  );
}

export default OrderRecord17Panel05;
