...
export interface OrderRecord03Panel03Props {
  facilityId: string;
  title?: string;
...
/**
 * OrderRecord03Panel03 — operational panel for orders domain slice 03/03.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function OrderRecord03Panel03({ facilityId, title = 'OrderRecord03 Workspace', onSelect }: OrderRecord03Panel03Props) {
  ...
  return (
    <section className="lis-panel lis-panel--orders" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} orders records (slice 03-03)
      </footer>
    </section>
  );
}

export default OrderRecord03Panel03;
