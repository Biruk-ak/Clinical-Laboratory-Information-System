...
export interface OrderRecord03Panel02Props {
  facilityId: string;
  title?: string;
...
/**
 * OrderRecord03Panel02 — operational panel for orders domain slice 03/02.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function OrderRecord03Panel02({ facilityId, title = 'OrderRecord03 Workspace', onSelect }: OrderRecord03Panel02Props) {
  ...
  return (
    <section className="lis-panel lis-panel--orders" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} orders records (slice 03-02)
      </footer>
    </section>
  );
}

export default OrderRecord03Panel02;
