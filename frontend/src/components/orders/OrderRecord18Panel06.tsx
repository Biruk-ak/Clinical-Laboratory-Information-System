...
export interface OrderRecord18Panel06Props {
  facilityId: string;
  title?: string;
...
/**
 * OrderRecord18Panel06 — operational panel for orders domain slice 18/06.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function OrderRecord18Panel06({ facilityId, title = 'OrderRecord18 Workspace', onSelect }: OrderRecord18Panel06Props) {
  ...
  return (
    <section className="lis-panel lis-panel--orders" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} orders records (slice 18-06)
      </footer>
    </section>
  );
}

export default OrderRecord18Panel06;
