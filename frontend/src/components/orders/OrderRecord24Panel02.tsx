...
export interface OrderRecord24Panel02Props {
  facilityId: string;
  title?: string;
...
/**
 * OrderRecord24Panel02 — operational panel for orders domain slice 24/02.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function OrderRecord24Panel02({ facilityId, title = 'OrderRecord24 Workspace', onSelect }: OrderRecord24Panel02Props) {
  ...
  return (
    <section className="lis-panel lis-panel--orders" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} orders records (slice 24-02)
      </footer>
    </section>
  );
}

export default OrderRecord24Panel02;
