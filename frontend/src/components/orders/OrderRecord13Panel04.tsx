...
export interface OrderRecord13Panel04Props {
  facilityId: string;
  title?: string;
...
/**
 * OrderRecord13Panel04 — operational panel for orders domain slice 13/04.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function OrderRecord13Panel04({ facilityId, title = 'OrderRecord13 Workspace', onSelect }: OrderRecord13Panel04Props) {
  ...
  return (
    <section className="lis-panel lis-panel--orders" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} orders records (slice 13-04)
      </footer>
    </section>
  );
}

export default OrderRecord13Panel04;
