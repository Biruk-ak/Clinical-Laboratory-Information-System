...
export interface OrderRecord17Panel03Props {
  facilityId: string;
  title?: string;
...
/**
 * OrderRecord17Panel03 — operational panel for orders domain slice 17/03.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function OrderRecord17Panel03({ facilityId, title = 'OrderRecord17 Workspace', onSelect }: OrderRecord17Panel03Props) {
  ...
  return (
    <section className="lis-panel lis-panel--orders" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} orders records (slice 17-03)
      </footer>
    </section>
  );
}

export default OrderRecord17Panel03;
