...
export interface OrderRecord28Panel04Props {
  facilityId: string;
  title?: string;
...
/**
 * OrderRecord28Panel04 — operational panel for orders domain slice 28/04.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function OrderRecord28Panel04({ facilityId, title = 'OrderRecord28 Workspace', onSelect }: OrderRecord28Panel04Props) {
  ...
  return (
    <section className="lis-panel lis-panel--orders" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} orders records (slice 28-04)
      </footer>
    </section>
  );
}

export default OrderRecord28Panel04;
