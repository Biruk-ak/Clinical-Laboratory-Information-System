...
export interface OrderRecord28Panel02Props {
  facilityId: string;
  title?: string;
...
/**
 * OrderRecord28Panel02 — operational panel for orders domain slice 28/02.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function OrderRecord28Panel02({ facilityId, title = 'OrderRecord28 Workspace', onSelect }: OrderRecord28Panel02Props) {
  ...
  return (
    <section className="lis-panel lis-panel--orders" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} orders records (slice 28-02)
      </footer>
    </section>
  );
}

export default OrderRecord28Panel02;
