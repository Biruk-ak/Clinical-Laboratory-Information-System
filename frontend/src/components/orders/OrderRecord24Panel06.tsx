...
export interface OrderRecord24Panel06Props {
  facilityId: string;
  title?: string;
...
/**
 * OrderRecord24Panel06 — operational panel for orders domain slice 24/06.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function OrderRecord24Panel06({ facilityId, title = 'OrderRecord24 Workspace', onSelect }: OrderRecord24Panel06Props) {
  ...
  return (
    <section className="lis-panel lis-panel--orders" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} orders records (slice 24-06)
      </footer>
    </section>
  );
}

export default OrderRecord24Panel06;
