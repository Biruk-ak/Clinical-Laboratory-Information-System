...
export interface OrderRecord17Panel02Props {
  facilityId: string;
  title?: string;
...
/**
 * OrderRecord17Panel02 — operational panel for orders domain slice 17/02.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function OrderRecord17Panel02({ facilityId, title = 'OrderRecord17 Workspace', onSelect }: OrderRecord17Panel02Props) {
  ...
  return (
    <section className="lis-panel lis-panel--orders" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} orders records (slice 17-02)
      </footer>
    </section>
  );
}

export default OrderRecord17Panel02;
