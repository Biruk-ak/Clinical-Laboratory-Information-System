...
export interface OrderRecord18Panel05Props {
  facilityId: string;
  title?: string;
...
/**
 * OrderRecord18Panel05 — operational panel for orders domain slice 18/05.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function OrderRecord18Panel05({ facilityId, title = 'OrderRecord18 Workspace', onSelect }: OrderRecord18Panel05Props) {
  ...
  return (
    <section className="lis-panel lis-panel--orders" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} orders records (slice 18-05)
      </footer>
    </section>
  );
}

export default OrderRecord18Panel05;
