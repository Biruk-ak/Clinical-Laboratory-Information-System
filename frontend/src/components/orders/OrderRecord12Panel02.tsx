...
export interface OrderRecord12Panel02Props {
  facilityId: string;
  title?: string;
...
/**
 * OrderRecord12Panel02 — operational panel for orders domain slice 12/02.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function OrderRecord12Panel02({ facilityId, title = 'OrderRecord12 Workspace', onSelect }: OrderRecord12Panel02Props) {
  ...
  return (
    <section className="lis-panel lis-panel--orders" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} orders records (slice 12-02)
      </footer>
    </section>
  );
}

export default OrderRecord12Panel02;
