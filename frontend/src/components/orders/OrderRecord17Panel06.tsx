...
export interface OrderRecord17Panel06Props {
  facilityId: string;
  title?: string;
...
/**
 * OrderRecord17Panel06 — operational panel for orders domain slice 17/06.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function OrderRecord17Panel06({ facilityId, title = 'OrderRecord17 Workspace', onSelect }: OrderRecord17Panel06Props) {
  ...
  return (
    <section className="lis-panel lis-panel--orders" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} orders records (slice 17-06)
      </footer>
    </section>
  );
}

export default OrderRecord17Panel06;
