...
export interface OrderRecord01Panel05Props {
  facilityId: string;
  title?: string;
...
/**
 * OrderRecord01Panel05 — operational panel for orders domain slice 01/05.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function OrderRecord01Panel05({ facilityId, title = 'OrderRecord01 Workspace', onSelect }: OrderRecord01Panel05Props) {
  ...
  return (
    <section className="lis-panel lis-panel--orders" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} orders records (slice 01-05)
      </footer>
    </section>
  );
}

export default OrderRecord01Panel05;
