...
export interface OrderRecord13Panel02Props {
  facilityId: string;
  title?: string;
...
/**
 * OrderRecord13Panel02 — operational panel for orders domain slice 13/02.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function OrderRecord13Panel02({ facilityId, title = 'OrderRecord13 Workspace', onSelect }: OrderRecord13Panel02Props) {
  ...
  return (
    <section className="lis-panel lis-panel--orders" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} orders records (slice 13-02)
      </footer>
    </section>
  );
}

export default OrderRecord13Panel02;
