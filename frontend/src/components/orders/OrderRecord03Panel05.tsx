...
export interface OrderRecord03Panel05Props {
  facilityId: string;
  title?: string;
...
/**
 * OrderRecord03Panel05 — operational panel for orders domain slice 03/05.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function OrderRecord03Panel05({ facilityId, title = 'OrderRecord03 Workspace', onSelect }: OrderRecord03Panel05Props) {
  ...
  return (
    <section className="lis-panel lis-panel--orders" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} orders records (slice 03-05)
      </footer>
    </section>
  );
}

export default OrderRecord03Panel05;
