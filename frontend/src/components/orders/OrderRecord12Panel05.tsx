...
export interface OrderRecord12Panel05Props {
  facilityId: string;
  title?: string;
...
/**
 * OrderRecord12Panel05 — operational panel for orders domain slice 12/05.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function OrderRecord12Panel05({ facilityId, title = 'OrderRecord12 Workspace', onSelect }: OrderRecord12Panel05Props) {
  ...
  return (
    <section className="lis-panel lis-panel--orders" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} orders records (slice 12-05)
      </footer>
    </section>
  );
}

export default OrderRecord12Panel05;
