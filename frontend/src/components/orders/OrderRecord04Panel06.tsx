...
export interface OrderRecord04Panel06Props {
  facilityId: string;
  title?: string;
...
/**
 * OrderRecord04Panel06 — operational panel for orders domain slice 04/06.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function OrderRecord04Panel06({ facilityId, title = 'OrderRecord04 Workspace', onSelect }: OrderRecord04Panel06Props) {
  ...
  return (
    <section className="lis-panel lis-panel--orders" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} orders records (slice 04-06)
      </footer>
    </section>
  );
}

export default OrderRecord04Panel06;
