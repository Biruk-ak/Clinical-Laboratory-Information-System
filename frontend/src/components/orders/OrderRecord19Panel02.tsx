...
export interface OrderRecord19Panel02Props {
  facilityId: string;
  title?: string;
...
/**
 * OrderRecord19Panel02 — operational panel for orders domain slice 19/02.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function OrderRecord19Panel02({ facilityId, title = 'OrderRecord19 Workspace', onSelect }: OrderRecord19Panel02Props) {
  ...
  return (
    <section className="lis-panel lis-panel--orders" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} orders records (slice 19-02)
      </footer>
    </section>
  );
}

export default OrderRecord19Panel02;
