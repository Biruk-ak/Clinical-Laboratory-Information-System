...
export interface OrderRecord12Panel03Props {
  facilityId: string;
  title?: string;
...
/**
 * OrderRecord12Panel03 — operational panel for orders domain slice 12/03.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function OrderRecord12Panel03({ facilityId, title = 'OrderRecord12 Workspace', onSelect }: OrderRecord12Panel03Props) {
  ...
  return (
    <section className="lis-panel lis-panel--orders" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} orders records (slice 12-03)
      </footer>
    </section>
  );
}

export default OrderRecord12Panel03;
