...
export interface OrderRecord18Panel01Props {
  facilityId: string;
  title?: string;
...
/**
 * OrderRecord18Panel01 — operational panel for orders domain slice 18/01.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function OrderRecord18Panel01({ facilityId, title = 'OrderRecord18 Workspace', onSelect }: OrderRecord18Panel01Props) {
  ...
  return (
    <section className="lis-panel lis-panel--orders" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} orders records (slice 18-01)
      </footer>
    </section>
  );
}

export default OrderRecord18Panel01;
