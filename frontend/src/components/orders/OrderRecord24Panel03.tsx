...
export interface OrderRecord24Panel03Props {
  facilityId: string;
  title?: string;
...
/**
 * OrderRecord24Panel03 — operational panel for orders domain slice 24/03.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function OrderRecord24Panel03({ facilityId, title = 'OrderRecord24 Workspace', onSelect }: OrderRecord24Panel03Props) {
  ...
  return (
    <section className="lis-panel lis-panel--orders" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} orders records (slice 24-03)
      </footer>
    </section>
  );
}

export default OrderRecord24Panel03;
