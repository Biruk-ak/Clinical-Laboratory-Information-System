...
export interface OrderRecord18Panel02Props {
  facilityId: string;
  title?: string;
...
/**
 * OrderRecord18Panel02 — operational panel for orders domain slice 18/02.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function OrderRecord18Panel02({ facilityId, title = 'OrderRecord18 Workspace', onSelect }: OrderRecord18Panel02Props) {
  ...
  return (
    <section className="lis-panel lis-panel--orders" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} orders records (slice 18-02)
      </footer>
    </section>
  );
}

export default OrderRecord18Panel02;
