...
export interface OrderRecord10Panel03Props {
  facilityId: string;
  title?: string;
...
/**
 * OrderRecord10Panel03 — operational panel for orders domain slice 10/03.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function OrderRecord10Panel03({ facilityId, title = 'OrderRecord10 Workspace', onSelect }: OrderRecord10Panel03Props) {
  ...
  return (
    <section className="lis-panel lis-panel--orders" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} orders records (slice 10-03)
      </footer>
    </section>
  );
}

export default OrderRecord10Panel03;
