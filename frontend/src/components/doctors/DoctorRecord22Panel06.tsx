...
export interface DoctorRecord22Panel06Props {
  facilityId: string;
  title?: string;
...
/**
 * DoctorRecord22Panel06 — operational panel for doctors domain slice 22/06.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function DoctorRecord22Panel06({ facilityId, title = 'DoctorRecord22 Workspace', onSelect }: DoctorRecord22Panel06Props) {
  ...
  return (
    <section className="lis-panel lis-panel--doctors" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} doctors records (slice 22-06)
      </footer>
    </section>
  );
}

export default DoctorRecord22Panel06;
