...
export interface DoctorRecord22Panel03Props {
  facilityId: string;
  title?: string;
...
/**
 * DoctorRecord22Panel03 — operational panel for doctors domain slice 22/03.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function DoctorRecord22Panel03({ facilityId, title = 'DoctorRecord22 Workspace', onSelect }: DoctorRecord22Panel03Props) {
  ...
  return (
    <section className="lis-panel lis-panel--doctors" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} doctors records (slice 22-03)
      </footer>
    </section>
  );
}

export default DoctorRecord22Panel03;
