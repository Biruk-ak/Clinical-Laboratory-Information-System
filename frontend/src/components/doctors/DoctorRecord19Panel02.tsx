...
export interface DoctorRecord19Panel02Props {
  facilityId: string;
  title?: string;
...
/**
 * DoctorRecord19Panel02 — operational panel for doctors domain slice 19/02.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function DoctorRecord19Panel02({ facilityId, title = 'DoctorRecord19 Workspace', onSelect }: DoctorRecord19Panel02Props) {
  ...
  return (
    <section className="lis-panel lis-panel--doctors" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} doctors records (slice 19-02)
      </footer>
    </section>
  );
}

export default DoctorRecord19Panel02;
