...
export interface DoctorRecord11Panel05Props {
  facilityId: string;
  title?: string;
...
/**
 * DoctorRecord11Panel05 — operational panel for doctors domain slice 11/05.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function DoctorRecord11Panel05({ facilityId, title = 'DoctorRecord11 Workspace', onSelect }: DoctorRecord11Panel05Props) {
  ...
  return (
    <section className="lis-panel lis-panel--doctors" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} doctors records (slice 11-05)
      </footer>
    </section>
  );
}

export default DoctorRecord11Panel05;
