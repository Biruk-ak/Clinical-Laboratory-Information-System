...
export interface DoctorRecord11Panel01Props {
  facilityId: string;
  title?: string;
...
/**
 * DoctorRecord11Panel01 — operational panel for doctors domain slice 11/01.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function DoctorRecord11Panel01({ facilityId, title = 'DoctorRecord11 Workspace', onSelect }: DoctorRecord11Panel01Props) {
  ...
  return (
    <section className="lis-panel lis-panel--doctors" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} doctors records (slice 11-01)
      </footer>
    </section>
  );
}

export default DoctorRecord11Panel01;
