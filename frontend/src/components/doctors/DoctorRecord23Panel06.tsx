...
export interface DoctorRecord23Panel06Props {
  facilityId: string;
  title?: string;
...
/**
 * DoctorRecord23Panel06 — operational panel for doctors domain slice 23/06.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function DoctorRecord23Panel06({ facilityId, title = 'DoctorRecord23 Workspace', onSelect }: DoctorRecord23Panel06Props) {
  ...
  return (
    <section className="lis-panel lis-panel--doctors" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} doctors records (slice 23-06)
      </footer>
    </section>
  );
}

export default DoctorRecord23Panel06;
