...
export interface DoctorRecord14Panel06Props {
  facilityId: string;
  title?: string;
...
/**
 * DoctorRecord14Panel06 — operational panel for doctors domain slice 14/06.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function DoctorRecord14Panel06({ facilityId, title = 'DoctorRecord14 Workspace', onSelect }: DoctorRecord14Panel06Props) {
  ...
  return (
    <section className="lis-panel lis-panel--doctors" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} doctors records (slice 14-06)
      </footer>
    </section>
  );
}

export default DoctorRecord14Panel06;
