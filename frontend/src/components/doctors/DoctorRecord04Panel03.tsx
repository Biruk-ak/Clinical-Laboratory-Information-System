...
export interface DoctorRecord04Panel03Props {
  facilityId: string;
  title?: string;
...
/**
 * DoctorRecord04Panel03 — operational panel for doctors domain slice 04/03.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function DoctorRecord04Panel03({ facilityId, title = 'DoctorRecord04 Workspace', onSelect }: DoctorRecord04Panel03Props) {
  ...
  return (
    <section className="lis-panel lis-panel--doctors" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} doctors records (slice 04-03)
      </footer>
    </section>
  );
}

export default DoctorRecord04Panel03;
