...
export interface DoctorRecord23Panel05Props {
  facilityId: string;
  title?: string;
...
/**
 * DoctorRecord23Panel05 — operational panel for doctors domain slice 23/05.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function DoctorRecord23Panel05({ facilityId, title = 'DoctorRecord23 Workspace', onSelect }: DoctorRecord23Panel05Props) {
  ...
  return (
    <section className="lis-panel lis-panel--doctors" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} doctors records (slice 23-05)
      </footer>
    </section>
  );
}

export default DoctorRecord23Panel05;
