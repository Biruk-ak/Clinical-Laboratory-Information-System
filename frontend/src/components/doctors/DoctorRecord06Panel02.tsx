...
export interface DoctorRecord06Panel02Props {
  facilityId: string;
  title?: string;
...
/**
 * DoctorRecord06Panel02 — operational panel for doctors domain slice 06/02.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function DoctorRecord06Panel02({ facilityId, title = 'DoctorRecord06 Workspace', onSelect }: DoctorRecord06Panel02Props) {
  ...
  return (
    <section className="lis-panel lis-panel--doctors" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} doctors records (slice 06-02)
      </footer>
    </section>
  );
}

export default DoctorRecord06Panel02;
