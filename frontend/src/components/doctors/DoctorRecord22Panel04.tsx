...
export interface DoctorRecord22Panel04Props {
  facilityId: string;
  title?: string;
...
/**
 * DoctorRecord22Panel04 — operational panel for doctors domain slice 22/04.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function DoctorRecord22Panel04({ facilityId, title = 'DoctorRecord22 Workspace', onSelect }: DoctorRecord22Panel04Props) {
  ...
  return (
    <section className="lis-panel lis-panel--doctors" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} doctors records (slice 22-04)
      </footer>
    </section>
  );
}

export default DoctorRecord22Panel04;
