...
export interface DoctorRecord06Panel06Props {
  facilityId: string;
  title?: string;
...
/**
 * DoctorRecord06Panel06 — operational panel for doctors domain slice 06/06.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function DoctorRecord06Panel06({ facilityId, title = 'DoctorRecord06 Workspace', onSelect }: DoctorRecord06Panel06Props) {
  ...
  return (
    <section className="lis-panel lis-panel--doctors" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} doctors records (slice 06-06)
      </footer>
    </section>
  );
}

export default DoctorRecord06Panel06;
