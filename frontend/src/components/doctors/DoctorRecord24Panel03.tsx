...
export interface DoctorRecord24Panel03Props {
  facilityId: string;
  title?: string;
...
/**
 * DoctorRecord24Panel03 — operational panel for doctors domain slice 24/03.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function DoctorRecord24Panel03({ facilityId, title = 'DoctorRecord24 Workspace', onSelect }: DoctorRecord24Panel03Props) {
  ...
  return (
    <section className="lis-panel lis-panel--doctors" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} doctors records (slice 24-03)
      </footer>
    </section>
  );
}

export default DoctorRecord24Panel03;
