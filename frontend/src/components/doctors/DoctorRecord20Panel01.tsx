...
export interface DoctorRecord20Panel01Props {
  facilityId: string;
  title?: string;
...
/**
 * DoctorRecord20Panel01 — operational panel for doctors domain slice 20/01.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function DoctorRecord20Panel01({ facilityId, title = 'DoctorRecord20 Workspace', onSelect }: DoctorRecord20Panel01Props) {
  ...
  return (
    <section className="lis-panel lis-panel--doctors" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} doctors records (slice 20-01)
      </footer>
    </section>
  );
}

export default DoctorRecord20Panel01;
