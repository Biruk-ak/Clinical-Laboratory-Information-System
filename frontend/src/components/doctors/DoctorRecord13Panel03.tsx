...
export interface DoctorRecord13Panel03Props {
  facilityId: string;
  title?: string;
...
/**
 * DoctorRecord13Panel03 — operational panel for doctors domain slice 13/03.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function DoctorRecord13Panel03({ facilityId, title = 'DoctorRecord13 Workspace', onSelect }: DoctorRecord13Panel03Props) {
  ...
  return (
    <section className="lis-panel lis-panel--doctors" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} doctors records (slice 13-03)
      </footer>
    </section>
  );
}

export default DoctorRecord13Panel03;
