...
export interface DoctorRecord05Panel01Props {
  facilityId: string;
  title?: string;
...
/**
 * DoctorRecord05Panel01 — operational panel for doctors domain slice 05/01.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function DoctorRecord05Panel01({ facilityId, title = 'DoctorRecord05 Workspace', onSelect }: DoctorRecord05Panel01Props) {
  ...
  return (
    <section className="lis-panel lis-panel--doctors" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} doctors records (slice 05-01)
      </footer>
    </section>
  );
}

export default DoctorRecord05Panel01;
