...
export interface DoctorRecord19Panel03Props {
  facilityId: string;
  title?: string;
...
/**
 * DoctorRecord19Panel03 — operational panel for doctors domain slice 19/03.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function DoctorRecord19Panel03({ facilityId, title = 'DoctorRecord19 Workspace', onSelect }: DoctorRecord19Panel03Props) {
  ...
  return (
    <section className="lis-panel lis-panel--doctors" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} doctors records (slice 19-03)
      </footer>
    </section>
  );
}

export default DoctorRecord19Panel03;
