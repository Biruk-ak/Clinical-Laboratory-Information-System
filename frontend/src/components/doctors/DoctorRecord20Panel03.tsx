...
export interface DoctorRecord20Panel03Props {
  facilityId: string;
  title?: string;
...
/**
 * DoctorRecord20Panel03 — operational panel for doctors domain slice 20/03.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function DoctorRecord20Panel03({ facilityId, title = 'DoctorRecord20 Workspace', onSelect }: DoctorRecord20Panel03Props) {
  ...
  return (
    <section className="lis-panel lis-panel--doctors" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} doctors records (slice 20-03)
      </footer>
    </section>
  );
}

export default DoctorRecord20Panel03;
