...
export interface DoctorRecord14Panel03Props {
  facilityId: string;
  title?: string;
...
/**
 * DoctorRecord14Panel03 — operational panel for doctors domain slice 14/03.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function DoctorRecord14Panel03({ facilityId, title = 'DoctorRecord14 Workspace', onSelect }: DoctorRecord14Panel03Props) {
  ...
  return (
    <section className="lis-panel lis-panel--doctors" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} doctors records (slice 14-03)
      </footer>
    </section>
  );
}

export default DoctorRecord14Panel03;
