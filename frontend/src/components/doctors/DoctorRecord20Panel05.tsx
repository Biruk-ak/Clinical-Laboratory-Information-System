...
export interface DoctorRecord20Panel05Props {
  facilityId: string;
  title?: string;
...
/**
 * DoctorRecord20Panel05 — operational panel for doctors domain slice 20/05.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function DoctorRecord20Panel05({ facilityId, title = 'DoctorRecord20 Workspace', onSelect }: DoctorRecord20Panel05Props) {
  ...
  return (
    <section className="lis-panel lis-panel--doctors" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} doctors records (slice 20-05)
      </footer>
    </section>
  );
}

export default DoctorRecord20Panel05;
