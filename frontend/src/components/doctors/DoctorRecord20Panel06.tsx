...
export interface DoctorRecord20Panel06Props {
  facilityId: string;
  title?: string;
...
/**
 * DoctorRecord20Panel06 — operational panel for doctors domain slice 20/06.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function DoctorRecord20Panel06({ facilityId, title = 'DoctorRecord20 Workspace', onSelect }: DoctorRecord20Panel06Props) {
  ...
  return (
    <section className="lis-panel lis-panel--doctors" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} doctors records (slice 20-06)
      </footer>
    </section>
  );
}

export default DoctorRecord20Panel06;
