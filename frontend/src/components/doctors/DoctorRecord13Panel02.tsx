...
export interface DoctorRecord13Panel02Props {
  facilityId: string;
  title?: string;
...
/**
 * DoctorRecord13Panel02 — operational panel for doctors domain slice 13/02.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function DoctorRecord13Panel02({ facilityId, title = 'DoctorRecord13 Workspace', onSelect }: DoctorRecord13Panel02Props) {
  ...
  return (
    <section className="lis-panel lis-panel--doctors" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} doctors records (slice 13-02)
      </footer>
    </section>
  );
}

export default DoctorRecord13Panel02;
