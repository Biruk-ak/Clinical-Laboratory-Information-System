...
export interface DoctorRecord11Panel03Props {
  facilityId: string;
  title?: string;
...
/**
 * DoctorRecord11Panel03 — operational panel for doctors domain slice 11/03.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function DoctorRecord11Panel03({ facilityId, title = 'DoctorRecord11 Workspace', onSelect }: DoctorRecord11Panel03Props) {
  ...
  return (
    <section className="lis-panel lis-panel--doctors" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} doctors records (slice 11-03)
      </footer>
    </section>
  );
}

export default DoctorRecord11Panel03;
