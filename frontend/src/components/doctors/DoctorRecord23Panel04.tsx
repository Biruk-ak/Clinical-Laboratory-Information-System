...
export interface DoctorRecord23Panel04Props {
  facilityId: string;
  title?: string;
...
/**
 * DoctorRecord23Panel04 — operational panel for doctors domain slice 23/04.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function DoctorRecord23Panel04({ facilityId, title = 'DoctorRecord23 Workspace', onSelect }: DoctorRecord23Panel04Props) {
  ...
  return (
    <section className="lis-panel lis-panel--doctors" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} doctors records (slice 23-04)
      </footer>
    </section>
  );
}

export default DoctorRecord23Panel04;
