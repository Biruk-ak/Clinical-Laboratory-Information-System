...
export interface DoctorRecord05Panel03Props {
  facilityId: string;
  title?: string;
...
/**
 * DoctorRecord05Panel03 — operational panel for doctors domain slice 05/03.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function DoctorRecord05Panel03({ facilityId, title = 'DoctorRecord05 Workspace', onSelect }: DoctorRecord05Panel03Props) {
  ...
  return (
    <section className="lis-panel lis-panel--doctors" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} doctors records (slice 05-03)
      </footer>
    </section>
  );
}

export default DoctorRecord05Panel03;
