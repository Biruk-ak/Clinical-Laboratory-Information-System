...
export interface DoctorRecord26Panel02Props {
  facilityId: string;
  title?: string;
...
/**
 * DoctorRecord26Panel02 — operational panel for doctors domain slice 26/02.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function DoctorRecord26Panel02({ facilityId, title = 'DoctorRecord26 Workspace', onSelect }: DoctorRecord26Panel02Props) {
  ...
  return (
    <section className="lis-panel lis-panel--doctors" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} doctors records (slice 26-02)
      </footer>
    </section>
  );
}

export default DoctorRecord26Panel02;
