...
export interface DoctorRecord05Panel05Props {
  facilityId: string;
  title?: string;
...
/**
 * DoctorRecord05Panel05 — operational panel for doctors domain slice 05/05.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function DoctorRecord05Panel05({ facilityId, title = 'DoctorRecord05 Workspace', onSelect }: DoctorRecord05Panel05Props) {
  ...
  return (
    <section className="lis-panel lis-panel--doctors" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} doctors records (slice 05-05)
      </footer>
    </section>
  );
}

export default DoctorRecord05Panel05;
