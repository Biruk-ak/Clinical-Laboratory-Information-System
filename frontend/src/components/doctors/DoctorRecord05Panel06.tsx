...
export interface DoctorRecord05Panel06Props {
  facilityId: string;
  title?: string;
...
/**
 * DoctorRecord05Panel06 — operational panel for doctors domain slice 05/06.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function DoctorRecord05Panel06({ facilityId, title = 'DoctorRecord05 Workspace', onSelect }: DoctorRecord05Panel06Props) {
  ...
  return (
    <section className="lis-panel lis-panel--doctors" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} doctors records (slice 05-06)
      </footer>
    </section>
  );
}

export default DoctorRecord05Panel06;
