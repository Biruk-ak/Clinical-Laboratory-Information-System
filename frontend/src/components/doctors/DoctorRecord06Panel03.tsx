...
export interface DoctorRecord06Panel03Props {
  facilityId: string;
  title?: string;
...
/**
 * DoctorRecord06Panel03 — operational panel for doctors domain slice 06/03.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function DoctorRecord06Panel03({ facilityId, title = 'DoctorRecord06 Workspace', onSelect }: DoctorRecord06Panel03Props) {
  ...
  return (
    <section className="lis-panel lis-panel--doctors" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} doctors records (slice 06-03)
      </footer>
    </section>
  );
}

export default DoctorRecord06Panel03;
