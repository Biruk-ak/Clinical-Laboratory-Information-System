...
export interface DoctorRecord05Panel04Props {
  facilityId: string;
  title?: string;
...
/**
 * DoctorRecord05Panel04 — operational panel for doctors domain slice 05/04.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function DoctorRecord05Panel04({ facilityId, title = 'DoctorRecord05 Workspace', onSelect }: DoctorRecord05Panel04Props) {
  ...
  return (
    <section className="lis-panel lis-panel--doctors" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} doctors records (slice 05-04)
      </footer>
    </section>
  );
}

export default DoctorRecord05Panel04;
