...
export interface DoctorRecord19Panel06Props {
  facilityId: string;
  title?: string;
...
/**
 * DoctorRecord19Panel06 — operational panel for doctors domain slice 19/06.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function DoctorRecord19Panel06({ facilityId, title = 'DoctorRecord19 Workspace', onSelect }: DoctorRecord19Panel06Props) {
  ...
  return (
    <section className="lis-panel lis-panel--doctors" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} doctors records (slice 19-06)
      </footer>
    </section>
  );
}

export default DoctorRecord19Panel06;
