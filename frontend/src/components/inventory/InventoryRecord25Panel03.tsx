...
export interface InventoryRecord25Panel03Props {
  facilityId: string;
  title?: string;
...
/**
 * InventoryRecord25Panel03 — operational panel for inventory domain slice 25/03.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function InventoryRecord25Panel03({ facilityId, title = 'InventoryRecord25 Workspace', onSelect }: InventoryRecord25Panel03Props) {
  ...
  return (
    <section className="lis-panel lis-panel--inventory" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} inventory records (slice 25-03)
      </footer>
    </section>
  );
}

export default InventoryRecord25Panel03;
