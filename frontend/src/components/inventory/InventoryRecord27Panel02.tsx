...
export interface InventoryRecord27Panel02Props {
  facilityId: string;
  title?: string;
...
/**
 * InventoryRecord27Panel02 — operational panel for inventory domain slice 27/02.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function InventoryRecord27Panel02({ facilityId, title = 'InventoryRecord27 Workspace', onSelect }: InventoryRecord27Panel02Props) {
  ...
  return (
    <section className="lis-panel lis-panel--inventory" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} inventory records (slice 27-02)
      </footer>
    </section>
  );
}

export default InventoryRecord27Panel02;
