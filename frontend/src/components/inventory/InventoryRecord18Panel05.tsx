...
export interface InventoryRecord18Panel05Props {
  facilityId: string;
  title?: string;
...
/**
 * InventoryRecord18Panel05 — operational panel for inventory domain slice 18/05.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function InventoryRecord18Panel05({ facilityId, title = 'InventoryRecord18 Workspace', onSelect }: InventoryRecord18Panel05Props) {
  ...
  return (
    <section className="lis-panel lis-panel--inventory" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} inventory records (slice 18-05)
      </footer>
    </section>
  );
}

export default InventoryRecord18Panel05;
