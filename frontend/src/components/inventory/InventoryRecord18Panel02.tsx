...
export interface InventoryRecord18Panel02Props {
  facilityId: string;
  title?: string;
...
/**
 * InventoryRecord18Panel02 — operational panel for inventory domain slice 18/02.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function InventoryRecord18Panel02({ facilityId, title = 'InventoryRecord18 Workspace', onSelect }: InventoryRecord18Panel02Props) {
  ...
  return (
    <section className="lis-panel lis-panel--inventory" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} inventory records (slice 18-02)
      </footer>
    </section>
  );
}

export default InventoryRecord18Panel02;
