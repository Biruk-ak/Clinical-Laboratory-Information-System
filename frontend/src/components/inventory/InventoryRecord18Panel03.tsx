...
export interface InventoryRecord18Panel03Props {
  facilityId: string;
  title?: string;
...
/**
 * InventoryRecord18Panel03 — operational panel for inventory domain slice 18/03.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function InventoryRecord18Panel03({ facilityId, title = 'InventoryRecord18 Workspace', onSelect }: InventoryRecord18Panel03Props) {
  ...
  return (
    <section className="lis-panel lis-panel--inventory" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} inventory records (slice 18-03)
      </footer>
    </section>
  );
}

export default InventoryRecord18Panel03;
