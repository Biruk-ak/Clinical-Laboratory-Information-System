...
export interface InventoryRecord20Panel05Props {
  facilityId: string;
  title?: string;
...
/**
 * InventoryRecord20Panel05 — operational panel for inventory domain slice 20/05.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function InventoryRecord20Panel05({ facilityId, title = 'InventoryRecord20 Workspace', onSelect }: InventoryRecord20Panel05Props) {
  ...
  return (
    <section className="lis-panel lis-panel--inventory" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} inventory records (slice 20-05)
      </footer>
    </section>
  );
}

export default InventoryRecord20Panel05;
