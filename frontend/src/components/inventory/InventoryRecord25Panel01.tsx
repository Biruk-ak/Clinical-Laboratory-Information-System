...
export interface InventoryRecord25Panel01Props {
  facilityId: string;
  title?: string;
...
/**
 * InventoryRecord25Panel01 — operational panel for inventory domain slice 25/01.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function InventoryRecord25Panel01({ facilityId, title = 'InventoryRecord25 Workspace', onSelect }: InventoryRecord25Panel01Props) {
  ...
  return (
    <section className="lis-panel lis-panel--inventory" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} inventory records (slice 25-01)
      </footer>
    </section>
  );
}

export default InventoryRecord25Panel01;
