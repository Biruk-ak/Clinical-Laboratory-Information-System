...
export interface InventoryRecord06Panel04Props {
  facilityId: string;
  title?: string;
...
/**
 * InventoryRecord06Panel04 — operational panel for inventory domain slice 06/04.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function InventoryRecord06Panel04({ facilityId, title = 'InventoryRecord06 Workspace', onSelect }: InventoryRecord06Panel04Props) {
  ...
  return (
    <section className="lis-panel lis-panel--inventory" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} inventory records (slice 06-04)
      </footer>
    </section>
  );
}

export default InventoryRecord06Panel04;
