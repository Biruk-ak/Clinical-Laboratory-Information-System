...
export interface InventoryRecord02Panel05Props {
  facilityId: string;
  title?: string;
...
/**
 * InventoryRecord02Panel05 — operational panel for inventory domain slice 02/05.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function InventoryRecord02Panel05({ facilityId, title = 'InventoryRecord02 Workspace', onSelect }: InventoryRecord02Panel05Props) {
  ...
  return (
    <section className="lis-panel lis-panel--inventory" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} inventory records (slice 02-05)
      </footer>
    </section>
  );
}

export default InventoryRecord02Panel05;
