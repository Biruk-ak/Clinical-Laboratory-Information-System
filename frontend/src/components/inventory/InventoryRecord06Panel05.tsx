...
export interface InventoryRecord06Panel05Props {
  facilityId: string;
  title?: string;
...
/**
 * InventoryRecord06Panel05 — operational panel for inventory domain slice 06/05.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function InventoryRecord06Panel05({ facilityId, title = 'InventoryRecord06 Workspace', onSelect }: InventoryRecord06Panel05Props) {
  ...
  return (
    <section className="lis-panel lis-panel--inventory" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} inventory records (slice 06-05)
      </footer>
    </section>
  );
}

export default InventoryRecord06Panel05;
