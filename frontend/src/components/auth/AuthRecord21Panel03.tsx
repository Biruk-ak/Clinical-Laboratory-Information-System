...
export interface AuthRecord21Panel03Props {
  facilityId: string;
  title?: string;
...
/**
 * AuthRecord21Panel03 — operational panel for auth domain slice 21/03.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function AuthRecord21Panel03({ facilityId, title = 'AuthRecord21 Workspace', onSelect }: AuthRecord21Panel03Props) {
  ...
  return (
    <section className="lis-panel lis-panel--auth" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} auth records (slice 21-03)
      </footer>
    </section>
  );
}

export default AuthRecord21Panel03;
