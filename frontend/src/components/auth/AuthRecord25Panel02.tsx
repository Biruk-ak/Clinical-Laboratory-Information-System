...
export interface AuthRecord25Panel02Props {
  facilityId: string;
  title?: string;
...
/**
 * AuthRecord25Panel02 — operational panel for auth domain slice 25/02.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function AuthRecord25Panel02({ facilityId, title = 'AuthRecord25 Workspace', onSelect }: AuthRecord25Panel02Props) {
  ...
  return (
    <section className="lis-panel lis-panel--auth" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} auth records (slice 25-02)
      </footer>
    </section>
  );
}

export default AuthRecord25Panel02;
