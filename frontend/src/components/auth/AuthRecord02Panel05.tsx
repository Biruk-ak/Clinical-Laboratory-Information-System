...
export interface AuthRecord02Panel05Props {
  facilityId: string;
  title?: string;
...
/**
 * AuthRecord02Panel05 — operational panel for auth domain slice 02/05.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function AuthRecord02Panel05({ facilityId, title = 'AuthRecord02 Workspace', onSelect }: AuthRecord02Panel05Props) {
  ...
  return (
    <section className="lis-panel lis-panel--auth" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} auth records (slice 02-05)
      </footer>
    </section>
  );
}

export default AuthRecord02Panel05;
