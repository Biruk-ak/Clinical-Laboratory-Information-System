...
export interface AuthRecord14Panel06Props {
  facilityId: string;
  title?: string;
...
/**
 * AuthRecord14Panel06 — operational panel for auth domain slice 14/06.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function AuthRecord14Panel06({ facilityId, title = 'AuthRecord14 Workspace', onSelect }: AuthRecord14Panel06Props) {
  ...
  return (
    <section className="lis-panel lis-panel--auth" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} auth records (slice 14-06)
      </footer>
    </section>
  );
}

export default AuthRecord14Panel06;
