...
export interface AuthRecord14Panel03Props {
  facilityId: string;
  title?: string;
...
/**
 * AuthRecord14Panel03 — operational panel for auth domain slice 14/03.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function AuthRecord14Panel03({ facilityId, title = 'AuthRecord14 Workspace', onSelect }: AuthRecord14Panel03Props) {
  ...
  return (
    <section className="lis-panel lis-panel--auth" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} auth records (slice 14-03)
      </footer>
    </section>
  );
}

export default AuthRecord14Panel03;
