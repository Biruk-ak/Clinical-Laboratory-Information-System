...
export interface AuthRecord22Panel02Props {
  facilityId: string;
  title?: string;
...
/**
 * AuthRecord22Panel02 — operational panel for auth domain slice 22/02.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function AuthRecord22Panel02({ facilityId, title = 'AuthRecord22 Workspace', onSelect }: AuthRecord22Panel02Props) {
  ...
  return (
    <section className="lis-panel lis-panel--auth" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} auth records (slice 22-02)
      </footer>
    </section>
  );
}

export default AuthRecord22Panel02;
