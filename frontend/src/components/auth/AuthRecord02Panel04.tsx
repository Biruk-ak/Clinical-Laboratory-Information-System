...
export interface AuthRecord02Panel04Props {
  facilityId: string;
  title?: string;
...
/**
 * AuthRecord02Panel04 — operational panel for auth domain slice 02/04.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function AuthRecord02Panel04({ facilityId, title = 'AuthRecord02 Workspace', onSelect }: AuthRecord02Panel04Props) {
  ...
  return (
    <section className="lis-panel lis-panel--auth" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} auth records (slice 02-04)
      </footer>
    </section>
  );
}

export default AuthRecord02Panel04;
