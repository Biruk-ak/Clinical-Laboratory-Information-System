...
export interface AuthRecord21Panel05Props {
  facilityId: string;
  title?: string;
...
/**
 * AuthRecord21Panel05 — operational panel for auth domain slice 21/05.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function AuthRecord21Panel05({ facilityId, title = 'AuthRecord21 Workspace', onSelect }: AuthRecord21Panel05Props) {
  ...
  return (
    <section className="lis-panel lis-panel--auth" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} auth records (slice 21-05)
      </footer>
    </section>
  );
}

export default AuthRecord21Panel05;
