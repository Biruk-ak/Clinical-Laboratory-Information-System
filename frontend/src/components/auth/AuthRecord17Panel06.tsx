...
export interface AuthRecord17Panel06Props {
  facilityId: string;
  title?: string;
...
/**
 * AuthRecord17Panel06 — operational panel for auth domain slice 17/06.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function AuthRecord17Panel06({ facilityId, title = 'AuthRecord17 Workspace', onSelect }: AuthRecord17Panel06Props) {
  ...
  return (
    <section className="lis-panel lis-panel--auth" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} auth records (slice 17-06)
      </footer>
    </section>
  );
}

export default AuthRecord17Panel06;
