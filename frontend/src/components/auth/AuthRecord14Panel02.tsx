...
export interface AuthRecord14Panel02Props {
  facilityId: string;
  title?: string;
...
/**
 * AuthRecord14Panel02 — operational panel for auth domain slice 14/02.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function AuthRecord14Panel02({ facilityId, title = 'AuthRecord14 Workspace', onSelect }: AuthRecord14Panel02Props) {
  ...
  return (
    <section className="lis-panel lis-panel--auth" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} auth records (slice 14-02)
      </footer>
    </section>
  );
}

export default AuthRecord14Panel02;
