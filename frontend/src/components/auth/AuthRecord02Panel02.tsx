...
export interface AuthRecord02Panel02Props {
  facilityId: string;
  title?: string;
...
/**
 * AuthRecord02Panel02 — operational panel for auth domain slice 02/02.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function AuthRecord02Panel02({ facilityId, title = 'AuthRecord02 Workspace', onSelect }: AuthRecord02Panel02Props) {
  ...
  return (
    <section className="lis-panel lis-panel--auth" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} auth records (slice 02-02)
      </footer>
    </section>
  );
}

export default AuthRecord02Panel02;
