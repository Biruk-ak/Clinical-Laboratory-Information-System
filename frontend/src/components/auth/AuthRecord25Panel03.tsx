...
export interface AuthRecord25Panel03Props {
  facilityId: string;
  title?: string;
...
/**
 * AuthRecord25Panel03 — operational panel for auth domain slice 25/03.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function AuthRecord25Panel03({ facilityId, title = 'AuthRecord25 Workspace', onSelect }: AuthRecord25Panel03Props) {
  ...
  return (
    <section className="lis-panel lis-panel--auth" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} auth records (slice 25-03)
      </footer>
    </section>
  );
}

export default AuthRecord25Panel03;
