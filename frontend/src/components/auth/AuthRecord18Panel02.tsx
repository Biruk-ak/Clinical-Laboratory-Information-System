...
export interface AuthRecord18Panel02Props {
  facilityId: string;
  title?: string;
...
/**
 * AuthRecord18Panel02 — operational panel for auth domain slice 18/02.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function AuthRecord18Panel02({ facilityId, title = 'AuthRecord18 Workspace', onSelect }: AuthRecord18Panel02Props) {
  ...
  return (
    <section className="lis-panel lis-panel--auth" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} auth records (slice 18-02)
      </footer>
    </section>
  );
}

export default AuthRecord18Panel02;
