...
export interface AuthRecord25Panel04Props {
  facilityId: string;
  title?: string;
...
/**
 * AuthRecord25Panel04 — operational panel for auth domain slice 25/04.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function AuthRecord25Panel04({ facilityId, title = 'AuthRecord25 Workspace', onSelect }: AuthRecord25Panel04Props) {
  ...
  return (
    <section className="lis-panel lis-panel--auth" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} auth records (slice 25-04)
      </footer>
    </section>
  );
}

export default AuthRecord25Panel04;
