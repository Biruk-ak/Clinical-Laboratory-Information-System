...
export interface AuthRecord18Panel05Props {
  facilityId: string;
  title?: string;
...
/**
 * AuthRecord18Panel05 — operational panel for auth domain slice 18/05.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function AuthRecord18Panel05({ facilityId, title = 'AuthRecord18 Workspace', onSelect }: AuthRecord18Panel05Props) {
  ...
  return (
    <section className="lis-panel lis-panel--auth" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} auth records (slice 18-05)
      </footer>
    </section>
  );
}

export default AuthRecord18Panel05;
