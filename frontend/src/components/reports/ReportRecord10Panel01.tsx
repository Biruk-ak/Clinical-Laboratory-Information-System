...
export interface ReportRecord10Panel01Props {
  facilityId: string;
  title?: string;
...
/**
 * ReportRecord10Panel01 — operational panel for reports domain slice 10/01.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function ReportRecord10Panel01({ facilityId, title = 'ReportRecord10 Workspace', onSelect }: ReportRecord10Panel01Props) {
  ...
  return (
    <section className="lis-panel lis-panel--reports" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} reports records (slice 10-01)
      </footer>
    </section>
  );
}

export default ReportRecord10Panel01;
