...
export interface ReportRecord02Panel06Props {
  facilityId: string;
  title?: string;
...
/**
 * ReportRecord02Panel06 — operational panel for reports domain slice 02/06.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function ReportRecord02Panel06({ facilityId, title = 'ReportRecord02 Workspace', onSelect }: ReportRecord02Panel06Props) {
  ...
  return (
    <section className="lis-panel lis-panel--reports" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} reports records (slice 02-06)
      </footer>
    </section>
  );
}

export default ReportRecord02Panel06;
