...
export interface ReportRecord04Panel01Props {
  facilityId: string;
  title?: string;
...
/**
 * ReportRecord04Panel01 — operational panel for reports domain slice 04/01.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function ReportRecord04Panel01({ facilityId, title = 'ReportRecord04 Workspace', onSelect }: ReportRecord04Panel01Props) {
  ...
  return (
    <section className="lis-panel lis-panel--reports" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} reports records (slice 04-01)
      </footer>
    </section>
  );
}

export default ReportRecord04Panel01;
