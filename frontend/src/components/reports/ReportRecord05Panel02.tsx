...
export interface ReportRecord05Panel02Props {
  facilityId: string;
  title?: string;
...
/**
 * ReportRecord05Panel02 — operational panel for reports domain slice 05/02.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function ReportRecord05Panel02({ facilityId, title = 'ReportRecord05 Workspace', onSelect }: ReportRecord05Panel02Props) {
  ...
  return (
    <section className="lis-panel lis-panel--reports" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} reports records (slice 05-02)
      </footer>
    </section>
  );
}

export default ReportRecord05Panel02;
