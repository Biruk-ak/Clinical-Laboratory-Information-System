...
export interface ReportRecord20Panel03Props {
  facilityId: string;
  title?: string;
...
/**
 * ReportRecord20Panel03 — operational panel for reports domain slice 20/03.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function ReportRecord20Panel03({ facilityId, title = 'ReportRecord20 Workspace', onSelect }: ReportRecord20Panel03Props) {
  ...
  return (
    <section className="lis-panel lis-panel--reports" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} reports records (slice 20-03)
      </footer>
    </section>
  );
}

export default ReportRecord20Panel03;
