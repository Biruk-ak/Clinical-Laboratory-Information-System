...
export interface ReportRecord20Panel04Props {
  facilityId: string;
  title?: string;
...
/**
 * ReportRecord20Panel04 — operational panel for reports domain slice 20/04.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function ReportRecord20Panel04({ facilityId, title = 'ReportRecord20 Workspace', onSelect }: ReportRecord20Panel04Props) {
  ...
  return (
    <section className="lis-panel lis-panel--reports" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} reports records (slice 20-04)
      </footer>
    </section>
  );
}

export default ReportRecord20Panel04;
