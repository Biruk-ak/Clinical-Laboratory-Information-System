...
export interface ReportRecord20Panel05Props {
  facilityId: string;
  title?: string;
...
/**
 * ReportRecord20Panel05 — operational panel for reports domain slice 20/05.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function ReportRecord20Panel05({ facilityId, title = 'ReportRecord20 Workspace', onSelect }: ReportRecord20Panel05Props) {
  ...
  return (
    <section className="lis-panel lis-panel--reports" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} reports records (slice 20-05)
      </footer>
    </section>
  );
}

export default ReportRecord20Panel05;
