...
export interface ReportRecord14Panel01Props {
  facilityId: string;
  title?: string;
...
/**
 * ReportRecord14Panel01 — operational panel for reports domain slice 14/01.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function ReportRecord14Panel01({ facilityId, title = 'ReportRecord14 Workspace', onSelect }: ReportRecord14Panel01Props) {
  ...
  return (
    <section className="lis-panel lis-panel--reports" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} reports records (slice 14-01)
      </footer>
    </section>
  );
}

export default ReportRecord14Panel01;
