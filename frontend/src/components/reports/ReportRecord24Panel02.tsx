...
export interface ReportRecord24Panel02Props {
  facilityId: string;
  title?: string;
...
/**
 * ReportRecord24Panel02 — operational panel for reports domain slice 24/02.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function ReportRecord24Panel02({ facilityId, title = 'ReportRecord24 Workspace', onSelect }: ReportRecord24Panel02Props) {
  ...
  return (
    <section className="lis-panel lis-panel--reports" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} reports records (slice 24-02)
      </footer>
    </section>
  );
}

export default ReportRecord24Panel02;
