...
export interface ReportRecord12Panel03Props {
  facilityId: string;
  title?: string;
...
/**
 * ReportRecord12Panel03 — operational panel for reports domain slice 12/03.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function ReportRecord12Panel03({ facilityId, title = 'ReportRecord12 Workspace', onSelect }: ReportRecord12Panel03Props) {
  ...
  return (
    <section className="lis-panel lis-panel--reports" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} reports records (slice 12-03)
      </footer>
    </section>
  );
}

export default ReportRecord12Panel03;
