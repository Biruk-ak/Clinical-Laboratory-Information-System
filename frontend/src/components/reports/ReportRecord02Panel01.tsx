...
export interface ReportRecord02Panel01Props {
  facilityId: string;
  title?: string;
...
/**
 * ReportRecord02Panel01 — operational panel for reports domain slice 02/01.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function ReportRecord02Panel01({ facilityId, title = 'ReportRecord02 Workspace', onSelect }: ReportRecord02Panel01Props) {
  ...
  return (
    <section className="lis-panel lis-panel--reports" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} reports records (slice 02-01)
      </footer>
    </section>
  );
}

export default ReportRecord02Panel01;
