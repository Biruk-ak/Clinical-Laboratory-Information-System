...
export interface ReportRecord11Panel02Props {
  facilityId: string;
  title?: string;
...
/**
 * ReportRecord11Panel02 — operational panel for reports domain slice 11/02.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function ReportRecord11Panel02({ facilityId, title = 'ReportRecord11 Workspace', onSelect }: ReportRecord11Panel02Props) {
  ...
  return (
    <section className="lis-panel lis-panel--reports" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} reports records (slice 11-02)
      </footer>
    </section>
  );
}

export default ReportRecord11Panel02;
