...
export interface ReportRecord23Panel02Props {
  facilityId: string;
  title?: string;
...
/**
 * ReportRecord23Panel02 — operational panel for reports domain slice 23/02.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function ReportRecord23Panel02({ facilityId, title = 'ReportRecord23 Workspace', onSelect }: ReportRecord23Panel02Props) {
  ...
  return (
    <section className="lis-panel lis-panel--reports" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} reports records (slice 23-02)
      </footer>
    </section>
  );
}

export default ReportRecord23Panel02;
