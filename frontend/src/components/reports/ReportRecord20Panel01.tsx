...
export interface ReportRecord20Panel01Props {
  facilityId: string;
  title?: string;
...
/**
 * ReportRecord20Panel01 — operational panel for reports domain slice 20/01.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function ReportRecord20Panel01({ facilityId, title = 'ReportRecord20 Workspace', onSelect }: ReportRecord20Panel01Props) {
  ...
  return (
    <section className="lis-panel lis-panel--reports" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} reports records (slice 20-01)
      </footer>
    </section>
  );
}

export default ReportRecord20Panel01;
