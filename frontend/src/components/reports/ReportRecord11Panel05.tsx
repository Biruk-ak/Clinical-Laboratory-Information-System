...
export interface ReportRecord11Panel05Props {
  facilityId: string;
  title?: string;
...
/**
 * ReportRecord11Panel05 — operational panel for reports domain slice 11/05.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function ReportRecord11Panel05({ facilityId, title = 'ReportRecord11 Workspace', onSelect }: ReportRecord11Panel05Props) {
  ...
  return (
    <section className="lis-panel lis-panel--reports" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} reports records (slice 11-05)
      </footer>
    </section>
  );
}

export default ReportRecord11Panel05;
