...
export interface ReportRecord09Panel06Props {
  facilityId: string;
  title?: string;
...
/**
 * ReportRecord09Panel06 — operational panel for reports domain slice 09/06.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function ReportRecord09Panel06({ facilityId, title = 'ReportRecord09 Workspace', onSelect }: ReportRecord09Panel06Props) {
  ...
  return (
    <section className="lis-panel lis-panel--reports" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} reports records (slice 09-06)
      </footer>
    </section>
  );
}

export default ReportRecord09Panel06;
