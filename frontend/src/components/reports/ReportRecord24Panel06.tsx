...
export interface ReportRecord24Panel06Props {
  facilityId: string;
  title?: string;
...
/**
 * ReportRecord24Panel06 — operational panel for reports domain slice 24/06.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function ReportRecord24Panel06({ facilityId, title = 'ReportRecord24 Workspace', onSelect }: ReportRecord24Panel06Props) {
  ...
  return (
    <section className="lis-panel lis-panel--reports" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} reports records (slice 24-06)
      </footer>
    </section>
  );
}

export default ReportRecord24Panel06;
