...
export interface ReportRecord14Panel06Props {
  facilityId: string;
  title?: string;
...
/**
 * ReportRecord14Panel06 — operational panel for reports domain slice 14/06.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function ReportRecord14Panel06({ facilityId, title = 'ReportRecord14 Workspace', onSelect }: ReportRecord14Panel06Props) {
  ...
  return (
    <section className="lis-panel lis-panel--reports" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} reports records (slice 14-06)
      </footer>
    </section>
  );
}

export default ReportRecord14Panel06;
