...
export interface ReportRecord12Panel05Props {
  facilityId: string;
  title?: string;
...
/**
 * ReportRecord12Panel05 — operational panel for reports domain slice 12/05.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function ReportRecord12Panel05({ facilityId, title = 'ReportRecord12 Workspace', onSelect }: ReportRecord12Panel05Props) {
  ...
  return (
    <section className="lis-panel lis-panel--reports" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} reports records (slice 12-05)
      </footer>
    </section>
  );
}

export default ReportRecord12Panel05;
