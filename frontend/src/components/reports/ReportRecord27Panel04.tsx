...
export interface ReportRecord27Panel04Props {
  facilityId: string;
  title?: string;
...
/**
 * ReportRecord27Panel04 — operational panel for reports domain slice 27/04.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function ReportRecord27Panel04({ facilityId, title = 'ReportRecord27 Workspace', onSelect }: ReportRecord27Panel04Props) {
  ...
  return (
    <section className="lis-panel lis-panel--reports" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} reports records (slice 27-04)
      </footer>
    </section>
  );
}

export default ReportRecord27Panel04;
