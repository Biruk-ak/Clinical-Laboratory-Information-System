...
export interface ReportRecord05Panel05Props {
  facilityId: string;
  title?: string;
...
/**
 * ReportRecord05Panel05 — operational panel for reports domain slice 05/05.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function ReportRecord05Panel05({ facilityId, title = 'ReportRecord05 Workspace', onSelect }: ReportRecord05Panel05Props) {
  ...
  return (
    <section className="lis-panel lis-panel--reports" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} reports records (slice 05-05)
      </footer>
    </section>
  );
}

export default ReportRecord05Panel05;
