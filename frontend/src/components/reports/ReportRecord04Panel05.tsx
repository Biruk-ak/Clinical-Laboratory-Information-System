...
export interface ReportRecord04Panel05Props {
  facilityId: string;
  title?: string;
...
/**
 * ReportRecord04Panel05 — operational panel for reports domain slice 04/05.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function ReportRecord04Panel05({ facilityId, title = 'ReportRecord04 Workspace', onSelect }: ReportRecord04Panel05Props) {
  ...
  return (
    <section className="lis-panel lis-panel--reports" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} reports records (slice 04-05)
      </footer>
    </section>
  );
}

export default ReportRecord04Panel05;
