...
export interface ReportRecord11Panel06Props {
  facilityId: string;
  title?: string;
...
/**
 * ReportRecord11Panel06 — operational panel for reports domain slice 11/06.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function ReportRecord11Panel06({ facilityId, title = 'ReportRecord11 Workspace', onSelect }: ReportRecord11Panel06Props) {
  ...
  return (
    <section className="lis-panel lis-panel--reports" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} reports records (slice 11-06)
      </footer>
    </section>
  );
}

export default ReportRecord11Panel06;
