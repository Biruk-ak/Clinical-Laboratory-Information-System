...
export interface ReportRecord02Panel05Props {
  facilityId: string;
  title?: string;
...
/**
 * ReportRecord02Panel05 — operational panel for reports domain slice 02/05.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function ReportRecord02Panel05({ facilityId, title = 'ReportRecord02 Workspace', onSelect }: ReportRecord02Panel05Props) {
  ...
  return (
    <section className="lis-panel lis-panel--reports" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} reports records (slice 02-05)
      </footer>
    </section>
  );
}

export default ReportRecord02Panel05;
