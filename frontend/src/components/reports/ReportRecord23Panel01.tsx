...
export interface ReportRecord23Panel01Props {
  facilityId: string;
  title?: string;
...
/**
 * ReportRecord23Panel01 — operational panel for reports domain slice 23/01.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function ReportRecord23Panel01({ facilityId, title = 'ReportRecord23 Workspace', onSelect }: ReportRecord23Panel01Props) {
  ...
  return (
    <section className="lis-panel lis-panel--reports" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} reports records (slice 23-01)
      </footer>
    </section>
  );
}

export default ReportRecord23Panel01;
