...
export interface ReportRecord10Panel06Props {
  facilityId: string;
  title?: string;
...
/**
 * ReportRecord10Panel06 — operational panel for reports domain slice 10/06.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function ReportRecord10Panel06({ facilityId, title = 'ReportRecord10 Workspace', onSelect }: ReportRecord10Panel06Props) {
  ...
  return (
    <section className="lis-panel lis-panel--reports" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} reports records (slice 10-06)
      </footer>
    </section>
  );
}

export default ReportRecord10Panel06;
