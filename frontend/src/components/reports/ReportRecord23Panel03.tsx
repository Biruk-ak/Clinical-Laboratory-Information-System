...
export interface ReportRecord23Panel03Props {
  facilityId: string;
  title?: string;
...
/**
 * ReportRecord23Panel03 — operational panel for reports domain slice 23/03.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function ReportRecord23Panel03({ facilityId, title = 'ReportRecord23 Workspace', onSelect }: ReportRecord23Panel03Props) {
  ...
  return (
    <section className="lis-panel lis-panel--reports" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} reports records (slice 23-03)
      </footer>
    </section>
  );
}

export default ReportRecord23Panel03;
