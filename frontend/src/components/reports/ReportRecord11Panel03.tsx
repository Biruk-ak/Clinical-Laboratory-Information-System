...
export interface ReportRecord11Panel03Props {
  facilityId: string;
  title?: string;
...
/**
 * ReportRecord11Panel03 — operational panel for reports domain slice 11/03.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function ReportRecord11Panel03({ facilityId, title = 'ReportRecord11 Workspace', onSelect }: ReportRecord11Panel03Props) {
  ...
  return (
    <section className="lis-panel lis-panel--reports" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} reports records (slice 11-03)
      </footer>
    </section>
  );
}

export default ReportRecord11Panel03;
