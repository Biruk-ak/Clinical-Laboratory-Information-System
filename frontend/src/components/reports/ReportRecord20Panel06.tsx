...
export interface ReportRecord20Panel06Props {
  facilityId: string;
  title?: string;
...
/**
 * ReportRecord20Panel06 — operational panel for reports domain slice 20/06.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function ReportRecord20Panel06({ facilityId, title = 'ReportRecord20 Workspace', onSelect }: ReportRecord20Panel06Props) {
  ...
  return (
    <section className="lis-panel lis-panel--reports" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} reports records (slice 20-06)
      </footer>
    </section>
  );
}

export default ReportRecord20Panel06;
