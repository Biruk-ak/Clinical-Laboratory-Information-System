...
export interface ReportRecord14Panel02Props {
  facilityId: string;
  title?: string;
...
/**
 * ReportRecord14Panel02 — operational panel for reports domain slice 14/02.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function ReportRecord14Panel02({ facilityId, title = 'ReportRecord14 Workspace', onSelect }: ReportRecord14Panel02Props) {
  ...
  return (
    <section className="lis-panel lis-panel--reports" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} reports records (slice 14-02)
      </footer>
    </section>
  );
}

export default ReportRecord14Panel02;
