...
export interface ReportRecord12Panel01Props {
  facilityId: string;
  title?: string;
...
/**
 * ReportRecord12Panel01 — operational panel for reports domain slice 12/01.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function ReportRecord12Panel01({ facilityId, title = 'ReportRecord12 Workspace', onSelect }: ReportRecord12Panel01Props) {
  ...
  return (
    <section className="lis-panel lis-panel--reports" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} reports records (slice 12-01)
      </footer>
    </section>
  );
}

export default ReportRecord12Panel01;
