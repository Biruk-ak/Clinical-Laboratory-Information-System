...
export interface ReportRecord23Panel05Props {
  facilityId: string;
  title?: string;
...
/**
 * ReportRecord23Panel05 — operational panel for reports domain slice 23/05.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function ReportRecord23Panel05({ facilityId, title = 'ReportRecord23 Workspace', onSelect }: ReportRecord23Panel05Props) {
  ...
  return (
    <section className="lis-panel lis-panel--reports" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} reports records (slice 23-05)
      </footer>
    </section>
  );
}

export default ReportRecord23Panel05;
