...
export interface ReportRecord04Panel03Props {
  facilityId: string;
  title?: string;
...
/**
 * ReportRecord04Panel03 — operational panel for reports domain slice 04/03.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function ReportRecord04Panel03({ facilityId, title = 'ReportRecord04 Workspace', onSelect }: ReportRecord04Panel03Props) {
  ...
  return (
    <section className="lis-panel lis-panel--reports" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} reports records (slice 04-03)
      </footer>
    </section>
  );
}

export default ReportRecord04Panel03;
