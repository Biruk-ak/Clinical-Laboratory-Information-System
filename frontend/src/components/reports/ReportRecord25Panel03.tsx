...
export interface ReportRecord25Panel03Props {
  facilityId: string;
  title?: string;
...
/**
 * ReportRecord25Panel03 — operational panel for reports domain slice 25/03.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function ReportRecord25Panel03({ facilityId, title = 'ReportRecord25 Workspace', onSelect }: ReportRecord25Panel03Props) {
  ...
  return (
    <section className="lis-panel lis-panel--reports" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} reports records (slice 25-03)
      </footer>
    </section>
  );
}

export default ReportRecord25Panel03;
