...
export interface ReportRecord05Panel03Props {
  facilityId: string;
  title?: string;
...
/**
 * ReportRecord05Panel03 — operational panel for reports domain slice 05/03.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function ReportRecord05Panel03({ facilityId, title = 'ReportRecord05 Workspace', onSelect }: ReportRecord05Panel03Props) {
  ...
  return (
    <section className="lis-panel lis-panel--reports" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} reports records (slice 05-03)
      </footer>
    </section>
  );
}

export default ReportRecord05Panel03;
