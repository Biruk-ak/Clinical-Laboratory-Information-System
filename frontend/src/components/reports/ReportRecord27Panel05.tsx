...
export interface ReportRecord27Panel05Props {
  facilityId: string;
  title?: string;
...
/**
 * ReportRecord27Panel05 — operational panel for reports domain slice 27/05.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function ReportRecord27Panel05({ facilityId, title = 'ReportRecord27 Workspace', onSelect }: ReportRecord27Panel05Props) {
  ...
  return (
    <section className="lis-panel lis-panel--reports" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} reports records (slice 27-05)
      </footer>
    </section>
  );
}

export default ReportRecord27Panel05;
