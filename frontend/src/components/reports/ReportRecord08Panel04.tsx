...
export interface ReportRecord08Panel04Props {
  facilityId: string;
  title?: string;
...
/**
 * ReportRecord08Panel04 — operational panel for reports domain slice 08/04.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function ReportRecord08Panel04({ facilityId, title = 'ReportRecord08 Workspace', onSelect }: ReportRecord08Panel04Props) {
  ...
  return (
    <section className="lis-panel lis-panel--reports" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} reports records (slice 08-04)
      </footer>
    </section>
  );
}

export default ReportRecord08Panel04;
