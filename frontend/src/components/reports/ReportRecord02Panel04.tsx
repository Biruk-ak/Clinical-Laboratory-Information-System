...
export interface ReportRecord02Panel04Props {
  facilityId: string;
  title?: string;
...
/**
 * ReportRecord02Panel04 — operational panel for reports domain slice 02/04.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function ReportRecord02Panel04({ facilityId, title = 'ReportRecord02 Workspace', onSelect }: ReportRecord02Panel04Props) {
  ...
  return (
    <section className="lis-panel lis-panel--reports" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} reports records (slice 02-04)
      </footer>
    </section>
  );
}

export default ReportRecord02Panel04;
