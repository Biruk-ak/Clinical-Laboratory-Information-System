...
export interface ReportRecord08Panel02Props {
  facilityId: string;
  title?: string;
...
/**
 * ReportRecord08Panel02 — operational panel for reports domain slice 08/02.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function ReportRecord08Panel02({ facilityId, title = 'ReportRecord08 Workspace', onSelect }: ReportRecord08Panel02Props) {
  ...
  return (
    <section className="lis-panel lis-panel--reports" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} reports records (slice 08-02)
      </footer>
    </section>
  );
}

export default ReportRecord08Panel02;
