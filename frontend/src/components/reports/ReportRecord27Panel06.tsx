...
export interface ReportRecord27Panel06Props {
  facilityId: string;
  title?: string;
...
/**
 * ReportRecord27Panel06 — operational panel for reports domain slice 27/06.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function ReportRecord27Panel06({ facilityId, title = 'ReportRecord27 Workspace', onSelect }: ReportRecord27Panel06Props) {
  ...
  return (
    <section className="lis-panel lis-panel--reports" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} reports records (slice 27-06)
      </footer>
    </section>
  );
}

export default ReportRecord27Panel06;
