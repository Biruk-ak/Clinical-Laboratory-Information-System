...
export interface ReportRecord05Panel01Props {
  facilityId: string;
  title?: string;
...
/**
 * ReportRecord05Panel01 — operational panel for reports domain slice 05/01.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function ReportRecord05Panel01({ facilityId, title = 'ReportRecord05 Workspace', onSelect }: ReportRecord05Panel01Props) {
  ...
  return (
    <section className="lis-panel lis-panel--reports" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} reports records (slice 05-01)
      </footer>
    </section>
  );
}

export default ReportRecord05Panel01;
