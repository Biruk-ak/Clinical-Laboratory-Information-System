...
export interface ReportRecord28Panel06Props {
  facilityId: string;
  title?: string;
...
/**
 * ReportRecord28Panel06 — operational panel for reports domain slice 28/06.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function ReportRecord28Panel06({ facilityId, title = 'ReportRecord28 Workspace', onSelect }: ReportRecord28Panel06Props) {
  ...
  return (
    <section className="lis-panel lis-panel--reports" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} reports records (slice 28-06)
      </footer>
    </section>
  );
}

export default ReportRecord28Panel06;
