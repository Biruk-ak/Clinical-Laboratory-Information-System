...
export interface ReportRecord18Panel05Props {
  facilityId: string;
  title?: string;
...
/**
 * ReportRecord18Panel05 — operational panel for reports domain slice 18/05.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function ReportRecord18Panel05({ facilityId, title = 'ReportRecord18 Workspace', onSelect }: ReportRecord18Panel05Props) {
  ...
  return (
    <section className="lis-panel lis-panel--reports" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} reports records (slice 18-05)
      </footer>
    </section>
  );
}

export default ReportRecord18Panel05;
