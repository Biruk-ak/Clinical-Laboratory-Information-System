...
export interface ReportRecord09Panel05Props {
  facilityId: string;
  title?: string;
...
/**
 * ReportRecord09Panel05 — operational panel for reports domain slice 09/05.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function ReportRecord09Panel05({ facilityId, title = 'ReportRecord09 Workspace', onSelect }: ReportRecord09Panel05Props) {
  ...
  return (
    <section className="lis-panel lis-panel--reports" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} reports records (slice 09-05)
      </footer>
    </section>
  );
}

export default ReportRecord09Panel05;
