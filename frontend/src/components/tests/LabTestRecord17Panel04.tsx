...
export interface LabTestRecord17Panel04Props {
  facilityId: string;
  title?: string;
...
/**
 * LabTestRecord17Panel04 — operational panel for tests domain slice 17/04.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function LabTestRecord17Panel04({ facilityId, title = 'LabTestRecord17 Workspace', onSelect }: LabTestRecord17Panel04Props) {
  ...
  return (
    <section className="lis-panel lis-panel--tests" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} tests records (slice 17-04)
      </footer>
    </section>
  );
}

export default LabTestRecord17Panel04;
