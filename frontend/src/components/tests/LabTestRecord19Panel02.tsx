...
export interface LabTestRecord19Panel02Props {
  facilityId: string;
  title?: string;
...
/**
 * LabTestRecord19Panel02 — operational panel for tests domain slice 19/02.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function LabTestRecord19Panel02({ facilityId, title = 'LabTestRecord19 Workspace', onSelect }: LabTestRecord19Panel02Props) {
  ...
  return (
    <section className="lis-panel lis-panel--tests" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} tests records (slice 19-02)
      </footer>
    </section>
  );
}

export default LabTestRecord19Panel02;
