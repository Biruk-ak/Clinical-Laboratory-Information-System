...
export interface LabTestRecord11Panel02Props {
  facilityId: string;
  title?: string;
...
/**
 * LabTestRecord11Panel02 — operational panel for tests domain slice 11/02.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function LabTestRecord11Panel02({ facilityId, title = 'LabTestRecord11 Workspace', onSelect }: LabTestRecord11Panel02Props) {
  ...
  return (
    <section className="lis-panel lis-panel--tests" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} tests records (slice 11-02)
      </footer>
    </section>
  );
}

export default LabTestRecord11Panel02;
