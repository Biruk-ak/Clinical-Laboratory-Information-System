...
export interface LabTestRecord02Panel02Props {
  facilityId: string;
  title?: string;
...
/**
 * LabTestRecord02Panel02 — operational panel for tests domain slice 02/02.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function LabTestRecord02Panel02({ facilityId, title = 'LabTestRecord02 Workspace', onSelect }: LabTestRecord02Panel02Props) {
  ...
  return (
    <section className="lis-panel lis-panel--tests" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} tests records (slice 02-02)
      </footer>
    </section>
  );
}

export default LabTestRecord02Panel02;
