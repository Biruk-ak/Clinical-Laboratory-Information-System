...
export interface LabTestRecord18Panel01Props {
  facilityId: string;
  title?: string;
...
/**
 * LabTestRecord18Panel01 — operational panel for tests domain slice 18/01.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function LabTestRecord18Panel01({ facilityId, title = 'LabTestRecord18 Workspace', onSelect }: LabTestRecord18Panel01Props) {
  ...
  return (
    <section className="lis-panel lis-panel--tests" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} tests records (slice 18-01)
      </footer>
    </section>
  );
}

export default LabTestRecord18Panel01;
