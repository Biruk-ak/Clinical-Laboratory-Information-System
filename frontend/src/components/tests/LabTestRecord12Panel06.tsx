...
export interface LabTestRecord12Panel06Props {
  facilityId: string;
  title?: string;
...
/**
 * LabTestRecord12Panel06 — operational panel for tests domain slice 12/06.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function LabTestRecord12Panel06({ facilityId, title = 'LabTestRecord12 Workspace', onSelect }: LabTestRecord12Panel06Props) {
  ...
  return (
    <section className="lis-panel lis-panel--tests" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} tests records (slice 12-06)
      </footer>
    </section>
  );
}

export default LabTestRecord12Panel06;
