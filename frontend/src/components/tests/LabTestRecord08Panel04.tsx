...
export interface LabTestRecord08Panel04Props {
  facilityId: string;
  title?: string;
...
/**
 * LabTestRecord08Panel04 — operational panel for tests domain slice 08/04.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function LabTestRecord08Panel04({ facilityId, title = 'LabTestRecord08 Workspace', onSelect }: LabTestRecord08Panel04Props) {
  ...
  return (
    <section className="lis-panel lis-panel--tests" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} tests records (slice 08-04)
      </footer>
    </section>
  );
}

export default LabTestRecord08Panel04;
