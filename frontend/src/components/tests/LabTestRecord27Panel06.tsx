...
export interface LabTestRecord27Panel06Props {
  facilityId: string;
  title?: string;
...
/**
 * LabTestRecord27Panel06 — operational panel for tests domain slice 27/06.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function LabTestRecord27Panel06({ facilityId, title = 'LabTestRecord27 Workspace', onSelect }: LabTestRecord27Panel06Props) {
  ...
  return (
    <section className="lis-panel lis-panel--tests" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} tests records (slice 27-06)
      </footer>
    </section>
  );
}

export default LabTestRecord27Panel06;
