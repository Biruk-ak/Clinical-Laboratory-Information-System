...
export interface LabTestRecord11Panel04Props {
  facilityId: string;
  title?: string;
...
/**
 * LabTestRecord11Panel04 — operational panel for tests domain slice 11/04.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function LabTestRecord11Panel04({ facilityId, title = 'LabTestRecord11 Workspace', onSelect }: LabTestRecord11Panel04Props) {
  ...
  return (
    <section className="lis-panel lis-panel--tests" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} tests records (slice 11-04)
      </footer>
    </section>
  );
}

export default LabTestRecord11Panel04;
