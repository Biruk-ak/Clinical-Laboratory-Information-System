...
export interface LabTestRecord12Panel02Props {
  facilityId: string;
  title?: string;
...
/**
 * LabTestRecord12Panel02 — operational panel for tests domain slice 12/02.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function LabTestRecord12Panel02({ facilityId, title = 'LabTestRecord12 Workspace', onSelect }: LabTestRecord12Panel02Props) {
  ...
  return (
    <section className="lis-panel lis-panel--tests" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} tests records (slice 12-02)
      </footer>
    </section>
  );
}

export default LabTestRecord12Panel02;
