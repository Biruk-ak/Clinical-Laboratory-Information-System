...
export interface LabTestRecord03Panel04Props {
  facilityId: string;
  title?: string;
...
/**
 * LabTestRecord03Panel04 — operational panel for tests domain slice 03/04.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function LabTestRecord03Panel04({ facilityId, title = 'LabTestRecord03 Workspace', onSelect }: LabTestRecord03Panel04Props) {
  ...
  return (
    <section className="lis-panel lis-panel--tests" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} tests records (slice 03-04)
      </footer>
    </section>
  );
}

export default LabTestRecord03Panel04;
