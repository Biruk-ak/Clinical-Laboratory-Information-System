...
export interface LabTestRecord11Panel03Props {
  facilityId: string;
  title?: string;
...
/**
 * LabTestRecord11Panel03 — operational panel for tests domain slice 11/03.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function LabTestRecord11Panel03({ facilityId, title = 'LabTestRecord11 Workspace', onSelect }: LabTestRecord11Panel03Props) {
  ...
  return (
    <section className="lis-panel lis-panel--tests" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} tests records (slice 11-03)
      </footer>
    </section>
  );
}

export default LabTestRecord11Panel03;
