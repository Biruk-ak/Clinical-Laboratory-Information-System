...
export interface LabTestRecord20Panel06Props {
  facilityId: string;
  title?: string;
...
/**
 * LabTestRecord20Panel06 — operational panel for tests domain slice 20/06.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function LabTestRecord20Panel06({ facilityId, title = 'LabTestRecord20 Workspace', onSelect }: LabTestRecord20Panel06Props) {
  ...
  return (
    <section className="lis-panel lis-panel--tests" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} tests records (slice 20-06)
      </footer>
    </section>
  );
}

export default LabTestRecord20Panel06;
