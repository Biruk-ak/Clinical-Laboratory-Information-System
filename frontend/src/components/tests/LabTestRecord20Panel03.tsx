...
export interface LabTestRecord20Panel03Props {
  facilityId: string;
  title?: string;
...
/**
 * LabTestRecord20Panel03 — operational panel for tests domain slice 20/03.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function LabTestRecord20Panel03({ facilityId, title = 'LabTestRecord20 Workspace', onSelect }: LabTestRecord20Panel03Props) {
  ...
  return (
    <section className="lis-panel lis-panel--tests" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} tests records (slice 20-03)
      </footer>
    </section>
  );
}

export default LabTestRecord20Panel03;
