...
export interface LabTestRecord10Panel03Props {
  facilityId: string;
  title?: string;
...
/**
 * LabTestRecord10Panel03 — operational panel for tests domain slice 10/03.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function LabTestRecord10Panel03({ facilityId, title = 'LabTestRecord10 Workspace', onSelect }: LabTestRecord10Panel03Props) {
  ...
  return (
    <section className="lis-panel lis-panel--tests" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} tests records (slice 10-03)
      </footer>
    </section>
  );
}

export default LabTestRecord10Panel03;
