...
export interface LabTestRecord25Panel05Props {
  facilityId: string;
  title?: string;
...
/**
 * LabTestRecord25Panel05 — operational panel for tests domain slice 25/05.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function LabTestRecord25Panel05({ facilityId, title = 'LabTestRecord25 Workspace', onSelect }: LabTestRecord25Panel05Props) {
  ...
  return (
    <section className="lis-panel lis-panel--tests" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} tests records (slice 25-05)
      </footer>
    </section>
  );
}

export default LabTestRecord25Panel05;
