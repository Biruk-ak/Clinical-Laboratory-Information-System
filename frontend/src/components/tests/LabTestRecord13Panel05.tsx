...
export interface LabTestRecord13Panel05Props {
  facilityId: string;
  title?: string;
...
/**
 * LabTestRecord13Panel05 — operational panel for tests domain slice 13/05.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function LabTestRecord13Panel05({ facilityId, title = 'LabTestRecord13 Workspace', onSelect }: LabTestRecord13Panel05Props) {
  ...
  return (
    <section className="lis-panel lis-panel--tests" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} tests records (slice 13-05)
      </footer>
    </section>
  );
}

export default LabTestRecord13Panel05;
