...
export interface LabTestRecord02Panel03Props {
  facilityId: string;
  title?: string;
...
/**
 * LabTestRecord02Panel03 — operational panel for tests domain slice 02/03.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function LabTestRecord02Panel03({ facilityId, title = 'LabTestRecord02 Workspace', onSelect }: LabTestRecord02Panel03Props) {
  ...
  return (
    <section className="lis-panel lis-panel--tests" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} tests records (slice 02-03)
      </footer>
    </section>
  );
}

export default LabTestRecord02Panel03;
