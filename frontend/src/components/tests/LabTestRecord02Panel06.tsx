...
export interface LabTestRecord02Panel06Props {
  facilityId: string;
  title?: string;
...
/**
 * LabTestRecord02Panel06 — operational panel for tests domain slice 02/06.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function LabTestRecord02Panel06({ facilityId, title = 'LabTestRecord02 Workspace', onSelect }: LabTestRecord02Panel06Props) {
  ...
  return (
    <section className="lis-panel lis-panel--tests" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} tests records (slice 02-06)
      </footer>
    </section>
  );
}

export default LabTestRecord02Panel06;
