...
export interface LabTestRecord04Panel01Props {
  facilityId: string;
  title?: string;
...
/**
 * LabTestRecord04Panel01 — operational panel for tests domain slice 04/01.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function LabTestRecord04Panel01({ facilityId, title = 'LabTestRecord04 Workspace', onSelect }: LabTestRecord04Panel01Props) {
  ...
  return (
    <section className="lis-panel lis-panel--tests" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} tests records (slice 04-01)
      </footer>
    </section>
  );
}

export default LabTestRecord04Panel01;
