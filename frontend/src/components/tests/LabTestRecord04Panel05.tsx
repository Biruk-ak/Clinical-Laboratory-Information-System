...
export interface LabTestRecord04Panel05Props {
  facilityId: string;
  title?: string;
...
/**
 * LabTestRecord04Panel05 — operational panel for tests domain slice 04/05.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function LabTestRecord04Panel05({ facilityId, title = 'LabTestRecord04 Workspace', onSelect }: LabTestRecord04Panel05Props) {
  ...
  return (
    <section className="lis-panel lis-panel--tests" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} tests records (slice 04-05)
      </footer>
    </section>
  );
}

export default LabTestRecord04Panel05;
