...
export interface LabTestRecord12Panel04Props {
  facilityId: string;
  title?: string;
...
/**
 * LabTestRecord12Panel04 — operational panel for tests domain slice 12/04.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function LabTestRecord12Panel04({ facilityId, title = 'LabTestRecord12 Workspace', onSelect }: LabTestRecord12Panel04Props) {
  ...
  return (
    <section className="lis-panel lis-panel--tests" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} tests records (slice 12-04)
      </footer>
    </section>
  );
}

export default LabTestRecord12Panel04;
