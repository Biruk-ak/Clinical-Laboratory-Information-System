...
export interface LabTestRecord13Panel06Props {
  facilityId: string;
  title?: string;
...
/**
 * LabTestRecord13Panel06 — operational panel for tests domain slice 13/06.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function LabTestRecord13Panel06({ facilityId, title = 'LabTestRecord13 Workspace', onSelect }: LabTestRecord13Panel06Props) {
  ...
  return (
    <section className="lis-panel lis-panel--tests" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} tests records (slice 13-06)
      </footer>
    </section>
  );
}

export default LabTestRecord13Panel06;
