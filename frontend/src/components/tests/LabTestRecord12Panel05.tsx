...
export interface LabTestRecord12Panel05Props {
  facilityId: string;
  title?: string;
...
/**
 * LabTestRecord12Panel05 — operational panel for tests domain slice 12/05.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function LabTestRecord12Panel05({ facilityId, title = 'LabTestRecord12 Workspace', onSelect }: LabTestRecord12Panel05Props) {
  ...
  return (
    <section className="lis-panel lis-panel--tests" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} tests records (slice 12-05)
      </footer>
    </section>
  );
}

export default LabTestRecord12Panel05;
