...
export interface LabTestRecord27Panel05Props {
  facilityId: string;
  title?: string;
...
/**
 * LabTestRecord27Panel05 — operational panel for tests domain slice 27/05.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function LabTestRecord27Panel05({ facilityId, title = 'LabTestRecord27 Workspace', onSelect }: LabTestRecord27Panel05Props) {
  ...
  return (
    <section className="lis-panel lis-panel--tests" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} tests records (slice 27-05)
      </footer>
    </section>
  );
}

export default LabTestRecord27Panel05;
