...
export interface LabTestRecord13Panel01Props {
  facilityId: string;
  title?: string;
...
/**
 * LabTestRecord13Panel01 — operational panel for tests domain slice 13/01.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function LabTestRecord13Panel01({ facilityId, title = 'LabTestRecord13 Workspace', onSelect }: LabTestRecord13Panel01Props) {
  ...
  return (
    <section className="lis-panel lis-panel--tests" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} tests records (slice 13-01)
      </footer>
    </section>
  );
}

export default LabTestRecord13Panel01;
