...
export interface LabTestRecord07Panel04Props {
  facilityId: string;
  title?: string;
...
/**
 * LabTestRecord07Panel04 — operational panel for tests domain slice 07/04.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function LabTestRecord07Panel04({ facilityId, title = 'LabTestRecord07 Workspace', onSelect }: LabTestRecord07Panel04Props) {
  ...
  return (
    <section className="lis-panel lis-panel--tests" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} tests records (slice 07-04)
      </footer>
    </section>
  );
}

export default LabTestRecord07Panel04;
