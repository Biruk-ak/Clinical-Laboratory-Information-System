...
export interface LabTestRecord05Panel06Props {
  facilityId: string;
  title?: string;
...
/**
 * LabTestRecord05Panel06 — operational panel for tests domain slice 05/06.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function LabTestRecord05Panel06({ facilityId, title = 'LabTestRecord05 Workspace', onSelect }: LabTestRecord05Panel06Props) {
  ...
  return (
    <section className="lis-panel lis-panel--tests" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} tests records (slice 05-06)
      </footer>
    </section>
  );
}

export default LabTestRecord05Panel06;
