...
export interface LabTestRecord18Panel05Props {
  facilityId: string;
  title?: string;
...
/**
 * LabTestRecord18Panel05 — operational panel for tests domain slice 18/05.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function LabTestRecord18Panel05({ facilityId, title = 'LabTestRecord18 Workspace', onSelect }: LabTestRecord18Panel05Props) {
  ...
  return (
    <section className="lis-panel lis-panel--tests" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} tests records (slice 18-05)
      </footer>
    </section>
  );
}

export default LabTestRecord18Panel05;
