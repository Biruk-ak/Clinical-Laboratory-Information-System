...
export interface LabTestRecord01Panel06Props {
  facilityId: string;
  title?: string;
...
/**
 * LabTestRecord01Panel06 — operational panel for tests domain slice 01/06.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function LabTestRecord01Panel06({ facilityId, title = 'LabTestRecord01 Workspace', onSelect }: LabTestRecord01Panel06Props) {
  ...
  return (
    <section className="lis-panel lis-panel--tests" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} tests records (slice 01-06)
      </footer>
    </section>
  );
}

export default LabTestRecord01Panel06;
