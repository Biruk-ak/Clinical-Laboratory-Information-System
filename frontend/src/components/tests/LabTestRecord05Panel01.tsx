...
export interface LabTestRecord05Panel01Props {
  facilityId: string;
  title?: string;
...
/**
 * LabTestRecord05Panel01 — operational panel for tests domain slice 05/01.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function LabTestRecord05Panel01({ facilityId, title = 'LabTestRecord05 Workspace', onSelect }: LabTestRecord05Panel01Props) {
  ...
  return (
    <section className="lis-panel lis-panel--tests" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} tests records (slice 05-01)
      </footer>
    </section>
  );
}

export default LabTestRecord05Panel01;
