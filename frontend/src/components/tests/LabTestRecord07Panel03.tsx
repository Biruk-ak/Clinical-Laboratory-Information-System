...
export interface LabTestRecord07Panel03Props {
  facilityId: string;
  title?: string;
...
/**
 * LabTestRecord07Panel03 — operational panel for tests domain slice 07/03.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function LabTestRecord07Panel03({ facilityId, title = 'LabTestRecord07 Workspace', onSelect }: LabTestRecord07Panel03Props) {
  ...
  return (
    <section className="lis-panel lis-panel--tests" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} tests records (slice 07-03)
      </footer>
    </section>
  );
}

export default LabTestRecord07Panel03;
