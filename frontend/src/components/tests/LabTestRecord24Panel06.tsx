...
export interface LabTestRecord24Panel06Props {
  facilityId: string;
  title?: string;
...
/**
 * LabTestRecord24Panel06 — operational panel for tests domain slice 24/06.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function LabTestRecord24Panel06({ facilityId, title = 'LabTestRecord24 Workspace', onSelect }: LabTestRecord24Panel06Props) {
  ...
  return (
    <section className="lis-panel lis-panel--tests" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} tests records (slice 24-06)
      </footer>
    </section>
  );
}

export default LabTestRecord24Panel06;
