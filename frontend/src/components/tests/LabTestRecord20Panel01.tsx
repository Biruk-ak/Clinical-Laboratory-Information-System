...
export interface LabTestRecord20Panel01Props {
  facilityId: string;
  title?: string;
...
/**
 * LabTestRecord20Panel01 — operational panel for tests domain slice 20/01.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function LabTestRecord20Panel01({ facilityId, title = 'LabTestRecord20 Workspace', onSelect }: LabTestRecord20Panel01Props) {
  ...
  return (
    <section className="lis-panel lis-panel--tests" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} tests records (slice 20-01)
      </footer>
    </section>
  );
}

export default LabTestRecord20Panel01;
