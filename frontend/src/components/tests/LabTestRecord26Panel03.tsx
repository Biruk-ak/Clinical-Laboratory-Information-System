...
export interface LabTestRecord26Panel03Props {
  facilityId: string;
  title?: string;
...
/**
 * LabTestRecord26Panel03 — operational panel for tests domain slice 26/03.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function LabTestRecord26Panel03({ facilityId, title = 'LabTestRecord26 Workspace', onSelect }: LabTestRecord26Panel03Props) {
  ...
  return (
    <section className="lis-panel lis-panel--tests" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} tests records (slice 26-03)
      </footer>
    </section>
  );
}

export default LabTestRecord26Panel03;
