...
export interface LabTestRecord08Panel03Props {
  facilityId: string;
  title?: string;
...
/**
 * LabTestRecord08Panel03 — operational panel for tests domain slice 08/03.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function LabTestRecord08Panel03({ facilityId, title = 'LabTestRecord08 Workspace', onSelect }: LabTestRecord08Panel03Props) {
  ...
  return (
    <section className="lis-panel lis-panel--tests" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} tests records (slice 08-03)
      </footer>
    </section>
  );
}

export default LabTestRecord08Panel03;
