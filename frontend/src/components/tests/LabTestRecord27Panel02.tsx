...
export interface LabTestRecord27Panel02Props {
  facilityId: string;
  title?: string;
...
/**
 * LabTestRecord27Panel02 — operational panel for tests domain slice 27/02.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function LabTestRecord27Panel02({ facilityId, title = 'LabTestRecord27 Workspace', onSelect }: LabTestRecord27Panel02Props) {
  ...
  return (
    <section className="lis-panel lis-panel--tests" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} tests records (slice 27-02)
      </footer>
    </section>
  );
}

export default LabTestRecord27Panel02;
