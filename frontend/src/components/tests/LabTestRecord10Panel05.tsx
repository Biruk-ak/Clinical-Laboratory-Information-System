...
export interface LabTestRecord10Panel05Props {
  facilityId: string;
  title?: string;
...
/**
 * LabTestRecord10Panel05 — operational panel for tests domain slice 10/05.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function LabTestRecord10Panel05({ facilityId, title = 'LabTestRecord10 Workspace', onSelect }: LabTestRecord10Panel05Props) {
  ...
  return (
    <section className="lis-panel lis-panel--tests" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} tests records (slice 10-05)
      </footer>
    </section>
  );
}

export default LabTestRecord10Panel05;
