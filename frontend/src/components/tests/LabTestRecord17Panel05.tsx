...
export interface LabTestRecord17Panel05Props {
  facilityId: string;
  title?: string;
...
/**
 * LabTestRecord17Panel05 — operational panel for tests domain slice 17/05.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function LabTestRecord17Panel05({ facilityId, title = 'LabTestRecord17 Workspace', onSelect }: LabTestRecord17Panel05Props) {
  ...
  return (
    <section className="lis-panel lis-panel--tests" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} tests records (slice 17-05)
      </footer>
    </section>
  );
}

export default LabTestRecord17Panel05;
