...
export interface LabTestRecord05Panel03Props {
  facilityId: string;
  title?: string;
...
/**
 * LabTestRecord05Panel03 — operational panel for tests domain slice 05/03.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function LabTestRecord05Panel03({ facilityId, title = 'LabTestRecord05 Workspace', onSelect }: LabTestRecord05Panel03Props) {
  ...
  return (
    <section className="lis-panel lis-panel--tests" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} tests records (slice 05-03)
      </footer>
    </section>
  );
}

export default LabTestRecord05Panel03;
