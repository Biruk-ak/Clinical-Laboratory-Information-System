...
export interface LabTestRecord02Panel04Props {
  facilityId: string;
  title?: string;
...
/**
 * LabTestRecord02Panel04 — operational panel for tests domain slice 02/04.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function LabTestRecord02Panel04({ facilityId, title = 'LabTestRecord02 Workspace', onSelect }: LabTestRecord02Panel04Props) {
  ...
  return (
    <section className="lis-panel lis-panel--tests" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} tests records (slice 02-04)
      </footer>
    </section>
  );
}

export default LabTestRecord02Panel04;
