...
export interface LabTestRecord10Panel02Props {
  facilityId: string;
  title?: string;
...
/**
 * LabTestRecord10Panel02 — operational panel for tests domain slice 10/02.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function LabTestRecord10Panel02({ facilityId, title = 'LabTestRecord10 Workspace', onSelect }: LabTestRecord10Panel02Props) {
  ...
  return (
    <section className="lis-panel lis-panel--tests" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} tests records (slice 10-02)
      </footer>
    </section>
  );
}

export default LabTestRecord10Panel02;
