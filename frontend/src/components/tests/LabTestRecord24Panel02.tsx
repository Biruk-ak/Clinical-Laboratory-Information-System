...
export interface LabTestRecord24Panel02Props {
  facilityId: string;
  title?: string;
...
/**
 * LabTestRecord24Panel02 — operational panel for tests domain slice 24/02.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function LabTestRecord24Panel02({ facilityId, title = 'LabTestRecord24 Workspace', onSelect }: LabTestRecord24Panel02Props) {
  ...
  return (
    <section className="lis-panel lis-panel--tests" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} tests records (slice 24-02)
      </footer>
    </section>
  );
}

export default LabTestRecord24Panel02;
