...
export interface LabTestRecord25Panel04Props {
  facilityId: string;
  title?: string;
...
/**
 * LabTestRecord25Panel04 — operational panel for tests domain slice 25/04.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function LabTestRecord25Panel04({ facilityId, title = 'LabTestRecord25 Workspace', onSelect }: LabTestRecord25Panel04Props) {
  ...
  return (
    <section className="lis-panel lis-panel--tests" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} tests records (slice 25-04)
      </footer>
    </section>
  );
}

export default LabTestRecord25Panel04;
