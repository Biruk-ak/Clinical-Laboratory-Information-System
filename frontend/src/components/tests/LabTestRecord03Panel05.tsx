...
export interface LabTestRecord03Panel05Props {
  facilityId: string;
  title?: string;
...
/**
 * LabTestRecord03Panel05 — operational panel for tests domain slice 03/05.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function LabTestRecord03Panel05({ facilityId, title = 'LabTestRecord03 Workspace', onSelect }: LabTestRecord03Panel05Props) {
  ...
  return (
    <section className="lis-panel lis-panel--tests" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} tests records (slice 03-05)
      </footer>
    </section>
  );
}

export default LabTestRecord03Panel05;
