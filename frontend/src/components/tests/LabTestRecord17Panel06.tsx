...
export interface LabTestRecord17Panel06Props {
  facilityId: string;
  title?: string;
...
/**
 * LabTestRecord17Panel06 — operational panel for tests domain slice 17/06.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function LabTestRecord17Panel06({ facilityId, title = 'LabTestRecord17 Workspace', onSelect }: LabTestRecord17Panel06Props) {
  ...
  return (
    <section className="lis-panel lis-panel--tests" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} tests records (slice 17-06)
      </footer>
    </section>
  );
}

export default LabTestRecord17Panel06;
