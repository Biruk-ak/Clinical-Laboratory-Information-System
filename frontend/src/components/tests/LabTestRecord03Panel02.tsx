...
export interface LabTestRecord03Panel02Props {
  facilityId: string;
  title?: string;
...
/**
 * LabTestRecord03Panel02 — operational panel for tests domain slice 03/02.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function LabTestRecord03Panel02({ facilityId, title = 'LabTestRecord03 Workspace', onSelect }: LabTestRecord03Panel02Props) {
  ...
  return (
    <section className="lis-panel lis-panel--tests" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} tests records (slice 03-02)
      </footer>
    </section>
  );
}

export default LabTestRecord03Panel02;
