...
export interface LabTestRecord03Panel03Props {
  facilityId: string;
  title?: string;
...
/**
 * LabTestRecord03Panel03 — operational panel for tests domain slice 03/03.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function LabTestRecord03Panel03({ facilityId, title = 'LabTestRecord03 Workspace', onSelect }: LabTestRecord03Panel03Props) {
  ...
  return (
    <section className="lis-panel lis-panel--tests" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} tests records (slice 03-03)
      </footer>
    </section>
  );
}

export default LabTestRecord03Panel03;
