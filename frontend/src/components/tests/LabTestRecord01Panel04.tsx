...
export interface LabTestRecord01Panel04Props {
  facilityId: string;
  title?: string;
...
/**
 * LabTestRecord01Panel04 — operational panel for tests domain slice 01/04.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function LabTestRecord01Panel04({ facilityId, title = 'LabTestRecord01 Workspace', onSelect }: LabTestRecord01Panel04Props) {
  ...
  return (
    <section className="lis-panel lis-panel--tests" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} tests records (slice 01-04)
      </footer>
    </section>
  );
}

export default LabTestRecord01Panel04;
