...
export interface LabTestRecord25Panel03Props {
  facilityId: string;
  title?: string;
...
/**
 * LabTestRecord25Panel03 — operational panel for tests domain slice 25/03.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function LabTestRecord25Panel03({ facilityId, title = 'LabTestRecord25 Workspace', onSelect }: LabTestRecord25Panel03Props) {
  ...
  return (
    <section className="lis-panel lis-panel--tests" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} tests records (slice 25-03)
      </footer>
    </section>
  );
}

export default LabTestRecord25Panel03;
