...
export interface LabTestRecord08Panel01Props {
  facilityId: string;
  title?: string;
...
/**
 * LabTestRecord08Panel01 — operational panel for tests domain slice 08/01.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function LabTestRecord08Panel01({ facilityId, title = 'LabTestRecord08 Workspace', onSelect }: LabTestRecord08Panel01Props) {
  ...
  return (
    <section className="lis-panel lis-panel--tests" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} tests records (slice 08-01)
      </footer>
    </section>
  );
}

export default LabTestRecord08Panel01;
