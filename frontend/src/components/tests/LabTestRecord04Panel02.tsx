...
export interface LabTestRecord04Panel02Props {
  facilityId: string;
  title?: string;
...
/**
 * LabTestRecord04Panel02 — operational panel for tests domain slice 04/02.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function LabTestRecord04Panel02({ facilityId, title = 'LabTestRecord04 Workspace', onSelect }: LabTestRecord04Panel02Props) {
  ...
  return (
    <section className="lis-panel lis-panel--tests" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} tests records (slice 04-02)
      </footer>
    </section>
  );
}

export default LabTestRecord04Panel02;
