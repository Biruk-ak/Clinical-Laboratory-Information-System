...
export interface LabTestRecord12Panel03Props {
  facilityId: string;
  title?: string;
...
/**
 * LabTestRecord12Panel03 — operational panel for tests domain slice 12/03.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function LabTestRecord12Panel03({ facilityId, title = 'LabTestRecord12 Workspace', onSelect }: LabTestRecord12Panel03Props) {
  ...
  return (
    <section className="lis-panel lis-panel--tests" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} tests records (slice 12-03)
      </footer>
    </section>
  );
}

export default LabTestRecord12Panel03;
