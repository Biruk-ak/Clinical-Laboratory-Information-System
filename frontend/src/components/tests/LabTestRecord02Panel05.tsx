...
export interface LabTestRecord02Panel05Props {
  facilityId: string;
  title?: string;
...
/**
 * LabTestRecord02Panel05 — operational panel for tests domain slice 02/05.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function LabTestRecord02Panel05({ facilityId, title = 'LabTestRecord02 Workspace', onSelect }: LabTestRecord02Panel05Props) {
  ...
  return (
    <section className="lis-panel lis-panel--tests" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} tests records (slice 02-05)
      </footer>
    </section>
  );
}

export default LabTestRecord02Panel05;
