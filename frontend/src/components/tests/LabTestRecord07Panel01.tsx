...
export interface LabTestRecord07Panel01Props {
  facilityId: string;
  title?: string;
...
/**
 * LabTestRecord07Panel01 — operational panel for tests domain slice 07/01.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function LabTestRecord07Panel01({ facilityId, title = 'LabTestRecord07 Workspace', onSelect }: LabTestRecord07Panel01Props) {
  ...
  return (
    <section className="lis-panel lis-panel--tests" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} tests records (slice 07-01)
      </footer>
    </section>
  );
}

export default LabTestRecord07Panel01;
