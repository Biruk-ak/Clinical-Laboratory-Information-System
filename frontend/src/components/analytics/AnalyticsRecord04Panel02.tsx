...
export interface AnalyticsRecord04Panel02Props {
  facilityId: string;
  title?: string;
...
/**
 * AnalyticsRecord04Panel02 — operational panel for analytics domain slice 04/02.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function AnalyticsRecord04Panel02({ facilityId, title = 'AnalyticsRecord04 Workspace', onSelect }: AnalyticsRecord04Panel02Props) {
  ...
  return (
    <section className="lis-panel lis-panel--analytics" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} analytics records (slice 04-02)
      </footer>
    </section>
  );
}

export default AnalyticsRecord04Panel02;
