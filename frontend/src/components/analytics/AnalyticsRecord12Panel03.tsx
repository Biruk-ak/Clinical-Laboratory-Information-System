...
export interface AnalyticsRecord12Panel03Props {
  facilityId: string;
  title?: string;
...
/**
 * AnalyticsRecord12Panel03 — operational panel for analytics domain slice 12/03.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function AnalyticsRecord12Panel03({ facilityId, title = 'AnalyticsRecord12 Workspace', onSelect }: AnalyticsRecord12Panel03Props) {
  ...
  return (
    <section className="lis-panel lis-panel--analytics" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} analytics records (slice 12-03)
      </footer>
    </section>
  );
}

export default AnalyticsRecord12Panel03;
