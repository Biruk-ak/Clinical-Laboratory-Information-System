...
export interface AnalyticsRecord12Panel01Props {
  facilityId: string;
  title?: string;
...
/**
 * AnalyticsRecord12Panel01 — operational panel for analytics domain slice 12/01.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function AnalyticsRecord12Panel01({ facilityId, title = 'AnalyticsRecord12 Workspace', onSelect }: AnalyticsRecord12Panel01Props) {
  ...
  return (
    <section className="lis-panel lis-panel--analytics" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} analytics records (slice 12-01)
      </footer>
    </section>
  );
}

export default AnalyticsRecord12Panel01;
