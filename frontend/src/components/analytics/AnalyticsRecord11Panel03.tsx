...
export interface AnalyticsRecord11Panel03Props {
  facilityId: string;
  title?: string;
...
/**
 * AnalyticsRecord11Panel03 — operational panel for analytics domain slice 11/03.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function AnalyticsRecord11Panel03({ facilityId, title = 'AnalyticsRecord11 Workspace', onSelect }: AnalyticsRecord11Panel03Props) {
  ...
  return (
    <section className="lis-panel lis-panel--analytics" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} analytics records (slice 11-03)
      </footer>
    </section>
  );
}

export default AnalyticsRecord11Panel03;
