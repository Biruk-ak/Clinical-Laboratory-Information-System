...
export interface AnalyticsRecord15Panel02Props {
  facilityId: string;
  title?: string;
...
/**
 * AnalyticsRecord15Panel02 — operational panel for analytics domain slice 15/02.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function AnalyticsRecord15Panel02({ facilityId, title = 'AnalyticsRecord15 Workspace', onSelect }: AnalyticsRecord15Panel02Props) {
  ...
  return (
    <section className="lis-panel lis-panel--analytics" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} analytics records (slice 15-02)
      </footer>
    </section>
  );
}

export default AnalyticsRecord15Panel02;
