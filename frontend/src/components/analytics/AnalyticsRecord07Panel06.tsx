...
export interface AnalyticsRecord07Panel06Props {
  facilityId: string;
  title?: string;
...
/**
 * AnalyticsRecord07Panel06 — operational panel for analytics domain slice 07/06.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function AnalyticsRecord07Panel06({ facilityId, title = 'AnalyticsRecord07 Workspace', onSelect }: AnalyticsRecord07Panel06Props) {
  ...
  return (
    <section className="lis-panel lis-panel--analytics" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} analytics records (slice 07-06)
      </footer>
    </section>
  );
}

export default AnalyticsRecord07Panel06;
