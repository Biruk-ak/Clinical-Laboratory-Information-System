...
export interface AnalyticsRecord02Panel06Props {
  facilityId: string;
  title?: string;
...
/**
 * AnalyticsRecord02Panel06 — operational panel for analytics domain slice 02/06.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function AnalyticsRecord02Panel06({ facilityId, title = 'AnalyticsRecord02 Workspace', onSelect }: AnalyticsRecord02Panel06Props) {
  ...
  return (
    <section className="lis-panel lis-panel--analytics" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} analytics records (slice 02-06)
      </footer>
    </section>
  );
}

export default AnalyticsRecord02Panel06;
