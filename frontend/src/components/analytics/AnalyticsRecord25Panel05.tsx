...
export interface AnalyticsRecord25Panel05Props {
  facilityId: string;
  title?: string;
...
/**
 * AnalyticsRecord25Panel05 — operational panel for analytics domain slice 25/05.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function AnalyticsRecord25Panel05({ facilityId, title = 'AnalyticsRecord25 Workspace', onSelect }: AnalyticsRecord25Panel05Props) {
  ...
  return (
    <section className="lis-panel lis-panel--analytics" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} analytics records (slice 25-05)
      </footer>
    </section>
  );
}

export default AnalyticsRecord25Panel05;
