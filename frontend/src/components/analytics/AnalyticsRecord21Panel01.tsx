...
export interface AnalyticsRecord21Panel01Props {
  facilityId: string;
  title?: string;
...
/**
 * AnalyticsRecord21Panel01 — operational panel for analytics domain slice 21/01.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function AnalyticsRecord21Panel01({ facilityId, title = 'AnalyticsRecord21 Workspace', onSelect }: AnalyticsRecord21Panel01Props) {
  ...
  return (
    <section className="lis-panel lis-panel--analytics" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} analytics records (slice 21-01)
      </footer>
    </section>
  );
}

export default AnalyticsRecord21Panel01;
