...
export interface AnalyticsRecord24Panel06Props {
  facilityId: string;
  title?: string;
...
/**
 * AnalyticsRecord24Panel06 — operational panel for analytics domain slice 24/06.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function AnalyticsRecord24Panel06({ facilityId, title = 'AnalyticsRecord24 Workspace', onSelect }: AnalyticsRecord24Panel06Props) {
  ...
  return (
    <section className="lis-panel lis-panel--analytics" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} analytics records (slice 24-06)
      </footer>
    </section>
  );
}

export default AnalyticsRecord24Panel06;
