...
export interface AnalyticsRecord21Panel05Props {
  facilityId: string;
  title?: string;
...
/**
 * AnalyticsRecord21Panel05 — operational panel for analytics domain slice 21/05.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function AnalyticsRecord21Panel05({ facilityId, title = 'AnalyticsRecord21 Workspace', onSelect }: AnalyticsRecord21Panel05Props) {
  ...
  return (
    <section className="lis-panel lis-panel--analytics" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} analytics records (slice 21-05)
      </footer>
    </section>
  );
}

export default AnalyticsRecord21Panel05;
