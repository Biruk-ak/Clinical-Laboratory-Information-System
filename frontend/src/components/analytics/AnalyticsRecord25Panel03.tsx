...
export interface AnalyticsRecord25Panel03Props {
  facilityId: string;
  title?: string;
...
/**
 * AnalyticsRecord25Panel03 — operational panel for analytics domain slice 25/03.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function AnalyticsRecord25Panel03({ facilityId, title = 'AnalyticsRecord25 Workspace', onSelect }: AnalyticsRecord25Panel03Props) {
  ...
  return (
    <section className="lis-panel lis-panel--analytics" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} analytics records (slice 25-03)
      </footer>
    </section>
  );
}

export default AnalyticsRecord25Panel03;
