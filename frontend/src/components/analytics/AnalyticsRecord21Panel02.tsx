...
export interface AnalyticsRecord21Panel02Props {
  facilityId: string;
  title?: string;
...
/**
 * AnalyticsRecord21Panel02 — operational panel for analytics domain slice 21/02.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function AnalyticsRecord21Panel02({ facilityId, title = 'AnalyticsRecord21 Workspace', onSelect }: AnalyticsRecord21Panel02Props) {
  ...
  return (
    <section className="lis-panel lis-panel--analytics" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} analytics records (slice 21-02)
      </footer>
    </section>
  );
}

export default AnalyticsRecord21Panel02;
