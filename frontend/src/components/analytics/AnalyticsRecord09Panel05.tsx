...
export interface AnalyticsRecord09Panel05Props {
  facilityId: string;
  title?: string;
...
/**
 * AnalyticsRecord09Panel05 — operational panel for analytics domain slice 09/05.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function AnalyticsRecord09Panel05({ facilityId, title = 'AnalyticsRecord09 Workspace', onSelect }: AnalyticsRecord09Panel05Props) {
  ...
  return (
    <section className="lis-panel lis-panel--analytics" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} analytics records (slice 09-05)
      </footer>
    </section>
  );
}

export default AnalyticsRecord09Panel05;
