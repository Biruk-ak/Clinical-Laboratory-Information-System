...
export interface AnalyticsRecord23Panel03Props {
  facilityId: string;
  title?: string;
...
/**
 * AnalyticsRecord23Panel03 — operational panel for analytics domain slice 23/03.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function AnalyticsRecord23Panel03({ facilityId, title = 'AnalyticsRecord23 Workspace', onSelect }: AnalyticsRecord23Panel03Props) {
  ...
  return (
    <section className="lis-panel lis-panel--analytics" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} analytics records (slice 23-03)
      </footer>
    </section>
  );
}

export default AnalyticsRecord23Panel03;
