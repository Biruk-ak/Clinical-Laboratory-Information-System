...
export interface AnalyticsRecord04Panel05Props {
  facilityId: string;
  title?: string;
...
/**
 * AnalyticsRecord04Panel05 — operational panel for analytics domain slice 04/05.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function AnalyticsRecord04Panel05({ facilityId, title = 'AnalyticsRecord04 Workspace', onSelect }: AnalyticsRecord04Panel05Props) {
  ...
  return (
    <section className="lis-panel lis-panel--analytics" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} analytics records (slice 04-05)
      </footer>
    </section>
  );
}

export default AnalyticsRecord04Panel05;
