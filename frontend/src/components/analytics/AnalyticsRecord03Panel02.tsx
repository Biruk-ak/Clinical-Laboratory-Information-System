...
export interface AnalyticsRecord03Panel02Props {
  facilityId: string;
  title?: string;
...
/**
 * AnalyticsRecord03Panel02 — operational panel for analytics domain slice 03/02.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function AnalyticsRecord03Panel02({ facilityId, title = 'AnalyticsRecord03 Workspace', onSelect }: AnalyticsRecord03Panel02Props) {
  ...
  return (
    <section className="lis-panel lis-panel--analytics" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} analytics records (slice 03-02)
      </footer>
    </section>
  );
}

export default AnalyticsRecord03Panel02;
