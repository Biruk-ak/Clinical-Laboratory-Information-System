...
export interface AnalyticsRecord04Panel06Props {
  facilityId: string;
  title?: string;
...
/**
 * AnalyticsRecord04Panel06 — operational panel for analytics domain slice 04/06.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function AnalyticsRecord04Panel06({ facilityId, title = 'AnalyticsRecord04 Workspace', onSelect }: AnalyticsRecord04Panel06Props) {
  ...
  return (
    <section className="lis-panel lis-panel--analytics" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} analytics records (slice 04-06)
      </footer>
    </section>
  );
}

export default AnalyticsRecord04Panel06;
