...
export interface AnalyticsRecord14Panel02Props {
  facilityId: string;
  title?: string;
...
/**
 * AnalyticsRecord14Panel02 — operational panel for analytics domain slice 14/02.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function AnalyticsRecord14Panel02({ facilityId, title = 'AnalyticsRecord14 Workspace', onSelect }: AnalyticsRecord14Panel02Props) {
  ...
  return (
    <section className="lis-panel lis-panel--analytics" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} analytics records (slice 14-02)
      </footer>
    </section>
  );
}

export default AnalyticsRecord14Panel02;
