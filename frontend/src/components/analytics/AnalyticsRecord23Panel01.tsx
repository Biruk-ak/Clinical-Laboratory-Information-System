...
export interface AnalyticsRecord23Panel01Props {
  facilityId: string;
  title?: string;
...
/**
 * AnalyticsRecord23Panel01 — operational panel for analytics domain slice 23/01.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function AnalyticsRecord23Panel01({ facilityId, title = 'AnalyticsRecord23 Workspace', onSelect }: AnalyticsRecord23Panel01Props) {
  ...
  return (
    <section className="lis-panel lis-panel--analytics" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} analytics records (slice 23-01)
      </footer>
    </section>
  );
}

export default AnalyticsRecord23Panel01;
