...
export interface AnalyticsRecord07Panel02Props {
  facilityId: string;
  title?: string;
...
/**
 * AnalyticsRecord07Panel02 — operational panel for analytics domain slice 07/02.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function AnalyticsRecord07Panel02({ facilityId, title = 'AnalyticsRecord07 Workspace', onSelect }: AnalyticsRecord07Panel02Props) {
  ...
  return (
    <section className="lis-panel lis-panel--analytics" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} analytics records (slice 07-02)
      </footer>
    </section>
  );
}

export default AnalyticsRecord07Panel02;
