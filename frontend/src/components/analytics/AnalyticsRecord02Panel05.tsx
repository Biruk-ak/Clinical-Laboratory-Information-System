...
export interface AnalyticsRecord02Panel05Props {
  facilityId: string;
  title?: string;
...
/**
 * AnalyticsRecord02Panel05 — operational panel for analytics domain slice 02/05.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function AnalyticsRecord02Panel05({ facilityId, title = 'AnalyticsRecord02 Workspace', onSelect }: AnalyticsRecord02Panel05Props) {
  ...
  return (
    <section className="lis-panel lis-panel--analytics" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} analytics records (slice 02-05)
      </footer>
    </section>
  );
}

export default AnalyticsRecord02Panel05;
