...
export interface AnalyticsRecord24Panel04Props {
  facilityId: string;
  title?: string;
...
/**
 * AnalyticsRecord24Panel04 — operational panel for analytics domain slice 24/04.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function AnalyticsRecord24Panel04({ facilityId, title = 'AnalyticsRecord24 Workspace', onSelect }: AnalyticsRecord24Panel04Props) {
  ...
  return (
    <section className="lis-panel lis-panel--analytics" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} analytics records (slice 24-04)
      </footer>
    </section>
  );
}

export default AnalyticsRecord24Panel04;
