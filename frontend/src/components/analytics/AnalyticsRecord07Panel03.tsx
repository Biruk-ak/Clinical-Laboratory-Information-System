...
export interface AnalyticsRecord07Panel03Props {
  facilityId: string;
  title?: string;
...
/**
 * AnalyticsRecord07Panel03 — operational panel for analytics domain slice 07/03.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function AnalyticsRecord07Panel03({ facilityId, title = 'AnalyticsRecord07 Workspace', onSelect }: AnalyticsRecord07Panel03Props) {
  ...
  return (
    <section className="lis-panel lis-panel--analytics" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} analytics records (slice 07-03)
      </footer>
    </section>
  );
}

export default AnalyticsRecord07Panel03;
