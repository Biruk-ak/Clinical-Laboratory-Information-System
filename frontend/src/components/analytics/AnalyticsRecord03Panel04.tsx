...
export interface AnalyticsRecord03Panel04Props {
  facilityId: string;
  title?: string;
...
/**
 * AnalyticsRecord03Panel04 — operational panel for analytics domain slice 03/04.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function AnalyticsRecord03Panel04({ facilityId, title = 'AnalyticsRecord03 Workspace', onSelect }: AnalyticsRecord03Panel04Props) {
  ...
  return (
    <section className="lis-panel lis-panel--analytics" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} analytics records (slice 03-04)
      </footer>
    </section>
  );
}

export default AnalyticsRecord03Panel04;
