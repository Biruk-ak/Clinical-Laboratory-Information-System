...
export interface AnalyticsRecord12Panel04Props {
  facilityId: string;
  title?: string;
...
/**
 * AnalyticsRecord12Panel04 — operational panel for analytics domain slice 12/04.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function AnalyticsRecord12Panel04({ facilityId, title = 'AnalyticsRecord12 Workspace', onSelect }: AnalyticsRecord12Panel04Props) {
  ...
  return (
    <section className="lis-panel lis-panel--analytics" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} analytics records (slice 12-04)
      </footer>
    </section>
  );
}

export default AnalyticsRecord12Panel04;
