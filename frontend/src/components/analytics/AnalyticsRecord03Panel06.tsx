...
export interface AnalyticsRecord03Panel06Props {
  facilityId: string;
  title?: string;
...
/**
 * AnalyticsRecord03Panel06 — operational panel for analytics domain slice 03/06.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function AnalyticsRecord03Panel06({ facilityId, title = 'AnalyticsRecord03 Workspace', onSelect }: AnalyticsRecord03Panel06Props) {
  ...
  return (
    <section className="lis-panel lis-panel--analytics" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} analytics records (slice 03-06)
      </footer>
    </section>
  );
}

export default AnalyticsRecord03Panel06;
