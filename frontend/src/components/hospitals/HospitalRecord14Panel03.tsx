...
export interface HospitalRecord14Panel03Props {
  facilityId: string;
  title?: string;
...
/**
 * HospitalRecord14Panel03 — operational panel for hospitals domain slice 14/03.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function HospitalRecord14Panel03({ facilityId, title = 'HospitalRecord14 Workspace', onSelect }: HospitalRecord14Panel03Props) {
  ...
  return (
    <section className="lis-panel lis-panel--hospitals" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} hospitals records (slice 14-03)
      </footer>
    </section>
  );
}

export default HospitalRecord14Panel03;
