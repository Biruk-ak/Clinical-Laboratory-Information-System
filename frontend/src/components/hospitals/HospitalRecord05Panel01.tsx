...
export interface HospitalRecord05Panel01Props {
  facilityId: string;
  title?: string;
...
/**
 * HospitalRecord05Panel01 — operational panel for hospitals domain slice 05/01.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function HospitalRecord05Panel01({ facilityId, title = 'HospitalRecord05 Workspace', onSelect }: HospitalRecord05Panel01Props) {
  ...
  return (
    <section className="lis-panel lis-panel--hospitals" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} hospitals records (slice 05-01)
      </footer>
    </section>
  );
}

export default HospitalRecord05Panel01;
