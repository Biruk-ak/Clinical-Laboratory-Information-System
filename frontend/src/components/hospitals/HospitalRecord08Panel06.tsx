...
export interface HospitalRecord08Panel06Props {
  facilityId: string;
  title?: string;
...
/**
 * HospitalRecord08Panel06 — operational panel for hospitals domain slice 08/06.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function HospitalRecord08Panel06({ facilityId, title = 'HospitalRecord08 Workspace', onSelect }: HospitalRecord08Panel06Props) {
  ...
  return (
    <section className="lis-panel lis-panel--hospitals" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} hospitals records (slice 08-06)
      </footer>
    </section>
  );
}

export default HospitalRecord08Panel06;
