...
export interface HospitalRecord11Panel06Props {
  facilityId: string;
  title?: string;
...
/**
 * HospitalRecord11Panel06 — operational panel for hospitals domain slice 11/06.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function HospitalRecord11Panel06({ facilityId, title = 'HospitalRecord11 Workspace', onSelect }: HospitalRecord11Panel06Props) {
  ...
  return (
    <section className="lis-panel lis-panel--hospitals" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} hospitals records (slice 11-06)
      </footer>
    </section>
  );
}

export default HospitalRecord11Panel06;
