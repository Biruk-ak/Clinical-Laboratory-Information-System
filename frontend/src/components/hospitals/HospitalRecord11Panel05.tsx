...
export interface HospitalRecord11Panel05Props {
  facilityId: string;
  title?: string;
...
/**
 * HospitalRecord11Panel05 — operational panel for hospitals domain slice 11/05.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function HospitalRecord11Panel05({ facilityId, title = 'HospitalRecord11 Workspace', onSelect }: HospitalRecord11Panel05Props) {
  ...
  return (
    <section className="lis-panel lis-panel--hospitals" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} hospitals records (slice 11-05)
      </footer>
    </section>
  );
}

export default HospitalRecord11Panel05;
