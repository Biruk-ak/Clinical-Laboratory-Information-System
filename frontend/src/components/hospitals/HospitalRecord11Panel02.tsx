...
export interface HospitalRecord11Panel02Props {
  facilityId: string;
  title?: string;
...
/**
 * HospitalRecord11Panel02 — operational panel for hospitals domain slice 11/02.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function HospitalRecord11Panel02({ facilityId, title = 'HospitalRecord11 Workspace', onSelect }: HospitalRecord11Panel02Props) {
  ...
  return (
    <section className="lis-panel lis-panel--hospitals" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} hospitals records (slice 11-02)
      </footer>
    </section>
  );
}

export default HospitalRecord11Panel02;
