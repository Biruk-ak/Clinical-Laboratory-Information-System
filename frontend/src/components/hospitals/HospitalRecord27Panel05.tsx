...
export interface HospitalRecord27Panel05Props {
  facilityId: string;
  title?: string;
...
/**
 * HospitalRecord27Panel05 — operational panel for hospitals domain slice 27/05.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function HospitalRecord27Panel05({ facilityId, title = 'HospitalRecord27 Workspace', onSelect }: HospitalRecord27Panel05Props) {
  ...
  return (
    <section className="lis-panel lis-panel--hospitals" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} hospitals records (slice 27-05)
      </footer>
    </section>
  );
}

export default HospitalRecord27Panel05;
