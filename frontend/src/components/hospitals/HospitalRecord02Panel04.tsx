...
export interface HospitalRecord02Panel04Props {
  facilityId: string;
  title?: string;
...
/**
 * HospitalRecord02Panel04 — operational panel for hospitals domain slice 02/04.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function HospitalRecord02Panel04({ facilityId, title = 'HospitalRecord02 Workspace', onSelect }: HospitalRecord02Panel04Props) {
  ...
  return (
    <section className="lis-panel lis-panel--hospitals" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} hospitals records (slice 02-04)
      </footer>
    </section>
  );
}

export default HospitalRecord02Panel04;
