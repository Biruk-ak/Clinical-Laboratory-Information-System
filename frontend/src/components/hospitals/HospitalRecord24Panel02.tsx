...
export interface HospitalRecord24Panel02Props {
  facilityId: string;
  title?: string;
...
/**
 * HospitalRecord24Panel02 — operational panel for hospitals domain slice 24/02.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function HospitalRecord24Panel02({ facilityId, title = 'HospitalRecord24 Workspace', onSelect }: HospitalRecord24Panel02Props) {
  ...
  return (
    <section className="lis-panel lis-panel--hospitals" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} hospitals records (slice 24-02)
      </footer>
    </section>
  );
}

export default HospitalRecord24Panel02;
