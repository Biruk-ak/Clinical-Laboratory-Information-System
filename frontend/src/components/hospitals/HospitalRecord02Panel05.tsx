...
export interface HospitalRecord02Panel05Props {
  facilityId: string;
  title?: string;
...
/**
 * HospitalRecord02Panel05 — operational panel for hospitals domain slice 02/05.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function HospitalRecord02Panel05({ facilityId, title = 'HospitalRecord02 Workspace', onSelect }: HospitalRecord02Panel05Props) {
  ...
  return (
    <section className="lis-panel lis-panel--hospitals" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} hospitals records (slice 02-05)
      </footer>
    </section>
  );
}

export default HospitalRecord02Panel05;
