...
export interface HospitalRecord18Panel06Props {
  facilityId: string;
  title?: string;
...
/**
 * HospitalRecord18Panel06 — operational panel for hospitals domain slice 18/06.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function HospitalRecord18Panel06({ facilityId, title = 'HospitalRecord18 Workspace', onSelect }: HospitalRecord18Panel06Props) {
  ...
  return (
    <section className="lis-panel lis-panel--hospitals" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} hospitals records (slice 18-06)
      </footer>
    </section>
  );
}

export default HospitalRecord18Panel06;
