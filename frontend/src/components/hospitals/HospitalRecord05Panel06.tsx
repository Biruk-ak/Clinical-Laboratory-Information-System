...
export interface HospitalRecord05Panel06Props {
  facilityId: string;
  title?: string;
...
/**
 * HospitalRecord05Panel06 — operational panel for hospitals domain slice 05/06.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function HospitalRecord05Panel06({ facilityId, title = 'HospitalRecord05 Workspace', onSelect }: HospitalRecord05Panel06Props) {
  ...
  return (
    <section className="lis-panel lis-panel--hospitals" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} hospitals records (slice 05-06)
      </footer>
    </section>
  );
}

export default HospitalRecord05Panel06;
