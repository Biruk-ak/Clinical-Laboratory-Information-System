...
export interface HospitalRecord14Panel06Props {
  facilityId: string;
  title?: string;
...
/**
 * HospitalRecord14Panel06 — operational panel for hospitals domain slice 14/06.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function HospitalRecord14Panel06({ facilityId, title = 'HospitalRecord14 Workspace', onSelect }: HospitalRecord14Panel06Props) {
  ...
  return (
    <section className="lis-panel lis-panel--hospitals" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} hospitals records (slice 14-06)
      </footer>
    </section>
  );
}

export default HospitalRecord14Panel06;
