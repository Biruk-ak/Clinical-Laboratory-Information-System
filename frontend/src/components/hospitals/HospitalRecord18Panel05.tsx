...
export interface HospitalRecord18Panel05Props {
  facilityId: string;
  title?: string;
...
/**
 * HospitalRecord18Panel05 — operational panel for hospitals domain slice 18/05.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function HospitalRecord18Panel05({ facilityId, title = 'HospitalRecord18 Workspace', onSelect }: HospitalRecord18Panel05Props) {
  ...
  return (
    <section className="lis-panel lis-panel--hospitals" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} hospitals records (slice 18-05)
      </footer>
    </section>
  );
}

export default HospitalRecord18Panel05;
