...
export interface HospitalRecord24Panel06Props {
  facilityId: string;
  title?: string;
...
/**
 * HospitalRecord24Panel06 — operational panel for hospitals domain slice 24/06.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function HospitalRecord24Panel06({ facilityId, title = 'HospitalRecord24 Workspace', onSelect }: HospitalRecord24Panel06Props) {
  ...
  return (
    <section className="lis-panel lis-panel--hospitals" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} hospitals records (slice 24-06)
      </footer>
    </section>
  );
}

export default HospitalRecord24Panel06;
