...
export interface HospitalRecord18Panel04Props {
  facilityId: string;
  title?: string;
...
/**
 * HospitalRecord18Panel04 — operational panel for hospitals domain slice 18/04.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function HospitalRecord18Panel04({ facilityId, title = 'HospitalRecord18 Workspace', onSelect }: HospitalRecord18Panel04Props) {
  ...
  return (
    <section className="lis-panel lis-panel--hospitals" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} hospitals records (slice 18-04)
      </footer>
    </section>
  );
}

export default HospitalRecord18Panel04;
