...
export interface HospitalRecord18Panel02Props {
  facilityId: string;
  title?: string;
...
/**
 * HospitalRecord18Panel02 — operational panel for hospitals domain slice 18/02.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function HospitalRecord18Panel02({ facilityId, title = 'HospitalRecord18 Workspace', onSelect }: HospitalRecord18Panel02Props) {
  ...
  return (
    <section className="lis-panel lis-panel--hospitals" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} hospitals records (slice 18-02)
      </footer>
    </section>
  );
}

export default HospitalRecord18Panel02;
