...
export interface NotificationRecord03Panel06Props {
  facilityId: string;
  title?: string;
...
/**
 * NotificationRecord03Panel06 — operational panel for notifications domain slice 03/06.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function NotificationRecord03Panel06({ facilityId, title = 'NotificationRecord03 Workspace', onSelect }: NotificationRecord03Panel06Props) {
  ...
  return (
    <section className="lis-panel lis-panel--notifications" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} notifications records (slice 03-06)
      </footer>
    </section>
  );
}

export default NotificationRecord03Panel06;
