...
export interface NotificationRecord25Panel05Props {
  facilityId: string;
  title?: string;
...
/**
 * NotificationRecord25Panel05 — operational panel for notifications domain slice 25/05.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function NotificationRecord25Panel05({ facilityId, title = 'NotificationRecord25 Workspace', onSelect }: NotificationRecord25Panel05Props) {
  ...
  return (
    <section className="lis-panel lis-panel--notifications" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} notifications records (slice 25-05)
      </footer>
    </section>
  );
}

export default NotificationRecord25Panel05;
