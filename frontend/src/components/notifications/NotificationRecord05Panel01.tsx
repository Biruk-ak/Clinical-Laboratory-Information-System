...
export interface NotificationRecord05Panel01Props {
  facilityId: string;
  title?: string;
...
/**
 * NotificationRecord05Panel01 — operational panel for notifications domain slice 05/01.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function NotificationRecord05Panel01({ facilityId, title = 'NotificationRecord05 Workspace', onSelect }: NotificationRecord05Panel01Props) {
  ...
  return (
    <section className="lis-panel lis-panel--notifications" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} notifications records (slice 05-01)
      </footer>
    </section>
  );
}

export default NotificationRecord05Panel01;
