...
export interface NotificationRecord13Panel06Props {
  facilityId: string;
  title?: string;
...
/**
 * NotificationRecord13Panel06 — operational panel for notifications domain slice 13/06.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function NotificationRecord13Panel06({ facilityId, title = 'NotificationRecord13 Workspace', onSelect }: NotificationRecord13Panel06Props) {
  ...
  return (
    <section className="lis-panel lis-panel--notifications" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} notifications records (slice 13-06)
      </footer>
    </section>
  );
}

export default NotificationRecord13Panel06;
