...
export interface NotificationRecord28Panel06Props {
  facilityId: string;
  title?: string;
...
/**
 * NotificationRecord28Panel06 — operational panel for notifications domain slice 28/06.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function NotificationRecord28Panel06({ facilityId, title = 'NotificationRecord28 Workspace', onSelect }: NotificationRecord28Panel06Props) {
  ...
  return (
    <section className="lis-panel lis-panel--notifications" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} notifications records (slice 28-06)
      </footer>
    </section>
  );
}

export default NotificationRecord28Panel06;
