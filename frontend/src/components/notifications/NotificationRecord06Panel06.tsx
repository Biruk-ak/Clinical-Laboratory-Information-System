...
export interface NotificationRecord06Panel06Props {
  facilityId: string;
  title?: string;
...
/**
 * NotificationRecord06Panel06 — operational panel for notifications domain slice 06/06.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function NotificationRecord06Panel06({ facilityId, title = 'NotificationRecord06 Workspace', onSelect }: NotificationRecord06Panel06Props) {
  ...
  return (
    <section className="lis-panel lis-panel--notifications" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} notifications records (slice 06-06)
      </footer>
    </section>
  );
}

export default NotificationRecord06Panel06;
