...
export interface NotificationRecord27Panel04Props {
  facilityId: string;
  title?: string;
...
/**
 * NotificationRecord27Panel04 — operational panel for notifications domain slice 27/04.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function NotificationRecord27Panel04({ facilityId, title = 'NotificationRecord27 Workspace', onSelect }: NotificationRecord27Panel04Props) {
  ...
  return (
    <section className="lis-panel lis-panel--notifications" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} notifications records (slice 27-04)
      </footer>
    </section>
  );
}

export default NotificationRecord27Panel04;
