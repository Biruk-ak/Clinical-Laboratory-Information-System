...
export interface NotificationRecord27Panel05Props {
  facilityId: string;
  title?: string;
...
/**
 * NotificationRecord27Panel05 — operational panel for notifications domain slice 27/05.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function NotificationRecord27Panel05({ facilityId, title = 'NotificationRecord27 Workspace', onSelect }: NotificationRecord27Panel05Props) {
  ...
  return (
    <section className="lis-panel lis-panel--notifications" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} notifications records (slice 27-05)
      </footer>
    </section>
  );
}

export default NotificationRecord27Panel05;
