...
export interface NotificationRecord06Panel03Props {
  facilityId: string;
  title?: string;
...
/**
 * NotificationRecord06Panel03 — operational panel for notifications domain slice 06/03.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function NotificationRecord06Panel03({ facilityId, title = 'NotificationRecord06 Workspace', onSelect }: NotificationRecord06Panel03Props) {
  ...
  return (
    <section className="lis-panel lis-panel--notifications" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} notifications records (slice 06-03)
      </footer>
    </section>
  );
}

export default NotificationRecord06Panel03;
