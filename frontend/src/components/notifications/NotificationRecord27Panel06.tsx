...
export interface NotificationRecord27Panel06Props {
  facilityId: string;
  title?: string;
...
/**
 * NotificationRecord27Panel06 — operational panel for notifications domain slice 27/06.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function NotificationRecord27Panel06({ facilityId, title = 'NotificationRecord27 Workspace', onSelect }: NotificationRecord27Panel06Props) {
  ...
  return (
    <section className="lis-panel lis-panel--notifications" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} notifications records (slice 27-06)
      </footer>
    </section>
  );
}

export default NotificationRecord27Panel06;
