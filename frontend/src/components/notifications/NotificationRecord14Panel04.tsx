...
export interface NotificationRecord14Panel04Props {
  facilityId: string;
  title?: string;
...
/**
 * NotificationRecord14Panel04 — operational panel for notifications domain slice 14/04.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function NotificationRecord14Panel04({ facilityId, title = 'NotificationRecord14 Workspace', onSelect }: NotificationRecord14Panel04Props) {
  ...
  return (
    <section className="lis-panel lis-panel--notifications" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} notifications records (slice 14-04)
      </footer>
    </section>
  );
}

export default NotificationRecord14Panel04;
