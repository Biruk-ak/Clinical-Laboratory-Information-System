...
export interface NotificationRecord06Panel02Props {
  facilityId: string;
  title?: string;
...
/**
 * NotificationRecord06Panel02 — operational panel for notifications domain slice 06/02.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function NotificationRecord06Panel02({ facilityId, title = 'NotificationRecord06 Workspace', onSelect }: NotificationRecord06Panel02Props) {
  ...
  return (
    <section className="lis-panel lis-panel--notifications" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} notifications records (slice 06-02)
      </footer>
    </section>
  );
}

export default NotificationRecord06Panel02;
