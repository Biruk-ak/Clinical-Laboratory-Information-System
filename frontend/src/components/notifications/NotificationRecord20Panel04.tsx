...
export interface NotificationRecord20Panel04Props {
  facilityId: string;
  title?: string;
...
/**
 * NotificationRecord20Panel04 — operational panel for notifications domain slice 20/04.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function NotificationRecord20Panel04({ facilityId, title = 'NotificationRecord20 Workspace', onSelect }: NotificationRecord20Panel04Props) {
  ...
  return (
    <section className="lis-panel lis-panel--notifications" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} notifications records (slice 20-04)
      </footer>
    </section>
  );
}

export default NotificationRecord20Panel04;
