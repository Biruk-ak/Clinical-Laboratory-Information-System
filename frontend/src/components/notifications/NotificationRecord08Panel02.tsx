...
export interface NotificationRecord08Panel02Props {
  facilityId: string;
  title?: string;
...
/**
 * NotificationRecord08Panel02 — operational panel for notifications domain slice 08/02.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function NotificationRecord08Panel02({ facilityId, title = 'NotificationRecord08 Workspace', onSelect }: NotificationRecord08Panel02Props) {
  ...
  return (
    <section className="lis-panel lis-panel--notifications" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} notifications records (slice 08-02)
      </footer>
    </section>
  );
}

export default NotificationRecord08Panel02;
