...
export interface NotificationRecord05Panel02Props {
  facilityId: string;
  title?: string;
...
/**
 * NotificationRecord05Panel02 — operational panel for notifications domain slice 05/02.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function NotificationRecord05Panel02({ facilityId, title = 'NotificationRecord05 Workspace', onSelect }: NotificationRecord05Panel02Props) {
  ...
  return (
    <section className="lis-panel lis-panel--notifications" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} notifications records (slice 05-02)
      </footer>
    </section>
  );
}

export default NotificationRecord05Panel02;
