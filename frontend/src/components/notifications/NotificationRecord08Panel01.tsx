...
export interface NotificationRecord08Panel01Props {
  facilityId: string;
  title?: string;
...
/**
 * NotificationRecord08Panel01 — operational panel for notifications domain slice 08/01.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function NotificationRecord08Panel01({ facilityId, title = 'NotificationRecord08 Workspace', onSelect }: NotificationRecord08Panel01Props) {
  ...
  return (
    <section className="lis-panel lis-panel--notifications" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} notifications records (slice 08-01)
      </footer>
    </section>
  );
}

export default NotificationRecord08Panel01;
