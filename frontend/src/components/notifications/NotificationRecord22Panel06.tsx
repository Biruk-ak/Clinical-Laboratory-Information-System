...
export interface NotificationRecord22Panel06Props {
  facilityId: string;
  title?: string;
...
/**
 * NotificationRecord22Panel06 — operational panel for notifications domain slice 22/06.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function NotificationRecord22Panel06({ facilityId, title = 'NotificationRecord22 Workspace', onSelect }: NotificationRecord22Panel06Props) {
  ...
  return (
    <section className="lis-panel lis-panel--notifications" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} notifications records (slice 22-06)
      </footer>
    </section>
  );
}

export default NotificationRecord22Panel06;
