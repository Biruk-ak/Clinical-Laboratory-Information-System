...
export interface NotificationRecord25Panel06Props {
  facilityId: string;
  title?: string;
...
/**
 * NotificationRecord25Panel06 — operational panel for notifications domain slice 25/06.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function NotificationRecord25Panel06({ facilityId, title = 'NotificationRecord25 Workspace', onSelect }: NotificationRecord25Panel06Props) {
  ...
  return (
    <section className="lis-panel lis-panel--notifications" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} notifications records (slice 25-06)
      </footer>
    </section>
  );
}

export default NotificationRecord25Panel06;
