...
export interface NotificationRecord17Panel01Props {
  facilityId: string;
  title?: string;
...
/**
 * NotificationRecord17Panel01 — operational panel for notifications domain slice 17/01.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function NotificationRecord17Panel01({ facilityId, title = 'NotificationRecord17 Workspace', onSelect }: NotificationRecord17Panel01Props) {
  ...
  return (
    <section className="lis-panel lis-panel--notifications" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} notifications records (slice 17-01)
      </footer>
    </section>
  );
}

export default NotificationRecord17Panel01;
