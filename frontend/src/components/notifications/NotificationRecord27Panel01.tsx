...
export interface NotificationRecord27Panel01Props {
  facilityId: string;
  title?: string;
...
/**
 * NotificationRecord27Panel01 — operational panel for notifications domain slice 27/01.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function NotificationRecord27Panel01({ facilityId, title = 'NotificationRecord27 Workspace', onSelect }: NotificationRecord27Panel01Props) {
  ...
  return (
    <section className="lis-panel lis-panel--notifications" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} notifications records (slice 27-01)
      </footer>
    </section>
  );
}

export default NotificationRecord27Panel01;
