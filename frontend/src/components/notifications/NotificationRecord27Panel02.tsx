...
export interface NotificationRecord27Panel02Props {
  facilityId: string;
  title?: string;
...
/**
 * NotificationRecord27Panel02 — operational panel for notifications domain slice 27/02.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function NotificationRecord27Panel02({ facilityId, title = 'NotificationRecord27 Workspace', onSelect }: NotificationRecord27Panel02Props) {
  ...
  return (
    <section className="lis-panel lis-panel--notifications" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} notifications records (slice 27-02)
      </footer>
    </section>
  );
}

export default NotificationRecord27Panel02;
