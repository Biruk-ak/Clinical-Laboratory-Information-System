...
export interface NotificationRecord14Panel03Props {
  facilityId: string;
  title?: string;
...
/**
 * NotificationRecord14Panel03 — operational panel for notifications domain slice 14/03.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function NotificationRecord14Panel03({ facilityId, title = 'NotificationRecord14 Workspace', onSelect }: NotificationRecord14Panel03Props) {
  ...
  return (
    <section className="lis-panel lis-panel--notifications" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} notifications records (slice 14-03)
      </footer>
    </section>
  );
}

export default NotificationRecord14Panel03;
