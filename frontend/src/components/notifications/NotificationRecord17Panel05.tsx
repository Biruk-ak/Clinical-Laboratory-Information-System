...
export interface NotificationRecord17Panel05Props {
  facilityId: string;
  title?: string;
...
/**
 * NotificationRecord17Panel05 — operational panel for notifications domain slice 17/05.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function NotificationRecord17Panel05({ facilityId, title = 'NotificationRecord17 Workspace', onSelect }: NotificationRecord17Panel05Props) {
  ...
  return (
    <section className="lis-panel lis-panel--notifications" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} notifications records (slice 17-05)
      </footer>
    </section>
  );
}

export default NotificationRecord17Panel05;
