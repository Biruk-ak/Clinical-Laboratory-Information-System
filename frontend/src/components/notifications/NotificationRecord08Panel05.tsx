...
export interface NotificationRecord08Panel05Props {
  facilityId: string;
  title?: string;
...
/**
 * NotificationRecord08Panel05 — operational panel for notifications domain slice 08/05.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function NotificationRecord08Panel05({ facilityId, title = 'NotificationRecord08 Workspace', onSelect }: NotificationRecord08Panel05Props) {
  ...
  return (
    <section className="lis-panel lis-panel--notifications" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} notifications records (slice 08-05)
      </footer>
    </section>
  );
}

export default NotificationRecord08Panel05;
