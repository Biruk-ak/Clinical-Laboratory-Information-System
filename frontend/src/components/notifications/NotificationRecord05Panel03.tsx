...
export interface NotificationRecord05Panel03Props {
  facilityId: string;
  title?: string;
...
/**
 * NotificationRecord05Panel03 — operational panel for notifications domain slice 05/03.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function NotificationRecord05Panel03({ facilityId, title = 'NotificationRecord05 Workspace', onSelect }: NotificationRecord05Panel03Props) {
  ...
  return (
    <section className="lis-panel lis-panel--notifications" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} notifications records (slice 05-03)
      </footer>
    </section>
  );
}

export default NotificationRecord05Panel03;
