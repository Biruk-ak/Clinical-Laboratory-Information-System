...
export interface NotificationRecord20Panel01Props {
  facilityId: string;
  title?: string;
...
/**
 * NotificationRecord20Panel01 — operational panel for notifications domain slice 20/01.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function NotificationRecord20Panel01({ facilityId, title = 'NotificationRecord20 Workspace', onSelect }: NotificationRecord20Panel01Props) {
  ...
  return (
    <section className="lis-panel lis-panel--notifications" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} notifications records (slice 20-01)
      </footer>
    </section>
  );
}

export default NotificationRecord20Panel01;
