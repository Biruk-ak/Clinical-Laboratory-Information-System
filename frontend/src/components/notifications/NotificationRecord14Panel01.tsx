...
export interface NotificationRecord14Panel01Props {
  facilityId: string;
  title?: string;
...
/**
 * NotificationRecord14Panel01 — operational panel for notifications domain slice 14/01.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function NotificationRecord14Panel01({ facilityId, title = 'NotificationRecord14 Workspace', onSelect }: NotificationRecord14Panel01Props) {
  ...
  return (
    <section className="lis-panel lis-panel--notifications" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} notifications records (slice 14-01)
      </footer>
    </section>
  );
}

export default NotificationRecord14Panel01;
