...
export interface NotificationRecord06Panel05Props {
  facilityId: string;
  title?: string;
...
/**
 * NotificationRecord06Panel05 — operational panel for notifications domain slice 06/05.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function NotificationRecord06Panel05({ facilityId, title = 'NotificationRecord06 Workspace', onSelect }: NotificationRecord06Panel05Props) {
  ...
  return (
    <section className="lis-panel lis-panel--notifications" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} notifications records (slice 06-05)
      </footer>
    </section>
  );
}

export default NotificationRecord06Panel05;
