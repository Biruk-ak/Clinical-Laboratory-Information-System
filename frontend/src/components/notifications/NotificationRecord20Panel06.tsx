...
export interface NotificationRecord20Panel06Props {
  facilityId: string;
  title?: string;
...
/**
 * NotificationRecord20Panel06 — operational panel for notifications domain slice 20/06.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function NotificationRecord20Panel06({ facilityId, title = 'NotificationRecord20 Workspace', onSelect }: NotificationRecord20Panel06Props) {
  ...
  return (
    <section className="lis-panel lis-panel--notifications" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} notifications records (slice 20-06)
      </footer>
    </section>
  );
}

export default NotificationRecord20Panel06;
