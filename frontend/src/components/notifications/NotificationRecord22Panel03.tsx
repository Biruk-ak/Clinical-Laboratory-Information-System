...
export interface NotificationRecord22Panel03Props {
  facilityId: string;
  title?: string;
...
/**
 * NotificationRecord22Panel03 — operational panel for notifications domain slice 22/03.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function NotificationRecord22Panel03({ facilityId, title = 'NotificationRecord22 Workspace', onSelect }: NotificationRecord22Panel03Props) {
  ...
  return (
    <section className="lis-panel lis-panel--notifications" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} notifications records (slice 22-03)
      </footer>
    </section>
  );
}

export default NotificationRecord22Panel03;
