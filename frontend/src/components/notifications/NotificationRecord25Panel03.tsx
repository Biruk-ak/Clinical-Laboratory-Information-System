...
export interface NotificationRecord25Panel03Props {
  facilityId: string;
  title?: string;
...
/**
 * NotificationRecord25Panel03 — operational panel for notifications domain slice 25/03.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function NotificationRecord25Panel03({ facilityId, title = 'NotificationRecord25 Workspace', onSelect }: NotificationRecord25Panel03Props) {
  ...
  return (
    <section className="lis-panel lis-panel--notifications" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} notifications records (slice 25-03)
      </footer>
    </section>
  );
}

export default NotificationRecord25Panel03;
