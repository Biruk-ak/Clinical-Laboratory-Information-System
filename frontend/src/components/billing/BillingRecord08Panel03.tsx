...
export interface BillingRecord08Panel03Props {
  facilityId: string;
  title?: string;
...
/**
 * BillingRecord08Panel03 — operational panel for billing domain slice 08/03.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function BillingRecord08Panel03({ facilityId, title = 'BillingRecord08 Workspace', onSelect }: BillingRecord08Panel03Props) {
  ...
  return (
    <section className="lis-panel lis-panel--billing" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} billing records (slice 08-03)
      </footer>
    </section>
  );
}

export default BillingRecord08Panel03;
