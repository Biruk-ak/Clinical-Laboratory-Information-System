...
export interface BillingRecord22Panel02Props {
  facilityId: string;
  title?: string;
...
/**
 * BillingRecord22Panel02 — operational panel for billing domain slice 22/02.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function BillingRecord22Panel02({ facilityId, title = 'BillingRecord22 Workspace', onSelect }: BillingRecord22Panel02Props) {
  ...
  return (
    <section className="lis-panel lis-panel--billing" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} billing records (slice 22-02)
      </footer>
    </section>
  );
}

export default BillingRecord22Panel02;
