...
export interface BillingRecord09Panel03Props {
  facilityId: string;
  title?: string;
...
/**
 * BillingRecord09Panel03 — operational panel for billing domain slice 09/03.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function BillingRecord09Panel03({ facilityId, title = 'BillingRecord09 Workspace', onSelect }: BillingRecord09Panel03Props) {
  ...
  return (
    <section className="lis-panel lis-panel--billing" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} billing records (slice 09-03)
      </footer>
    </section>
  );
}

export default BillingRecord09Panel03;
