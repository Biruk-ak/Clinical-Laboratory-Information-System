...
export interface BillingRecord24Panel01Props {
  facilityId: string;
  title?: string;
...
/**
 * BillingRecord24Panel01 — operational panel for billing domain slice 24/01.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function BillingRecord24Panel01({ facilityId, title = 'BillingRecord24 Workspace', onSelect }: BillingRecord24Panel01Props) {
  ...
  return (
    <section className="lis-panel lis-panel--billing" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} billing records (slice 24-01)
      </footer>
    </section>
  );
}

export default BillingRecord24Panel01;
