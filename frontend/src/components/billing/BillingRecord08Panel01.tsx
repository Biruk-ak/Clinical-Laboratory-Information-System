...
export interface BillingRecord08Panel01Props {
  facilityId: string;
  title?: string;
...
/**
 * BillingRecord08Panel01 — operational panel for billing domain slice 08/01.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function BillingRecord08Panel01({ facilityId, title = 'BillingRecord08 Workspace', onSelect }: BillingRecord08Panel01Props) {
  ...
  return (
    <section className="lis-panel lis-panel--billing" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} billing records (slice 08-01)
      </footer>
    </section>
  );
}

export default BillingRecord08Panel01;
