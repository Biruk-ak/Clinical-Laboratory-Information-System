...
export interface BillingRecord24Panel06Props {
  facilityId: string;
  title?: string;
...
/**
 * BillingRecord24Panel06 — operational panel for billing domain slice 24/06.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function BillingRecord24Panel06({ facilityId, title = 'BillingRecord24 Workspace', onSelect }: BillingRecord24Panel06Props) {
  ...
  return (
    <section className="lis-panel lis-panel--billing" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} billing records (slice 24-06)
      </footer>
    </section>
  );
}

export default BillingRecord24Panel06;
