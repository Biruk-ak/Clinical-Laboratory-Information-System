...
export interface BillingRecord26Panel06Props {
  facilityId: string;
  title?: string;
...
/**
 * BillingRecord26Panel06 — operational panel for billing domain slice 26/06.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function BillingRecord26Panel06({ facilityId, title = 'BillingRecord26 Workspace', onSelect }: BillingRecord26Panel06Props) {
  ...
  return (
    <section className="lis-panel lis-panel--billing" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} billing records (slice 26-06)
      </footer>
    </section>
  );
}

export default BillingRecord26Panel06;
