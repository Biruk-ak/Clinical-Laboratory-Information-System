...
export interface BillingRecord18Panel01Props {
  facilityId: string;
  title?: string;
...
/**
 * BillingRecord18Panel01 — operational panel for billing domain slice 18/01.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function BillingRecord18Panel01({ facilityId, title = 'BillingRecord18 Workspace', onSelect }: BillingRecord18Panel01Props) {
  ...
  return (
    <section className="lis-panel lis-panel--billing" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} billing records (slice 18-01)
      </footer>
    </section>
  );
}

export default BillingRecord18Panel01;
