...
export interface BillingRecord22Panel06Props {
  facilityId: string;
  title?: string;
...
/**
 * BillingRecord22Panel06 — operational panel for billing domain slice 22/06.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function BillingRecord22Panel06({ facilityId, title = 'BillingRecord22 Workspace', onSelect }: BillingRecord22Panel06Props) {
  ...
  return (
    <section className="lis-panel lis-panel--billing" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} billing records (slice 22-06)
      </footer>
    </section>
  );
}

export default BillingRecord22Panel06;
