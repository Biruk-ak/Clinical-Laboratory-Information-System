...
export interface BillingRecord20Panel06Props {
  facilityId: string;
  title?: string;
...
/**
 * BillingRecord20Panel06 — operational panel for billing domain slice 20/06.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function BillingRecord20Panel06({ facilityId, title = 'BillingRecord20 Workspace', onSelect }: BillingRecord20Panel06Props) {
  ...
  return (
    <section className="lis-panel lis-panel--billing" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} billing records (slice 20-06)
      </footer>
    </section>
  );
}

export default BillingRecord20Panel06;
