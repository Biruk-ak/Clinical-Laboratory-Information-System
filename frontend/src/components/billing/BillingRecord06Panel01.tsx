...
export interface BillingRecord06Panel01Props {
  facilityId: string;
  title?: string;
...
/**
 * BillingRecord06Panel01 — operational panel for billing domain slice 06/01.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function BillingRecord06Panel01({ facilityId, title = 'BillingRecord06 Workspace', onSelect }: BillingRecord06Panel01Props) {
  ...
  return (
    <section className="lis-panel lis-panel--billing" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} billing records (slice 06-01)
      </footer>
    </section>
  );
}

export default BillingRecord06Panel01;
