...
export interface BillingRecord26Panel02Props {
  facilityId: string;
  title?: string;
...
/**
 * BillingRecord26Panel02 — operational panel for billing domain slice 26/02.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function BillingRecord26Panel02({ facilityId, title = 'BillingRecord26 Workspace', onSelect }: BillingRecord26Panel02Props) {
  ...
  return (
    <section className="lis-panel lis-panel--billing" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} billing records (slice 26-02)
      </footer>
    </section>
  );
}

export default BillingRecord26Panel02;
