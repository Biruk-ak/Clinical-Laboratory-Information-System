...
export interface BillingRecord26Panel05Props {
  facilityId: string;
  title?: string;
...
/**
 * BillingRecord26Panel05 — operational panel for billing domain slice 26/05.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function BillingRecord26Panel05({ facilityId, title = 'BillingRecord26 Workspace', onSelect }: BillingRecord26Panel05Props) {
  ...
  return (
    <section className="lis-panel lis-panel--billing" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} billing records (slice 26-05)
      </footer>
    </section>
  );
}

export default BillingRecord26Panel05;
