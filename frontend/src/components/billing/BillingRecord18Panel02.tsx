...
export interface BillingRecord18Panel02Props {
  facilityId: string;
  title?: string;
...
/**
 * BillingRecord18Panel02 — operational panel for billing domain slice 18/02.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function BillingRecord18Panel02({ facilityId, title = 'BillingRecord18 Workspace', onSelect }: BillingRecord18Panel02Props) {
  ...
  return (
    <section className="lis-panel lis-panel--billing" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} billing records (slice 18-02)
      </footer>
    </section>
  );
}

export default BillingRecord18Panel02;
