...
export interface BillingRecord26Panel03Props {
  facilityId: string;
  title?: string;
...
/**
 * BillingRecord26Panel03 — operational panel for billing domain slice 26/03.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function BillingRecord26Panel03({ facilityId, title = 'BillingRecord26 Workspace', onSelect }: BillingRecord26Panel03Props) {
  ...
  return (
    <section className="lis-panel lis-panel--billing" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} billing records (slice 26-03)
      </footer>
    </section>
  );
}

export default BillingRecord26Panel03;
