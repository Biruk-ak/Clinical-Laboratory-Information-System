...
export interface BillingRecord08Panel06Props {
  facilityId: string;
  title?: string;
...
/**
 * BillingRecord08Panel06 — operational panel for billing domain slice 08/06.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function BillingRecord08Panel06({ facilityId, title = 'BillingRecord08 Workspace', onSelect }: BillingRecord08Panel06Props) {
  ...
  return (
    <section className="lis-panel lis-panel--billing" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} billing records (slice 08-06)
      </footer>
    </section>
  );
}

export default BillingRecord08Panel06;
