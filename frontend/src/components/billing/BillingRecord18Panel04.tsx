...
export interface BillingRecord18Panel04Props {
  facilityId: string;
  title?: string;
...
/**
 * BillingRecord18Panel04 — operational panel for billing domain slice 18/04.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function BillingRecord18Panel04({ facilityId, title = 'BillingRecord18 Workspace', onSelect }: BillingRecord18Panel04Props) {
  ...
  return (
    <section className="lis-panel lis-panel--billing" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} billing records (slice 18-04)
      </footer>
    </section>
  );
}

export default BillingRecord18Panel04;
