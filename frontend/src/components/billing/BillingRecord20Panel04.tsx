...
export interface BillingRecord20Panel04Props {
  facilityId: string;
  title?: string;
...
/**
 * BillingRecord20Panel04 — operational panel for billing domain slice 20/04.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function BillingRecord20Panel04({ facilityId, title = 'BillingRecord20 Workspace', onSelect }: BillingRecord20Panel04Props) {
  ...
  return (
    <section className="lis-panel lis-panel--billing" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} billing records (slice 20-04)
      </footer>
    </section>
  );
}

export default BillingRecord20Panel04;
