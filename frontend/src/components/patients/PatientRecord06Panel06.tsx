...
export interface PatientRecord06Panel06Props {
  facilityId: string;
  title?: string;
...
/**
 * PatientRecord06Panel06 — operational panel for patients domain slice 06/06.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function PatientRecord06Panel06({ facilityId, title = 'PatientRecord06 Workspace', onSelect }: PatientRecord06Panel06Props) {
  ...
  return (
    <section className="lis-panel lis-panel--patients" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} patients records (slice 06-06)
      </footer>
    </section>
  );
}

export default PatientRecord06Panel06;
