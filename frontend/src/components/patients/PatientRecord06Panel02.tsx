...
export interface PatientRecord06Panel02Props {
  facilityId: string;
  title?: string;
...
/**
 * PatientRecord06Panel02 — operational panel for patients domain slice 06/02.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function PatientRecord06Panel02({ facilityId, title = 'PatientRecord06 Workspace', onSelect }: PatientRecord06Panel02Props) {
  ...
  return (
    <section className="lis-panel lis-panel--patients" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} patients records (slice 06-02)
      </footer>
    </section>
  );
}

export default PatientRecord06Panel02;
