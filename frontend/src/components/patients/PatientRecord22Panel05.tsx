...
export interface PatientRecord22Panel05Props {
  facilityId: string;
  title?: string;
...
/**
 * PatientRecord22Panel05 — operational panel for patients domain slice 22/05.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function PatientRecord22Panel05({ facilityId, title = 'PatientRecord22 Workspace', onSelect }: PatientRecord22Panel05Props) {
  ...
  return (
    <section className="lis-panel lis-panel--patients" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} patients records (slice 22-05)
      </footer>
    </section>
  );
}

export default PatientRecord22Panel05;
