...
export interface PatientRecord26Panel02Props {
  facilityId: string;
  title?: string;
...
/**
 * PatientRecord26Panel02 — operational panel for patients domain slice 26/02.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function PatientRecord26Panel02({ facilityId, title = 'PatientRecord26 Workspace', onSelect }: PatientRecord26Panel02Props) {
  ...
  return (
    <section className="lis-panel lis-panel--patients" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} patients records (slice 26-02)
      </footer>
    </section>
  );
}

export default PatientRecord26Panel02;
