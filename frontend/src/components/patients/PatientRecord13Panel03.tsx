...
export interface PatientRecord13Panel03Props {
  facilityId: string;
  title?: string;
...
/**
 * PatientRecord13Panel03 — operational panel for patients domain slice 13/03.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function PatientRecord13Panel03({ facilityId, title = 'PatientRecord13 Workspace', onSelect }: PatientRecord13Panel03Props) {
  ...
  return (
    <section className="lis-panel lis-panel--patients" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} patients records (slice 13-03)
      </footer>
    </section>
  );
}

export default PatientRecord13Panel03;
