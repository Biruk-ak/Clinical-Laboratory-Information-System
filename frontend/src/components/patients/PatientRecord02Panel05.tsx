...
export interface PatientRecord02Panel05Props {
  facilityId: string;
  title?: string;
...
/**
 * PatientRecord02Panel05 — operational panel for patients domain slice 02/05.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function PatientRecord02Panel05({ facilityId, title = 'PatientRecord02 Workspace', onSelect }: PatientRecord02Panel05Props) {
  ...
  return (
    <section className="lis-panel lis-panel--patients" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} patients records (slice 02-05)
      </footer>
    </section>
  );
}

export default PatientRecord02Panel05;
