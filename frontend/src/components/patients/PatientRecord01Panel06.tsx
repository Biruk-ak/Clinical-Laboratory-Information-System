...
export interface PatientRecord01Panel06Props {
  facilityId: string;
  title?: string;
...
/**
 * PatientRecord01Panel06 — operational panel for patients domain slice 01/06.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function PatientRecord01Panel06({ facilityId, title = 'PatientRecord01 Workspace', onSelect }: PatientRecord01Panel06Props) {
  ...
  return (
    <section className="lis-panel lis-panel--patients" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} patients records (slice 01-06)
      </footer>
    </section>
  );
}

export default PatientRecord01Panel06;
