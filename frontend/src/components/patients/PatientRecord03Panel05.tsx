...
export interface PatientRecord03Panel05Props {
  facilityId: string;
  title?: string;
...
/**
 * PatientRecord03Panel05 — operational panel for patients domain slice 03/05.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function PatientRecord03Panel05({ facilityId, title = 'PatientRecord03 Workspace', onSelect }: PatientRecord03Panel05Props) {
  ...
  return (
    <section className="lis-panel lis-panel--patients" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} patients records (slice 03-05)
      </footer>
    </section>
  );
}

export default PatientRecord03Panel05;
