...
export interface PatientRecord15Panel01Props {
  facilityId: string;
  title?: string;
...
/**
 * PatientRecord15Panel01 — operational panel for patients domain slice 15/01.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function PatientRecord15Panel01({ facilityId, title = 'PatientRecord15 Workspace', onSelect }: PatientRecord15Panel01Props) {
  ...
  return (
    <section className="lis-panel lis-panel--patients" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} patients records (slice 15-01)
      </footer>
    </section>
  );
}

export default PatientRecord15Panel01;
