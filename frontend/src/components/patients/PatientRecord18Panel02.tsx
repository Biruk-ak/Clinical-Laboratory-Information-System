...
export interface PatientRecord18Panel02Props {
  facilityId: string;
  title?: string;
...
/**
 * PatientRecord18Panel02 — operational panel for patients domain slice 18/02.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function PatientRecord18Panel02({ facilityId, title = 'PatientRecord18 Workspace', onSelect }: PatientRecord18Panel02Props) {
  ...
  return (
    <section className="lis-panel lis-panel--patients" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} patients records (slice 18-02)
      </footer>
    </section>
  );
}

export default PatientRecord18Panel02;
