...
export interface PatientRecord19Panel01Props {
  facilityId: string;
  title?: string;
...
/**
 * PatientRecord19Panel01 — operational panel for patients domain slice 19/01.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function PatientRecord19Panel01({ facilityId, title = 'PatientRecord19 Workspace', onSelect }: PatientRecord19Panel01Props) {
  ...
  return (
    <section className="lis-panel lis-panel--patients" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} patients records (slice 19-01)
      </footer>
    </section>
  );
}

export default PatientRecord19Panel01;
