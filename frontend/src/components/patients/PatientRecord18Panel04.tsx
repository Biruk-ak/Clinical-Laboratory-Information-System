...
export interface PatientRecord18Panel04Props {
  facilityId: string;
  title?: string;
...
/**
 * PatientRecord18Panel04 — operational panel for patients domain slice 18/04.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function PatientRecord18Panel04({ facilityId, title = 'PatientRecord18 Workspace', onSelect }: PatientRecord18Panel04Props) {
  ...
  return (
    <section className="lis-panel lis-panel--patients" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} patients records (slice 18-04)
      </footer>
    </section>
  );
}

export default PatientRecord18Panel04;
