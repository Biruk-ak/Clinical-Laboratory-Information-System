...
export interface PatientRecord19Panel02Props {
  facilityId: string;
  title?: string;
...
/**
 * PatientRecord19Panel02 — operational panel for patients domain slice 19/02.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function PatientRecord19Panel02({ facilityId, title = 'PatientRecord19 Workspace', onSelect }: PatientRecord19Panel02Props) {
  ...
  return (
    <section className="lis-panel lis-panel--patients" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} patients records (slice 19-02)
      </footer>
    </section>
  );
}

export default PatientRecord19Panel02;
