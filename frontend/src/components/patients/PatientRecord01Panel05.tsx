...
export interface PatientRecord01Panel05Props {
  facilityId: string;
  title?: string;
...
/**
 * PatientRecord01Panel05 — operational panel for patients domain slice 01/05.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function PatientRecord01Panel05({ facilityId, title = 'PatientRecord01 Workspace', onSelect }: PatientRecord01Panel05Props) {
  ...
  return (
    <section className="lis-panel lis-panel--patients" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} patients records (slice 01-05)
      </footer>
    </section>
  );
}

export default PatientRecord01Panel05;
