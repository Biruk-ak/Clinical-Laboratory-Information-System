...
export interface PatientRecord11Panel05Props {
  facilityId: string;
  title?: string;
...
/**
 * PatientRecord11Panel05 — operational panel for patients domain slice 11/05.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function PatientRecord11Panel05({ facilityId, title = 'PatientRecord11 Workspace', onSelect }: PatientRecord11Panel05Props) {
  ...
  return (
    <section className="lis-panel lis-panel--patients" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} patients records (slice 11-05)
      </footer>
    </section>
  );
}

export default PatientRecord11Panel05;
