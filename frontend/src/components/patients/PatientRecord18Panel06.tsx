...
export interface PatientRecord18Panel06Props {
  facilityId: string;
  title?: string;
...
/**
 * PatientRecord18Panel06 — operational panel for patients domain slice 18/06.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function PatientRecord18Panel06({ facilityId, title = 'PatientRecord18 Workspace', onSelect }: PatientRecord18Panel06Props) {
  ...
  return (
    <section className="lis-panel lis-panel--patients" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} patients records (slice 18-06)
      </footer>
    </section>
  );
}

export default PatientRecord18Panel06;
