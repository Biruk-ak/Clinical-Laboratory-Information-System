...
export interface PatientRecord17Panel04Props {
  facilityId: string;
  title?: string;
...
/**
 * PatientRecord17Panel04 — operational panel for patients domain slice 17/04.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function PatientRecord17Panel04({ facilityId, title = 'PatientRecord17 Workspace', onSelect }: PatientRecord17Panel04Props) {
  ...
  return (
    <section className="lis-panel lis-panel--patients" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} patients records (slice 17-04)
      </footer>
    </section>
  );
}

export default PatientRecord17Panel04;
