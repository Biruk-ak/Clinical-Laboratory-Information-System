...
export interface PatientRecord22Panel06Props {
  facilityId: string;
  title?: string;
...
/**
 * PatientRecord22Panel06 — operational panel for patients domain slice 22/06.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function PatientRecord22Panel06({ facilityId, title = 'PatientRecord22 Workspace', onSelect }: PatientRecord22Panel06Props) {
  ...
  return (
    <section className="lis-panel lis-panel--patients" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} patients records (slice 22-06)
      </footer>
    </section>
  );
}

export default PatientRecord22Panel06;
