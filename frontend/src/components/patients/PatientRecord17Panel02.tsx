...
export interface PatientRecord17Panel02Props {
  facilityId: string;
  title?: string;
...
/**
 * PatientRecord17Panel02 — operational panel for patients domain slice 17/02.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function PatientRecord17Panel02({ facilityId, title = 'PatientRecord17 Workspace', onSelect }: PatientRecord17Panel02Props) {
  ...
  return (
    <section className="lis-panel lis-panel--patients" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} patients records (slice 17-02)
      </footer>
    </section>
  );
}

export default PatientRecord17Panel02;
