...
export interface PatientRecord03Panel04Props {
  facilityId: string;
  title?: string;
...
/**
 * PatientRecord03Panel04 — operational panel for patients domain slice 03/04.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function PatientRecord03Panel04({ facilityId, title = 'PatientRecord03 Workspace', onSelect }: PatientRecord03Panel04Props) {
  ...
  return (
    <section className="lis-panel lis-panel--patients" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} patients records (slice 03-04)
      </footer>
    </section>
  );
}

export default PatientRecord03Panel04;
