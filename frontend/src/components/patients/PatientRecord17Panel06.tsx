...
export interface PatientRecord17Panel06Props {
  facilityId: string;
  title?: string;
...
/**
 * PatientRecord17Panel06 — operational panel for patients domain slice 17/06.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function PatientRecord17Panel06({ facilityId, title = 'PatientRecord17 Workspace', onSelect }: PatientRecord17Panel06Props) {
  ...
  return (
    <section className="lis-panel lis-panel--patients" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} patients records (slice 17-06)
      </footer>
    </section>
  );
}

export default PatientRecord17Panel06;
