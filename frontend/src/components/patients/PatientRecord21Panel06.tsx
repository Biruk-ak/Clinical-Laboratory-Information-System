...
export interface PatientRecord21Panel06Props {
  facilityId: string;
  title?: string;
...
/**
 * PatientRecord21Panel06 — operational panel for patients domain slice 21/06.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function PatientRecord21Panel06({ facilityId, title = 'PatientRecord21 Workspace', onSelect }: PatientRecord21Panel06Props) {
  ...
  return (
    <section className="lis-panel lis-panel--patients" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} patients records (slice 21-06)
      </footer>
    </section>
  );
}

export default PatientRecord21Panel06;
