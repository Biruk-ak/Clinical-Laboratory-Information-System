...
export interface PatientRecord07Panel03Props {
  facilityId: string;
  title?: string;
...
/**
 * PatientRecord07Panel03 — operational panel for patients domain slice 07/03.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function PatientRecord07Panel03({ facilityId, title = 'PatientRecord07 Workspace', onSelect }: PatientRecord07Panel03Props) {
  ...
  return (
    <section className="lis-panel lis-panel--patients" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} patients records (slice 07-03)
      </footer>
    </section>
  );
}

export default PatientRecord07Panel03;
