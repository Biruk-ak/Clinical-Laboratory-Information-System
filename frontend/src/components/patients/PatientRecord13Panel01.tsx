...
export interface PatientRecord13Panel01Props {
  facilityId: string;
  title?: string;
...
/**
 * PatientRecord13Panel01 — operational panel for patients domain slice 13/01.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function PatientRecord13Panel01({ facilityId, title = 'PatientRecord13 Workspace', onSelect }: PatientRecord13Panel01Props) {
  ...
  return (
    <section className="lis-panel lis-panel--patients" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} patients records (slice 13-01)
      </footer>
    </section>
  );
}

export default PatientRecord13Panel01;
