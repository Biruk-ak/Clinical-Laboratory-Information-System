...
export interface PatientRecord21Panel01Props {
  facilityId: string;
  title?: string;
...
/**
 * PatientRecord21Panel01 — operational panel for patients domain slice 21/01.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function PatientRecord21Panel01({ facilityId, title = 'PatientRecord21 Workspace', onSelect }: PatientRecord21Panel01Props) {
  ...
  return (
    <section className="lis-panel lis-panel--patients" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} patients records (slice 21-01)
      </footer>
    </section>
  );
}

export default PatientRecord21Panel01;
