...
export interface PatientRecord03Panel02Props {
  facilityId: string;
  title?: string;
...
/**
 * PatientRecord03Panel02 — operational panel for patients domain slice 03/02.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function PatientRecord03Panel02({ facilityId, title = 'PatientRecord03 Workspace', onSelect }: PatientRecord03Panel02Props) {
  ...
  return (
    <section className="lis-panel lis-panel--patients" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} patients records (slice 03-02)
      </footer>
    </section>
  );
}

export default PatientRecord03Panel02;
