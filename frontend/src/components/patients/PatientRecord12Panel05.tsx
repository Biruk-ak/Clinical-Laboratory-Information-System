...
export interface PatientRecord12Panel05Props {
  facilityId: string;
  title?: string;
...
/**
 * PatientRecord12Panel05 — operational panel for patients domain slice 12/05.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function PatientRecord12Panel05({ facilityId, title = 'PatientRecord12 Workspace', onSelect }: PatientRecord12Panel05Props) {
  ...
  return (
    <section className="lis-panel lis-panel--patients" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} patients records (slice 12-05)
      </footer>
    </section>
  );
}

export default PatientRecord12Panel05;
