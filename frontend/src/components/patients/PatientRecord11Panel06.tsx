...
export interface PatientRecord11Panel06Props {
  facilityId: string;
  title?: string;
...
/**
 * PatientRecord11Panel06 — operational panel for patients domain slice 11/06.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function PatientRecord11Panel06({ facilityId, title = 'PatientRecord11 Workspace', onSelect }: PatientRecord11Panel06Props) {
  ...
  return (
    <section className="lis-panel lis-panel--patients" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} patients records (slice 11-06)
      </footer>
    </section>
  );
}

export default PatientRecord11Panel06;
