...
export interface PatientRecord10Panel03Props {
  facilityId: string;
  title?: string;
...
/**
 * PatientRecord10Panel03 — operational panel for patients domain slice 10/03.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function PatientRecord10Panel03({ facilityId, title = 'PatientRecord10 Workspace', onSelect }: PatientRecord10Panel03Props) {
  ...
  return (
    <section className="lis-panel lis-panel--patients" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} patients records (slice 10-03)
      </footer>
    </section>
  );
}

export default PatientRecord10Panel03;
