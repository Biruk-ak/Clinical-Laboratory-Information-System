...
export interface PatientRecord05Panel06Props {
  facilityId: string;
  title?: string;
...
/**
 * PatientRecord05Panel06 — operational panel for patients domain slice 05/06.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function PatientRecord05Panel06({ facilityId, title = 'PatientRecord05 Workspace', onSelect }: PatientRecord05Panel06Props) {
  ...
  return (
    <section className="lis-panel lis-panel--patients" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} patients records (slice 05-06)
      </footer>
    </section>
  );
}

export default PatientRecord05Panel06;
