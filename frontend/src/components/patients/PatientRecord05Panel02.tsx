...
export interface PatientRecord05Panel02Props {
  facilityId: string;
  title?: string;
...
/**
 * PatientRecord05Panel02 — operational panel for patients domain slice 05/02.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function PatientRecord05Panel02({ facilityId, title = 'PatientRecord05 Workspace', onSelect }: PatientRecord05Panel02Props) {
  ...
  return (
    <section className="lis-panel lis-panel--patients" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} patients records (slice 05-02)
      </footer>
    </section>
  );
}

export default PatientRecord05Panel02;
