...
export interface PatientRecord10Panel04Props {
  facilityId: string;
  title?: string;
...
/**
 * PatientRecord10Panel04 — operational panel for patients domain slice 10/04.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function PatientRecord10Panel04({ facilityId, title = 'PatientRecord10 Workspace', onSelect }: PatientRecord10Panel04Props) {
  ...
  return (
    <section className="lis-panel lis-panel--patients" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} patients records (slice 10-04)
      </footer>
    </section>
  );
}

export default PatientRecord10Panel04;
