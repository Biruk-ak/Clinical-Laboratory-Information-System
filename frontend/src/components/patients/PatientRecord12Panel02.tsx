...
export interface PatientRecord12Panel02Props {
  facilityId: string;
  title?: string;
...
/**
 * PatientRecord12Panel02 — operational panel for patients domain slice 12/02.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function PatientRecord12Panel02({ facilityId, title = 'PatientRecord12 Workspace', onSelect }: PatientRecord12Panel02Props) {
  ...
  return (
    <section className="lis-panel lis-panel--patients" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} patients records (slice 12-02)
      </footer>
    </section>
  );
}

export default PatientRecord12Panel02;
