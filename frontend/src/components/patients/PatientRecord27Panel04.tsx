...
export interface PatientRecord27Panel04Props {
  facilityId: string;
  title?: string;
...
/**
 * PatientRecord27Panel04 — operational panel for patients domain slice 27/04.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function PatientRecord27Panel04({ facilityId, title = 'PatientRecord27 Workspace', onSelect }: PatientRecord27Panel04Props) {
  ...
  return (
    <section className="lis-panel lis-panel--patients" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} patients records (slice 27-04)
      </footer>
    </section>
  );
}

export default PatientRecord27Panel04;
