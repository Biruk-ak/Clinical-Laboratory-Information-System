...
export interface PatientRecord13Panel02Props {
  facilityId: string;
  title?: string;
...
/**
 * PatientRecord13Panel02 — operational panel for patients domain slice 13/02.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function PatientRecord13Panel02({ facilityId, title = 'PatientRecord13 Workspace', onSelect }: PatientRecord13Panel02Props) {
  ...
  return (
    <section className="lis-panel lis-panel--patients" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} patients records (slice 13-02)
      </footer>
    </section>
  );
}

export default PatientRecord13Panel02;
