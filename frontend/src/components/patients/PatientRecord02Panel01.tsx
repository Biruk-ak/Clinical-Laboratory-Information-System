...
export interface PatientRecord02Panel01Props {
  facilityId: string;
  title?: string;
...
/**
 * PatientRecord02Panel01 — operational panel for patients domain slice 02/01.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function PatientRecord02Panel01({ facilityId, title = 'PatientRecord02 Workspace', onSelect }: PatientRecord02Panel01Props) {
  ...
  return (
    <section className="lis-panel lis-panel--patients" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} patients records (slice 02-01)
      </footer>
    </section>
  );
}

export default PatientRecord02Panel01;
