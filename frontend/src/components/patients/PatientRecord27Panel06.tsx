...
export interface PatientRecord27Panel06Props {
  facilityId: string;
  title?: string;
...
/**
 * PatientRecord27Panel06 — operational panel for patients domain slice 27/06.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function PatientRecord27Panel06({ facilityId, title = 'PatientRecord27 Workspace', onSelect }: PatientRecord27Panel06Props) {
  ...
  return (
    <section className="lis-panel lis-panel--patients" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} patients records (slice 27-06)
      </footer>
    </section>
  );
}

export default PatientRecord27Panel06;
