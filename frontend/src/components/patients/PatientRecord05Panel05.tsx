...
export interface PatientRecord05Panel05Props {
  facilityId: string;
  title?: string;
...
/**
 * PatientRecord05Panel05 — operational panel for patients domain slice 05/05.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function PatientRecord05Panel05({ facilityId, title = 'PatientRecord05 Workspace', onSelect }: PatientRecord05Panel05Props) {
  ...
  return (
    <section className="lis-panel lis-panel--patients" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} patients records (slice 05-05)
      </footer>
    </section>
  );
}

export default PatientRecord05Panel05;
