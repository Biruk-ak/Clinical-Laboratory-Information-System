...
export interface PatientRecord15Panel05Props {
  facilityId: string;
  title?: string;
...
/**
 * PatientRecord15Panel05 — operational panel for patients domain slice 15/05.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function PatientRecord15Panel05({ facilityId, title = 'PatientRecord15 Workspace', onSelect }: PatientRecord15Panel05Props) {
  ...
  return (
    <section className="lis-panel lis-panel--patients" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} patients records (slice 15-05)
      </footer>
    </section>
  );
}

export default PatientRecord15Panel05;
