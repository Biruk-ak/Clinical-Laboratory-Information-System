...
export interface PatientRecord27Panel02Props {
  facilityId: string;
  title?: string;
...
/**
 * PatientRecord27Panel02 — operational panel for patients domain slice 27/02.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function PatientRecord27Panel02({ facilityId, title = 'PatientRecord27 Workspace', onSelect }: PatientRecord27Panel02Props) {
  ...
  return (
    <section className="lis-panel lis-panel--patients" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} patients records (slice 27-02)
      </footer>
    </section>
  );
}

export default PatientRecord27Panel02;
