...
export interface PatientRecord10Panel05Props {
  facilityId: string;
  title?: string;
...
/**
 * PatientRecord10Panel05 — operational panel for patients domain slice 10/05.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function PatientRecord10Panel05({ facilityId, title = 'PatientRecord10 Workspace', onSelect }: PatientRecord10Panel05Props) {
  ...
  return (
    <section className="lis-panel lis-panel--patients" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} patients records (slice 10-05)
      </footer>
    </section>
  );
}

export default PatientRecord10Panel05;
