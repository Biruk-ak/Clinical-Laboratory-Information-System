...
export interface PatientRecord13Panel05Props {
  facilityId: string;
  title?: string;
...
/**
 * PatientRecord13Panel05 — operational panel for patients domain slice 13/05.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function PatientRecord13Panel05({ facilityId, title = 'PatientRecord13 Workspace', onSelect }: PatientRecord13Panel05Props) {
  ...
  return (
    <section className="lis-panel lis-panel--patients" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} patients records (slice 13-05)
      </footer>
    </section>
  );
}

export default PatientRecord13Panel05;
