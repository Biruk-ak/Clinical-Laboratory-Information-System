...
export interface PatientRecord07Panel06Props {
  facilityId: string;
  title?: string;
...
/**
 * PatientRecord07Panel06 — operational panel for patients domain slice 07/06.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function PatientRecord07Panel06({ facilityId, title = 'PatientRecord07 Workspace', onSelect }: PatientRecord07Panel06Props) {
  ...
  return (
    <section className="lis-panel lis-panel--patients" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} patients records (slice 07-06)
      </footer>
    </section>
  );
}

export default PatientRecord07Panel06;
