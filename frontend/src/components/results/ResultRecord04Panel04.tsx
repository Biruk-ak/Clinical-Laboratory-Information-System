...
export interface ResultRecord04Panel04Props {
  facilityId: string;
  title?: string;
...
/**
 * ResultRecord04Panel04 — operational panel for results domain slice 04/04.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function ResultRecord04Panel04({ facilityId, title = 'ResultRecord04 Workspace', onSelect }: ResultRecord04Panel04Props) {
  ...
  return (
    <section className="lis-panel lis-panel--results" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} results records (slice 04-04)
      </footer>
    </section>
  );
}

export default ResultRecord04Panel04;
