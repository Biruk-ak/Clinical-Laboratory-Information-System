...
export interface ResultRecord12Panel02Props {
  facilityId: string;
  title?: string;
...
/**
 * ResultRecord12Panel02 — operational panel for results domain slice 12/02.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function ResultRecord12Panel02({ facilityId, title = 'ResultRecord12 Workspace', onSelect }: ResultRecord12Panel02Props) {
  ...
  return (
    <section className="lis-panel lis-panel--results" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} results records (slice 12-02)
      </footer>
    </section>
  );
}

export default ResultRecord12Panel02;
