...
export interface ResultRecord04Panel05Props {
  facilityId: string;
  title?: string;
...
/**
 * ResultRecord04Panel05 — operational panel for results domain slice 04/05.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function ResultRecord04Panel05({ facilityId, title = 'ResultRecord04 Workspace', onSelect }: ResultRecord04Panel05Props) {
  ...
  return (
    <section className="lis-panel lis-panel--results" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} results records (slice 04-05)
      </footer>
    </section>
  );
}

export default ResultRecord04Panel05;
