...
export interface ResultRecord12Panel03Props {
  facilityId: string;
  title?: string;
...
/**
 * ResultRecord12Panel03 — operational panel for results domain slice 12/03.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function ResultRecord12Panel03({ facilityId, title = 'ResultRecord12 Workspace', onSelect }: ResultRecord12Panel03Props) {
  ...
  return (
    <section className="lis-panel lis-panel--results" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} results records (slice 12-03)
      </footer>
    </section>
  );
}

export default ResultRecord12Panel03;
