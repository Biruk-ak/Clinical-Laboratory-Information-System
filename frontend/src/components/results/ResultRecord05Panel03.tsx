...
export interface ResultRecord05Panel03Props {
  facilityId: string;
  title?: string;
...
/**
 * ResultRecord05Panel03 — operational panel for results domain slice 05/03.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function ResultRecord05Panel03({ facilityId, title = 'ResultRecord05 Workspace', onSelect }: ResultRecord05Panel03Props) {
  ...
  return (
    <section className="lis-panel lis-panel--results" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} results records (slice 05-03)
      </footer>
    </section>
  );
}

export default ResultRecord05Panel03;
