...
export interface ResultRecord23Panel06Props {
  facilityId: string;
  title?: string;
...
/**
 * ResultRecord23Panel06 — operational panel for results domain slice 23/06.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function ResultRecord23Panel06({ facilityId, title = 'ResultRecord23 Workspace', onSelect }: ResultRecord23Panel06Props) {
  ...
  return (
    <section className="lis-panel lis-panel--results" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} results records (slice 23-06)
      </footer>
    </section>
  );
}

export default ResultRecord23Panel06;
