...
export interface ResultRecord08Panel03Props {
  facilityId: string;
  title?: string;
...
/**
 * ResultRecord08Panel03 — operational panel for results domain slice 08/03.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function ResultRecord08Panel03({ facilityId, title = 'ResultRecord08 Workspace', onSelect }: ResultRecord08Panel03Props) {
  ...
  return (
    <section className="lis-panel lis-panel--results" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} results records (slice 08-03)
      </footer>
    </section>
  );
}

export default ResultRecord08Panel03;
