...
export interface ResultRecord27Panel05Props {
  facilityId: string;
  title?: string;
...
/**
 * ResultRecord27Panel05 — operational panel for results domain slice 27/05.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function ResultRecord27Panel05({ facilityId, title = 'ResultRecord27 Workspace', onSelect }: ResultRecord27Panel05Props) {
  ...
  return (
    <section className="lis-panel lis-panel--results" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} results records (slice 27-05)
      </footer>
    </section>
  );
}

export default ResultRecord27Panel05;
