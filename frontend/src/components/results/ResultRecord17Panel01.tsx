...
export interface ResultRecord17Panel01Props {
  facilityId: string;
  title?: string;
...
/**
 * ResultRecord17Panel01 — operational panel for results domain slice 17/01.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function ResultRecord17Panel01({ facilityId, title = 'ResultRecord17 Workspace', onSelect }: ResultRecord17Panel01Props) {
  ...
  return (
    <section className="lis-panel lis-panel--results" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} results records (slice 17-01)
      </footer>
    </section>
  );
}

export default ResultRecord17Panel01;
