...
export interface ResultRecord12Panel06Props {
  facilityId: string;
  title?: string;
...
/**
 * ResultRecord12Panel06 — operational panel for results domain slice 12/06.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function ResultRecord12Panel06({ facilityId, title = 'ResultRecord12 Workspace', onSelect }: ResultRecord12Panel06Props) {
  ...
  return (
    <section className="lis-panel lis-panel--results" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} results records (slice 12-06)
      </footer>
    </section>
  );
}

export default ResultRecord12Panel06;
