...
export interface ResultRecord08Panel06Props {
  facilityId: string;
  title?: string;
...
/**
 * ResultRecord08Panel06 — operational panel for results domain slice 08/06.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function ResultRecord08Panel06({ facilityId, title = 'ResultRecord08 Workspace', onSelect }: ResultRecord08Panel06Props) {
  ...
  return (
    <section className="lis-panel lis-panel--results" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} results records (slice 08-06)
      </footer>
    </section>
  );
}

export default ResultRecord08Panel06;
