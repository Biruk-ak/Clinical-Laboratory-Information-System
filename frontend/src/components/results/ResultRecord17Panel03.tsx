...
export interface ResultRecord17Panel03Props {
  facilityId: string;
  title?: string;
...
/**
 * ResultRecord17Panel03 — operational panel for results domain slice 17/03.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function ResultRecord17Panel03({ facilityId, title = 'ResultRecord17 Workspace', onSelect }: ResultRecord17Panel03Props) {
  ...
  return (
    <section className="lis-panel lis-panel--results" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} results records (slice 17-03)
      </footer>
    </section>
  );
}

export default ResultRecord17Panel03;
