...
export interface ResultRecord15Panel03Props {
  facilityId: string;
  title?: string;
...
/**
 * ResultRecord15Panel03 — operational panel for results domain slice 15/03.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function ResultRecord15Panel03({ facilityId, title = 'ResultRecord15 Workspace', onSelect }: ResultRecord15Panel03Props) {
  ...
  return (
    <section className="lis-panel lis-panel--results" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} results records (slice 15-03)
      </footer>
    </section>
  );
}

export default ResultRecord15Panel03;
