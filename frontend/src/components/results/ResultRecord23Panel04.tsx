...
export interface ResultRecord23Panel04Props {
  facilityId: string;
  title?: string;
...
/**
 * ResultRecord23Panel04 — operational panel for results domain slice 23/04.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function ResultRecord23Panel04({ facilityId, title = 'ResultRecord23 Workspace', onSelect }: ResultRecord23Panel04Props) {
  ...
  return (
    <section className="lis-panel lis-panel--results" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} results records (slice 23-04)
      </footer>
    </section>
  );
}

export default ResultRecord23Panel04;
