...
export interface ResultRecord10Panel03Props {
  facilityId: string;
  title?: string;
...
/**
 * ResultRecord10Panel03 — operational panel for results domain slice 10/03.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function ResultRecord10Panel03({ facilityId, title = 'ResultRecord10 Workspace', onSelect }: ResultRecord10Panel03Props) {
  ...
  return (
    <section className="lis-panel lis-panel--results" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} results records (slice 10-03)
      </footer>
    </section>
  );
}

export default ResultRecord10Panel03;
