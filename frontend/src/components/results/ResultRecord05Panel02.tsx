...
export interface ResultRecord05Panel02Props {
  facilityId: string;
  title?: string;
...
/**
 * ResultRecord05Panel02 — operational panel for results domain slice 05/02.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function ResultRecord05Panel02({ facilityId, title = 'ResultRecord05 Workspace', onSelect }: ResultRecord05Panel02Props) {
  ...
  return (
    <section className="lis-panel lis-panel--results" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} results records (slice 05-02)
      </footer>
    </section>
  );
}

export default ResultRecord05Panel02;
