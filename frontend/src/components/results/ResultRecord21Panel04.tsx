...
export interface ResultRecord21Panel04Props {
  facilityId: string;
  title?: string;
...
/**
 * ResultRecord21Panel04 — operational panel for results domain slice 21/04.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function ResultRecord21Panel04({ facilityId, title = 'ResultRecord21 Workspace', onSelect }: ResultRecord21Panel04Props) {
  ...
  return (
    <section className="lis-panel lis-panel--results" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} results records (slice 21-04)
      </footer>
    </section>
  );
}

export default ResultRecord21Panel04;
