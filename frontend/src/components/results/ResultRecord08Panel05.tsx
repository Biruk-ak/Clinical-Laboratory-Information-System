...
export interface ResultRecord08Panel05Props {
  facilityId: string;
  title?: string;
...
/**
 * ResultRecord08Panel05 — operational panel for results domain slice 08/05.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function ResultRecord08Panel05({ facilityId, title = 'ResultRecord08 Workspace', onSelect }: ResultRecord08Panel05Props) {
  ...
  return (
    <section className="lis-panel lis-panel--results" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} results records (slice 08-05)
      </footer>
    </section>
  );
}

export default ResultRecord08Panel05;
