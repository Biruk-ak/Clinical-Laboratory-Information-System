...
export interface ResultRecord21Panel06Props {
  facilityId: string;
  title?: string;
...
/**
 * ResultRecord21Panel06 — operational panel for results domain slice 21/06.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function ResultRecord21Panel06({ facilityId, title = 'ResultRecord21 Workspace', onSelect }: ResultRecord21Panel06Props) {
  ...
  return (
    <section className="lis-panel lis-panel--results" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} results records (slice 21-06)
      </footer>
    </section>
  );
}

export default ResultRecord21Panel06;
