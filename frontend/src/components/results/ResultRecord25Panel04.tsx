...
export interface ResultRecord25Panel04Props {
  facilityId: string;
  title?: string;
...
/**
 * ResultRecord25Panel04 — operational panel for results domain slice 25/04.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function ResultRecord25Panel04({ facilityId, title = 'ResultRecord25 Workspace', onSelect }: ResultRecord25Panel04Props) {
  ...
  return (
    <section className="lis-panel lis-panel--results" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} results records (slice 25-04)
      </footer>
    </section>
  );
}

export default ResultRecord25Panel04;
