...
export interface ResultRecord13Panel06Props {
  facilityId: string;
  title?: string;
...
/**
 * ResultRecord13Panel06 — operational panel for results domain slice 13/06.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function ResultRecord13Panel06({ facilityId, title = 'ResultRecord13 Workspace', onSelect }: ResultRecord13Panel06Props) {
  ...
  return (
    <section className="lis-panel lis-panel--results" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} results records (slice 13-06)
      </footer>
    </section>
  );
}

export default ResultRecord13Panel06;
