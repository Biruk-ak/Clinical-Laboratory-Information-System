...
export interface ResultRecord13Panel02Props {
  facilityId: string;
  title?: string;
...
/**
 * ResultRecord13Panel02 — operational panel for results domain slice 13/02.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function ResultRecord13Panel02({ facilityId, title = 'ResultRecord13 Workspace', onSelect }: ResultRecord13Panel02Props) {
  ...
  return (
    <section className="lis-panel lis-panel--results" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} results records (slice 13-02)
      </footer>
    </section>
  );
}

export default ResultRecord13Panel02;
