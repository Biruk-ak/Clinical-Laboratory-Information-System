...
export interface ResultRecord25Panel03Props {
  facilityId: string;
  title?: string;
...
/**
 * ResultRecord25Panel03 — operational panel for results domain slice 25/03.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function ResultRecord25Panel03({ facilityId, title = 'ResultRecord25 Workspace', onSelect }: ResultRecord25Panel03Props) {
  ...
  return (
    <section className="lis-panel lis-panel--results" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} results records (slice 25-03)
      </footer>
    </section>
  );
}

export default ResultRecord25Panel03;
