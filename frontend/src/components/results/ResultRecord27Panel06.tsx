...
export interface ResultRecord27Panel06Props {
  facilityId: string;
  title?: string;
...
/**
 * ResultRecord27Panel06 — operational panel for results domain slice 27/06.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function ResultRecord27Panel06({ facilityId, title = 'ResultRecord27 Workspace', onSelect }: ResultRecord27Panel06Props) {
  ...
  return (
    <section className="lis-panel lis-panel--results" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} results records (slice 27-06)
      </footer>
    </section>
  );
}

export default ResultRecord27Panel06;
