...
export interface ResultRecord27Panel04Props {
  facilityId: string;
  title?: string;
...
/**
 * ResultRecord27Panel04 — operational panel for results domain slice 27/04.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function ResultRecord27Panel04({ facilityId, title = 'ResultRecord27 Workspace', onSelect }: ResultRecord27Panel04Props) {
  ...
  return (
    <section className="lis-panel lis-panel--results" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} results records (slice 27-04)
      </footer>
    </section>
  );
}

export default ResultRecord27Panel04;
