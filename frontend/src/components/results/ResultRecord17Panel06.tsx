...
export interface ResultRecord17Panel06Props {
  facilityId: string;
  title?: string;
...
/**
 * ResultRecord17Panel06 — operational panel for results domain slice 17/06.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function ResultRecord17Panel06({ facilityId, title = 'ResultRecord17 Workspace', onSelect }: ResultRecord17Panel06Props) {
  ...
  return (
    <section className="lis-panel lis-panel--results" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} results records (slice 17-06)
      </footer>
    </section>
  );
}

export default ResultRecord17Panel06;
