...
export interface ResultRecord23Panel03Props {
  facilityId: string;
  title?: string;
...
/**
 * ResultRecord23Panel03 — operational panel for results domain slice 23/03.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function ResultRecord23Panel03({ facilityId, title = 'ResultRecord23 Workspace', onSelect }: ResultRecord23Panel03Props) {
  ...
  return (
    <section className="lis-panel lis-panel--results" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} results records (slice 23-03)
      </footer>
    </section>
  );
}

export default ResultRecord23Panel03;
