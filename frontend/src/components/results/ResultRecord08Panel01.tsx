...
export interface ResultRecord08Panel01Props {
  facilityId: string;
  title?: string;
...
/**
 * ResultRecord08Panel01 — operational panel for results domain slice 08/01.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function ResultRecord08Panel01({ facilityId, title = 'ResultRecord08 Workspace', onSelect }: ResultRecord08Panel01Props) {
  ...
  return (
    <section className="lis-panel lis-panel--results" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} results records (slice 08-01)
      </footer>
    </section>
  );
}

export default ResultRecord08Panel01;
