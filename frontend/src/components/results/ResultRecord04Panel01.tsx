...
export interface ResultRecord04Panel01Props {
  facilityId: string;
  title?: string;
...
/**
 * ResultRecord04Panel01 — operational panel for results domain slice 04/01.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function ResultRecord04Panel01({ facilityId, title = 'ResultRecord04 Workspace', onSelect }: ResultRecord04Panel01Props) {
  ...
  return (
    <section className="lis-panel lis-panel--results" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} results records (slice 04-01)
      </footer>
    </section>
  );
}

export default ResultRecord04Panel01;
