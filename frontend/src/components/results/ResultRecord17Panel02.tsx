...
export interface ResultRecord17Panel02Props {
  facilityId: string;
  title?: string;
...
/**
 * ResultRecord17Panel02 — operational panel for results domain slice 17/02.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function ResultRecord17Panel02({ facilityId, title = 'ResultRecord17 Workspace', onSelect }: ResultRecord17Panel02Props) {
  ...
  return (
    <section className="lis-panel lis-panel--results" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} results records (slice 17-02)
      </footer>
    </section>
  );
}

export default ResultRecord17Panel02;
