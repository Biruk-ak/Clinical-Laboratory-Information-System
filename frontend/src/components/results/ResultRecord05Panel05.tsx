...
export interface ResultRecord05Panel05Props {
  facilityId: string;
  title?: string;
...
/**
 * ResultRecord05Panel05 — operational panel for results domain slice 05/05.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function ResultRecord05Panel05({ facilityId, title = 'ResultRecord05 Workspace', onSelect }: ResultRecord05Panel05Props) {
  ...
  return (
    <section className="lis-panel lis-panel--results" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} results records (slice 05-05)
      </footer>
    </section>
  );
}

export default ResultRecord05Panel05;
