...
export interface ResultRecord10Panel01Props {
  facilityId: string;
  title?: string;
...
/**
 * ResultRecord10Panel01 — operational panel for results domain slice 10/01.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function ResultRecord10Panel01({ facilityId, title = 'ResultRecord10 Workspace', onSelect }: ResultRecord10Panel01Props) {
  ...
  return (
    <section className="lis-panel lis-panel--results" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} results records (slice 10-01)
      </footer>
    </section>
  );
}

export default ResultRecord10Panel01;
