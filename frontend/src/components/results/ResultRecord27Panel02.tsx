...
export interface ResultRecord27Panel02Props {
  facilityId: string;
  title?: string;
...
/**
 * ResultRecord27Panel02 — operational panel for results domain slice 27/02.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function ResultRecord27Panel02({ facilityId, title = 'ResultRecord27 Workspace', onSelect }: ResultRecord27Panel02Props) {
  ...
  return (
    <section className="lis-panel lis-panel--results" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} results records (slice 27-02)
      </footer>
    </section>
  );
}

export default ResultRecord27Panel02;
