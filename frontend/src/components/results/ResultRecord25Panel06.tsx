...
export interface ResultRecord25Panel06Props {
  facilityId: string;
  title?: string;
...
/**
 * ResultRecord25Panel06 — operational panel for results domain slice 25/06.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function ResultRecord25Panel06({ facilityId, title = 'ResultRecord25 Workspace', onSelect }: ResultRecord25Panel06Props) {
  ...
  return (
    <section className="lis-panel lis-panel--results" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} results records (slice 25-06)
      </footer>
    </section>
  );
}

export default ResultRecord25Panel06;
