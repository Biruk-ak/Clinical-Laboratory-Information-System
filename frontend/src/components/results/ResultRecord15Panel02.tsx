...
export interface ResultRecord15Panel02Props {
  facilityId: string;
  title?: string;
...
/**
 * ResultRecord15Panel02 — operational panel for results domain slice 15/02.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function ResultRecord15Panel02({ facilityId, title = 'ResultRecord15 Workspace', onSelect }: ResultRecord15Panel02Props) {
  ...
  return (
    <section className="lis-panel lis-panel--results" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} results records (slice 15-02)
      </footer>
    </section>
  );
}

export default ResultRecord15Panel02;
