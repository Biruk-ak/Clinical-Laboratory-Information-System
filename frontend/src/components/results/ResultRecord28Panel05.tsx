...
export interface ResultRecord28Panel05Props {
  facilityId: string;
  title?: string;
...
/**
 * ResultRecord28Panel05 — operational panel for results domain slice 28/05.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function ResultRecord28Panel05({ facilityId, title = 'ResultRecord28 Workspace', onSelect }: ResultRecord28Panel05Props) {
  ...
  return (
    <section className="lis-panel lis-panel--results" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} results records (slice 28-05)
      </footer>
    </section>
  );
}

export default ResultRecord28Panel05;
