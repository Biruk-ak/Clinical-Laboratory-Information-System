...
export interface ResultRecord13Panel05Props {
  facilityId: string;
  title?: string;
...
/**
 * ResultRecord13Panel05 — operational panel for results domain slice 13/05.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function ResultRecord13Panel05({ facilityId, title = 'ResultRecord13 Workspace', onSelect }: ResultRecord13Panel05Props) {
  ...
  return (
    <section className="lis-panel lis-panel--results" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} results records (slice 13-05)
      </footer>
    </section>
  );
}

export default ResultRecord13Panel05;
