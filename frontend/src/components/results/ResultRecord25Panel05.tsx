...
export interface ResultRecord25Panel05Props {
  facilityId: string;
  title?: string;
...
/**
 * ResultRecord25Panel05 — operational panel for results domain slice 25/05.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function ResultRecord25Panel05({ facilityId, title = 'ResultRecord25 Workspace', onSelect }: ResultRecord25Panel05Props) {
  ...
  return (
    <section className="lis-panel lis-panel--results" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} results records (slice 25-05)
      </footer>
    </section>
  );
}

export default ResultRecord25Panel05;
