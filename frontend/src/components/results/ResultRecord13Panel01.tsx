...
export interface ResultRecord13Panel01Props {
  facilityId: string;
  title?: string;
...
/**
 * ResultRecord13Panel01 — operational panel for results domain slice 13/01.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function ResultRecord13Panel01({ facilityId, title = 'ResultRecord13 Workspace', onSelect }: ResultRecord13Panel01Props) {
  ...
  return (
    <section className="lis-panel lis-panel--results" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} results records (slice 13-01)
      </footer>
    </section>
  );
}

export default ResultRecord13Panel01;
