...
export interface ResultRecord23Panel02Props {
  facilityId: string;
  title?: string;
...
/**
 * ResultRecord23Panel02 — operational panel for results domain slice 23/02.
 * Supports list, filter by active status, and soft-archive actions.
 */
export function ResultRecord23Panel02({ facilityId, title = 'ResultRecord23 Workspace', onSelect }: ResultRecord23Panel02Props) {
  ...
  return (
    <section className="lis-panel lis-panel--results" aria-label={title}>
      ...
      <footer className="lis-panel__footer">
        Showing {filtered.length} of {items.length} results records (slice 23-02)
      </footer>
    </section>
  );
}

export default ResultRecord23Panel02;
