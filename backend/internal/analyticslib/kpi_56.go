...
// KPI56Input captures inputs for KPI calculation set 56.
type KPI56Input struct {
	Ordered   float64
	Completed float64
	Rejected  float64
	TATMinutes float64
...
// KPI56Result holds derived operational metrics.
type KPI56Result struct {
...
// ComputeKPI56 derives a weighted operational score.
func ComputeKPI56(in KPI56Input) KPI56Result {
