...
// KPI80Input captures inputs for KPI calculation set 80.
type KPI80Input struct {
	Ordered   float64
	Completed float64
	Rejected  float64
	TATMinutes float64
...
// KPI80Result holds derived operational metrics.
type KPI80Result struct {
...
// ComputeKPI80 derives a weighted operational score.
func ComputeKPI80(in KPI80Input) KPI80Result {
