...
// KPI10Input captures inputs for KPI calculation set 10.
type KPI10Input struct {
	Ordered   float64
	Completed float64
	Rejected  float64
	TATMinutes float64
...
// KPI10Result holds derived operational metrics.
type KPI10Result struct {
...
// ComputeKPI10 derives a weighted operational score.
func ComputeKPI10(in KPI10Input) KPI10Result {
