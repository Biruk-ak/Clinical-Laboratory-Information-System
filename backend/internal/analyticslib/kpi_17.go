...
// KPI17Input captures inputs for KPI calculation set 17.
type KPI17Input struct {
	Ordered   float64
	Completed float64
	Rejected  float64
	TATMinutes float64
...
// KPI17Result holds derived operational metrics.
type KPI17Result struct {
...
// ComputeKPI17 derives a weighted operational score.
func ComputeKPI17(in KPI17Input) KPI17Result {
