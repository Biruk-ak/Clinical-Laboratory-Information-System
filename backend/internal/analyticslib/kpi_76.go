...
// KPI76Input captures inputs for KPI calculation set 76.
type KPI76Input struct {
	Ordered   float64
	Completed float64
	Rejected  float64
	TATMinutes float64
...
// KPI76Result holds derived operational metrics.
type KPI76Result struct {
...
// ComputeKPI76 derives a weighted operational score.
func ComputeKPI76(in KPI76Input) KPI76Result {
