...
// KPI44Input captures inputs for KPI calculation set 44.
type KPI44Input struct {
	Ordered   float64
	Completed float64
	Rejected  float64
	TATMinutes float64
...
// KPI44Result holds derived operational metrics.
type KPI44Result struct {
...
// ComputeKPI44 derives a weighted operational score.
func ComputeKPI44(in KPI44Input) KPI44Result {
