...
// KPI46Input captures inputs for KPI calculation set 46.
type KPI46Input struct {
	Ordered   float64
	Completed float64
	Rejected  float64
	TATMinutes float64
...
// KPI46Result holds derived operational metrics.
type KPI46Result struct {
...
// ComputeKPI46 derives a weighted operational score.
func ComputeKPI46(in KPI46Input) KPI46Result {
