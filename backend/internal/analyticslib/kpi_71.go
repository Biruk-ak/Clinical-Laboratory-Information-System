...
// KPI71Input captures inputs for KPI calculation set 71.
type KPI71Input struct {
	Ordered   float64
	Completed float64
	Rejected  float64
	TATMinutes float64
...
// KPI71Result holds derived operational metrics.
type KPI71Result struct {
...
// ComputeKPI71 derives a weighted operational score.
func ComputeKPI71(in KPI71Input) KPI71Result {
