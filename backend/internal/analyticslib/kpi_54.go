...
// KPI54Input captures inputs for KPI calculation set 54.
type KPI54Input struct {
	Ordered   float64
	Completed float64
	Rejected  float64
	TATMinutes float64
...
// KPI54Result holds derived operational metrics.
type KPI54Result struct {
...
// ComputeKPI54 derives a weighted operational score.
func ComputeKPI54(in KPI54Input) KPI54Result {
