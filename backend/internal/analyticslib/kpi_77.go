...
// KPI77Input captures inputs for KPI calculation set 77.
type KPI77Input struct {
	Ordered   float64
	Completed float64
	Rejected  float64
	TATMinutes float64
...
// KPI77Result holds derived operational metrics.
type KPI77Result struct {
...
// ComputeKPI77 derives a weighted operational score.
func ComputeKPI77(in KPI77Input) KPI77Result {
