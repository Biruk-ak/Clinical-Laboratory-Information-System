...
// KPI39Input captures inputs for KPI calculation set 39.
type KPI39Input struct {
	Ordered   float64
	Completed float64
	Rejected  float64
	TATMinutes float64
...
// KPI39Result holds derived operational metrics.
type KPI39Result struct {
...
// ComputeKPI39 derives a weighted operational score.
func ComputeKPI39(in KPI39Input) KPI39Result {
