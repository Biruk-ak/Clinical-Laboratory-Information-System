...
// KPI49Input captures inputs for KPI calculation set 49.
type KPI49Input struct {
	Ordered   float64
	Completed float64
	Rejected  float64
	TATMinutes float64
...
// KPI49Result holds derived operational metrics.
type KPI49Result struct {
...
// ComputeKPI49 derives a weighted operational score.
func ComputeKPI49(in KPI49Input) KPI49Result {
