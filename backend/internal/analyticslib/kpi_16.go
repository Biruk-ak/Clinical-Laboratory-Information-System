...
// KPI16Input captures inputs for KPI calculation set 16.
type KPI16Input struct {
	Ordered   float64
	Completed float64
	Rejected  float64
	TATMinutes float64
...
// KPI16Result holds derived operational metrics.
type KPI16Result struct {
...
// ComputeKPI16 derives a weighted operational score.
func ComputeKPI16(in KPI16Input) KPI16Result {
