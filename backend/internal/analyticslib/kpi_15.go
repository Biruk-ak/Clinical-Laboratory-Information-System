...
// KPI15Input captures inputs for KPI calculation set 15.
type KPI15Input struct {
	Ordered   float64
	Completed float64
	Rejected  float64
	TATMinutes float64
...
// KPI15Result holds derived operational metrics.
type KPI15Result struct {
...
// ComputeKPI15 derives a weighted operational score.
func ComputeKPI15(in KPI15Input) KPI15Result {
