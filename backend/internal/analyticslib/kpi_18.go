...
// KPI18Input captures inputs for KPI calculation set 18.
type KPI18Input struct {
	Ordered   float64
	Completed float64
	Rejected  float64
	TATMinutes float64
...
// KPI18Result holds derived operational metrics.
type KPI18Result struct {
...
// ComputeKPI18 derives a weighted operational score.
func ComputeKPI18(in KPI18Input) KPI18Result {
