...
// KPI29Input captures inputs for KPI calculation set 29.
type KPI29Input struct {
	Ordered   float64
	Completed float64
	Rejected  float64
	TATMinutes float64
...
// KPI29Result holds derived operational metrics.
type KPI29Result struct {
...
// ComputeKPI29 derives a weighted operational score.
func ComputeKPI29(in KPI29Input) KPI29Result {
