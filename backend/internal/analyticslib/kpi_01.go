...
// KPI01Input captures inputs for KPI calculation set 01.
type KPI01Input struct {
	Ordered   float64
	Completed float64
	Rejected  float64
	TATMinutes float64
...
// KPI01Result holds derived operational metrics.
type KPI01Result struct {
...
// ComputeKPI01 derives a weighted operational score.
func ComputeKPI01(in KPI01Input) KPI01Result {
