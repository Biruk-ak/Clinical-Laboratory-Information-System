...
// KPI34Input captures inputs for KPI calculation set 34.
type KPI34Input struct {
	Ordered   float64
	Completed float64
	Rejected  float64
	TATMinutes float64
...
// KPI34Result holds derived operational metrics.
type KPI34Result struct {
...
// ComputeKPI34 derives a weighted operational score.
func ComputeKPI34(in KPI34Input) KPI34Result {
