...
// KPI55Input captures inputs for KPI calculation set 55.
type KPI55Input struct {
	Ordered   float64
	Completed float64
	Rejected  float64
	TATMinutes float64
...
// KPI55Result holds derived operational metrics.
type KPI55Result struct {
...
// ComputeKPI55 derives a weighted operational score.
func ComputeKPI55(in KPI55Input) KPI55Result {
