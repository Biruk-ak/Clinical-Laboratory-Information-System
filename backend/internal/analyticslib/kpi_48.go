...
// KPI48Input captures inputs for KPI calculation set 48.
type KPI48Input struct {
	Ordered   float64
	Completed float64
	Rejected  float64
	TATMinutes float64
...
// KPI48Result holds derived operational metrics.
type KPI48Result struct {
...
// ComputeKPI48 derives a weighted operational score.
func ComputeKPI48(in KPI48Input) KPI48Result {
