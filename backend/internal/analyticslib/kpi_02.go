...
// KPI02Input captures inputs for KPI calculation set 02.
type KPI02Input struct {
	Ordered   float64
	Completed float64
	Rejected  float64
	TATMinutes float64
...
// KPI02Result holds derived operational metrics.
type KPI02Result struct {
...
// ComputeKPI02 derives a weighted operational score.
func ComputeKPI02(in KPI02Input) KPI02Result {
