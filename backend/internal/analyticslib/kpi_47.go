...
// KPI47Input captures inputs for KPI calculation set 47.
type KPI47Input struct {
	Ordered   float64
	Completed float64
	Rejected  float64
	TATMinutes float64
...
// KPI47Result holds derived operational metrics.
type KPI47Result struct {
...
// ComputeKPI47 derives a weighted operational score.
func ComputeKPI47(in KPI47Input) KPI47Result {
