...
// KPI23Input captures inputs for KPI calculation set 23.
type KPI23Input struct {
	Ordered   float64
	Completed float64
	Rejected  float64
	TATMinutes float64
...
// KPI23Result holds derived operational metrics.
type KPI23Result struct {
...
// ComputeKPI23 derives a weighted operational score.
func ComputeKPI23(in KPI23Input) KPI23Result {
