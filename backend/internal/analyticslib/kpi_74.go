...
// KPI74Input captures inputs for KPI calculation set 74.
type KPI74Input struct {
	Ordered   float64
	Completed float64
	Rejected  float64
	TATMinutes float64
...
// KPI74Result holds derived operational metrics.
type KPI74Result struct {
...
// ComputeKPI74 derives a weighted operational score.
func ComputeKPI74(in KPI74Input) KPI74Result {
