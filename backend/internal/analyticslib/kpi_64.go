...
// KPI64Input captures inputs for KPI calculation set 64.
type KPI64Input struct {
	Ordered   float64
	Completed float64
	Rejected  float64
	TATMinutes float64
...
// KPI64Result holds derived operational metrics.
type KPI64Result struct {
...
// ComputeKPI64 derives a weighted operational score.
func ComputeKPI64(in KPI64Input) KPI64Result {
