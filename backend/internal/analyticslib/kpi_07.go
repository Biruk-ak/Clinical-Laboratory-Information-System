...
// KPI07Input captures inputs for KPI calculation set 07.
type KPI07Input struct {
	Ordered   float64
	Completed float64
	Rejected  float64
	TATMinutes float64
...
// KPI07Result holds derived operational metrics.
type KPI07Result struct {
...
// ComputeKPI07 derives a weighted operational score.
func ComputeKPI07(in KPI07Input) KPI07Result {
