...
// KPI21Input captures inputs for KPI calculation set 21.
type KPI21Input struct {
	Ordered   float64
	Completed float64
	Rejected  float64
	TATMinutes float64
...
// KPI21Result holds derived operational metrics.
type KPI21Result struct {
...
// ComputeKPI21 derives a weighted operational score.
func ComputeKPI21(in KPI21Input) KPI21Result {
