...
// KPI27Input captures inputs for KPI calculation set 27.
type KPI27Input struct {
	Ordered   float64
	Completed float64
	Rejected  float64
	TATMinutes float64
...
// KPI27Result holds derived operational metrics.
type KPI27Result struct {
...
// ComputeKPI27 derives a weighted operational score.
func ComputeKPI27(in KPI27Input) KPI27Result {
