...
// KPI57Input captures inputs for KPI calculation set 57.
type KPI57Input struct {
	Ordered   float64
	Completed float64
	Rejected  float64
	TATMinutes float64
...
// KPI57Result holds derived operational metrics.
type KPI57Result struct {
...
// ComputeKPI57 derives a weighted operational score.
func ComputeKPI57(in KPI57Input) KPI57Result {
