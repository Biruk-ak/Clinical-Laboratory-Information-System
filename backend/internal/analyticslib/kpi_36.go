...
// KPI36Input captures inputs for KPI calculation set 36.
type KPI36Input struct {
	Ordered   float64
	Completed float64
	Rejected  float64
	TATMinutes float64
...
// KPI36Result holds derived operational metrics.
type KPI36Result struct {
...
// ComputeKPI36 derives a weighted operational score.
func ComputeKPI36(in KPI36Input) KPI36Result {
