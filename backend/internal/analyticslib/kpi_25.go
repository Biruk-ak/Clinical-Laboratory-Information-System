...
// KPI25Input captures inputs for KPI calculation set 25.
type KPI25Input struct {
	Ordered   float64
	Completed float64
	Rejected  float64
	TATMinutes float64
...
// KPI25Result holds derived operational metrics.
type KPI25Result struct {
...
// ComputeKPI25 derives a weighted operational score.
func ComputeKPI25(in KPI25Input) KPI25Result {
