...
// KPI73Input captures inputs for KPI calculation set 73.
type KPI73Input struct {
	Ordered   float64
	Completed float64
	Rejected  float64
	TATMinutes float64
...
// KPI73Result holds derived operational metrics.
type KPI73Result struct {
...
// ComputeKPI73 derives a weighted operational score.
func ComputeKPI73(in KPI73Input) KPI73Result {
