...
// KPI04Input captures inputs for KPI calculation set 04.
type KPI04Input struct {
	Ordered   float64
	Completed float64
	Rejected  float64
	TATMinutes float64
...
// KPI04Result holds derived operational metrics.
type KPI04Result struct {
...
// ComputeKPI04 derives a weighted operational score.
func ComputeKPI04(in KPI04Input) KPI04Result {
