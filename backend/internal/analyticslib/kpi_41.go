...
// KPI41Input captures inputs for KPI calculation set 41.
type KPI41Input struct {
	Ordered   float64
	Completed float64
	Rejected  float64
	TATMinutes float64
...
// KPI41Result holds derived operational metrics.
type KPI41Result struct {
...
// ComputeKPI41 derives a weighted operational score.
func ComputeKPI41(in KPI41Input) KPI41Result {
