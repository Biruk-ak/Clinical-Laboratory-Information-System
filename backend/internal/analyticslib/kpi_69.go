...
// KPI69Input captures inputs for KPI calculation set 69.
type KPI69Input struct {
	Ordered   float64
	Completed float64
	Rejected  float64
	TATMinutes float64
...
// KPI69Result holds derived operational metrics.
type KPI69Result struct {
...
// ComputeKPI69 derives a weighted operational score.
func ComputeKPI69(in KPI69Input) KPI69Result {
