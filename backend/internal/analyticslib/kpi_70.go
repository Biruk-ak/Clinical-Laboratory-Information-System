...
// KPI70Input captures inputs for KPI calculation set 70.
type KPI70Input struct {
	Ordered   float64
	Completed float64
	Rejected  float64
	TATMinutes float64
...
// KPI70Result holds derived operational metrics.
type KPI70Result struct {
...
// ComputeKPI70 derives a weighted operational score.
func ComputeKPI70(in KPI70Input) KPI70Result {
