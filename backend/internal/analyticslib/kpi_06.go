...
// KPI06Input captures inputs for KPI calculation set 06.
type KPI06Input struct {
	Ordered   float64
	Completed float64
	Rejected  float64
	TATMinutes float64
...
// KPI06Result holds derived operational metrics.
type KPI06Result struct {
...
// ComputeKPI06 derives a weighted operational score.
func ComputeKPI06(in KPI06Input) KPI06Result {
