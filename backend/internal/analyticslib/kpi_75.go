...
// KPI75Input captures inputs for KPI calculation set 75.
type KPI75Input struct {
	Ordered   float64
	Completed float64
	Rejected  float64
	TATMinutes float64
...
// KPI75Result holds derived operational metrics.
type KPI75Result struct {
...
// ComputeKPI75 derives a weighted operational score.
func ComputeKPI75(in KPI75Input) KPI75Result {
