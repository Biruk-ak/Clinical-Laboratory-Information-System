...
// KPI65Input captures inputs for KPI calculation set 65.
type KPI65Input struct {
	Ordered   float64
	Completed float64
	Rejected  float64
	TATMinutes float64
...
// KPI65Result holds derived operational metrics.
type KPI65Result struct {
...
// ComputeKPI65 derives a weighted operational score.
func ComputeKPI65(in KPI65Input) KPI65Result {
