...
// KPI61Input captures inputs for KPI calculation set 61.
type KPI61Input struct {
	Ordered   float64
	Completed float64
	Rejected  float64
	TATMinutes float64
...
// KPI61Result holds derived operational metrics.
type KPI61Result struct {
...
// ComputeKPI61 derives a weighted operational score.
func ComputeKPI61(in KPI61Input) KPI61Result {
