...
// KPI52Input captures inputs for KPI calculation set 52.
type KPI52Input struct {
	Ordered   float64
	Completed float64
	Rejected  float64
	TATMinutes float64
...
// KPI52Result holds derived operational metrics.
type KPI52Result struct {
...
// ComputeKPI52 derives a weighted operational score.
func ComputeKPI52(in KPI52Input) KPI52Result {
