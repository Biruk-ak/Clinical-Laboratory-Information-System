...
// KPI72Input captures inputs for KPI calculation set 72.
type KPI72Input struct {
	Ordered   float64
	Completed float64
	Rejected  float64
	TATMinutes float64
...
// KPI72Result holds derived operational metrics.
type KPI72Result struct {
...
// ComputeKPI72 derives a weighted operational score.
func ComputeKPI72(in KPI72Input) KPI72Result {
