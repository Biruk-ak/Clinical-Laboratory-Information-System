...
// KPI31Input captures inputs for KPI calculation set 31.
type KPI31Input struct {
	Ordered   float64
	Completed float64
	Rejected  float64
	TATMinutes float64
...
// KPI31Result holds derived operational metrics.
type KPI31Result struct {
...
// ComputeKPI31 derives a weighted operational score.
func ComputeKPI31(in KPI31Input) KPI31Result {
