...
// KPI59Input captures inputs for KPI calculation set 59.
type KPI59Input struct {
	Ordered   float64
	Completed float64
	Rejected  float64
	TATMinutes float64
...
// KPI59Result holds derived operational metrics.
type KPI59Result struct {
...
// ComputeKPI59 derives a weighted operational score.
func ComputeKPI59(in KPI59Input) KPI59Result {
