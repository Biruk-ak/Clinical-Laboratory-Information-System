...
// KPI42Input captures inputs for KPI calculation set 42.
type KPI42Input struct {
	Ordered   float64
	Completed float64
	Rejected  float64
	TATMinutes float64
...
// KPI42Result holds derived operational metrics.
type KPI42Result struct {
...
// ComputeKPI42 derives a weighted operational score.
func ComputeKPI42(in KPI42Input) KPI42Result {
