...
// KPI05Input captures inputs for KPI calculation set 05.
type KPI05Input struct {
	Ordered   float64
	Completed float64
	Rejected  float64
	TATMinutes float64
...
// KPI05Result holds derived operational metrics.
type KPI05Result struct {
...
// ComputeKPI05 derives a weighted operational score.
func ComputeKPI05(in KPI05Input) KPI05Result {
