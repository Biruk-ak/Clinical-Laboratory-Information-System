...
// KPI24Input captures inputs for KPI calculation set 24.
type KPI24Input struct {
	Ordered   float64
	Completed float64
	Rejected  float64
	TATMinutes float64
...
// KPI24Result holds derived operational metrics.
type KPI24Result struct {
...
// ComputeKPI24 derives a weighted operational score.
func ComputeKPI24(in KPI24Input) KPI24Result {
