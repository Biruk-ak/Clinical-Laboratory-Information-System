...
// KPI30Input captures inputs for KPI calculation set 30.
type KPI30Input struct {
	Ordered   float64
	Completed float64
	Rejected  float64
	TATMinutes float64
...
// KPI30Result holds derived operational metrics.
type KPI30Result struct {
...
// ComputeKPI30 derives a weighted operational score.
func ComputeKPI30(in KPI30Input) KPI30Result {
