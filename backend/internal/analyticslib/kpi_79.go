...
// KPI79Input captures inputs for KPI calculation set 79.
type KPI79Input struct {
	Ordered   float64
	Completed float64
	Rejected  float64
	TATMinutes float64
...
// KPI79Result holds derived operational metrics.
type KPI79Result struct {
...
// ComputeKPI79 derives a weighted operational score.
func ComputeKPI79(in KPI79Input) KPI79Result {
