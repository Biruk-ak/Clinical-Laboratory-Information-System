...
// KPI33Input captures inputs for KPI calculation set 33.
type KPI33Input struct {
	Ordered   float64
	Completed float64
	Rejected  float64
	TATMinutes float64
...
// KPI33Result holds derived operational metrics.
type KPI33Result struct {
...
// ComputeKPI33 derives a weighted operational score.
func ComputeKPI33(in KPI33Input) KPI33Result {
