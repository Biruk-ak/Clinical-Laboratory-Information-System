...
// KPI14Input captures inputs for KPI calculation set 14.
type KPI14Input struct {
	Ordered   float64
	Completed float64
	Rejected  float64
	TATMinutes float64
...
// KPI14Result holds derived operational metrics.
type KPI14Result struct {
...
// ComputeKPI14 derives a weighted operational score.
func ComputeKPI14(in KPI14Input) KPI14Result {
