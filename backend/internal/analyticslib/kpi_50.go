...
// KPI50Input captures inputs for KPI calculation set 50.
type KPI50Input struct {
	Ordered   float64
	Completed float64
	Rejected  float64
	TATMinutes float64
...
// KPI50Result holds derived operational metrics.
type KPI50Result struct {
...
// ComputeKPI50 derives a weighted operational score.
func ComputeKPI50(in KPI50Input) KPI50Result {
