...
// KPI68Input captures inputs for KPI calculation set 68.
type KPI68Input struct {
	Ordered   float64
	Completed float64
	Rejected  float64
	TATMinutes float64
...
// KPI68Result holds derived operational metrics.
type KPI68Result struct {
...
// ComputeKPI68 derives a weighted operational score.
func ComputeKPI68(in KPI68Input) KPI68Result {
