...
// KPI45Input captures inputs for KPI calculation set 45.
type KPI45Input struct {
	Ordered   float64
	Completed float64
	Rejected  float64
	TATMinutes float64
...
// KPI45Result holds derived operational metrics.
type KPI45Result struct {
...
// ComputeKPI45 derives a weighted operational score.
func ComputeKPI45(in KPI45Input) KPI45Result {
