...
// KPI11Input captures inputs for KPI calculation set 11.
type KPI11Input struct {
	Ordered   float64
	Completed float64
	Rejected  float64
	TATMinutes float64
...
// KPI11Result holds derived operational metrics.
type KPI11Result struct {
...
// ComputeKPI11 derives a weighted operational score.
func ComputeKPI11(in KPI11Input) KPI11Result {
