...
// KPI13Input captures inputs for KPI calculation set 13.
type KPI13Input struct {
	Ordered   float64
	Completed float64
	Rejected  float64
	TATMinutes float64
...
// KPI13Result holds derived operational metrics.
type KPI13Result struct {
...
// ComputeKPI13 derives a weighted operational score.
func ComputeKPI13(in KPI13Input) KPI13Result {
