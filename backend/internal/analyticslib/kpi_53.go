...
// KPI53Input captures inputs for KPI calculation set 53.
type KPI53Input struct {
	Ordered   float64
	Completed float64
	Rejected  float64
	TATMinutes float64
...
// KPI53Result holds derived operational metrics.
type KPI53Result struct {
...
// ComputeKPI53 derives a weighted operational score.
func ComputeKPI53(in KPI53Input) KPI53Result {
