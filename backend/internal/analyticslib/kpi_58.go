...
// KPI58Input captures inputs for KPI calculation set 58.
type KPI58Input struct {
	Ordered   float64
	Completed float64
	Rejected  float64
	TATMinutes float64
...
// KPI58Result holds derived operational metrics.
type KPI58Result struct {
...
// ComputeKPI58 derives a weighted operational score.
func ComputeKPI58(in KPI58Input) KPI58Result {
