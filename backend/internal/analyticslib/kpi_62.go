...
// KPI62Input captures inputs for KPI calculation set 62.
type KPI62Input struct {
	Ordered   float64
	Completed float64
	Rejected  float64
	TATMinutes float64
...
// KPI62Result holds derived operational metrics.
type KPI62Result struct {
...
// ComputeKPI62 derives a weighted operational score.
func ComputeKPI62(in KPI62Input) KPI62Result {
