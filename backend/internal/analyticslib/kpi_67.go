...
// KPI67Input captures inputs for KPI calculation set 67.
type KPI67Input struct {
	Ordered   float64
	Completed float64
	Rejected  float64
	TATMinutes float64
...
// KPI67Result holds derived operational metrics.
type KPI67Result struct {
...
// ComputeKPI67 derives a weighted operational score.
func ComputeKPI67(in KPI67Input) KPI67Result {
