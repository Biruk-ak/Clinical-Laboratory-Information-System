...
// KPI43Input captures inputs for KPI calculation set 43.
type KPI43Input struct {
	Ordered   float64
	Completed float64
	Rejected  float64
	TATMinutes float64
...
// KPI43Result holds derived operational metrics.
type KPI43Result struct {
...
// ComputeKPI43 derives a weighted operational score.
func ComputeKPI43(in KPI43Input) KPI43Result {
