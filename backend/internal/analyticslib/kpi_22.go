...
// KPI22Input captures inputs for KPI calculation set 22.
type KPI22Input struct {
	Ordered   float64
	Completed float64
	Rejected  float64
	TATMinutes float64
...
// KPI22Result holds derived operational metrics.
type KPI22Result struct {
...
// ComputeKPI22 derives a weighted operational score.
func ComputeKPI22(in KPI22Input) KPI22Result {
