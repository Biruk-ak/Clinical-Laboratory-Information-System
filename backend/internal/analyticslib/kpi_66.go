...
// KPI66Input captures inputs for KPI calculation set 66.
type KPI66Input struct {
	Ordered   float64
	Completed float64
	Rejected  float64
	TATMinutes float64
...
// KPI66Result holds derived operational metrics.
type KPI66Result struct {
...
// ComputeKPI66 derives a weighted operational score.
func ComputeKPI66(in KPI66Input) KPI66Result {
