...
// KPI60Input captures inputs for KPI calculation set 60.
type KPI60Input struct {
	Ordered   float64
	Completed float64
	Rejected  float64
	TATMinutes float64
...
// KPI60Result holds derived operational metrics.
type KPI60Result struct {
...
// ComputeKPI60 derives a weighted operational score.
func ComputeKPI60(in KPI60Input) KPI60Result {
