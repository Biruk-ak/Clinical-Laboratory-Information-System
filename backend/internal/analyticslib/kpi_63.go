...
// KPI63Input captures inputs for KPI calculation set 63.
type KPI63Input struct {
	Ordered   float64
	Completed float64
	Rejected  float64
	TATMinutes float64
...
// KPI63Result holds derived operational metrics.
type KPI63Result struct {
...
// ComputeKPI63 derives a weighted operational score.
func ComputeKPI63(in KPI63Input) KPI63Result {
