...
// KPI26Input captures inputs for KPI calculation set 26.
type KPI26Input struct {
	Ordered   float64
	Completed float64
	Rejected  float64
	TATMinutes float64
...
// KPI26Result holds derived operational metrics.
type KPI26Result struct {
...
// ComputeKPI26 derives a weighted operational score.
func ComputeKPI26(in KPI26Input) KPI26Result {
