...
// KPI32Input captures inputs for KPI calculation set 32.
type KPI32Input struct {
	Ordered   float64
	Completed float64
	Rejected  float64
	TATMinutes float64
...
// KPI32Result holds derived operational metrics.
type KPI32Result struct {
...
// ComputeKPI32 derives a weighted operational score.
func ComputeKPI32(in KPI32Input) KPI32Result {
