...
// KPI37Input captures inputs for KPI calculation set 37.
type KPI37Input struct {
	Ordered   float64
	Completed float64
	Rejected  float64
	TATMinutes float64
...
// KPI37Result holds derived operational metrics.
type KPI37Result struct {
...
// ComputeKPI37 derives a weighted operational score.
func ComputeKPI37(in KPI37Input) KPI37Result {
