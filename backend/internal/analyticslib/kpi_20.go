...
// KPI20Input captures inputs for KPI calculation set 20.
type KPI20Input struct {
	Ordered   float64
	Completed float64
	Rejected  float64
	TATMinutes float64
...
// KPI20Result holds derived operational metrics.
type KPI20Result struct {
...
// ComputeKPI20 derives a weighted operational score.
func ComputeKPI20(in KPI20Input) KPI20Result {
