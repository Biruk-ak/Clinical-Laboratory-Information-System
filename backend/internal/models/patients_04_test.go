...
func TestPatientRecord04Validate(t *testing.T) {
	t.Parallel()
	valid := &models.PatientRecord04{
		ID: "id-4", DisplayName: "Sample PatientRecord04", Status: "active", Priority: 10,
	}
...
func TestPatientRecord04Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.PatientRecord04{
		ID: "id-4", DisplayName: "Lifecycle PatientRecord04", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
