...
func TestResultRecord06Validate(t *testing.T) {
	t.Parallel()
	valid := &models.ResultRecord06{
		ID: "id-6", DisplayName: "Sample ResultRecord06", Status: "active", Priority: 10,
	}
...
func TestResultRecord06Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.ResultRecord06{
		ID: "id-6", DisplayName: "Lifecycle ResultRecord06", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
