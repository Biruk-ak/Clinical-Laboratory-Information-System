...
func TestReportRecord05Validate(t *testing.T) {
	t.Parallel()
	valid := &models.ReportRecord05{
		ID: "id-5", DisplayName: "Sample ReportRecord05", Status: "active", Priority: 10,
	}
...
func TestReportRecord05Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.ReportRecord05{
		ID: "id-5", DisplayName: "Lifecycle ReportRecord05", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
