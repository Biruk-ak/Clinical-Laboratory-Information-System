...
func TestInventoryRecord02Validate(t *testing.T) {
	t.Parallel()
	valid := &models.InventoryRecord02{
		ID: "id-2", DisplayName: "Sample InventoryRecord02", Status: "active", Priority: 10,
	}
...
func TestInventoryRecord02Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.InventoryRecord02{
		ID: "id-2", DisplayName: "Lifecycle InventoryRecord02", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
