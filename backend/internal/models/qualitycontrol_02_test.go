...
func TestQualityControlRecord02Validate(t *testing.T) {
	t.Parallel()
	valid := &models.QualityControlRecord02{
		ID: "id-2", DisplayName: "Sample QualityControlRecord02", Status: "active", Priority: 10,
	}
...
func TestQualityControlRecord02Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.QualityControlRecord02{
		ID: "id-2", DisplayName: "Lifecycle QualityControlRecord02", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
