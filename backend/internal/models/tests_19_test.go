...
func TestLabTestRecord19Validate(t *testing.T) {
	t.Parallel()
	valid := &models.LabTestRecord19{
		ID: "id-19", DisplayName: "Sample LabTestRecord19", Status: "active", Priority: 10,
	}
...
func TestLabTestRecord19Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.LabTestRecord19{
		ID: "id-19", DisplayName: "Lifecycle LabTestRecord19", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
