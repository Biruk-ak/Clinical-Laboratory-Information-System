...
func TestResultRecord03Validate(t *testing.T) {
	t.Parallel()
	valid := &models.ResultRecord03{
		ID: "id-3", DisplayName: "Sample ResultRecord03", Status: "active", Priority: 10,
	}
...
func TestResultRecord03Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.ResultRecord03{
		ID: "id-3", DisplayName: "Lifecycle ResultRecord03", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
