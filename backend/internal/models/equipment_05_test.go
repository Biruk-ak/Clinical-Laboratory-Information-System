...
func TestEquipmentRecord05Validate(t *testing.T) {
	t.Parallel()
	valid := &models.EquipmentRecord05{
		ID: "id-5", DisplayName: "Sample EquipmentRecord05", Status: "active", Priority: 10,
	}
...
func TestEquipmentRecord05Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.EquipmentRecord05{
		ID: "id-5", DisplayName: "Lifecycle EquipmentRecord05", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
