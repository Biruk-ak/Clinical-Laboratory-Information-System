...
func TestHospitalRecord04Validate(t *testing.T) {
	t.Parallel()
	valid := &models.HospitalRecord04{
		ID: "id-4", DisplayName: "Sample HospitalRecord04", Status: "active", Priority: 10,
	}
...
func TestHospitalRecord04Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.HospitalRecord04{
		ID: "id-4", DisplayName: "Lifecycle HospitalRecord04", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
