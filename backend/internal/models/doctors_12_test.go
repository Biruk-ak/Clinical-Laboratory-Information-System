...
func TestDoctorRecord12Validate(t *testing.T) {
	t.Parallel()
	valid := &models.DoctorRecord12{
		ID: "id-12", DisplayName: "Sample DoctorRecord12", Status: "active", Priority: 10,
	}
...
func TestDoctorRecord12Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.DoctorRecord12{
		ID: "id-12", DisplayName: "Lifecycle DoctorRecord12", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
