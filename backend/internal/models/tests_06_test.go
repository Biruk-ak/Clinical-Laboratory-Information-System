...
func TestLabTestRecord06Validate(t *testing.T) {
	t.Parallel()
	valid := &models.LabTestRecord06{
		ID: "id-6", DisplayName: "Sample LabTestRecord06", Status: "active", Priority: 10,
	}
...
func TestLabTestRecord06Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.LabTestRecord06{
		ID: "id-6", DisplayName: "Lifecycle LabTestRecord06", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
