...
func TestBillingRecord08Validate(t *testing.T) {
	t.Parallel()
	valid := &models.BillingRecord08{
		ID: "id-8", DisplayName: "Sample BillingRecord08", Status: "active", Priority: 10,
	}
...
func TestBillingRecord08Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.BillingRecord08{
		ID: "id-8", DisplayName: "Lifecycle BillingRecord08", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
