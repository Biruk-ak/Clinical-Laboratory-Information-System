...
func TestAnalyticsRecord12Validate(t *testing.T) {
	t.Parallel()
	valid := &models.AnalyticsRecord12{
		ID: "id-12", DisplayName: "Sample AnalyticsRecord12", Status: "active", Priority: 10,
	}
...
func TestAnalyticsRecord12Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.AnalyticsRecord12{
		ID: "id-12", DisplayName: "Lifecycle AnalyticsRecord12", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
