...
func TestDoctorRecord21Validate(t *testing.T) {
	t.Parallel()
	valid := &models.DoctorRecord21{
		ID: "id-21", DisplayName: "Sample DoctorRecord21", Status: "active", Priority: 10,
	}
...
func TestDoctorRecord21Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.DoctorRecord21{
		ID: "id-21", DisplayName: "Lifecycle DoctorRecord21", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
