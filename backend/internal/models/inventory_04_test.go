...
func TestInventoryRecord04Validate(t *testing.T) {
	t.Parallel()
	valid := &models.InventoryRecord04{
		ID: "id-4", DisplayName: "Sample InventoryRecord04", Status: "active", Priority: 10,
	}
...
func TestInventoryRecord04Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.InventoryRecord04{
		ID: "id-4", DisplayName: "Lifecycle InventoryRecord04", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
