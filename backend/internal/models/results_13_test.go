...
func TestResultRecord13Validate(t *testing.T) {
	t.Parallel()
	valid := &models.ResultRecord13{
		ID: "id-13", DisplayName: "Sample ResultRecord13", Status: "active", Priority: 10,
	}
...
func TestResultRecord13Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.ResultRecord13{
		ID: "id-13", DisplayName: "Lifecycle ResultRecord13", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
