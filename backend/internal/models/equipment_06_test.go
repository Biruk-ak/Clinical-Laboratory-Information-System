...
func TestEquipmentRecord06Validate(t *testing.T) {
	t.Parallel()
	valid := &models.EquipmentRecord06{
		ID: "id-6", DisplayName: "Sample EquipmentRecord06", Status: "active", Priority: 10,
	}
...
func TestEquipmentRecord06Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.EquipmentRecord06{
		ID: "id-6", DisplayName: "Lifecycle EquipmentRecord06", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
