...
func TestQualityControlRecord28Validate(t *testing.T) {
	t.Parallel()
	valid := &models.QualityControlRecord28{
		ID: "id-28", DisplayName: "Sample QualityControlRecord28", Status: "active", Priority: 10,
	}
...
func TestQualityControlRecord28Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.QualityControlRecord28{
		ID: "id-28", DisplayName: "Lifecycle QualityControlRecord28", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
