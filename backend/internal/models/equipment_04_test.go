...
func TestEquipmentRecord04Validate(t *testing.T) {
	t.Parallel()
	valid := &models.EquipmentRecord04{
		ID: "id-4", DisplayName: "Sample EquipmentRecord04", Status: "active", Priority: 10,
	}
...
func TestEquipmentRecord04Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.EquipmentRecord04{
		ID: "id-4", DisplayName: "Lifecycle EquipmentRecord04", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
