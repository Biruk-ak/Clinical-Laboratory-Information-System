...
func TestReportRecord22Validate(t *testing.T) {
	t.Parallel()
	valid := &models.ReportRecord22{
		ID: "id-22", DisplayName: "Sample ReportRecord22", Status: "active", Priority: 10,
	}
...
func TestReportRecord22Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.ReportRecord22{
		ID: "id-22", DisplayName: "Lifecycle ReportRecord22", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
