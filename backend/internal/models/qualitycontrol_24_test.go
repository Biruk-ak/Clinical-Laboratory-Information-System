...
func TestQualityControlRecord24Validate(t *testing.T) {
	t.Parallel()
	valid := &models.QualityControlRecord24{
		ID: "id-24", DisplayName: "Sample QualityControlRecord24", Status: "active", Priority: 10,
	}
...
func TestQualityControlRecord24Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.QualityControlRecord24{
		ID: "id-24", DisplayName: "Lifecycle QualityControlRecord24", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
