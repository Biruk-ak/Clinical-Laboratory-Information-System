...
func TestAnalyticsRecord04Validate(t *testing.T) {
	t.Parallel()
	valid := &models.AnalyticsRecord04{
		ID: "id-4", DisplayName: "Sample AnalyticsRecord04", Status: "active", Priority: 10,
	}
...
func TestAnalyticsRecord04Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.AnalyticsRecord04{
		ID: "id-4", DisplayName: "Lifecycle AnalyticsRecord04", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
