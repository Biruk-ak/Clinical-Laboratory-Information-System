...
func TestNotificationRecord20Validate(t *testing.T) {
	t.Parallel()
	valid := &models.NotificationRecord20{
		ID: "id-20", DisplayName: "Sample NotificationRecord20", Status: "active", Priority: 10,
	}
...
func TestNotificationRecord20Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.NotificationRecord20{
		ID: "id-20", DisplayName: "Lifecycle NotificationRecord20", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
