...
func TestQualityControlRecord07Validate(t *testing.T) {
	t.Parallel()
	valid := &models.QualityControlRecord07{
		ID: "id-7", DisplayName: "Sample QualityControlRecord07", Status: "active", Priority: 10,
	}
...
func TestQualityControlRecord07Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.QualityControlRecord07{
		ID: "id-7", DisplayName: "Lifecycle QualityControlRecord07", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
