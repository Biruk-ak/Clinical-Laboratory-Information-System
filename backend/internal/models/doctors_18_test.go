...
func TestDoctorRecord18Validate(t *testing.T) {
	t.Parallel()
	valid := &models.DoctorRecord18{
		ID: "id-18", DisplayName: "Sample DoctorRecord18", Status: "active", Priority: 10,
	}
...
func TestDoctorRecord18Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.DoctorRecord18{
		ID: "id-18", DisplayName: "Lifecycle DoctorRecord18", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
