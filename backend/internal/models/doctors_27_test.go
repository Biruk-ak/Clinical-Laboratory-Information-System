...
func TestDoctorRecord27Validate(t *testing.T) {
	t.Parallel()
	valid := &models.DoctorRecord27{
		ID: "id-27", DisplayName: "Sample DoctorRecord27", Status: "active", Priority: 10,
	}
...
func TestDoctorRecord27Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.DoctorRecord27{
		ID: "id-27", DisplayName: "Lifecycle DoctorRecord27", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
