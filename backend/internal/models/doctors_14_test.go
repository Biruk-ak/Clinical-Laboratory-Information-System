...
func TestDoctorRecord14Validate(t *testing.T) {
	t.Parallel()
	valid := &models.DoctorRecord14{
		ID: "id-14", DisplayName: "Sample DoctorRecord14", Status: "active", Priority: 10,
	}
...
func TestDoctorRecord14Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.DoctorRecord14{
		ID: "id-14", DisplayName: "Lifecycle DoctorRecord14", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
