...
func TestResultRecord23Validate(t *testing.T) {
	t.Parallel()
	valid := &models.ResultRecord23{
		ID: "id-23", DisplayName: "Sample ResultRecord23", Status: "active", Priority: 10,
	}
...
func TestResultRecord23Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.ResultRecord23{
		ID: "id-23", DisplayName: "Lifecycle ResultRecord23", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
