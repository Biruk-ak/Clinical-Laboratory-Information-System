...
func TestPatientRecord26Validate(t *testing.T) {
	t.Parallel()
	valid := &models.PatientRecord26{
		ID: "id-26", DisplayName: "Sample PatientRecord26", Status: "active", Priority: 10,
	}
...
func TestPatientRecord26Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.PatientRecord26{
		ID: "id-26", DisplayName: "Lifecycle PatientRecord26", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
