...
func TestReportRecord21Validate(t *testing.T) {
	t.Parallel()
	valid := &models.ReportRecord21{
		ID: "id-21", DisplayName: "Sample ReportRecord21", Status: "active", Priority: 10,
	}
...
func TestReportRecord21Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.ReportRecord21{
		ID: "id-21", DisplayName: "Lifecycle ReportRecord21", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
