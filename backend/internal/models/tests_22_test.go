...
func TestLabTestRecord22Validate(t *testing.T) {
	t.Parallel()
	valid := &models.LabTestRecord22{
		ID: "id-22", DisplayName: "Sample LabTestRecord22", Status: "active", Priority: 10,
	}
...
func TestLabTestRecord22Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.LabTestRecord22{
		ID: "id-22", DisplayName: "Lifecycle LabTestRecord22", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
