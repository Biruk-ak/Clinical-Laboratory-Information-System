...
func TestSampleRecord10Validate(t *testing.T) {
	t.Parallel()
	valid := &models.SampleRecord10{
		ID: "id-10", DisplayName: "Sample SampleRecord10", Status: "active", Priority: 10,
	}
...
func TestSampleRecord10Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.SampleRecord10{
		ID: "id-10", DisplayName: "Lifecycle SampleRecord10", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
