...
func TestSampleRecord28Validate(t *testing.T) {
	t.Parallel()
	valid := &models.SampleRecord28{
		ID: "id-28", DisplayName: "Sample SampleRecord28", Status: "active", Priority: 10,
	}
...
func TestSampleRecord28Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.SampleRecord28{
		ID: "id-28", DisplayName: "Lifecycle SampleRecord28", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
