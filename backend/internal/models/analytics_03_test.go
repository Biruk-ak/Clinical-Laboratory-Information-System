...
func TestAnalyticsRecord03Validate(t *testing.T) {
	t.Parallel()
	valid := &models.AnalyticsRecord03{
		ID: "id-3", DisplayName: "Sample AnalyticsRecord03", Status: "active", Priority: 10,
	}
...
func TestAnalyticsRecord03Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.AnalyticsRecord03{
		ID: "id-3", DisplayName: "Lifecycle AnalyticsRecord03", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
