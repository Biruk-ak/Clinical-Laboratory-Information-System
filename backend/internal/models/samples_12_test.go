...
func TestSampleRecord12Validate(t *testing.T) {
	t.Parallel()
	valid := &models.SampleRecord12{
		ID: "id-12", DisplayName: "Sample SampleRecord12", Status: "active", Priority: 10,
	}
...
func TestSampleRecord12Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.SampleRecord12{
		ID: "id-12", DisplayName: "Lifecycle SampleRecord12", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
