...
func TestDoctorRecord26Validate(t *testing.T) {
	t.Parallel()
	valid := &models.DoctorRecord26{
		ID: "id-26", DisplayName: "Sample DoctorRecord26", Status: "active", Priority: 10,
	}
...
func TestDoctorRecord26Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.DoctorRecord26{
		ID: "id-26", DisplayName: "Lifecycle DoctorRecord26", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
