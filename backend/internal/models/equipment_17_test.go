...
func TestEquipmentRecord17Validate(t *testing.T) {
	t.Parallel()
	valid := &models.EquipmentRecord17{
		ID: "id-17", DisplayName: "Sample EquipmentRecord17", Status: "active", Priority: 10,
	}
...
func TestEquipmentRecord17Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.EquipmentRecord17{
		ID: "id-17", DisplayName: "Lifecycle EquipmentRecord17", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
