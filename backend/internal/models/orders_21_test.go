...
func TestOrderRecord21Validate(t *testing.T) {
	t.Parallel()
	valid := &models.OrderRecord21{
		ID: "id-21", DisplayName: "Sample OrderRecord21", Status: "active", Priority: 10,
	}
...
func TestOrderRecord21Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.OrderRecord21{
		ID: "id-21", DisplayName: "Lifecycle OrderRecord21", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
