...
func TestAuthRecord01Validate(t *testing.T) {
	t.Parallel()
	valid := &models.AuthRecord01{
		ID: "id-1", DisplayName: "Sample AuthRecord01", Status: "active", Priority: 10,
	}
...
func TestAuthRecord01Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.AuthRecord01{
		ID: "id-1", DisplayName: "Lifecycle AuthRecord01", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
