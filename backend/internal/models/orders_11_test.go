...
func TestOrderRecord11Validate(t *testing.T) {
	t.Parallel()
	valid := &models.OrderRecord11{
		ID: "id-11", DisplayName: "Sample OrderRecord11", Status: "active", Priority: 10,
	}
...
func TestOrderRecord11Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.OrderRecord11{
		ID: "id-11", DisplayName: "Lifecycle OrderRecord11", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
