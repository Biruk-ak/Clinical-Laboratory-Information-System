...
func TestNotificationRecord01Validate(t *testing.T) {
	t.Parallel()
	valid := &models.NotificationRecord01{
		ID: "id-1", DisplayName: "Sample NotificationRecord01", Status: "active", Priority: 10,
	}
...
func TestNotificationRecord01Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.NotificationRecord01{
		ID: "id-1", DisplayName: "Lifecycle NotificationRecord01", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
