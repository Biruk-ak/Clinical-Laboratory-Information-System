...
func TestReportRecord25Validate(t *testing.T) {
	t.Parallel()
	valid := &models.ReportRecord25{
		ID: "id-25", DisplayName: "Sample ReportRecord25", Status: "active", Priority: 10,
	}
...
func TestReportRecord25Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.ReportRecord25{
		ID: "id-25", DisplayName: "Lifecycle ReportRecord25", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
