...
func TestPatientRecord16Validate(t *testing.T) {
	t.Parallel()
	valid := &models.PatientRecord16{
		ID: "id-16", DisplayName: "Sample PatientRecord16", Status: "active", Priority: 10,
	}
...
func TestPatientRecord16Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.PatientRecord16{
		ID: "id-16", DisplayName: "Lifecycle PatientRecord16", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
