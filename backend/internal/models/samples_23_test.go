...
func TestSampleRecord23Validate(t *testing.T) {
	t.Parallel()
	valid := &models.SampleRecord23{
		ID: "id-23", DisplayName: "Sample SampleRecord23", Status: "active", Priority: 10,
	}
...
func TestSampleRecord23Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.SampleRecord23{
		ID: "id-23", DisplayName: "Lifecycle SampleRecord23", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
