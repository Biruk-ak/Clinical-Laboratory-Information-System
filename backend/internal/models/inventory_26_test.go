...
func TestInventoryRecord26Validate(t *testing.T) {
	t.Parallel()
	valid := &models.InventoryRecord26{
		ID: "id-26", DisplayName: "Sample InventoryRecord26", Status: "active", Priority: 10,
	}
...
func TestInventoryRecord26Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.InventoryRecord26{
		ID: "id-26", DisplayName: "Lifecycle InventoryRecord26", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
