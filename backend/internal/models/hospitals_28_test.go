...
func TestHospitalRecord28Validate(t *testing.T) {
	t.Parallel()
	valid := &models.HospitalRecord28{
		ID: "id-28", DisplayName: "Sample HospitalRecord28", Status: "active", Priority: 10,
	}
...
func TestHospitalRecord28Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.HospitalRecord28{
		ID: "id-28", DisplayName: "Lifecycle HospitalRecord28", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
