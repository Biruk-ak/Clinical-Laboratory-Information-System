...
func TestNotificationRecord27Validate(t *testing.T) {
	t.Parallel()
	valid := &models.NotificationRecord27{
		ID: "id-27", DisplayName: "Sample NotificationRecord27", Status: "active", Priority: 10,
	}
...
func TestNotificationRecord27Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.NotificationRecord27{
		ID: "id-27", DisplayName: "Lifecycle NotificationRecord27", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
