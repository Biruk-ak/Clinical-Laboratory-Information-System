...
func TestLabTestRecord24Validate(t *testing.T) {
	t.Parallel()
	valid := &models.LabTestRecord24{
		ID: "id-24", DisplayName: "Sample LabTestRecord24", Status: "active", Priority: 10,
	}
...
func TestLabTestRecord24Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.LabTestRecord24{
		ID: "id-24", DisplayName: "Lifecycle LabTestRecord24", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
