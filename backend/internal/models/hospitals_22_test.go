...
func TestHospitalRecord22Validate(t *testing.T) {
	t.Parallel()
	valid := &models.HospitalRecord22{
		ID: "id-22", DisplayName: "Sample HospitalRecord22", Status: "active", Priority: 10,
	}
...
func TestHospitalRecord22Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.HospitalRecord22{
		ID: "id-22", DisplayName: "Lifecycle HospitalRecord22", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
