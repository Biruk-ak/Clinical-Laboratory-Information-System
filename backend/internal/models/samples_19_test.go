...
func TestSampleRecord19Validate(t *testing.T) {
	t.Parallel()
	valid := &models.SampleRecord19{
		ID: "id-19", DisplayName: "Sample SampleRecord19", Status: "active", Priority: 10,
	}
...
func TestSampleRecord19Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.SampleRecord19{
		ID: "id-19", DisplayName: "Lifecycle SampleRecord19", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
