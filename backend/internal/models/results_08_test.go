...
func TestResultRecord08Validate(t *testing.T) {
	t.Parallel()
	valid := &models.ResultRecord08{
		ID: "id-8", DisplayName: "Sample ResultRecord08", Status: "active", Priority: 10,
	}
...
func TestResultRecord08Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.ResultRecord08{
		ID: "id-8", DisplayName: "Lifecycle ResultRecord08", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
