...
func TestResultRecord09Validate(t *testing.T) {
	t.Parallel()
	valid := &models.ResultRecord09{
		ID: "id-9", DisplayName: "Sample ResultRecord09", Status: "active", Priority: 10,
	}
...
func TestResultRecord09Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.ResultRecord09{
		ID: "id-9", DisplayName: "Lifecycle ResultRecord09", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
