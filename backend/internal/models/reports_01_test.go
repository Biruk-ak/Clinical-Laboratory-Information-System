...
func TestReportRecord01Validate(t *testing.T) {
	t.Parallel()
	valid := &models.ReportRecord01{
		ID: "id-1", DisplayName: "Sample ReportRecord01", Status: "active", Priority: 10,
	}
...
func TestReportRecord01Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.ReportRecord01{
		ID: "id-1", DisplayName: "Lifecycle ReportRecord01", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
