...
func TestBillingRecord11Validate(t *testing.T) {
	t.Parallel()
	valid := &models.BillingRecord11{
		ID: "id-11", DisplayName: "Sample BillingRecord11", Status: "active", Priority: 10,
	}
...
func TestBillingRecord11Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.BillingRecord11{
		ID: "id-11", DisplayName: "Lifecycle BillingRecord11", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
