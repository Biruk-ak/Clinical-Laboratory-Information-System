...
func TestHospitalRecord20Validate(t *testing.T) {
	t.Parallel()
	valid := &models.HospitalRecord20{
		ID: "id-20", DisplayName: "Sample HospitalRecord20", Status: "active", Priority: 10,
	}
...
func TestHospitalRecord20Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.HospitalRecord20{
		ID: "id-20", DisplayName: "Lifecycle HospitalRecord20", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
