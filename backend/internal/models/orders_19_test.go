...
func TestOrderRecord19Validate(t *testing.T) {
	t.Parallel()
	valid := &models.OrderRecord19{
		ID: "id-19", DisplayName: "Sample OrderRecord19", Status: "active", Priority: 10,
	}
...
func TestOrderRecord19Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.OrderRecord19{
		ID: "id-19", DisplayName: "Lifecycle OrderRecord19", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
