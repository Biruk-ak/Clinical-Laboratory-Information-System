...
func TestReportRecord14Validate(t *testing.T) {
	t.Parallel()
	valid := &models.ReportRecord14{
		ID: "id-14", DisplayName: "Sample ReportRecord14", Status: "active", Priority: 10,
	}
...
func TestReportRecord14Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.ReportRecord14{
		ID: "id-14", DisplayName: "Lifecycle ReportRecord14", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
