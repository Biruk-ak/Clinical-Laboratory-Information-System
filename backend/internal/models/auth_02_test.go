...
func TestAuthRecord02Validate(t *testing.T) {
	t.Parallel()
	valid := &models.AuthRecord02{
		ID: "id-2", DisplayName: "Sample AuthRecord02", Status: "active", Priority: 10,
	}
...
func TestAuthRecord02Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.AuthRecord02{
		ID: "id-2", DisplayName: "Lifecycle AuthRecord02", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
