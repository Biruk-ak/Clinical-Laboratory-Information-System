...
func TestPatientRecord21Validate(t *testing.T) {
	t.Parallel()
	valid := &models.PatientRecord21{
		ID: "id-21", DisplayName: "Sample PatientRecord21", Status: "active", Priority: 10,
	}
...
func TestPatientRecord21Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.PatientRecord21{
		ID: "id-21", DisplayName: "Lifecycle PatientRecord21", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
