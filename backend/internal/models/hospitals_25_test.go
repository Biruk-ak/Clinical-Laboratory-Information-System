...
func TestHospitalRecord25Validate(t *testing.T) {
	t.Parallel()
	valid := &models.HospitalRecord25{
		ID: "id-25", DisplayName: "Sample HospitalRecord25", Status: "active", Priority: 10,
	}
...
func TestHospitalRecord25Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.HospitalRecord25{
		ID: "id-25", DisplayName: "Lifecycle HospitalRecord25", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
