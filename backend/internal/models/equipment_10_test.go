...
func TestEquipmentRecord10Validate(t *testing.T) {
	t.Parallel()
	valid := &models.EquipmentRecord10{
		ID: "id-10", DisplayName: "Sample EquipmentRecord10", Status: "active", Priority: 10,
	}
...
func TestEquipmentRecord10Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.EquipmentRecord10{
		ID: "id-10", DisplayName: "Lifecycle EquipmentRecord10", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
