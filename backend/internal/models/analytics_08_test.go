...
func TestAnalyticsRecord08Validate(t *testing.T) {
	t.Parallel()
	valid := &models.AnalyticsRecord08{
		ID: "id-8", DisplayName: "Sample AnalyticsRecord08", Status: "active", Priority: 10,
	}
...
func TestAnalyticsRecord08Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.AnalyticsRecord08{
		ID: "id-8", DisplayName: "Lifecycle AnalyticsRecord08", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
