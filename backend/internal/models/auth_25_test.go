...
func TestAuthRecord25Validate(t *testing.T) {
	t.Parallel()
	valid := &models.AuthRecord25{
		ID: "id-25", DisplayName: "Sample AuthRecord25", Status: "active", Priority: 10,
	}
...
func TestAuthRecord25Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.AuthRecord25{
		ID: "id-25", DisplayName: "Lifecycle AuthRecord25", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
