...
func TestReportRecord02Validate(t *testing.T) {
	t.Parallel()
	valid := &models.ReportRecord02{
		ID: "id-2", DisplayName: "Sample ReportRecord02", Status: "active", Priority: 10,
	}
...
func TestReportRecord02Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.ReportRecord02{
		ID: "id-2", DisplayName: "Lifecycle ReportRecord02", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
