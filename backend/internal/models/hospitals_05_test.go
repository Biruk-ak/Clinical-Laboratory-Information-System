...
func TestHospitalRecord05Validate(t *testing.T) {
	t.Parallel()
	valid := &models.HospitalRecord05{
		ID: "id-5", DisplayName: "Sample HospitalRecord05", Status: "active", Priority: 10,
	}
...
func TestHospitalRecord05Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.HospitalRecord05{
		ID: "id-5", DisplayName: "Lifecycle HospitalRecord05", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
