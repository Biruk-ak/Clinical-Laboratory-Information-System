...
func TestHospitalRecord02Validate(t *testing.T) {
	t.Parallel()
	valid := &models.HospitalRecord02{
		ID: "id-2", DisplayName: "Sample HospitalRecord02", Status: "active", Priority: 10,
	}
...
func TestHospitalRecord02Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.HospitalRecord02{
		ID: "id-2", DisplayName: "Lifecycle HospitalRecord02", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
