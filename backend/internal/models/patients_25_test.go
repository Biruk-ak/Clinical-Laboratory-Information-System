...
func TestPatientRecord25Validate(t *testing.T) {
	t.Parallel()
	valid := &models.PatientRecord25{
		ID: "id-25", DisplayName: "Sample PatientRecord25", Status: "active", Priority: 10,
	}
...
func TestPatientRecord25Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.PatientRecord25{
		ID: "id-25", DisplayName: "Lifecycle PatientRecord25", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
