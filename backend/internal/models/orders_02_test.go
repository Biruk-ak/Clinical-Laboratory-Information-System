...
func TestOrderRecord02Validate(t *testing.T) {
	t.Parallel()
	valid := &models.OrderRecord02{
		ID: "id-2", DisplayName: "Sample OrderRecord02", Status: "active", Priority: 10,
	}
...
func TestOrderRecord02Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.OrderRecord02{
		ID: "id-2", DisplayName: "Lifecycle OrderRecord02", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
