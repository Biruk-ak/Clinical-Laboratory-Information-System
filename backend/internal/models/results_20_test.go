...
func TestResultRecord20Validate(t *testing.T) {
	t.Parallel()
	valid := &models.ResultRecord20{
		ID: "id-20", DisplayName: "Sample ResultRecord20", Status: "active", Priority: 10,
	}
...
func TestResultRecord20Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.ResultRecord20{
		ID: "id-20", DisplayName: "Lifecycle ResultRecord20", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
