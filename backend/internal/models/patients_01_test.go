...
func TestPatientRecord01Validate(t *testing.T) {
	t.Parallel()
	valid := &models.PatientRecord01{
		ID: "id-1", DisplayName: "Sample PatientRecord01", Status: "active", Priority: 10,
	}
...
func TestPatientRecord01Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.PatientRecord01{
		ID: "id-1", DisplayName: "Lifecycle PatientRecord01", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
