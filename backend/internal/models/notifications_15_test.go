...
func TestNotificationRecord15Validate(t *testing.T) {
	t.Parallel()
	valid := &models.NotificationRecord15{
		ID: "id-15", DisplayName: "Sample NotificationRecord15", Status: "active", Priority: 10,
	}
...
func TestNotificationRecord15Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.NotificationRecord15{
		ID: "id-15", DisplayName: "Lifecycle NotificationRecord15", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
