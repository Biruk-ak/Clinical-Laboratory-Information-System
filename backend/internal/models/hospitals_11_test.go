...
func TestHospitalRecord11Validate(t *testing.T) {
	t.Parallel()
	valid := &models.HospitalRecord11{
		ID: "id-11", DisplayName: "Sample HospitalRecord11", Status: "active", Priority: 10,
	}
...
func TestHospitalRecord11Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.HospitalRecord11{
		ID: "id-11", DisplayName: "Lifecycle HospitalRecord11", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
