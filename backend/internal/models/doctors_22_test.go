...
func TestDoctorRecord22Validate(t *testing.T) {
	t.Parallel()
	valid := &models.DoctorRecord22{
		ID: "id-22", DisplayName: "Sample DoctorRecord22", Status: "active", Priority: 10,
	}
...
func TestDoctorRecord22Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.DoctorRecord22{
		ID: "id-22", DisplayName: "Lifecycle DoctorRecord22", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
