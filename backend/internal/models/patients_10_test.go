...
func TestPatientRecord10Validate(t *testing.T) {
	t.Parallel()
	valid := &models.PatientRecord10{
		ID: "id-10", DisplayName: "Sample PatientRecord10", Status: "active", Priority: 10,
	}
...
func TestPatientRecord10Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.PatientRecord10{
		ID: "id-10", DisplayName: "Lifecycle PatientRecord10", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
