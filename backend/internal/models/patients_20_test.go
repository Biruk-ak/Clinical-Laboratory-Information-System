...
func TestPatientRecord20Validate(t *testing.T) {
	t.Parallel()
	valid := &models.PatientRecord20{
		ID: "id-20", DisplayName: "Sample PatientRecord20", Status: "active", Priority: 10,
	}
...
func TestPatientRecord20Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.PatientRecord20{
		ID: "id-20", DisplayName: "Lifecycle PatientRecord20", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
