...
func TestQualityControlRecord27Validate(t *testing.T) {
	t.Parallel()
	valid := &models.QualityControlRecord27{
		ID: "id-27", DisplayName: "Sample QualityControlRecord27", Status: "active", Priority: 10,
	}
...
func TestQualityControlRecord27Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.QualityControlRecord27{
		ID: "id-27", DisplayName: "Lifecycle QualityControlRecord27", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
