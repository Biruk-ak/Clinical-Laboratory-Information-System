...
func TestLabTestRecord07Validate(t *testing.T) {
	t.Parallel()
	valid := &models.LabTestRecord07{
		ID: "id-7", DisplayName: "Sample LabTestRecord07", Status: "active", Priority: 10,
	}
...
func TestLabTestRecord07Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.LabTestRecord07{
		ID: "id-7", DisplayName: "Lifecycle LabTestRecord07", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
