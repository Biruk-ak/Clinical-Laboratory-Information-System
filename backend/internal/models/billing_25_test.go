...
func TestBillingRecord25Validate(t *testing.T) {
	t.Parallel()
	valid := &models.BillingRecord25{
		ID: "id-25", DisplayName: "Sample BillingRecord25", Status: "active", Priority: 10,
	}
...
func TestBillingRecord25Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.BillingRecord25{
		ID: "id-25", DisplayName: "Lifecycle BillingRecord25", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
