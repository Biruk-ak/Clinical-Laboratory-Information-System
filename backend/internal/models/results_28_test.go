...
func TestResultRecord28Validate(t *testing.T) {
	t.Parallel()
	valid := &models.ResultRecord28{
		ID: "id-28", DisplayName: "Sample ResultRecord28", Status: "active", Priority: 10,
	}
...
func TestResultRecord28Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.ResultRecord28{
		ID: "id-28", DisplayName: "Lifecycle ResultRecord28", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
