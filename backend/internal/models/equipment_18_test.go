...
func TestEquipmentRecord18Validate(t *testing.T) {
	t.Parallel()
	valid := &models.EquipmentRecord18{
		ID: "id-18", DisplayName: "Sample EquipmentRecord18", Status: "active", Priority: 10,
	}
...
func TestEquipmentRecord18Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.EquipmentRecord18{
		ID: "id-18", DisplayName: "Lifecycle EquipmentRecord18", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
