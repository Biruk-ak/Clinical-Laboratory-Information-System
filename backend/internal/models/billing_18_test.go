...
func TestBillingRecord18Validate(t *testing.T) {
	t.Parallel()
	valid := &models.BillingRecord18{
		ID: "id-18", DisplayName: "Sample BillingRecord18", Status: "active", Priority: 10,
	}
...
func TestBillingRecord18Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.BillingRecord18{
		ID: "id-18", DisplayName: "Lifecycle BillingRecord18", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
