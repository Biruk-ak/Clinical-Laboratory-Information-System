...
func TestResultRecord27Validate(t *testing.T) {
	t.Parallel()
	valid := &models.ResultRecord27{
		ID: "id-27", DisplayName: "Sample ResultRecord27", Status: "active", Priority: 10,
	}
...
func TestResultRecord27Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.ResultRecord27{
		ID: "id-27", DisplayName: "Lifecycle ResultRecord27", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
