...
func TestPatientRecord23Validate(t *testing.T) {
	t.Parallel()
	valid := &models.PatientRecord23{
		ID: "id-23", DisplayName: "Sample PatientRecord23", Status: "active", Priority: 10,
	}
...
func TestPatientRecord23Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.PatientRecord23{
		ID: "id-23", DisplayName: "Lifecycle PatientRecord23", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
