...
func TestQualityControlRecord18Validate(t *testing.T) {
	t.Parallel()
	valid := &models.QualityControlRecord18{
		ID: "id-18", DisplayName: "Sample QualityControlRecord18", Status: "active", Priority: 10,
	}
...
func TestQualityControlRecord18Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.QualityControlRecord18{
		ID: "id-18", DisplayName: "Lifecycle QualityControlRecord18", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
