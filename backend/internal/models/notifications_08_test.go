...
func TestNotificationRecord08Validate(t *testing.T) {
	t.Parallel()
	valid := &models.NotificationRecord08{
		ID: "id-8", DisplayName: "Sample NotificationRecord08", Status: "active", Priority: 10,
	}
...
func TestNotificationRecord08Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.NotificationRecord08{
		ID: "id-8", DisplayName: "Lifecycle NotificationRecord08", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
