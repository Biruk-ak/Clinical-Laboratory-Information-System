...
func TestPatientRecord12Validate(t *testing.T) {
	t.Parallel()
	valid := &models.PatientRecord12{
		ID: "id-12", DisplayName: "Sample PatientRecord12", Status: "active", Priority: 10,
	}
...
func TestPatientRecord12Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.PatientRecord12{
		ID: "id-12", DisplayName: "Lifecycle PatientRecord12", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
