...
func TestQualityControlRecord23Validate(t *testing.T) {
	t.Parallel()
	valid := &models.QualityControlRecord23{
		ID: "id-23", DisplayName: "Sample QualityControlRecord23", Status: "active", Priority: 10,
	}
...
func TestQualityControlRecord23Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.QualityControlRecord23{
		ID: "id-23", DisplayName: "Lifecycle QualityControlRecord23", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
