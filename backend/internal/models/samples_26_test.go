...
func TestSampleRecord26Validate(t *testing.T) {
	t.Parallel()
	valid := &models.SampleRecord26{
		ID: "id-26", DisplayName: "Sample SampleRecord26", Status: "active", Priority: 10,
	}
...
func TestSampleRecord26Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.SampleRecord26{
		ID: "id-26", DisplayName: "Lifecycle SampleRecord26", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
