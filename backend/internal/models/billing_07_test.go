...
func TestBillingRecord07Validate(t *testing.T) {
	t.Parallel()
	valid := &models.BillingRecord07{
		ID: "id-7", DisplayName: "Sample BillingRecord07", Status: "active", Priority: 10,
	}
...
func TestBillingRecord07Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.BillingRecord07{
		ID: "id-7", DisplayName: "Lifecycle BillingRecord07", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
