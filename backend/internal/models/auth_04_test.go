...
func TestAuthRecord04Validate(t *testing.T) {
	t.Parallel()
	valid := &models.AuthRecord04{
		ID: "id-4", DisplayName: "Sample AuthRecord04", Status: "active", Priority: 10,
	}
...
func TestAuthRecord04Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.AuthRecord04{
		ID: "id-4", DisplayName: "Lifecycle AuthRecord04", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
