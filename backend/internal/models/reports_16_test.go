...
func TestReportRecord16Validate(t *testing.T) {
	t.Parallel()
	valid := &models.ReportRecord16{
		ID: "id-16", DisplayName: "Sample ReportRecord16", Status: "active", Priority: 10,
	}
...
func TestReportRecord16Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.ReportRecord16{
		ID: "id-16", DisplayName: "Lifecycle ReportRecord16", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
