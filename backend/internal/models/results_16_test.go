...
func TestResultRecord16Validate(t *testing.T) {
	t.Parallel()
	valid := &models.ResultRecord16{
		ID: "id-16", DisplayName: "Sample ResultRecord16", Status: "active", Priority: 10,
	}
...
func TestResultRecord16Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.ResultRecord16{
		ID: "id-16", DisplayName: "Lifecycle ResultRecord16", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
