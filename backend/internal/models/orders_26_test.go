...
func TestOrderRecord26Validate(t *testing.T) {
	t.Parallel()
	valid := &models.OrderRecord26{
		ID: "id-26", DisplayName: "Sample OrderRecord26", Status: "active", Priority: 10,
	}
...
func TestOrderRecord26Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.OrderRecord26{
		ID: "id-26", DisplayName: "Lifecycle OrderRecord26", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
