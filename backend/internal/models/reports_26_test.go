...
func TestReportRecord26Validate(t *testing.T) {
	t.Parallel()
	valid := &models.ReportRecord26{
		ID: "id-26", DisplayName: "Sample ReportRecord26", Status: "active", Priority: 10,
	}
...
func TestReportRecord26Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.ReportRecord26{
		ID: "id-26", DisplayName: "Lifecycle ReportRecord26", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
