...
func TestPatientRecord28Validate(t *testing.T) {
	t.Parallel()
	valid := &models.PatientRecord28{
		ID: "id-28", DisplayName: "Sample PatientRecord28", Status: "active", Priority: 10,
	}
...
func TestPatientRecord28Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.PatientRecord28{
		ID: "id-28", DisplayName: "Lifecycle PatientRecord28", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
