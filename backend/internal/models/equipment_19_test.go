...
func TestEquipmentRecord19Validate(t *testing.T) {
	t.Parallel()
	valid := &models.EquipmentRecord19{
		ID: "id-19", DisplayName: "Sample EquipmentRecord19", Status: "active", Priority: 10,
	}
...
func TestEquipmentRecord19Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.EquipmentRecord19{
		ID: "id-19", DisplayName: "Lifecycle EquipmentRecord19", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
