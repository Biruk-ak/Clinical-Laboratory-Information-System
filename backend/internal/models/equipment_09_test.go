...
func TestEquipmentRecord09Validate(t *testing.T) {
	t.Parallel()
	valid := &models.EquipmentRecord09{
		ID: "id-9", DisplayName: "Sample EquipmentRecord09", Status: "active", Priority: 10,
	}
...
func TestEquipmentRecord09Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.EquipmentRecord09{
		ID: "id-9", DisplayName: "Lifecycle EquipmentRecord09", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
