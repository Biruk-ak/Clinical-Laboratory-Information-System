...
func TestInventoryRecord06Validate(t *testing.T) {
	t.Parallel()
	valid := &models.InventoryRecord06{
		ID: "id-6", DisplayName: "Sample InventoryRecord06", Status: "active", Priority: 10,
	}
...
func TestInventoryRecord06Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.InventoryRecord06{
		ID: "id-6", DisplayName: "Lifecycle InventoryRecord06", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
