...
func TestAnalyticsRecord02Validate(t *testing.T) {
	t.Parallel()
	valid := &models.AnalyticsRecord02{
		ID: "id-2", DisplayName: "Sample AnalyticsRecord02", Status: "active", Priority: 10,
	}
...
func TestAnalyticsRecord02Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.AnalyticsRecord02{
		ID: "id-2", DisplayName: "Lifecycle AnalyticsRecord02", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
