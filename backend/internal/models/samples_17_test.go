...
func TestSampleRecord17Validate(t *testing.T) {
	t.Parallel()
	valid := &models.SampleRecord17{
		ID: "id-17", DisplayName: "Sample SampleRecord17", Status: "active", Priority: 10,
	}
...
func TestSampleRecord17Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.SampleRecord17{
		ID: "id-17", DisplayName: "Lifecycle SampleRecord17", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
