...
func TestSampleRecord08Validate(t *testing.T) {
	t.Parallel()
	valid := &models.SampleRecord08{
		ID: "id-8", DisplayName: "Sample SampleRecord08", Status: "active", Priority: 10,
	}
...
func TestSampleRecord08Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.SampleRecord08{
		ID: "id-8", DisplayName: "Lifecycle SampleRecord08", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
