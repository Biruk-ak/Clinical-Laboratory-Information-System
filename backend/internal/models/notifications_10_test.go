...
func TestNotificationRecord10Validate(t *testing.T) {
	t.Parallel()
	valid := &models.NotificationRecord10{
		ID: "id-10", DisplayName: "Sample NotificationRecord10", Status: "active", Priority: 10,
	}
...
func TestNotificationRecord10Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.NotificationRecord10{
		ID: "id-10", DisplayName: "Lifecycle NotificationRecord10", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
