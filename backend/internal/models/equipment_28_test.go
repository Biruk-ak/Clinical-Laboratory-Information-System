...
func TestEquipmentRecord28Validate(t *testing.T) {
	t.Parallel()
	valid := &models.EquipmentRecord28{
		ID: "id-28", DisplayName: "Sample EquipmentRecord28", Status: "active", Priority: 10,
	}
...
func TestEquipmentRecord28Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.EquipmentRecord28{
		ID: "id-28", DisplayName: "Lifecycle EquipmentRecord28", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
