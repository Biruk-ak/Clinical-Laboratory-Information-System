...
func TestQualityControlRecord20Validate(t *testing.T) {
	t.Parallel()
	valid := &models.QualityControlRecord20{
		ID: "id-20", DisplayName: "Sample QualityControlRecord20", Status: "active", Priority: 10,
	}
...
func TestQualityControlRecord20Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.QualityControlRecord20{
		ID: "id-20", DisplayName: "Lifecycle QualityControlRecord20", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
