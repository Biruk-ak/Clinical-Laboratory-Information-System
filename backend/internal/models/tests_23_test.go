...
func TestLabTestRecord23Validate(t *testing.T) {
	t.Parallel()
	valid := &models.LabTestRecord23{
		ID: "id-23", DisplayName: "Sample LabTestRecord23", Status: "active", Priority: 10,
	}
...
func TestLabTestRecord23Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.LabTestRecord23{
		ID: "id-23", DisplayName: "Lifecycle LabTestRecord23", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
