...
func TestLabTestRecord27Validate(t *testing.T) {
	t.Parallel()
	valid := &models.LabTestRecord27{
		ID: "id-27", DisplayName: "Sample LabTestRecord27", Status: "active", Priority: 10,
	}
...
func TestLabTestRecord27Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.LabTestRecord27{
		ID: "id-27", DisplayName: "Lifecycle LabTestRecord27", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
