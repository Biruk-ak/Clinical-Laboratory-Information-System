...
func TestQualityControlRecord17Validate(t *testing.T) {
	t.Parallel()
	valid := &models.QualityControlRecord17{
		ID: "id-17", DisplayName: "Sample QualityControlRecord17", Status: "active", Priority: 10,
	}
...
func TestQualityControlRecord17Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.QualityControlRecord17{
		ID: "id-17", DisplayName: "Lifecycle QualityControlRecord17", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
