...
func TestNotificationRecord26Validate(t *testing.T) {
	t.Parallel()
	valid := &models.NotificationRecord26{
		ID: "id-26", DisplayName: "Sample NotificationRecord26", Status: "active", Priority: 10,
	}
...
func TestNotificationRecord26Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.NotificationRecord26{
		ID: "id-26", DisplayName: "Lifecycle NotificationRecord26", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
