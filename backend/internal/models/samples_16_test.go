...
func TestSampleRecord16Validate(t *testing.T) {
	t.Parallel()
	valid := &models.SampleRecord16{
		ID: "id-16", DisplayName: "Sample SampleRecord16", Status: "active", Priority: 10,
	}
...
func TestSampleRecord16Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.SampleRecord16{
		ID: "id-16", DisplayName: "Lifecycle SampleRecord16", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
