...
func TestDoctorRecord03Validate(t *testing.T) {
	t.Parallel()
	valid := &models.DoctorRecord03{
		ID: "id-3", DisplayName: "Sample DoctorRecord03", Status: "active", Priority: 10,
	}
...
func TestDoctorRecord03Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.DoctorRecord03{
		ID: "id-3", DisplayName: "Lifecycle DoctorRecord03", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
