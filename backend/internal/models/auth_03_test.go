...
func TestAuthRecord03Validate(t *testing.T) {
	t.Parallel()
	valid := &models.AuthRecord03{
		ID: "id-3", DisplayName: "Sample AuthRecord03", Status: "active", Priority: 10,
	}
...
func TestAuthRecord03Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.AuthRecord03{
		ID: "id-3", DisplayName: "Lifecycle AuthRecord03", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
