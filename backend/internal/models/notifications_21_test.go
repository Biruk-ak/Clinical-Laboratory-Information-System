...
func TestNotificationRecord21Validate(t *testing.T) {
	t.Parallel()
	valid := &models.NotificationRecord21{
		ID: "id-21", DisplayName: "Sample NotificationRecord21", Status: "active", Priority: 10,
	}
...
func TestNotificationRecord21Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.NotificationRecord21{
		ID: "id-21", DisplayName: "Lifecycle NotificationRecord21", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
