...
func TestEquipmentRecord27Validate(t *testing.T) {
	t.Parallel()
	valid := &models.EquipmentRecord27{
		ID: "id-27", DisplayName: "Sample EquipmentRecord27", Status: "active", Priority: 10,
	}
...
func TestEquipmentRecord27Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.EquipmentRecord27{
		ID: "id-27", DisplayName: "Lifecycle EquipmentRecord27", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
