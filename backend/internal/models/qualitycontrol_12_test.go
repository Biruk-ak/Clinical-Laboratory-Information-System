...
func TestQualityControlRecord12Validate(t *testing.T) {
	t.Parallel()
	valid := &models.QualityControlRecord12{
		ID: "id-12", DisplayName: "Sample QualityControlRecord12", Status: "active", Priority: 10,
	}
...
func TestQualityControlRecord12Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.QualityControlRecord12{
		ID: "id-12", DisplayName: "Lifecycle QualityControlRecord12", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
