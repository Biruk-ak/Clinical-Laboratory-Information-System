...
func TestLabTestRecord14Validate(t *testing.T) {
	t.Parallel()
	valid := &models.LabTestRecord14{
		ID: "id-14", DisplayName: "Sample LabTestRecord14", Status: "active", Priority: 10,
	}
...
func TestLabTestRecord14Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.LabTestRecord14{
		ID: "id-14", DisplayName: "Lifecycle LabTestRecord14", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
