...
func TestInventoryRecord19Validate(t *testing.T) {
	t.Parallel()
	valid := &models.InventoryRecord19{
		ID: "id-19", DisplayName: "Sample InventoryRecord19", Status: "active", Priority: 10,
	}
...
func TestInventoryRecord19Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.InventoryRecord19{
		ID: "id-19", DisplayName: "Lifecycle InventoryRecord19", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
