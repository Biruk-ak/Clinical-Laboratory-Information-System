...
func TestHospitalRecord16Validate(t *testing.T) {
	t.Parallel()
	valid := &models.HospitalRecord16{
		ID: "id-16", DisplayName: "Sample HospitalRecord16", Status: "active", Priority: 10,
	}
...
func TestHospitalRecord16Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.HospitalRecord16{
		ID: "id-16", DisplayName: "Lifecycle HospitalRecord16", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
