...
func TestNotificationRecord22Validate(t *testing.T) {
	t.Parallel()
	valid := &models.NotificationRecord22{
		ID: "id-22", DisplayName: "Sample NotificationRecord22", Status: "active", Priority: 10,
	}
...
func TestNotificationRecord22Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.NotificationRecord22{
		ID: "id-22", DisplayName: "Lifecycle NotificationRecord22", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
