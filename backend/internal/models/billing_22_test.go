...
func TestBillingRecord22Validate(t *testing.T) {
	t.Parallel()
	valid := &models.BillingRecord22{
		ID: "id-22", DisplayName: "Sample BillingRecord22", Status: "active", Priority: 10,
	}
...
func TestBillingRecord22Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.BillingRecord22{
		ID: "id-22", DisplayName: "Lifecycle BillingRecord22", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
