...
func TestInventoryRecord17Validate(t *testing.T) {
	t.Parallel()
	valid := &models.InventoryRecord17{
		ID: "id-17", DisplayName: "Sample InventoryRecord17", Status: "active", Priority: 10,
	}
...
func TestInventoryRecord17Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.InventoryRecord17{
		ID: "id-17", DisplayName: "Lifecycle InventoryRecord17", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
