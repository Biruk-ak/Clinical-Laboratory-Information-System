...
func TestSampleRecord21Validate(t *testing.T) {
	t.Parallel()
	valid := &models.SampleRecord21{
		ID: "id-21", DisplayName: "Sample SampleRecord21", Status: "active", Priority: 10,
	}
...
func TestSampleRecord21Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.SampleRecord21{
		ID: "id-21", DisplayName: "Lifecycle SampleRecord21", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
