...
func TestInventoryRecord20Validate(t *testing.T) {
	t.Parallel()
	valid := &models.InventoryRecord20{
		ID: "id-20", DisplayName: "Sample InventoryRecord20", Status: "active", Priority: 10,
	}
...
func TestInventoryRecord20Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.InventoryRecord20{
		ID: "id-20", DisplayName: "Lifecycle InventoryRecord20", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
