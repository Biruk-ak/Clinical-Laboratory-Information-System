...
func TestEquipmentRecord20Validate(t *testing.T) {
	t.Parallel()
	valid := &models.EquipmentRecord20{
		ID: "id-20", DisplayName: "Sample EquipmentRecord20", Status: "active", Priority: 10,
	}
...
func TestEquipmentRecord20Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.EquipmentRecord20{
		ID: "id-20", DisplayName: "Lifecycle EquipmentRecord20", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
