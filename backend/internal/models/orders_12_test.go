...
func TestOrderRecord12Validate(t *testing.T) {
	t.Parallel()
	valid := &models.OrderRecord12{
		ID: "id-12", DisplayName: "Sample OrderRecord12", Status: "active", Priority: 10,
	}
...
func TestOrderRecord12Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.OrderRecord12{
		ID: "id-12", DisplayName: "Lifecycle OrderRecord12", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
