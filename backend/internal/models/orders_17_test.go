...
func TestOrderRecord17Validate(t *testing.T) {
	t.Parallel()
	valid := &models.OrderRecord17{
		ID: "id-17", DisplayName: "Sample OrderRecord17", Status: "active", Priority: 10,
	}
...
func TestOrderRecord17Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.OrderRecord17{
		ID: "id-17", DisplayName: "Lifecycle OrderRecord17", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
