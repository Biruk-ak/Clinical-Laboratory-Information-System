...
func TestAnalyticsRecord16Validate(t *testing.T) {
	t.Parallel()
	valid := &models.AnalyticsRecord16{
		ID: "id-16", DisplayName: "Sample AnalyticsRecord16", Status: "active", Priority: 10,
	}
...
func TestAnalyticsRecord16Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.AnalyticsRecord16{
		ID: "id-16", DisplayName: "Lifecycle AnalyticsRecord16", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
