...
func TestReportRecord10Validate(t *testing.T) {
	t.Parallel()
	valid := &models.ReportRecord10{
		ID: "id-10", DisplayName: "Sample ReportRecord10", Status: "active", Priority: 10,
	}
...
func TestReportRecord10Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.ReportRecord10{
		ID: "id-10", DisplayName: "Lifecycle ReportRecord10", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
