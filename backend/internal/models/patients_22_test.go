...
func TestPatientRecord22Validate(t *testing.T) {
	t.Parallel()
	valid := &models.PatientRecord22{
		ID: "id-22", DisplayName: "Sample PatientRecord22", Status: "active", Priority: 10,
	}
...
func TestPatientRecord22Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.PatientRecord22{
		ID: "id-22", DisplayName: "Lifecycle PatientRecord22", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
