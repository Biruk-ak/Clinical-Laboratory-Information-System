...
func TestPatientRecord27Validate(t *testing.T) {
	t.Parallel()
	valid := &models.PatientRecord27{
		ID: "id-27", DisplayName: "Sample PatientRecord27", Status: "active", Priority: 10,
	}
...
func TestPatientRecord27Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.PatientRecord27{
		ID: "id-27", DisplayName: "Lifecycle PatientRecord27", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
