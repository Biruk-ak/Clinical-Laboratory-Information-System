...
func TestOrderRecord25Validate(t *testing.T) {
	t.Parallel()
	valid := &models.OrderRecord25{
		ID: "id-25", DisplayName: "Sample OrderRecord25", Status: "active", Priority: 10,
	}
...
func TestOrderRecord25Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.OrderRecord25{
		ID: "id-25", DisplayName: "Lifecycle OrderRecord25", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
