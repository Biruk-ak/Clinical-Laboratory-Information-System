...
func TestOrderRecord13Validate(t *testing.T) {
	t.Parallel()
	valid := &models.OrderRecord13{
		ID: "id-13", DisplayName: "Sample OrderRecord13", Status: "active", Priority: 10,
	}
...
func TestOrderRecord13Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.OrderRecord13{
		ID: "id-13", DisplayName: "Lifecycle OrderRecord13", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
