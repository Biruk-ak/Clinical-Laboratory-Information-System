...
func TestInventoryRecord18Validate(t *testing.T) {
	t.Parallel()
	valid := &models.InventoryRecord18{
		ID: "id-18", DisplayName: "Sample InventoryRecord18", Status: "active", Priority: 10,
	}
...
func TestInventoryRecord18Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.InventoryRecord18{
		ID: "id-18", DisplayName: "Lifecycle InventoryRecord18", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
