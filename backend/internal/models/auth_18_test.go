...
func TestAuthRecord18Validate(t *testing.T) {
	t.Parallel()
	valid := &models.AuthRecord18{
		ID: "id-18", DisplayName: "Sample AuthRecord18", Status: "active", Priority: 10,
	}
...
func TestAuthRecord18Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.AuthRecord18{
		ID: "id-18", DisplayName: "Lifecycle AuthRecord18", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
