...
func TestQualityControlRecord25Validate(t *testing.T) {
	t.Parallel()
	valid := &models.QualityControlRecord25{
		ID: "id-25", DisplayName: "Sample QualityControlRecord25", Status: "active", Priority: 10,
	}
...
func TestQualityControlRecord25Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.QualityControlRecord25{
		ID: "id-25", DisplayName: "Lifecycle QualityControlRecord25", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
