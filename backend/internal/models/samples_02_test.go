...
func TestSampleRecord02Validate(t *testing.T) {
	t.Parallel()
	valid := &models.SampleRecord02{
		ID: "id-2", DisplayName: "Sample SampleRecord02", Status: "active", Priority: 10,
	}
...
func TestSampleRecord02Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.SampleRecord02{
		ID: "id-2", DisplayName: "Lifecycle SampleRecord02", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
