...
func TestSampleRecord13Validate(t *testing.T) {
	t.Parallel()
	valid := &models.SampleRecord13{
		ID: "id-13", DisplayName: "Sample SampleRecord13", Status: "active", Priority: 10,
	}
...
func TestSampleRecord13Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.SampleRecord13{
		ID: "id-13", DisplayName: "Lifecycle SampleRecord13", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
