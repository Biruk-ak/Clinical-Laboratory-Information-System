...
func TestAuthRecord26Validate(t *testing.T) {
	t.Parallel()
	valid := &models.AuthRecord26{
		ID: "id-26", DisplayName: "Sample AuthRecord26", Status: "active", Priority: 10,
	}
...
func TestAuthRecord26Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.AuthRecord26{
		ID: "id-26", DisplayName: "Lifecycle AuthRecord26", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
