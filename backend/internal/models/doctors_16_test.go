...
func TestDoctorRecord16Validate(t *testing.T) {
	t.Parallel()
	valid := &models.DoctorRecord16{
		ID: "id-16", DisplayName: "Sample DoctorRecord16", Status: "active", Priority: 10,
	}
...
func TestDoctorRecord16Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.DoctorRecord16{
		ID: "id-16", DisplayName: "Lifecycle DoctorRecord16", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
