...
func TestAuthRecord05Validate(t *testing.T) {
	t.Parallel()
	valid := &models.AuthRecord05{
		ID: "id-5", DisplayName: "Sample AuthRecord05", Status: "active", Priority: 10,
	}
...
func TestAuthRecord05Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.AuthRecord05{
		ID: "id-5", DisplayName: "Lifecycle AuthRecord05", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
