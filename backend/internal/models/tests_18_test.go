...
func TestLabTestRecord18Validate(t *testing.T) {
	t.Parallel()
	valid := &models.LabTestRecord18{
		ID: "id-18", DisplayName: "Sample LabTestRecord18", Status: "active", Priority: 10,
	}
...
func TestLabTestRecord18Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.LabTestRecord18{
		ID: "id-18", DisplayName: "Lifecycle LabTestRecord18", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
