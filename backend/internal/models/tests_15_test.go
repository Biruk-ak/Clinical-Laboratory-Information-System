...
func TestLabTestRecord15Validate(t *testing.T) {
	t.Parallel()
	valid := &models.LabTestRecord15{
		ID: "id-15", DisplayName: "Sample LabTestRecord15", Status: "active", Priority: 10,
	}
...
func TestLabTestRecord15Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.LabTestRecord15{
		ID: "id-15", DisplayName: "Lifecycle LabTestRecord15", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
