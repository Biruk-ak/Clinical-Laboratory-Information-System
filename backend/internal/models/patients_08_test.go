...
func TestPatientRecord08Validate(t *testing.T) {
	t.Parallel()
	valid := &models.PatientRecord08{
		ID: "id-8", DisplayName: "Sample PatientRecord08", Status: "active", Priority: 10,
	}
...
func TestPatientRecord08Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.PatientRecord08{
		ID: "id-8", DisplayName: "Lifecycle PatientRecord08", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
