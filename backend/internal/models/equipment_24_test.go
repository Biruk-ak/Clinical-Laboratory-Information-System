...
func TestEquipmentRecord24Validate(t *testing.T) {
	t.Parallel()
	valid := &models.EquipmentRecord24{
		ID: "id-24", DisplayName: "Sample EquipmentRecord24", Status: "active", Priority: 10,
	}
...
func TestEquipmentRecord24Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.EquipmentRecord24{
		ID: "id-24", DisplayName: "Lifecycle EquipmentRecord24", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
