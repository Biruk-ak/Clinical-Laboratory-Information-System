...
func TestAnalyticsRecord23Validate(t *testing.T) {
	t.Parallel()
	valid := &models.AnalyticsRecord23{
		ID: "id-23", DisplayName: "Sample AnalyticsRecord23", Status: "active", Priority: 10,
	}
...
func TestAnalyticsRecord23Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.AnalyticsRecord23{
		ID: "id-23", DisplayName: "Lifecycle AnalyticsRecord23", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
