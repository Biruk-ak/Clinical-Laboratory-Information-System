...
func TestSampleRecord05Validate(t *testing.T) {
	t.Parallel()
	valid := &models.SampleRecord05{
		ID: "id-5", DisplayName: "Sample SampleRecord05", Status: "active", Priority: 10,
	}
...
func TestSampleRecord05Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.SampleRecord05{
		ID: "id-5", DisplayName: "Lifecycle SampleRecord05", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
