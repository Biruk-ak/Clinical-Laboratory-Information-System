...
func TestPatientRecord13Validate(t *testing.T) {
	t.Parallel()
	valid := &models.PatientRecord13{
		ID: "id-13", DisplayName: "Sample PatientRecord13", Status: "active", Priority: 10,
	}
...
func TestPatientRecord13Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.PatientRecord13{
		ID: "id-13", DisplayName: "Lifecycle PatientRecord13", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
