...
func TestPatientRecord18Validate(t *testing.T) {
	t.Parallel()
	valid := &models.PatientRecord18{
		ID: "id-18", DisplayName: "Sample PatientRecord18", Status: "active", Priority: 10,
	}
...
func TestPatientRecord18Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.PatientRecord18{
		ID: "id-18", DisplayName: "Lifecycle PatientRecord18", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
