...
func TestEquipmentRecord25Validate(t *testing.T) {
	t.Parallel()
	valid := &models.EquipmentRecord25{
		ID: "id-25", DisplayName: "Sample EquipmentRecord25", Status: "active", Priority: 10,
	}
...
func TestEquipmentRecord25Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.EquipmentRecord25{
		ID: "id-25", DisplayName: "Lifecycle EquipmentRecord25", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
