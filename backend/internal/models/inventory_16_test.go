...
func TestInventoryRecord16Validate(t *testing.T) {
	t.Parallel()
	valid := &models.InventoryRecord16{
		ID: "id-16", DisplayName: "Sample InventoryRecord16", Status: "active", Priority: 10,
	}
...
func TestInventoryRecord16Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.InventoryRecord16{
		ID: "id-16", DisplayName: "Lifecycle InventoryRecord16", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
