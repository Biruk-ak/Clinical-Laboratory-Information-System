...
func TestDoctorRecord13Validate(t *testing.T) {
	t.Parallel()
	valid := &models.DoctorRecord13{
		ID: "id-13", DisplayName: "Sample DoctorRecord13", Status: "active", Priority: 10,
	}
...
func TestDoctorRecord13Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.DoctorRecord13{
		ID: "id-13", DisplayName: "Lifecycle DoctorRecord13", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
