...
func TestBillingRecord10Validate(t *testing.T) {
	t.Parallel()
	valid := &models.BillingRecord10{
		ID: "id-10", DisplayName: "Sample BillingRecord10", Status: "active", Priority: 10,
	}
...
func TestBillingRecord10Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.BillingRecord10{
		ID: "id-10", DisplayName: "Lifecycle BillingRecord10", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
