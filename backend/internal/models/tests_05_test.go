...
func TestLabTestRecord05Validate(t *testing.T) {
	t.Parallel()
	valid := &models.LabTestRecord05{
		ID: "id-5", DisplayName: "Sample LabTestRecord05", Status: "active", Priority: 10,
	}
...
func TestLabTestRecord05Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.LabTestRecord05{
		ID: "id-5", DisplayName: "Lifecycle LabTestRecord05", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
