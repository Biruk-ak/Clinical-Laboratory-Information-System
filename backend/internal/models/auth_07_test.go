...
func TestAuthRecord07Validate(t *testing.T) {
	t.Parallel()
	valid := &models.AuthRecord07{
		ID: "id-7", DisplayName: "Sample AuthRecord07", Status: "active", Priority: 10,
	}
...
func TestAuthRecord07Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.AuthRecord07{
		ID: "id-7", DisplayName: "Lifecycle AuthRecord07", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
