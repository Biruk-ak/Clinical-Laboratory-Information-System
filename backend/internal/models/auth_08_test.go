...
func TestAuthRecord08Validate(t *testing.T) {
	t.Parallel()
	valid := &models.AuthRecord08{
		ID: "id-8", DisplayName: "Sample AuthRecord08", Status: "active", Priority: 10,
	}
...
func TestAuthRecord08Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.AuthRecord08{
		ID: "id-8", DisplayName: "Lifecycle AuthRecord08", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
