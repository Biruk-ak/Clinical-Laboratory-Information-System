...
func TestDoctorRecord01Validate(t *testing.T) {
	t.Parallel()
	valid := &models.DoctorRecord01{
		ID: "id-1", DisplayName: "Sample DoctorRecord01", Status: "active", Priority: 10,
	}
...
func TestDoctorRecord01Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.DoctorRecord01{
		ID: "id-1", DisplayName: "Lifecycle DoctorRecord01", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
