...
func TestHospitalRecord26Validate(t *testing.T) {
	t.Parallel()
	valid := &models.HospitalRecord26{
		ID: "id-26", DisplayName: "Sample HospitalRecord26", Status: "active", Priority: 10,
	}
...
func TestHospitalRecord26Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.HospitalRecord26{
		ID: "id-26", DisplayName: "Lifecycle HospitalRecord26", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
