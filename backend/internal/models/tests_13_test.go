...
func TestLabTestRecord13Validate(t *testing.T) {
	t.Parallel()
	valid := &models.LabTestRecord13{
		ID: "id-13", DisplayName: "Sample LabTestRecord13", Status: "active", Priority: 10,
	}
...
func TestLabTestRecord13Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.LabTestRecord13{
		ID: "id-13", DisplayName: "Lifecycle LabTestRecord13", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
