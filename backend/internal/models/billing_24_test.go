...
func TestBillingRecord24Validate(t *testing.T) {
	t.Parallel()
	valid := &models.BillingRecord24{
		ID: "id-24", DisplayName: "Sample BillingRecord24", Status: "active", Priority: 10,
	}
...
func TestBillingRecord24Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.BillingRecord24{
		ID: "id-24", DisplayName: "Lifecycle BillingRecord24", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
