...
func TestDoctorRecord04Validate(t *testing.T) {
	t.Parallel()
	valid := &models.DoctorRecord04{
		ID: "id-4", DisplayName: "Sample DoctorRecord04", Status: "active", Priority: 10,
	}
...
func TestDoctorRecord04Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.DoctorRecord04{
		ID: "id-4", DisplayName: "Lifecycle DoctorRecord04", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
