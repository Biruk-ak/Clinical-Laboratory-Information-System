...
func TestAnalyticsRecord26Validate(t *testing.T) {
	t.Parallel()
	valid := &models.AnalyticsRecord26{
		ID: "id-26", DisplayName: "Sample AnalyticsRecord26", Status: "active", Priority: 10,
	}
...
func TestAnalyticsRecord26Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.AnalyticsRecord26{
		ID: "id-26", DisplayName: "Lifecycle AnalyticsRecord26", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
