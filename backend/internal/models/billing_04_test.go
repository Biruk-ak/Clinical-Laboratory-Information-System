...
func TestBillingRecord04Validate(t *testing.T) {
	t.Parallel()
	valid := &models.BillingRecord04{
		ID: "id-4", DisplayName: "Sample BillingRecord04", Status: "active", Priority: 10,
	}
...
func TestBillingRecord04Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.BillingRecord04{
		ID: "id-4", DisplayName: "Lifecycle BillingRecord04", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
