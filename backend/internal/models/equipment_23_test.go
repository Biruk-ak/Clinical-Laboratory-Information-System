...
func TestEquipmentRecord23Validate(t *testing.T) {
	t.Parallel()
	valid := &models.EquipmentRecord23{
		ID: "id-23", DisplayName: "Sample EquipmentRecord23", Status: "active", Priority: 10,
	}
...
func TestEquipmentRecord23Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.EquipmentRecord23{
		ID: "id-23", DisplayName: "Lifecycle EquipmentRecord23", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
