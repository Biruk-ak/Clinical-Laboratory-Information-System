...
func TestLabTestRecord09Validate(t *testing.T) {
	t.Parallel()
	valid := &models.LabTestRecord09{
		ID: "id-9", DisplayName: "Sample LabTestRecord09", Status: "active", Priority: 10,
	}
...
func TestLabTestRecord09Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.LabTestRecord09{
		ID: "id-9", DisplayName: "Lifecycle LabTestRecord09", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
