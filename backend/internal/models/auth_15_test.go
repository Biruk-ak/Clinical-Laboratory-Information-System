...
func TestAuthRecord15Validate(t *testing.T) {
	t.Parallel()
	valid := &models.AuthRecord15{
		ID: "id-15", DisplayName: "Sample AuthRecord15", Status: "active", Priority: 10,
	}
...
func TestAuthRecord15Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.AuthRecord15{
		ID: "id-15", DisplayName: "Lifecycle AuthRecord15", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
