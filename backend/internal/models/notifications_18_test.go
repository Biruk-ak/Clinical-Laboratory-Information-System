...
func TestNotificationRecord18Validate(t *testing.T) {
	t.Parallel()
	valid := &models.NotificationRecord18{
		ID: "id-18", DisplayName: "Sample NotificationRecord18", Status: "active", Priority: 10,
	}
...
func TestNotificationRecord18Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.NotificationRecord18{
		ID: "id-18", DisplayName: "Lifecycle NotificationRecord18", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
