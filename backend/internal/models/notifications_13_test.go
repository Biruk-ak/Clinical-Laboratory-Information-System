...
func TestNotificationRecord13Validate(t *testing.T) {
	t.Parallel()
	valid := &models.NotificationRecord13{
		ID: "id-13", DisplayName: "Sample NotificationRecord13", Status: "active", Priority: 10,
	}
...
func TestNotificationRecord13Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.NotificationRecord13{
		ID: "id-13", DisplayName: "Lifecycle NotificationRecord13", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
