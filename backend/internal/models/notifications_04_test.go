...
func TestNotificationRecord04Validate(t *testing.T) {
	t.Parallel()
	valid := &models.NotificationRecord04{
		ID: "id-4", DisplayName: "Sample NotificationRecord04", Status: "active", Priority: 10,
	}
...
func TestNotificationRecord04Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.NotificationRecord04{
		ID: "id-4", DisplayName: "Lifecycle NotificationRecord04", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
