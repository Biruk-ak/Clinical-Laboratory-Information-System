...
func TestInventoryRecord22Validate(t *testing.T) {
	t.Parallel()
	valid := &models.InventoryRecord22{
		ID: "id-22", DisplayName: "Sample InventoryRecord22", Status: "active", Priority: 10,
	}
...
func TestInventoryRecord22Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.InventoryRecord22{
		ID: "id-22", DisplayName: "Lifecycle InventoryRecord22", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
