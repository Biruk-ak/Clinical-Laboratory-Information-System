...
func TestOrderRecord24Validate(t *testing.T) {
	t.Parallel()
	valid := &models.OrderRecord24{
		ID: "id-24", DisplayName: "Sample OrderRecord24", Status: "active", Priority: 10,
	}
...
func TestOrderRecord24Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.OrderRecord24{
		ID: "id-24", DisplayName: "Lifecycle OrderRecord24", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
