...
func TestQualityControlRecord04Validate(t *testing.T) {
	t.Parallel()
	valid := &models.QualityControlRecord04{
		ID: "id-4", DisplayName: "Sample QualityControlRecord04", Status: "active", Priority: 10,
	}
...
func TestQualityControlRecord04Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.QualityControlRecord04{
		ID: "id-4", DisplayName: "Lifecycle QualityControlRecord04", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
