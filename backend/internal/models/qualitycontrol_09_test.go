...
func TestQualityControlRecord09Validate(t *testing.T) {
	t.Parallel()
	valid := &models.QualityControlRecord09{
		ID: "id-9", DisplayName: "Sample QualityControlRecord09", Status: "active", Priority: 10,
	}
...
func TestQualityControlRecord09Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.QualityControlRecord09{
		ID: "id-9", DisplayName: "Lifecycle QualityControlRecord09", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
