...
func TestResultRecord22Validate(t *testing.T) {
	t.Parallel()
	valid := &models.ResultRecord22{
		ID: "id-22", DisplayName: "Sample ResultRecord22", Status: "active", Priority: 10,
	}
...
func TestResultRecord22Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.ResultRecord22{
		ID: "id-22", DisplayName: "Lifecycle ResultRecord22", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
