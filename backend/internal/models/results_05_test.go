...
func TestResultRecord05Validate(t *testing.T) {
	t.Parallel()
	valid := &models.ResultRecord05{
		ID: "id-5", DisplayName: "Sample ResultRecord05", Status: "active", Priority: 10,
	}
...
func TestResultRecord05Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.ResultRecord05{
		ID: "id-5", DisplayName: "Lifecycle ResultRecord05", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
