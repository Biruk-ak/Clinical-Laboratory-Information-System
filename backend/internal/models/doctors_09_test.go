...
func TestDoctorRecord09Validate(t *testing.T) {
	t.Parallel()
	valid := &models.DoctorRecord09{
		ID: "id-9", DisplayName: "Sample DoctorRecord09", Status: "active", Priority: 10,
	}
...
func TestDoctorRecord09Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.DoctorRecord09{
		ID: "id-9", DisplayName: "Lifecycle DoctorRecord09", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
