...
func TestEquipmentRecord15Validate(t *testing.T) {
	t.Parallel()
	valid := &models.EquipmentRecord15{
		ID: "id-15", DisplayName: "Sample EquipmentRecord15", Status: "active", Priority: 10,
	}
...
func TestEquipmentRecord15Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.EquipmentRecord15{
		ID: "id-15", DisplayName: "Lifecycle EquipmentRecord15", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
