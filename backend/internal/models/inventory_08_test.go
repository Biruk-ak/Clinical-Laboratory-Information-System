...
func TestInventoryRecord08Validate(t *testing.T) {
	t.Parallel()
	valid := &models.InventoryRecord08{
		ID: "id-8", DisplayName: "Sample InventoryRecord08", Status: "active", Priority: 10,
	}
...
func TestInventoryRecord08Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.InventoryRecord08{
		ID: "id-8", DisplayName: "Lifecycle InventoryRecord08", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
