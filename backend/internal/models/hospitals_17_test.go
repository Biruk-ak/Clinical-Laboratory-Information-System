...
func TestHospitalRecord17Validate(t *testing.T) {
	t.Parallel()
	valid := &models.HospitalRecord17{
		ID: "id-17", DisplayName: "Sample HospitalRecord17", Status: "active", Priority: 10,
	}
...
func TestHospitalRecord17Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.HospitalRecord17{
		ID: "id-17", DisplayName: "Lifecycle HospitalRecord17", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
