...
func TestOrderRecord23Validate(t *testing.T) {
	t.Parallel()
	valid := &models.OrderRecord23{
		ID: "id-23", DisplayName: "Sample OrderRecord23", Status: "active", Priority: 10,
	}
...
func TestOrderRecord23Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.OrderRecord23{
		ID: "id-23", DisplayName: "Lifecycle OrderRecord23", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
