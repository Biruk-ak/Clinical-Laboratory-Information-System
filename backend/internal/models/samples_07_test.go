...
func TestSampleRecord07Validate(t *testing.T) {
	t.Parallel()
	valid := &models.SampleRecord07{
		ID: "id-7", DisplayName: "Sample SampleRecord07", Status: "active", Priority: 10,
	}
...
func TestSampleRecord07Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.SampleRecord07{
		ID: "id-7", DisplayName: "Lifecycle SampleRecord07", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
