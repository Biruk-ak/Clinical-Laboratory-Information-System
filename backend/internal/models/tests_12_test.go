...
func TestLabTestRecord12Validate(t *testing.T) {
	t.Parallel()
	valid := &models.LabTestRecord12{
		ID: "id-12", DisplayName: "Sample LabTestRecord12", Status: "active", Priority: 10,
	}
...
func TestLabTestRecord12Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.LabTestRecord12{
		ID: "id-12", DisplayName: "Lifecycle LabTestRecord12", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
