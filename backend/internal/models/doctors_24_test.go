...
func TestDoctorRecord24Validate(t *testing.T) {
	t.Parallel()
	valid := &models.DoctorRecord24{
		ID: "id-24", DisplayName: "Sample DoctorRecord24", Status: "active", Priority: 10,
	}
...
func TestDoctorRecord24Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.DoctorRecord24{
		ID: "id-24", DisplayName: "Lifecycle DoctorRecord24", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
