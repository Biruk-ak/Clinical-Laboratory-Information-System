...
func TestBillingRecord19Validate(t *testing.T) {
	t.Parallel()
	valid := &models.BillingRecord19{
		ID: "id-19", DisplayName: "Sample BillingRecord19", Status: "active", Priority: 10,
	}
...
func TestBillingRecord19Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.BillingRecord19{
		ID: "id-19", DisplayName: "Lifecycle BillingRecord19", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
