...
func TestHospitalRecord23Validate(t *testing.T) {
	t.Parallel()
	valid := &models.HospitalRecord23{
		ID: "id-23", DisplayName: "Sample HospitalRecord23", Status: "active", Priority: 10,
	}
...
func TestHospitalRecord23Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.HospitalRecord23{
		ID: "id-23", DisplayName: "Lifecycle HospitalRecord23", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
