...
func TestOrderRecord09Validate(t *testing.T) {
	t.Parallel()
	valid := &models.OrderRecord09{
		ID: "id-9", DisplayName: "Sample OrderRecord09", Status: "active", Priority: 10,
	}
...
func TestOrderRecord09Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.OrderRecord09{
		ID: "id-9", DisplayName: "Lifecycle OrderRecord09", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
