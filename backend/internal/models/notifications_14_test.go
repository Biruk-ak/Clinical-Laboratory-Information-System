...
func TestNotificationRecord14Validate(t *testing.T) {
	t.Parallel()
	valid := &models.NotificationRecord14{
		ID: "id-14", DisplayName: "Sample NotificationRecord14", Status: "active", Priority: 10,
	}
...
func TestNotificationRecord14Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.NotificationRecord14{
		ID: "id-14", DisplayName: "Lifecycle NotificationRecord14", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
