...
func TestQualityControlRecord14Validate(t *testing.T) {
	t.Parallel()
	valid := &models.QualityControlRecord14{
		ID: "id-14", DisplayName: "Sample QualityControlRecord14", Status: "active", Priority: 10,
	}
...
func TestQualityControlRecord14Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.QualityControlRecord14{
		ID: "id-14", DisplayName: "Lifecycle QualityControlRecord14", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
