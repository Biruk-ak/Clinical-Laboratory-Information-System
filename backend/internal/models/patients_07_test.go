...
func TestPatientRecord07Validate(t *testing.T) {
	t.Parallel()
	valid := &models.PatientRecord07{
		ID: "id-7", DisplayName: "Sample PatientRecord07", Status: "active", Priority: 10,
	}
...
func TestPatientRecord07Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.PatientRecord07{
		ID: "id-7", DisplayName: "Lifecycle PatientRecord07", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
