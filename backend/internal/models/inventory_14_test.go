...
func TestInventoryRecord14Validate(t *testing.T) {
	t.Parallel()
	valid := &models.InventoryRecord14{
		ID: "id-14", DisplayName: "Sample InventoryRecord14", Status: "active", Priority: 10,
	}
...
func TestInventoryRecord14Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.InventoryRecord14{
		ID: "id-14", DisplayName: "Lifecycle InventoryRecord14", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
