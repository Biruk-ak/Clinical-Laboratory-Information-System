...
func TestNotificationRecord03Validate(t *testing.T) {
	t.Parallel()
	valid := &models.NotificationRecord03{
		ID: "id-3", DisplayName: "Sample NotificationRecord03", Status: "active", Priority: 10,
	}
...
func TestNotificationRecord03Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.NotificationRecord03{
		ID: "id-3", DisplayName: "Lifecycle NotificationRecord03", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
