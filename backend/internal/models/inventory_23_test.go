...
func TestInventoryRecord23Validate(t *testing.T) {
	t.Parallel()
	valid := &models.InventoryRecord23{
		ID: "id-23", DisplayName: "Sample InventoryRecord23", Status: "active", Priority: 10,
	}
...
func TestInventoryRecord23Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.InventoryRecord23{
		ID: "id-23", DisplayName: "Lifecycle InventoryRecord23", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
