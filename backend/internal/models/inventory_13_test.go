...
func TestInventoryRecord13Validate(t *testing.T) {
	t.Parallel()
	valid := &models.InventoryRecord13{
		ID: "id-13", DisplayName: "Sample InventoryRecord13", Status: "active", Priority: 10,
	}
...
func TestInventoryRecord13Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.InventoryRecord13{
		ID: "id-13", DisplayName: "Lifecycle InventoryRecord13", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
