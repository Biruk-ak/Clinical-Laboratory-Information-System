...
func TestReportRecord11Validate(t *testing.T) {
	t.Parallel()
	valid := &models.ReportRecord11{
		ID: "id-11", DisplayName: "Sample ReportRecord11", Status: "active", Priority: 10,
	}
...
func TestReportRecord11Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.ReportRecord11{
		ID: "id-11", DisplayName: "Lifecycle ReportRecord11", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
