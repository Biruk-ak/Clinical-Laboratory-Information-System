...
func TestReportRecord04Validate(t *testing.T) {
	t.Parallel()
	valid := &models.ReportRecord04{
		ID: "id-4", DisplayName: "Sample ReportRecord04", Status: "active", Priority: 10,
	}
...
func TestReportRecord04Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.ReportRecord04{
		ID: "id-4", DisplayName: "Lifecycle ReportRecord04", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
