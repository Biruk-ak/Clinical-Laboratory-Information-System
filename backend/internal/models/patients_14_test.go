...
func TestPatientRecord14Validate(t *testing.T) {
	t.Parallel()
	valid := &models.PatientRecord14{
		ID: "id-14", DisplayName: "Sample PatientRecord14", Status: "active", Priority: 10,
	}
...
func TestPatientRecord14Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.PatientRecord14{
		ID: "id-14", DisplayName: "Lifecycle PatientRecord14", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
