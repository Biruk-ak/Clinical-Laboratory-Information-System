...
func TestHospitalRecord03Validate(t *testing.T) {
	t.Parallel()
	valid := &models.HospitalRecord03{
		ID: "id-3", DisplayName: "Sample HospitalRecord03", Status: "active", Priority: 10,
	}
...
func TestHospitalRecord03Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.HospitalRecord03{
		ID: "id-3", DisplayName: "Lifecycle HospitalRecord03", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
