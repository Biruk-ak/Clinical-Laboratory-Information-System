...
func TestPatientRecord15Validate(t *testing.T) {
	t.Parallel()
	valid := &models.PatientRecord15{
		ID: "id-15", DisplayName: "Sample PatientRecord15", Status: "active", Priority: 10,
	}
...
func TestPatientRecord15Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.PatientRecord15{
		ID: "id-15", DisplayName: "Lifecycle PatientRecord15", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
