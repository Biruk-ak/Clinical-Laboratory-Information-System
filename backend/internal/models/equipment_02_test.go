...
func TestEquipmentRecord02Validate(t *testing.T) {
	t.Parallel()
	valid := &models.EquipmentRecord02{
		ID: "id-2", DisplayName: "Sample EquipmentRecord02", Status: "active", Priority: 10,
	}
...
func TestEquipmentRecord02Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.EquipmentRecord02{
		ID: "id-2", DisplayName: "Lifecycle EquipmentRecord02", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
