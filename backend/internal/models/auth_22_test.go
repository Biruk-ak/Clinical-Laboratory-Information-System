...
func TestAuthRecord22Validate(t *testing.T) {
	t.Parallel()
	valid := &models.AuthRecord22{
		ID: "id-22", DisplayName: "Sample AuthRecord22", Status: "active", Priority: 10,
	}
...
func TestAuthRecord22Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.AuthRecord22{
		ID: "id-22", DisplayName: "Lifecycle AuthRecord22", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
