...
func TestResultRecord19Validate(t *testing.T) {
	t.Parallel()
	valid := &models.ResultRecord19{
		ID: "id-19", DisplayName: "Sample ResultRecord19", Status: "active", Priority: 10,
	}
...
func TestResultRecord19Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.ResultRecord19{
		ID: "id-19", DisplayName: "Lifecycle ResultRecord19", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
