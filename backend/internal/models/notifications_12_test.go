...
func TestNotificationRecord12Validate(t *testing.T) {
	t.Parallel()
	valid := &models.NotificationRecord12{
		ID: "id-12", DisplayName: "Sample NotificationRecord12", Status: "active", Priority: 10,
	}
...
func TestNotificationRecord12Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.NotificationRecord12{
		ID: "id-12", DisplayName: "Lifecycle NotificationRecord12", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
