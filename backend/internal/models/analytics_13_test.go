...
func TestAnalyticsRecord13Validate(t *testing.T) {
	t.Parallel()
	valid := &models.AnalyticsRecord13{
		ID: "id-13", DisplayName: "Sample AnalyticsRecord13", Status: "active", Priority: 10,
	}
...
func TestAnalyticsRecord13Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.AnalyticsRecord13{
		ID: "id-13", DisplayName: "Lifecycle AnalyticsRecord13", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
