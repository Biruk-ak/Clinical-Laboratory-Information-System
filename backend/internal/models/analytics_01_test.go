...
func TestAnalyticsRecord01Validate(t *testing.T) {
	t.Parallel()
	valid := &models.AnalyticsRecord01{
		ID: "id-1", DisplayName: "Sample AnalyticsRecord01", Status: "active", Priority: 10,
	}
...
func TestAnalyticsRecord01Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.AnalyticsRecord01{
		ID: "id-1", DisplayName: "Lifecycle AnalyticsRecord01", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
