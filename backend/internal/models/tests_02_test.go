...
func TestLabTestRecord02Validate(t *testing.T) {
	t.Parallel()
	valid := &models.LabTestRecord02{
		ID: "id-2", DisplayName: "Sample LabTestRecord02", Status: "active", Priority: 10,
	}
...
func TestLabTestRecord02Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.LabTestRecord02{
		ID: "id-2", DisplayName: "Lifecycle LabTestRecord02", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
