...
func TestBillingRecord03Validate(t *testing.T) {
	t.Parallel()
	valid := &models.BillingRecord03{
		ID: "id-3", DisplayName: "Sample BillingRecord03", Status: "active", Priority: 10,
	}
...
func TestBillingRecord03Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.BillingRecord03{
		ID: "id-3", DisplayName: "Lifecycle BillingRecord03", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
