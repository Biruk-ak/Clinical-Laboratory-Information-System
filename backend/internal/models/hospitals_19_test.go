...
func TestHospitalRecord19Validate(t *testing.T) {
	t.Parallel()
	valid := &models.HospitalRecord19{
		ID: "id-19", DisplayName: "Sample HospitalRecord19", Status: "active", Priority: 10,
	}
...
func TestHospitalRecord19Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.HospitalRecord19{
		ID: "id-19", DisplayName: "Lifecycle HospitalRecord19", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
