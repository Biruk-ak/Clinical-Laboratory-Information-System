...
func TestHospitalRecord13Validate(t *testing.T) {
	t.Parallel()
	valid := &models.HospitalRecord13{
		ID: "id-13", DisplayName: "Sample HospitalRecord13", Status: "active", Priority: 10,
	}
...
func TestHospitalRecord13Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.HospitalRecord13{
		ID: "id-13", DisplayName: "Lifecycle HospitalRecord13", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
