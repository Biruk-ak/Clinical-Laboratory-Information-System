...
func TestEquipmentRecord01Validate(t *testing.T) {
	t.Parallel()
	valid := &models.EquipmentRecord01{
		ID: "id-1", DisplayName: "Sample EquipmentRecord01", Status: "active", Priority: 10,
	}
...
func TestEquipmentRecord01Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.EquipmentRecord01{
		ID: "id-1", DisplayName: "Lifecycle EquipmentRecord01", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
