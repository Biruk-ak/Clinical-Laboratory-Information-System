...
func TestOrderRecord20Validate(t *testing.T) {
	t.Parallel()
	valid := &models.OrderRecord20{
		ID: "id-20", DisplayName: "Sample OrderRecord20", Status: "active", Priority: 10,
	}
...
func TestOrderRecord20Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.OrderRecord20{
		ID: "id-20", DisplayName: "Lifecycle OrderRecord20", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
