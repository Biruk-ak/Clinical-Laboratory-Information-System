...
func TestDoctorRecord23Validate(t *testing.T) {
	t.Parallel()
	valid := &models.DoctorRecord23{
		ID: "id-23", DisplayName: "Sample DoctorRecord23", Status: "active", Priority: 10,
	}
...
func TestDoctorRecord23Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.DoctorRecord23{
		ID: "id-23", DisplayName: "Lifecycle DoctorRecord23", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
