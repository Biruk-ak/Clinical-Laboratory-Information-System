...
func TestQualityControlRecord05Validate(t *testing.T) {
	t.Parallel()
	valid := &models.QualityControlRecord05{
		ID: "id-5", DisplayName: "Sample QualityControlRecord05", Status: "active", Priority: 10,
	}
...
func TestQualityControlRecord05Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.QualityControlRecord05{
		ID: "id-5", DisplayName: "Lifecycle QualityControlRecord05", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
