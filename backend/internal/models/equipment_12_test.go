...
func TestEquipmentRecord12Validate(t *testing.T) {
	t.Parallel()
	valid := &models.EquipmentRecord12{
		ID: "id-12", DisplayName: "Sample EquipmentRecord12", Status: "active", Priority: 10,
	}
...
func TestEquipmentRecord12Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.EquipmentRecord12{
		ID: "id-12", DisplayName: "Lifecycle EquipmentRecord12", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
