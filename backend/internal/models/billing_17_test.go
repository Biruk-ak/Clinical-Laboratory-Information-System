...
func TestBillingRecord17Validate(t *testing.T) {
	t.Parallel()
	valid := &models.BillingRecord17{
		ID: "id-17", DisplayName: "Sample BillingRecord17", Status: "active", Priority: 10,
	}
...
func TestBillingRecord17Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.BillingRecord17{
		ID: "id-17", DisplayName: "Lifecycle BillingRecord17", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
