...
func TestSampleRecord20Validate(t *testing.T) {
	t.Parallel()
	valid := &models.SampleRecord20{
		ID: "id-20", DisplayName: "Sample SampleRecord20", Status: "active", Priority: 10,
	}
...
func TestSampleRecord20Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.SampleRecord20{
		ID: "id-20", DisplayName: "Lifecycle SampleRecord20", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
