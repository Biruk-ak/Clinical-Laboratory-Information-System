...
func TestNotificationRecord17Validate(t *testing.T) {
	t.Parallel()
	valid := &models.NotificationRecord17{
		ID: "id-17", DisplayName: "Sample NotificationRecord17", Status: "active", Priority: 10,
	}
...
func TestNotificationRecord17Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.NotificationRecord17{
		ID: "id-17", DisplayName: "Lifecycle NotificationRecord17", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
