...
func TestQualityControlRecord03Validate(t *testing.T) {
	t.Parallel()
	valid := &models.QualityControlRecord03{
		ID: "id-3", DisplayName: "Sample QualityControlRecord03", Status: "active", Priority: 10,
	}
...
func TestQualityControlRecord03Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.QualityControlRecord03{
		ID: "id-3", DisplayName: "Lifecycle QualityControlRecord03", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
