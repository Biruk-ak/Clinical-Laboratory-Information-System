...
func TestAnalyticsRecord14Validate(t *testing.T) {
	t.Parallel()
	valid := &models.AnalyticsRecord14{
		ID: "id-14", DisplayName: "Sample AnalyticsRecord14", Status: "active", Priority: 10,
	}
...
func TestAnalyticsRecord14Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.AnalyticsRecord14{
		ID: "id-14", DisplayName: "Lifecycle AnalyticsRecord14", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
