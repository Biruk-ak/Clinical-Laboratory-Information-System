...
func TestPatientRecord11Validate(t *testing.T) {
	t.Parallel()
	valid := &models.PatientRecord11{
		ID: "id-11", DisplayName: "Sample PatientRecord11", Status: "active", Priority: 10,
	}
...
func TestPatientRecord11Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.PatientRecord11{
		ID: "id-11", DisplayName: "Lifecycle PatientRecord11", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
