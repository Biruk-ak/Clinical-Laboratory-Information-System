...
func TestPatientRecord19Validate(t *testing.T) {
	t.Parallel()
	valid := &models.PatientRecord19{
		ID: "id-19", DisplayName: "Sample PatientRecord19", Status: "active", Priority: 10,
	}
...
func TestPatientRecord19Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.PatientRecord19{
		ID: "id-19", DisplayName: "Lifecycle PatientRecord19", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
