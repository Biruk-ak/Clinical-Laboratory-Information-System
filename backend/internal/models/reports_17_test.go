...
func TestReportRecord17Validate(t *testing.T) {
	t.Parallel()
	valid := &models.ReportRecord17{
		ID: "id-17", DisplayName: "Sample ReportRecord17", Status: "active", Priority: 10,
	}
...
func TestReportRecord17Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.ReportRecord17{
		ID: "id-17", DisplayName: "Lifecycle ReportRecord17", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
