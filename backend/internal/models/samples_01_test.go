...
func TestSampleRecord01Validate(t *testing.T) {
	t.Parallel()
	valid := &models.SampleRecord01{
		ID: "id-1", DisplayName: "Sample SampleRecord01", Status: "active", Priority: 10,
	}
...
func TestSampleRecord01Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.SampleRecord01{
		ID: "id-1", DisplayName: "Lifecycle SampleRecord01", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
