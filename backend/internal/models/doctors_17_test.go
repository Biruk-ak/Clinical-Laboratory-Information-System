...
func TestDoctorRecord17Validate(t *testing.T) {
	t.Parallel()
	valid := &models.DoctorRecord17{
		ID: "id-17", DisplayName: "Sample DoctorRecord17", Status: "active", Priority: 10,
	}
...
func TestDoctorRecord17Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.DoctorRecord17{
		ID: "id-17", DisplayName: "Lifecycle DoctorRecord17", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
