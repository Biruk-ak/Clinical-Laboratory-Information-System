...
func TestLabTestRecord11Validate(t *testing.T) {
	t.Parallel()
	valid := &models.LabTestRecord11{
		ID: "id-11", DisplayName: "Sample LabTestRecord11", Status: "active", Priority: 10,
	}
...
func TestLabTestRecord11Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.LabTestRecord11{
		ID: "id-11", DisplayName: "Lifecycle LabTestRecord11", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
