...
func TestNotificationRecord24Validate(t *testing.T) {
	t.Parallel()
	valid := &models.NotificationRecord24{
		ID: "id-24", DisplayName: "Sample NotificationRecord24", Status: "active", Priority: 10,
	}
...
func TestNotificationRecord24Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.NotificationRecord24{
		ID: "id-24", DisplayName: "Lifecycle NotificationRecord24", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
