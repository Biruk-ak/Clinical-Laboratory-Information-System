...
func TestEquipmentRecord21Validate(t *testing.T) {
	t.Parallel()
	valid := &models.EquipmentRecord21{
		ID: "id-21", DisplayName: "Sample EquipmentRecord21", Status: "active", Priority: 10,
	}
...
func TestEquipmentRecord21Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.EquipmentRecord21{
		ID: "id-21", DisplayName: "Lifecycle EquipmentRecord21", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
