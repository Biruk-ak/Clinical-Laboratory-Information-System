...
func TestReportRecord03Validate(t *testing.T) {
	t.Parallel()
	valid := &models.ReportRecord03{
		ID: "id-3", DisplayName: "Sample ReportRecord03", Status: "active", Priority: 10,
	}
...
func TestReportRecord03Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.ReportRecord03{
		ID: "id-3", DisplayName: "Lifecycle ReportRecord03", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
