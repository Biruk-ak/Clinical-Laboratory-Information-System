...
func TestAnalyticsRecord18Validate(t *testing.T) {
	t.Parallel()
	valid := &models.AnalyticsRecord18{
		ID: "id-18", DisplayName: "Sample AnalyticsRecord18", Status: "active", Priority: 10,
	}
...
func TestAnalyticsRecord18Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.AnalyticsRecord18{
		ID: "id-18", DisplayName: "Lifecycle AnalyticsRecord18", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
