...
func TestAnalyticsRecord27Validate(t *testing.T) {
	t.Parallel()
	valid := &models.AnalyticsRecord27{
		ID: "id-27", DisplayName: "Sample AnalyticsRecord27", Status: "active", Priority: 10,
	}
...
func TestAnalyticsRecord27Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.AnalyticsRecord27{
		ID: "id-27", DisplayName: "Lifecycle AnalyticsRecord27", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
