...
func TestSampleRecord15Validate(t *testing.T) {
	t.Parallel()
	valid := &models.SampleRecord15{
		ID: "id-15", DisplayName: "Sample SampleRecord15", Status: "active", Priority: 10,
	}
...
func TestSampleRecord15Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.SampleRecord15{
		ID: "id-15", DisplayName: "Lifecycle SampleRecord15", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
