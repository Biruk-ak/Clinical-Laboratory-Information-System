...
func TestAnalyticsRecord25Validate(t *testing.T) {
	t.Parallel()
	valid := &models.AnalyticsRecord25{
		ID: "id-25", DisplayName: "Sample AnalyticsRecord25", Status: "active", Priority: 10,
	}
...
func TestAnalyticsRecord25Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.AnalyticsRecord25{
		ID: "id-25", DisplayName: "Lifecycle AnalyticsRecord25", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
