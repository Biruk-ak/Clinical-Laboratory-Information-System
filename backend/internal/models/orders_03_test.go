...
func TestOrderRecord03Validate(t *testing.T) {
	t.Parallel()
	valid := &models.OrderRecord03{
		ID: "id-3", DisplayName: "Sample OrderRecord03", Status: "active", Priority: 10,
	}
...
func TestOrderRecord03Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.OrderRecord03{
		ID: "id-3", DisplayName: "Lifecycle OrderRecord03", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
