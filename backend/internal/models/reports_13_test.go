...
func TestReportRecord13Validate(t *testing.T) {
	t.Parallel()
	valid := &models.ReportRecord13{
		ID: "id-13", DisplayName: "Sample ReportRecord13", Status: "active", Priority: 10,
	}
...
func TestReportRecord13Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.ReportRecord13{
		ID: "id-13", DisplayName: "Lifecycle ReportRecord13", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
