...
func TestOrderRecord06Validate(t *testing.T) {
	t.Parallel()
	valid := &models.OrderRecord06{
		ID: "id-6", DisplayName: "Sample OrderRecord06", Status: "active", Priority: 10,
	}
...
func TestOrderRecord06Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.OrderRecord06{
		ID: "id-6", DisplayName: "Lifecycle OrderRecord06", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
