...
func TestSampleRecord06Validate(t *testing.T) {
	t.Parallel()
	valid := &models.SampleRecord06{
		ID: "id-6", DisplayName: "Sample SampleRecord06", Status: "active", Priority: 10,
	}
...
func TestSampleRecord06Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.SampleRecord06{
		ID: "id-6", DisplayName: "Lifecycle SampleRecord06", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
