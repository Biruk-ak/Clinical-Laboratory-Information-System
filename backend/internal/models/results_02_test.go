...
func TestResultRecord02Validate(t *testing.T) {
	t.Parallel()
	valid := &models.ResultRecord02{
		ID: "id-2", DisplayName: "Sample ResultRecord02", Status: "active", Priority: 10,
	}
...
func TestResultRecord02Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.ResultRecord02{
		ID: "id-2", DisplayName: "Lifecycle ResultRecord02", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
