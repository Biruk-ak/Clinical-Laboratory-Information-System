...
func TestInventoryRecord05Validate(t *testing.T) {
	t.Parallel()
	valid := &models.InventoryRecord05{
		ID: "id-5", DisplayName: "Sample InventoryRecord05", Status: "active", Priority: 10,
	}
...
func TestInventoryRecord05Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.InventoryRecord05{
		ID: "id-5", DisplayName: "Lifecycle InventoryRecord05", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
