...
func TestNotificationRecord07Validate(t *testing.T) {
	t.Parallel()
	valid := &models.NotificationRecord07{
		ID: "id-7", DisplayName: "Sample NotificationRecord07", Status: "active", Priority: 10,
	}
...
func TestNotificationRecord07Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.NotificationRecord07{
		ID: "id-7", DisplayName: "Lifecycle NotificationRecord07", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
