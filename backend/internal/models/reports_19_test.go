...
func TestReportRecord19Validate(t *testing.T) {
	t.Parallel()
	valid := &models.ReportRecord19{
		ID: "id-19", DisplayName: "Sample ReportRecord19", Status: "active", Priority: 10,
	}
...
func TestReportRecord19Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.ReportRecord19{
		ID: "id-19", DisplayName: "Lifecycle ReportRecord19", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
