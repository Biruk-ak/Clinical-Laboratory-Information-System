...
func TestLabTestRecord08Validate(t *testing.T) {
	t.Parallel()
	valid := &models.LabTestRecord08{
		ID: "id-8", DisplayName: "Sample LabTestRecord08", Status: "active", Priority: 10,
	}
...
func TestLabTestRecord08Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.LabTestRecord08{
		ID: "id-8", DisplayName: "Lifecycle LabTestRecord08", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
