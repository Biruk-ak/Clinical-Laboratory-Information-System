...
func TestHospitalRecord18Validate(t *testing.T) {
	t.Parallel()
	valid := &models.HospitalRecord18{
		ID: "id-18", DisplayName: "Sample HospitalRecord18", Status: "active", Priority: 10,
	}
...
func TestHospitalRecord18Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.HospitalRecord18{
		ID: "id-18", DisplayName: "Lifecycle HospitalRecord18", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
