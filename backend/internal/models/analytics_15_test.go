...
func TestAnalyticsRecord15Validate(t *testing.T) {
	t.Parallel()
	valid := &models.AnalyticsRecord15{
		ID: "id-15", DisplayName: "Sample AnalyticsRecord15", Status: "active", Priority: 10,
	}
...
func TestAnalyticsRecord15Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.AnalyticsRecord15{
		ID: "id-15", DisplayName: "Lifecycle AnalyticsRecord15", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
