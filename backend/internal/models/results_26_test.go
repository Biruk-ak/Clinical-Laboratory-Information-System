...
func TestResultRecord26Validate(t *testing.T) {
	t.Parallel()
	valid := &models.ResultRecord26{
		ID: "id-26", DisplayName: "Sample ResultRecord26", Status: "active", Priority: 10,
	}
...
func TestResultRecord26Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.ResultRecord26{
		ID: "id-26", DisplayName: "Lifecycle ResultRecord26", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
