...
func TestSampleRecord25Validate(t *testing.T) {
	t.Parallel()
	valid := &models.SampleRecord25{
		ID: "id-25", DisplayName: "Sample SampleRecord25", Status: "active", Priority: 10,
	}
...
func TestSampleRecord25Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.SampleRecord25{
		ID: "id-25", DisplayName: "Lifecycle SampleRecord25", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
