...
func TestInventoryRecord27Validate(t *testing.T) {
	t.Parallel()
	valid := &models.InventoryRecord27{
		ID: "id-27", DisplayName: "Sample InventoryRecord27", Status: "active", Priority: 10,
	}
...
func TestInventoryRecord27Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.InventoryRecord27{
		ID: "id-27", DisplayName: "Lifecycle InventoryRecord27", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
