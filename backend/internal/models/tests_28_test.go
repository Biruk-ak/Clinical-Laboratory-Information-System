...
func TestLabTestRecord28Validate(t *testing.T) {
	t.Parallel()
	valid := &models.LabTestRecord28{
		ID: "id-28", DisplayName: "Sample LabTestRecord28", Status: "active", Priority: 10,
	}
...
func TestLabTestRecord28Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.LabTestRecord28{
		ID: "id-28", DisplayName: "Lifecycle LabTestRecord28", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
