...
func TestLabTestRecord17Validate(t *testing.T) {
	t.Parallel()
	valid := &models.LabTestRecord17{
		ID: "id-17", DisplayName: "Sample LabTestRecord17", Status: "active", Priority: 10,
	}
...
func TestLabTestRecord17Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.LabTestRecord17{
		ID: "id-17", DisplayName: "Lifecycle LabTestRecord17", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
