...
func TestOrderRecord10Validate(t *testing.T) {
	t.Parallel()
	valid := &models.OrderRecord10{
		ID: "id-10", DisplayName: "Sample OrderRecord10", Status: "active", Priority: 10,
	}
...
func TestOrderRecord10Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.OrderRecord10{
		ID: "id-10", DisplayName: "Lifecycle OrderRecord10", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
