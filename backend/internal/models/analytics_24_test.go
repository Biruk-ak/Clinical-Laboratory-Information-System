...
func TestAnalyticsRecord24Validate(t *testing.T) {
	t.Parallel()
	valid := &models.AnalyticsRecord24{
		ID: "id-24", DisplayName: "Sample AnalyticsRecord24", Status: "active", Priority: 10,
	}
...
func TestAnalyticsRecord24Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.AnalyticsRecord24{
		ID: "id-24", DisplayName: "Lifecycle AnalyticsRecord24", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
