...
func TestReportRecord07Validate(t *testing.T) {
	t.Parallel()
	valid := &models.ReportRecord07{
		ID: "id-7", DisplayName: "Sample ReportRecord07", Status: "active", Priority: 10,
	}
...
func TestReportRecord07Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.ReportRecord07{
		ID: "id-7", DisplayName: "Lifecycle ReportRecord07", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
