...
func TestHospitalRecord09Validate(t *testing.T) {
	t.Parallel()
	valid := &models.HospitalRecord09{
		ID: "id-9", DisplayName: "Sample HospitalRecord09", Status: "active", Priority: 10,
	}
...
func TestHospitalRecord09Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.HospitalRecord09{
		ID: "id-9", DisplayName: "Lifecycle HospitalRecord09", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
