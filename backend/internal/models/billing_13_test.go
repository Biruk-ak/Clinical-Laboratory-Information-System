...
func TestBillingRecord13Validate(t *testing.T) {
	t.Parallel()
	valid := &models.BillingRecord13{
		ID: "id-13", DisplayName: "Sample BillingRecord13", Status: "active", Priority: 10,
	}
...
func TestBillingRecord13Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.BillingRecord13{
		ID: "id-13", DisplayName: "Lifecycle BillingRecord13", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
