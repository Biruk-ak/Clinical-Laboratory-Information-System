...
func TestAuthRecord16Validate(t *testing.T) {
	t.Parallel()
	valid := &models.AuthRecord16{
		ID: "id-16", DisplayName: "Sample AuthRecord16", Status: "active", Priority: 10,
	}
...
func TestAuthRecord16Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.AuthRecord16{
		ID: "id-16", DisplayName: "Lifecycle AuthRecord16", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
