...
func TestAnalyticsRecord07Validate(t *testing.T) {
	t.Parallel()
	valid := &models.AnalyticsRecord07{
		ID: "id-7", DisplayName: "Sample AnalyticsRecord07", Status: "active", Priority: 10,
	}
...
func TestAnalyticsRecord07Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.AnalyticsRecord07{
		ID: "id-7", DisplayName: "Lifecycle AnalyticsRecord07", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
