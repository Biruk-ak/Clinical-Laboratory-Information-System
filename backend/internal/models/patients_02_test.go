...
func TestPatientRecord02Validate(t *testing.T) {
	t.Parallel()
	valid := &models.PatientRecord02{
		ID: "id-2", DisplayName: "Sample PatientRecord02", Status: "active", Priority: 10,
	}
...
func TestPatientRecord02Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.PatientRecord02{
		ID: "id-2", DisplayName: "Lifecycle PatientRecord02", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
