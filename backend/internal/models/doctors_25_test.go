...
func TestDoctorRecord25Validate(t *testing.T) {
	t.Parallel()
	valid := &models.DoctorRecord25{
		ID: "id-25", DisplayName: "Sample DoctorRecord25", Status: "active", Priority: 10,
	}
...
func TestDoctorRecord25Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.DoctorRecord25{
		ID: "id-25", DisplayName: "Lifecycle DoctorRecord25", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
