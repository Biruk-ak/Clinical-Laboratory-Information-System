...
func TestLabTestRecord20Validate(t *testing.T) {
	t.Parallel()
	valid := &models.LabTestRecord20{
		ID: "id-20", DisplayName: "Sample LabTestRecord20", Status: "active", Priority: 10,
	}
...
func TestLabTestRecord20Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.LabTestRecord20{
		ID: "id-20", DisplayName: "Lifecycle LabTestRecord20", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
