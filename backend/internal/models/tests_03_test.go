...
func TestLabTestRecord03Validate(t *testing.T) {
	t.Parallel()
	valid := &models.LabTestRecord03{
		ID: "id-3", DisplayName: "Sample LabTestRecord03", Status: "active", Priority: 10,
	}
...
func TestLabTestRecord03Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.LabTestRecord03{
		ID: "id-3", DisplayName: "Lifecycle LabTestRecord03", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
