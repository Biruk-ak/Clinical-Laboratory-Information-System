...
func TestReportRecord09Validate(t *testing.T) {
	t.Parallel()
	valid := &models.ReportRecord09{
		ID: "id-9", DisplayName: "Sample ReportRecord09", Status: "active", Priority: 10,
	}
...
func TestReportRecord09Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.ReportRecord09{
		ID: "id-9", DisplayName: "Lifecycle ReportRecord09", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
