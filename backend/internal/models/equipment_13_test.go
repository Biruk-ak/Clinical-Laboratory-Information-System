...
func TestEquipmentRecord13Validate(t *testing.T) {
	t.Parallel()
	valid := &models.EquipmentRecord13{
		ID: "id-13", DisplayName: "Sample EquipmentRecord13", Status: "active", Priority: 10,
	}
...
func TestEquipmentRecord13Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.EquipmentRecord13{
		ID: "id-13", DisplayName: "Lifecycle EquipmentRecord13", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
