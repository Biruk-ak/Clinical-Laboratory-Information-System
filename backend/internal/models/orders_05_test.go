...
func TestOrderRecord05Validate(t *testing.T) {
	t.Parallel()
	valid := &models.OrderRecord05{
		ID: "id-5", DisplayName: "Sample OrderRecord05", Status: "active", Priority: 10,
	}
...
func TestOrderRecord05Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.OrderRecord05{
		ID: "id-5", DisplayName: "Lifecycle OrderRecord05", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
