...
func TestEquipmentRecord07Validate(t *testing.T) {
	t.Parallel()
	valid := &models.EquipmentRecord07{
		ID: "id-7", DisplayName: "Sample EquipmentRecord07", Status: "active", Priority: 10,
	}
...
func TestEquipmentRecord07Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.EquipmentRecord07{
		ID: "id-7", DisplayName: "Lifecycle EquipmentRecord07", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
