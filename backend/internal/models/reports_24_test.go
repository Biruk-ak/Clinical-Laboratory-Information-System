...
func TestReportRecord24Validate(t *testing.T) {
	t.Parallel()
	valid := &models.ReportRecord24{
		ID: "id-24", DisplayName: "Sample ReportRecord24", Status: "active", Priority: 10,
	}
...
func TestReportRecord24Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.ReportRecord24{
		ID: "id-24", DisplayName: "Lifecycle ReportRecord24", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
