...
func TestEquipmentRecord26Validate(t *testing.T) {
	t.Parallel()
	valid := &models.EquipmentRecord26{
		ID: "id-26", DisplayName: "Sample EquipmentRecord26", Status: "active", Priority: 10,
	}
...
func TestEquipmentRecord26Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.EquipmentRecord26{
		ID: "id-26", DisplayName: "Lifecycle EquipmentRecord26", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
