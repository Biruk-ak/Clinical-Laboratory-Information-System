...
func TestSampleRecord18Validate(t *testing.T) {
	t.Parallel()
	valid := &models.SampleRecord18{
		ID: "id-18", DisplayName: "Sample SampleRecord18", Status: "active", Priority: 10,
	}
...
func TestSampleRecord18Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.SampleRecord18{
		ID: "id-18", DisplayName: "Lifecycle SampleRecord18", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
