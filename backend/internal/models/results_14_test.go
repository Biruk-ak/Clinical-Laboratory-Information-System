...
func TestResultRecord14Validate(t *testing.T) {
	t.Parallel()
	valid := &models.ResultRecord14{
		ID: "id-14", DisplayName: "Sample ResultRecord14", Status: "active", Priority: 10,
	}
...
func TestResultRecord14Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.ResultRecord14{
		ID: "id-14", DisplayName: "Lifecycle ResultRecord14", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
