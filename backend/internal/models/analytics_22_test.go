...
func TestAnalyticsRecord22Validate(t *testing.T) {
	t.Parallel()
	valid := &models.AnalyticsRecord22{
		ID: "id-22", DisplayName: "Sample AnalyticsRecord22", Status: "active", Priority: 10,
	}
...
func TestAnalyticsRecord22Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.AnalyticsRecord22{
		ID: "id-22", DisplayName: "Lifecycle AnalyticsRecord22", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
