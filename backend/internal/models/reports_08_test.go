...
func TestReportRecord08Validate(t *testing.T) {
	t.Parallel()
	valid := &models.ReportRecord08{
		ID: "id-8", DisplayName: "Sample ReportRecord08", Status: "active", Priority: 10,
	}
...
func TestReportRecord08Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.ReportRecord08{
		ID: "id-8", DisplayName: "Lifecycle ReportRecord08", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
