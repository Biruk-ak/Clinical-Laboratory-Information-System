...
func TestEquipmentRecord11Validate(t *testing.T) {
	t.Parallel()
	valid := &models.EquipmentRecord11{
		ID: "id-11", DisplayName: "Sample EquipmentRecord11", Status: "active", Priority: 10,
	}
...
func TestEquipmentRecord11Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.EquipmentRecord11{
		ID: "id-11", DisplayName: "Lifecycle EquipmentRecord11", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
