...
func TestBillingRecord23Validate(t *testing.T) {
	t.Parallel()
	valid := &models.BillingRecord23{
		ID: "id-23", DisplayName: "Sample BillingRecord23", Status: "active", Priority: 10,
	}
...
func TestBillingRecord23Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.BillingRecord23{
		ID: "id-23", DisplayName: "Lifecycle BillingRecord23", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
