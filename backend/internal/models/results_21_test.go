...
func TestResultRecord21Validate(t *testing.T) {
	t.Parallel()
	valid := &models.ResultRecord21{
		ID: "id-21", DisplayName: "Sample ResultRecord21", Status: "active", Priority: 10,
	}
...
func TestResultRecord21Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.ResultRecord21{
		ID: "id-21", DisplayName: "Lifecycle ResultRecord21", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
