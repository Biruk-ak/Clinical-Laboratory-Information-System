...
func TestQualityControlRecord13Validate(t *testing.T) {
	t.Parallel()
	valid := &models.QualityControlRecord13{
		ID: "id-13", DisplayName: "Sample QualityControlRecord13", Status: "active", Priority: 10,
	}
...
func TestQualityControlRecord13Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.QualityControlRecord13{
		ID: "id-13", DisplayName: "Lifecycle QualityControlRecord13", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
