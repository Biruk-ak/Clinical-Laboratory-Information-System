...
func TestAuthRecord17Validate(t *testing.T) {
	t.Parallel()
	valid := &models.AuthRecord17{
		ID: "id-17", DisplayName: "Sample AuthRecord17", Status: "active", Priority: 10,
	}
...
func TestAuthRecord17Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.AuthRecord17{
		ID: "id-17", DisplayName: "Lifecycle AuthRecord17", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
