...
func TestDoctorRecord05Validate(t *testing.T) {
	t.Parallel()
	valid := &models.DoctorRecord05{
		ID: "id-5", DisplayName: "Sample DoctorRecord05", Status: "active", Priority: 10,
	}
...
func TestDoctorRecord05Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.DoctorRecord05{
		ID: "id-5", DisplayName: "Lifecycle DoctorRecord05", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
