...
func TestBillingRecord15Validate(t *testing.T) {
	t.Parallel()
	valid := &models.BillingRecord15{
		ID: "id-15", DisplayName: "Sample BillingRecord15", Status: "active", Priority: 10,
	}
...
func TestBillingRecord15Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.BillingRecord15{
		ID: "id-15", DisplayName: "Lifecycle BillingRecord15", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
