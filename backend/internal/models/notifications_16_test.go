...
func TestNotificationRecord16Validate(t *testing.T) {
	t.Parallel()
	valid := &models.NotificationRecord16{
		ID: "id-16", DisplayName: "Sample NotificationRecord16", Status: "active", Priority: 10,
	}
...
func TestNotificationRecord16Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.NotificationRecord16{
		ID: "id-16", DisplayName: "Lifecycle NotificationRecord16", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
