...
func TestNotificationRecord25Validate(t *testing.T) {
	t.Parallel()
	valid := &models.NotificationRecord25{
		ID: "id-25", DisplayName: "Sample NotificationRecord25", Status: "active", Priority: 10,
	}
...
func TestNotificationRecord25Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.NotificationRecord25{
		ID: "id-25", DisplayName: "Lifecycle NotificationRecord25", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
