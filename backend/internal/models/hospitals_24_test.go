...
func TestHospitalRecord24Validate(t *testing.T) {
	t.Parallel()
	valid := &models.HospitalRecord24{
		ID: "id-24", DisplayName: "Sample HospitalRecord24", Status: "active", Priority: 10,
	}
...
func TestHospitalRecord24Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.HospitalRecord24{
		ID: "id-24", DisplayName: "Lifecycle HospitalRecord24", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
