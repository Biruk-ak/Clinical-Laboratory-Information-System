...
func TestQualityControlRecord01Validate(t *testing.T) {
	t.Parallel()
	valid := &models.QualityControlRecord01{
		ID: "id-1", DisplayName: "Sample QualityControlRecord01", Status: "active", Priority: 10,
	}
...
func TestQualityControlRecord01Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.QualityControlRecord01{
		ID: "id-1", DisplayName: "Lifecycle QualityControlRecord01", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
