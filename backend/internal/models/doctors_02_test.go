...
func TestDoctorRecord02Validate(t *testing.T) {
	t.Parallel()
	valid := &models.DoctorRecord02{
		ID: "id-2", DisplayName: "Sample DoctorRecord02", Status: "active", Priority: 10,
	}
...
func TestDoctorRecord02Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.DoctorRecord02{
		ID: "id-2", DisplayName: "Lifecycle DoctorRecord02", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
