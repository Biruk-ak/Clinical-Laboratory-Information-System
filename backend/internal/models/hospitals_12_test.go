...
func TestHospitalRecord12Validate(t *testing.T) {
	t.Parallel()
	valid := &models.HospitalRecord12{
		ID: "id-12", DisplayName: "Sample HospitalRecord12", Status: "active", Priority: 10,
	}
...
func TestHospitalRecord12Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.HospitalRecord12{
		ID: "id-12", DisplayName: "Lifecycle HospitalRecord12", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
