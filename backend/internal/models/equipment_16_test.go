...
func TestEquipmentRecord16Validate(t *testing.T) {
	t.Parallel()
	valid := &models.EquipmentRecord16{
		ID: "id-16", DisplayName: "Sample EquipmentRecord16", Status: "active", Priority: 10,
	}
...
func TestEquipmentRecord16Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.EquipmentRecord16{
		ID: "id-16", DisplayName: "Lifecycle EquipmentRecord16", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
