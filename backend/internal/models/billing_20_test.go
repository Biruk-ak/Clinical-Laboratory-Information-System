...
func TestBillingRecord20Validate(t *testing.T) {
	t.Parallel()
	valid := &models.BillingRecord20{
		ID: "id-20", DisplayName: "Sample BillingRecord20", Status: "active", Priority: 10,
	}
...
func TestBillingRecord20Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.BillingRecord20{
		ID: "id-20", DisplayName: "Lifecycle BillingRecord20", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
