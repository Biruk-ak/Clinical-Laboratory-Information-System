...
func TestSampleRecord27Validate(t *testing.T) {
	t.Parallel()
	valid := &models.SampleRecord27{
		ID: "id-27", DisplayName: "Sample SampleRecord27", Status: "active", Priority: 10,
	}
...
func TestSampleRecord27Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.SampleRecord27{
		ID: "id-27", DisplayName: "Lifecycle SampleRecord27", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
