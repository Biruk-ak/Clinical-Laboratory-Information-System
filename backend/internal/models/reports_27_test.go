...
func TestReportRecord27Validate(t *testing.T) {
	t.Parallel()
	valid := &models.ReportRecord27{
		ID: "id-27", DisplayName: "Sample ReportRecord27", Status: "active", Priority: 10,
	}
...
func TestReportRecord27Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.ReportRecord27{
		ID: "id-27", DisplayName: "Lifecycle ReportRecord27", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
