...
func TestOrderRecord22Validate(t *testing.T) {
	t.Parallel()
	valid := &models.OrderRecord22{
		ID: "id-22", DisplayName: "Sample OrderRecord22", Status: "active", Priority: 10,
	}
...
func TestOrderRecord22Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.OrderRecord22{
		ID: "id-22", DisplayName: "Lifecycle OrderRecord22", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
