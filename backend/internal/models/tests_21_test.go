...
func TestLabTestRecord21Validate(t *testing.T) {
	t.Parallel()
	valid := &models.LabTestRecord21{
		ID: "id-21", DisplayName: "Sample LabTestRecord21", Status: "active", Priority: 10,
	}
...
func TestLabTestRecord21Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.LabTestRecord21{
		ID: "id-21", DisplayName: "Lifecycle LabTestRecord21", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
