...
func TestAnalyticsRecord21Validate(t *testing.T) {
	t.Parallel()
	valid := &models.AnalyticsRecord21{
		ID: "id-21", DisplayName: "Sample AnalyticsRecord21", Status: "active", Priority: 10,
	}
...
func TestAnalyticsRecord21Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.AnalyticsRecord21{
		ID: "id-21", DisplayName: "Lifecycle AnalyticsRecord21", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
