...
func TestDoctorRecord19Validate(t *testing.T) {
	t.Parallel()
	valid := &models.DoctorRecord19{
		ID: "id-19", DisplayName: "Sample DoctorRecord19", Status: "active", Priority: 10,
	}
...
func TestDoctorRecord19Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.DoctorRecord19{
		ID: "id-19", DisplayName: "Lifecycle DoctorRecord19", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
