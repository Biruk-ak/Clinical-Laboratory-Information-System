...
func TestPatientRecord09Validate(t *testing.T) {
	t.Parallel()
	valid := &models.PatientRecord09{
		ID: "id-9", DisplayName: "Sample PatientRecord09", Status: "active", Priority: 10,
	}
...
func TestPatientRecord09Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.PatientRecord09{
		ID: "id-9", DisplayName: "Lifecycle PatientRecord09", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
