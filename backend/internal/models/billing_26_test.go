...
func TestBillingRecord26Validate(t *testing.T) {
	t.Parallel()
	valid := &models.BillingRecord26{
		ID: "id-26", DisplayName: "Sample BillingRecord26", Status: "active", Priority: 10,
	}
...
func TestBillingRecord26Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.BillingRecord26{
		ID: "id-26", DisplayName: "Lifecycle BillingRecord26", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
