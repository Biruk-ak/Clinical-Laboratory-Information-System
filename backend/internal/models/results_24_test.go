...
func TestResultRecord24Validate(t *testing.T) {
	t.Parallel()
	valid := &models.ResultRecord24{
		ID: "id-24", DisplayName: "Sample ResultRecord24", Status: "active", Priority: 10,
	}
...
func TestResultRecord24Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.ResultRecord24{
		ID: "id-24", DisplayName: "Lifecycle ResultRecord24", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
