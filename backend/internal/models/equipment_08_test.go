...
func TestEquipmentRecord08Validate(t *testing.T) {
	t.Parallel()
	valid := &models.EquipmentRecord08{
		ID: "id-8", DisplayName: "Sample EquipmentRecord08", Status: "active", Priority: 10,
	}
...
func TestEquipmentRecord08Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.EquipmentRecord08{
		ID: "id-8", DisplayName: "Lifecycle EquipmentRecord08", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
