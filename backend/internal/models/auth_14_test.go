...
func TestAuthRecord14Validate(t *testing.T) {
	t.Parallel()
	valid := &models.AuthRecord14{
		ID: "id-14", DisplayName: "Sample AuthRecord14", Status: "active", Priority: 10,
	}
...
func TestAuthRecord14Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.AuthRecord14{
		ID: "id-14", DisplayName: "Lifecycle AuthRecord14", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
