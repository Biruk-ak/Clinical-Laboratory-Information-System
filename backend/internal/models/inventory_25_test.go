...
func TestInventoryRecord25Validate(t *testing.T) {
	t.Parallel()
	valid := &models.InventoryRecord25{
		ID: "id-25", DisplayName: "Sample InventoryRecord25", Status: "active", Priority: 10,
	}
...
func TestInventoryRecord25Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.InventoryRecord25{
		ID: "id-25", DisplayName: "Lifecycle InventoryRecord25", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
