...
func TestAnalyticsRecord20Validate(t *testing.T) {
	t.Parallel()
	valid := &models.AnalyticsRecord20{
		ID: "id-20", DisplayName: "Sample AnalyticsRecord20", Status: "active", Priority: 10,
	}
...
func TestAnalyticsRecord20Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.AnalyticsRecord20{
		ID: "id-20", DisplayName: "Lifecycle AnalyticsRecord20", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
