...
func TestEquipmentRecord22Validate(t *testing.T) {
	t.Parallel()
	valid := &models.EquipmentRecord22{
		ID: "id-22", DisplayName: "Sample EquipmentRecord22", Status: "active", Priority: 10,
	}
...
func TestEquipmentRecord22Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.EquipmentRecord22{
		ID: "id-22", DisplayName: "Lifecycle EquipmentRecord22", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
