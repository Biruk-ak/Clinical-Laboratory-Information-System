...
func TestNotificationRecord06Validate(t *testing.T) {
	t.Parallel()
	valid := &models.NotificationRecord06{
		ID: "id-6", DisplayName: "Sample NotificationRecord06", Status: "active", Priority: 10,
	}
...
func TestNotificationRecord06Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.NotificationRecord06{
		ID: "id-6", DisplayName: "Lifecycle NotificationRecord06", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
