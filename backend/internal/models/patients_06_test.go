...
func TestPatientRecord06Validate(t *testing.T) {
	t.Parallel()
	valid := &models.PatientRecord06{
		ID: "id-6", DisplayName: "Sample PatientRecord06", Status: "active", Priority: 10,
	}
...
func TestPatientRecord06Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.PatientRecord06{
		ID: "id-6", DisplayName: "Lifecycle PatientRecord06", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
