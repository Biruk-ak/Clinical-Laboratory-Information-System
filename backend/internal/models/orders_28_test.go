...
func TestOrderRecord28Validate(t *testing.T) {
	t.Parallel()
	valid := &models.OrderRecord28{
		ID: "id-28", DisplayName: "Sample OrderRecord28", Status: "active", Priority: 10,
	}
...
func TestOrderRecord28Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.OrderRecord28{
		ID: "id-28", DisplayName: "Lifecycle OrderRecord28", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
