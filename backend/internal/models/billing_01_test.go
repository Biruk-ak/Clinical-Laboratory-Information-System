...
func TestBillingRecord01Validate(t *testing.T) {
	t.Parallel()
	valid := &models.BillingRecord01{
		ID: "id-1", DisplayName: "Sample BillingRecord01", Status: "active", Priority: 10,
	}
...
func TestBillingRecord01Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.BillingRecord01{
		ID: "id-1", DisplayName: "Lifecycle BillingRecord01", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
