...
func TestEquipmentRecord14Validate(t *testing.T) {
	t.Parallel()
	valid := &models.EquipmentRecord14{
		ID: "id-14", DisplayName: "Sample EquipmentRecord14", Status: "active", Priority: 10,
	}
...
func TestEquipmentRecord14Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.EquipmentRecord14{
		ID: "id-14", DisplayName: "Lifecycle EquipmentRecord14", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
