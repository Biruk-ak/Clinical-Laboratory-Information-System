...
func TestLabTestRecord10Validate(t *testing.T) {
	t.Parallel()
	valid := &models.LabTestRecord10{
		ID: "id-10", DisplayName: "Sample LabTestRecord10", Status: "active", Priority: 10,
	}
...
func TestLabTestRecord10Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.LabTestRecord10{
		ID: "id-10", DisplayName: "Lifecycle LabTestRecord10", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
