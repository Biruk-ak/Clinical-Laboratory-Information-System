...
func TestInventoryRecord07Validate(t *testing.T) {
	t.Parallel()
	valid := &models.InventoryRecord07{
		ID: "id-7", DisplayName: "Sample InventoryRecord07", Status: "active", Priority: 10,
	}
...
func TestInventoryRecord07Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.InventoryRecord07{
		ID: "id-7", DisplayName: "Lifecycle InventoryRecord07", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
