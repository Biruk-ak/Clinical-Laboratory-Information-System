...
func TestOrderRecord15Validate(t *testing.T) {
	t.Parallel()
	valid := &models.OrderRecord15{
		ID: "id-15", DisplayName: "Sample OrderRecord15", Status: "active", Priority: 10,
	}
...
func TestOrderRecord15Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.OrderRecord15{
		ID: "id-15", DisplayName: "Lifecycle OrderRecord15", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
