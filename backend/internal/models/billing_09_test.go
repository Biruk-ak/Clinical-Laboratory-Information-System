...
func TestBillingRecord09Validate(t *testing.T) {
	t.Parallel()
	valid := &models.BillingRecord09{
		ID: "id-9", DisplayName: "Sample BillingRecord09", Status: "active", Priority: 10,
	}
...
func TestBillingRecord09Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.BillingRecord09{
		ID: "id-9", DisplayName: "Lifecycle BillingRecord09", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
