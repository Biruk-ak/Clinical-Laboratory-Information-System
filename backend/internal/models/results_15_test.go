...
func TestResultRecord15Validate(t *testing.T) {
	t.Parallel()
	valid := &models.ResultRecord15{
		ID: "id-15", DisplayName: "Sample ResultRecord15", Status: "active", Priority: 10,
	}
...
func TestResultRecord15Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.ResultRecord15{
		ID: "id-15", DisplayName: "Lifecycle ResultRecord15", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
