...
func TestDoctorRecord11Validate(t *testing.T) {
	t.Parallel()
	valid := &models.DoctorRecord11{
		ID: "id-11", DisplayName: "Sample DoctorRecord11", Status: "active", Priority: 10,
	}
...
func TestDoctorRecord11Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.DoctorRecord11{
		ID: "id-11", DisplayName: "Lifecycle DoctorRecord11", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
