...
func TestResultRecord10Validate(t *testing.T) {
	t.Parallel()
	valid := &models.ResultRecord10{
		ID: "id-10", DisplayName: "Sample ResultRecord10", Status: "active", Priority: 10,
	}
...
func TestResultRecord10Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.ResultRecord10{
		ID: "id-10", DisplayName: "Lifecycle ResultRecord10", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
