...
func TestHospitalRecord01Validate(t *testing.T) {
	t.Parallel()
	valid := &models.HospitalRecord01{
		ID: "id-1", DisplayName: "Sample HospitalRecord01", Status: "active", Priority: 10,
	}
...
func TestHospitalRecord01Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.HospitalRecord01{
		ID: "id-1", DisplayName: "Lifecycle HospitalRecord01", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
