...
func TestQualityControlRecord06Validate(t *testing.T) {
	t.Parallel()
	valid := &models.QualityControlRecord06{
		ID: "id-6", DisplayName: "Sample QualityControlRecord06", Status: "active", Priority: 10,
	}
...
func TestQualityControlRecord06Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.QualityControlRecord06{
		ID: "id-6", DisplayName: "Lifecycle QualityControlRecord06", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
