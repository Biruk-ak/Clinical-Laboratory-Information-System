...
func TestNotificationRecord19Validate(t *testing.T) {
	t.Parallel()
	valid := &models.NotificationRecord19{
		ID: "id-19", DisplayName: "Sample NotificationRecord19", Status: "active", Priority: 10,
	}
...
func TestNotificationRecord19Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.NotificationRecord19{
		ID: "id-19", DisplayName: "Lifecycle NotificationRecord19", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
