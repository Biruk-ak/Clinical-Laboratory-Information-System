...
func TestEquipmentRecord03Validate(t *testing.T) {
	t.Parallel()
	valid := &models.EquipmentRecord03{
		ID: "id-3", DisplayName: "Sample EquipmentRecord03", Status: "active", Priority: 10,
	}
...
func TestEquipmentRecord03Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.EquipmentRecord03{
		ID: "id-3", DisplayName: "Lifecycle EquipmentRecord03", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
