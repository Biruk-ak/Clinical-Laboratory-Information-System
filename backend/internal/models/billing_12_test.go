...
func TestBillingRecord12Validate(t *testing.T) {
	t.Parallel()
	valid := &models.BillingRecord12{
		ID: "id-12", DisplayName: "Sample BillingRecord12", Status: "active", Priority: 10,
	}
...
func TestBillingRecord12Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.BillingRecord12{
		ID: "id-12", DisplayName: "Lifecycle BillingRecord12", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
