...
func TestDoctorRecord06Validate(t *testing.T) {
	t.Parallel()
	valid := &models.DoctorRecord06{
		ID: "id-6", DisplayName: "Sample DoctorRecord06", Status: "active", Priority: 10,
	}
...
func TestDoctorRecord06Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.DoctorRecord06{
		ID: "id-6", DisplayName: "Lifecycle DoctorRecord06", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
