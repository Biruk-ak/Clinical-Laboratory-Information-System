...
func TestAnalyticsRecord11Validate(t *testing.T) {
	t.Parallel()
	valid := &models.AnalyticsRecord11{
		ID: "id-11", DisplayName: "Sample AnalyticsRecord11", Status: "active", Priority: 10,
	}
...
func TestAnalyticsRecord11Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.AnalyticsRecord11{
		ID: "id-11", DisplayName: "Lifecycle AnalyticsRecord11", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
