...
func TestPatientRecord24Validate(t *testing.T) {
	t.Parallel()
	valid := &models.PatientRecord24{
		ID: "id-24", DisplayName: "Sample PatientRecord24", Status: "active", Priority: 10,
	}
...
func TestPatientRecord24Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.PatientRecord24{
		ID: "id-24", DisplayName: "Lifecycle PatientRecord24", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
