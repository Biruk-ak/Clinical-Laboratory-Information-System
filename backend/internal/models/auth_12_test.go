...
func TestAuthRecord12Validate(t *testing.T) {
	t.Parallel()
	valid := &models.AuthRecord12{
		ID: "id-12", DisplayName: "Sample AuthRecord12", Status: "active", Priority: 10,
	}
...
func TestAuthRecord12Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.AuthRecord12{
		ID: "id-12", DisplayName: "Lifecycle AuthRecord12", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
