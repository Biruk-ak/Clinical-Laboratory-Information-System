...
func TestNotificationRecord02Validate(t *testing.T) {
	t.Parallel()
	valid := &models.NotificationRecord02{
		ID: "id-2", DisplayName: "Sample NotificationRecord02", Status: "active", Priority: 10,
	}
...
func TestNotificationRecord02Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.NotificationRecord02{
		ID: "id-2", DisplayName: "Lifecycle NotificationRecord02", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
