...
func TestDoctorRecord15Validate(t *testing.T) {
	t.Parallel()
	valid := &models.DoctorRecord15{
		ID: "id-15", DisplayName: "Sample DoctorRecord15", Status: "active", Priority: 10,
	}
...
func TestDoctorRecord15Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.DoctorRecord15{
		ID: "id-15", DisplayName: "Lifecycle DoctorRecord15", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
