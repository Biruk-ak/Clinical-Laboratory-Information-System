...
func TestLabTestRecord04Validate(t *testing.T) {
	t.Parallel()
	valid := &models.LabTestRecord04{
		ID: "id-4", DisplayName: "Sample LabTestRecord04", Status: "active", Priority: 10,
	}
...
func TestLabTestRecord04Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.LabTestRecord04{
		ID: "id-4", DisplayName: "Lifecycle LabTestRecord04", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
