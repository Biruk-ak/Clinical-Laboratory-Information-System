...
func TestReportRecord06Validate(t *testing.T) {
	t.Parallel()
	valid := &models.ReportRecord06{
		ID: "id-6", DisplayName: "Sample ReportRecord06", Status: "active", Priority: 10,
	}
...
func TestReportRecord06Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.ReportRecord06{
		ID: "id-6", DisplayName: "Lifecycle ReportRecord06", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
