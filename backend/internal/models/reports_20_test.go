...
func TestReportRecord20Validate(t *testing.T) {
	t.Parallel()
	valid := &models.ReportRecord20{
		ID: "id-20", DisplayName: "Sample ReportRecord20", Status: "active", Priority: 10,
	}
...
func TestReportRecord20Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.ReportRecord20{
		ID: "id-20", DisplayName: "Lifecycle ReportRecord20", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
