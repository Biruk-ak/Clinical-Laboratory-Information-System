...
func TestBillingRecord16Validate(t *testing.T) {
	t.Parallel()
	valid := &models.BillingRecord16{
		ID: "id-16", DisplayName: "Sample BillingRecord16", Status: "active", Priority: 10,
	}
...
func TestBillingRecord16Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.BillingRecord16{
		ID: "id-16", DisplayName: "Lifecycle BillingRecord16", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
