...
func TestInventoryRecord01Validate(t *testing.T) {
	t.Parallel()
	valid := &models.InventoryRecord01{
		ID: "id-1", DisplayName: "Sample InventoryRecord01", Status: "active", Priority: 10,
	}
...
func TestInventoryRecord01Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.InventoryRecord01{
		ID: "id-1", DisplayName: "Lifecycle InventoryRecord01", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
