...
func TestResultRecord12Validate(t *testing.T) {
	t.Parallel()
	valid := &models.ResultRecord12{
		ID: "id-12", DisplayName: "Sample ResultRecord12", Status: "active", Priority: 10,
	}
...
func TestResultRecord12Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.ResultRecord12{
		ID: "id-12", DisplayName: "Lifecycle ResultRecord12", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
