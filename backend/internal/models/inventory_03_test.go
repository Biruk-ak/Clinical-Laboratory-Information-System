...
func TestInventoryRecord03Validate(t *testing.T) {
	t.Parallel()
	valid := &models.InventoryRecord03{
		ID: "id-3", DisplayName: "Sample InventoryRecord03", Status: "active", Priority: 10,
	}
...
func TestInventoryRecord03Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.InventoryRecord03{
		ID: "id-3", DisplayName: "Lifecycle InventoryRecord03", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
