...
func TestReportRecord28Validate(t *testing.T) {
	t.Parallel()
	valid := &models.ReportRecord28{
		ID: "id-28", DisplayName: "Sample ReportRecord28", Status: "active", Priority: 10,
	}
...
func TestReportRecord28Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.ReportRecord28{
		ID: "id-28", DisplayName: "Lifecycle ReportRecord28", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
