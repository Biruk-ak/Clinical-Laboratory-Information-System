...
func TestLabTestRecord26Validate(t *testing.T) {
	t.Parallel()
	valid := &models.LabTestRecord26{
		ID: "id-26", DisplayName: "Sample LabTestRecord26", Status: "active", Priority: 10,
	}
...
func TestLabTestRecord26Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.LabTestRecord26{
		ID: "id-26", DisplayName: "Lifecycle LabTestRecord26", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
