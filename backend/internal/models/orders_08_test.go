...
func TestOrderRecord08Validate(t *testing.T) {
	t.Parallel()
	valid := &models.OrderRecord08{
		ID: "id-8", DisplayName: "Sample OrderRecord08", Status: "active", Priority: 10,
	}
...
func TestOrderRecord08Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.OrderRecord08{
		ID: "id-8", DisplayName: "Lifecycle OrderRecord08", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
