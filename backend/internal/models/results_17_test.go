...
func TestResultRecord17Validate(t *testing.T) {
	t.Parallel()
	valid := &models.ResultRecord17{
		ID: "id-17", DisplayName: "Sample ResultRecord17", Status: "active", Priority: 10,
	}
...
func TestResultRecord17Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.ResultRecord17{
		ID: "id-17", DisplayName: "Lifecycle ResultRecord17", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
