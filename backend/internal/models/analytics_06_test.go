...
func TestAnalyticsRecord06Validate(t *testing.T) {
	t.Parallel()
	valid := &models.AnalyticsRecord06{
		ID: "id-6", DisplayName: "Sample AnalyticsRecord06", Status: "active", Priority: 10,
	}
...
func TestAnalyticsRecord06Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.AnalyticsRecord06{
		ID: "id-6", DisplayName: "Lifecycle AnalyticsRecord06", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
