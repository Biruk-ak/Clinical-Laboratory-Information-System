...
func TestPatientRecord17Validate(t *testing.T) {
	t.Parallel()
	valid := &models.PatientRecord17{
		ID: "id-17", DisplayName: "Sample PatientRecord17", Status: "active", Priority: 10,
	}
...
func TestPatientRecord17Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.PatientRecord17{
		ID: "id-17", DisplayName: "Lifecycle PatientRecord17", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
