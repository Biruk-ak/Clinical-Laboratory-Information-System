...
func TestQualityControlRecord08Validate(t *testing.T) {
	t.Parallel()
	valid := &models.QualityControlRecord08{
		ID: "id-8", DisplayName: "Sample QualityControlRecord08", Status: "active", Priority: 10,
	}
...
func TestQualityControlRecord08Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.QualityControlRecord08{
		ID: "id-8", DisplayName: "Lifecycle QualityControlRecord08", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
