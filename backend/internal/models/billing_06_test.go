...
func TestBillingRecord06Validate(t *testing.T) {
	t.Parallel()
	valid := &models.BillingRecord06{
		ID: "id-6", DisplayName: "Sample BillingRecord06", Status: "active", Priority: 10,
	}
...
func TestBillingRecord06Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.BillingRecord06{
		ID: "id-6", DisplayName: "Lifecycle BillingRecord06", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
