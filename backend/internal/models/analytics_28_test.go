...
func TestAnalyticsRecord28Validate(t *testing.T) {
	t.Parallel()
	valid := &models.AnalyticsRecord28{
		ID: "id-28", DisplayName: "Sample AnalyticsRecord28", Status: "active", Priority: 10,
	}
...
func TestAnalyticsRecord28Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.AnalyticsRecord28{
		ID: "id-28", DisplayName: "Lifecycle AnalyticsRecord28", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
