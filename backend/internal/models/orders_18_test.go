...
func TestOrderRecord18Validate(t *testing.T) {
	t.Parallel()
	valid := &models.OrderRecord18{
		ID: "id-18", DisplayName: "Sample OrderRecord18", Status: "active", Priority: 10,
	}
...
func TestOrderRecord18Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.OrderRecord18{
		ID: "id-18", DisplayName: "Lifecycle OrderRecord18", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
