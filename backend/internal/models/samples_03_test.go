...
func TestSampleRecord03Validate(t *testing.T) {
	t.Parallel()
	valid := &models.SampleRecord03{
		ID: "id-3", DisplayName: "Sample SampleRecord03", Status: "active", Priority: 10,
	}
...
func TestSampleRecord03Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.SampleRecord03{
		ID: "id-3", DisplayName: "Lifecycle SampleRecord03", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
