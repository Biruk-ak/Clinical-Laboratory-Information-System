...
func TestDoctorRecord28Validate(t *testing.T) {
	t.Parallel()
	valid := &models.DoctorRecord28{
		ID: "id-28", DisplayName: "Sample DoctorRecord28", Status: "active", Priority: 10,
	}
...
func TestDoctorRecord28Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.DoctorRecord28{
		ID: "id-28", DisplayName: "Lifecycle DoctorRecord28", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
