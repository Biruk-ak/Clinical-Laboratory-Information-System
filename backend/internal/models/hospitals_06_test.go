...
func TestHospitalRecord06Validate(t *testing.T) {
	t.Parallel()
	valid := &models.HospitalRecord06{
		ID: "id-6", DisplayName: "Sample HospitalRecord06", Status: "active", Priority: 10,
	}
...
func TestHospitalRecord06Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.HospitalRecord06{
		ID: "id-6", DisplayName: "Lifecycle HospitalRecord06", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
