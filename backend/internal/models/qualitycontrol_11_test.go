...
func TestQualityControlRecord11Validate(t *testing.T) {
	t.Parallel()
	valid := &models.QualityControlRecord11{
		ID: "id-11", DisplayName: "Sample QualityControlRecord11", Status: "active", Priority: 10,
	}
...
func TestQualityControlRecord11Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.QualityControlRecord11{
		ID: "id-11", DisplayName: "Lifecycle QualityControlRecord11", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
