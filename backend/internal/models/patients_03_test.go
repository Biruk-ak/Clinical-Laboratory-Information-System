...
func TestPatientRecord03Validate(t *testing.T) {
	t.Parallel()
	valid := &models.PatientRecord03{
		ID: "id-3", DisplayName: "Sample PatientRecord03", Status: "active", Priority: 10,
	}
...
func TestPatientRecord03Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.PatientRecord03{
		ID: "id-3", DisplayName: "Lifecycle PatientRecord03", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
