...
func TestInventoryRecord28Validate(t *testing.T) {
	t.Parallel()
	valid := &models.InventoryRecord28{
		ID: "id-28", DisplayName: "Sample InventoryRecord28", Status: "active", Priority: 10,
	}
...
func TestInventoryRecord28Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.InventoryRecord28{
		ID: "id-28", DisplayName: "Lifecycle InventoryRecord28", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
