...
func TestSampleRecord22Validate(t *testing.T) {
	t.Parallel()
	valid := &models.SampleRecord22{
		ID: "id-22", DisplayName: "Sample SampleRecord22", Status: "active", Priority: 10,
	}
...
func TestSampleRecord22Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.SampleRecord22{
		ID: "id-22", DisplayName: "Lifecycle SampleRecord22", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
