...
func TestQualityControlRecord19Validate(t *testing.T) {
	t.Parallel()
	valid := &models.QualityControlRecord19{
		ID: "id-19", DisplayName: "Sample QualityControlRecord19", Status: "active", Priority: 10,
	}
...
func TestQualityControlRecord19Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.QualityControlRecord19{
		ID: "id-19", DisplayName: "Lifecycle QualityControlRecord19", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
