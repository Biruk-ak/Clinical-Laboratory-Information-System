...
func TestAnalyticsRecord10Validate(t *testing.T) {
	t.Parallel()
	valid := &models.AnalyticsRecord10{
		ID: "id-10", DisplayName: "Sample AnalyticsRecord10", Status: "active", Priority: 10,
	}
...
func TestAnalyticsRecord10Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.AnalyticsRecord10{
		ID: "id-10", DisplayName: "Lifecycle AnalyticsRecord10", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
