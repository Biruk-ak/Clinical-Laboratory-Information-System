...
func TestHospitalRecord27Validate(t *testing.T) {
	t.Parallel()
	valid := &models.HospitalRecord27{
		ID: "id-27", DisplayName: "Sample HospitalRecord27", Status: "active", Priority: 10,
	}
...
func TestHospitalRecord27Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.HospitalRecord27{
		ID: "id-27", DisplayName: "Lifecycle HospitalRecord27", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
