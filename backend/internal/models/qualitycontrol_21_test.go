...
func TestQualityControlRecord21Validate(t *testing.T) {
	t.Parallel()
	valid := &models.QualityControlRecord21{
		ID: "id-21", DisplayName: "Sample QualityControlRecord21", Status: "active", Priority: 10,
	}
...
func TestQualityControlRecord21Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.QualityControlRecord21{
		ID: "id-21", DisplayName: "Lifecycle QualityControlRecord21", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
