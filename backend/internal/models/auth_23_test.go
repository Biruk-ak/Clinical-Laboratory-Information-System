...
func TestAuthRecord23Validate(t *testing.T) {
	t.Parallel()
	valid := &models.AuthRecord23{
		ID: "id-23", DisplayName: "Sample AuthRecord23", Status: "active", Priority: 10,
	}
...
func TestAuthRecord23Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.AuthRecord23{
		ID: "id-23", DisplayName: "Lifecycle AuthRecord23", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
