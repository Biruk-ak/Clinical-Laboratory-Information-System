...
func TestQualityControlRecord16Validate(t *testing.T) {
	t.Parallel()
	valid := &models.QualityControlRecord16{
		ID: "id-16", DisplayName: "Sample QualityControlRecord16", Status: "active", Priority: 10,
	}
...
func TestQualityControlRecord16Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.QualityControlRecord16{
		ID: "id-16", DisplayName: "Lifecycle QualityControlRecord16", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
