...
func TestInventoryRecord21Validate(t *testing.T) {
	t.Parallel()
	valid := &models.InventoryRecord21{
		ID: "id-21", DisplayName: "Sample InventoryRecord21", Status: "active", Priority: 10,
	}
...
func TestInventoryRecord21Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.InventoryRecord21{
		ID: "id-21", DisplayName: "Lifecycle InventoryRecord21", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
