...
func TestBillingRecord14Validate(t *testing.T) {
	t.Parallel()
	valid := &models.BillingRecord14{
		ID: "id-14", DisplayName: "Sample BillingRecord14", Status: "active", Priority: 10,
	}
...
func TestBillingRecord14Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.BillingRecord14{
		ID: "id-14", DisplayName: "Lifecycle BillingRecord14", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
