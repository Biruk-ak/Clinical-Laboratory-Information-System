...
func TestOrderRecord01Validate(t *testing.T) {
	t.Parallel()
	valid := &models.OrderRecord01{
		ID: "id-1", DisplayName: "Sample OrderRecord01", Status: "active", Priority: 10,
	}
...
func TestOrderRecord01Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.OrderRecord01{
		ID: "id-1", DisplayName: "Lifecycle OrderRecord01", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
