...
func TestResultRecord11Validate(t *testing.T) {
	t.Parallel()
	valid := &models.ResultRecord11{
		ID: "id-11", DisplayName: "Sample ResultRecord11", Status: "active", Priority: 10,
	}
...
func TestResultRecord11Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.ResultRecord11{
		ID: "id-11", DisplayName: "Lifecycle ResultRecord11", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
