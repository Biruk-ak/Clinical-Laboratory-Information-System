...
func TestAuthRecord28Validate(t *testing.T) {
	t.Parallel()
	valid := &models.AuthRecord28{
		ID: "id-28", DisplayName: "Sample AuthRecord28", Status: "active", Priority: 10,
	}
...
func TestAuthRecord28Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.AuthRecord28{
		ID: "id-28", DisplayName: "Lifecycle AuthRecord28", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
