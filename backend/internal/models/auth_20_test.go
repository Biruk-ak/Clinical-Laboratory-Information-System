...
func TestAuthRecord20Validate(t *testing.T) {
	t.Parallel()
	valid := &models.AuthRecord20{
		ID: "id-20", DisplayName: "Sample AuthRecord20", Status: "active", Priority: 10,
	}
...
func TestAuthRecord20Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.AuthRecord20{
		ID: "id-20", DisplayName: "Lifecycle AuthRecord20", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
