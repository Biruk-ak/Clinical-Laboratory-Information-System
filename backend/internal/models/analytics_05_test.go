...
func TestAnalyticsRecord05Validate(t *testing.T) {
	t.Parallel()
	valid := &models.AnalyticsRecord05{
		ID: "id-5", DisplayName: "Sample AnalyticsRecord05", Status: "active", Priority: 10,
	}
...
func TestAnalyticsRecord05Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.AnalyticsRecord05{
		ID: "id-5", DisplayName: "Lifecycle AnalyticsRecord05", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
