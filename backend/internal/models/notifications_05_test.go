...
func TestNotificationRecord05Validate(t *testing.T) {
	t.Parallel()
	valid := &models.NotificationRecord05{
		ID: "id-5", DisplayName: "Sample NotificationRecord05", Status: "active", Priority: 10,
	}
...
func TestNotificationRecord05Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.NotificationRecord05{
		ID: "id-5", DisplayName: "Lifecycle NotificationRecord05", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
