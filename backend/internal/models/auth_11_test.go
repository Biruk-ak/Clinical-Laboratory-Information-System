...
func TestAuthRecord11Validate(t *testing.T) {
	t.Parallel()
	valid := &models.AuthRecord11{
		ID: "id-11", DisplayName: "Sample AuthRecord11", Status: "active", Priority: 10,
	}
...
func TestAuthRecord11Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.AuthRecord11{
		ID: "id-11", DisplayName: "Lifecycle AuthRecord11", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
