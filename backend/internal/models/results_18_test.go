...
func TestResultRecord18Validate(t *testing.T) {
	t.Parallel()
	valid := &models.ResultRecord18{
		ID: "id-18", DisplayName: "Sample ResultRecord18", Status: "active", Priority: 10,
	}
...
func TestResultRecord18Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.ResultRecord18{
		ID: "id-18", DisplayName: "Lifecycle ResultRecord18", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
