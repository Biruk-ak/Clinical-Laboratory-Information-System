...
func TestAuthRecord19Validate(t *testing.T) {
	t.Parallel()
	valid := &models.AuthRecord19{
		ID: "id-19", DisplayName: "Sample AuthRecord19", Status: "active", Priority: 10,
	}
...
func TestAuthRecord19Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.AuthRecord19{
		ID: "id-19", DisplayName: "Lifecycle AuthRecord19", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
