...
func TestHospitalRecord14Validate(t *testing.T) {
	t.Parallel()
	valid := &models.HospitalRecord14{
		ID: "id-14", DisplayName: "Sample HospitalRecord14", Status: "active", Priority: 10,
	}
...
func TestHospitalRecord14Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.HospitalRecord14{
		ID: "id-14", DisplayName: "Lifecycle HospitalRecord14", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
