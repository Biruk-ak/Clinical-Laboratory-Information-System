...
func TestNotificationRecord09Validate(t *testing.T) {
	t.Parallel()
	valid := &models.NotificationRecord09{
		ID: "id-9", DisplayName: "Sample NotificationRecord09", Status: "active", Priority: 10,
	}
...
func TestNotificationRecord09Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.NotificationRecord09{
		ID: "id-9", DisplayName: "Lifecycle NotificationRecord09", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
