...
func TestOrderRecord16Validate(t *testing.T) {
	t.Parallel()
	valid := &models.OrderRecord16{
		ID: "id-16", DisplayName: "Sample OrderRecord16", Status: "active", Priority: 10,
	}
...
func TestOrderRecord16Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.OrderRecord16{
		ID: "id-16", DisplayName: "Lifecycle OrderRecord16", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
