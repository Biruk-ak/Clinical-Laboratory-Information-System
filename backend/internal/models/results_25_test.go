...
func TestResultRecord25Validate(t *testing.T) {
	t.Parallel()
	valid := &models.ResultRecord25{
		ID: "id-25", DisplayName: "Sample ResultRecord25", Status: "active", Priority: 10,
	}
...
func TestResultRecord25Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.ResultRecord25{
		ID: "id-25", DisplayName: "Lifecycle ResultRecord25", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
