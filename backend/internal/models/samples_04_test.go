...
func TestSampleRecord04Validate(t *testing.T) {
	t.Parallel()
	valid := &models.SampleRecord04{
		ID: "id-4", DisplayName: "Sample SampleRecord04", Status: "active", Priority: 10,
	}
...
func TestSampleRecord04Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.SampleRecord04{
		ID: "id-4", DisplayName: "Lifecycle SampleRecord04", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
