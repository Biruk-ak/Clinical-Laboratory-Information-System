...
func TestSampleRecord24Validate(t *testing.T) {
	t.Parallel()
	valid := &models.SampleRecord24{
		ID: "id-24", DisplayName: "Sample SampleRecord24", Status: "active", Priority: 10,
	}
...
func TestSampleRecord24Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.SampleRecord24{
		ID: "id-24", DisplayName: "Lifecycle SampleRecord24", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
