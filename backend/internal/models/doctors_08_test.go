...
func TestDoctorRecord08Validate(t *testing.T) {
	t.Parallel()
	valid := &models.DoctorRecord08{
		ID: "id-8", DisplayName: "Sample DoctorRecord08", Status: "active", Priority: 10,
	}
...
func TestDoctorRecord08Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.DoctorRecord08{
		ID: "id-8", DisplayName: "Lifecycle DoctorRecord08", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
