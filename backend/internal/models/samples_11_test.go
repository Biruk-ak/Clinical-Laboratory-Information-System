...
func TestSampleRecord11Validate(t *testing.T) {
	t.Parallel()
	valid := &models.SampleRecord11{
		ID: "id-11", DisplayName: "Sample SampleRecord11", Status: "active", Priority: 10,
	}
...
func TestSampleRecord11Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.SampleRecord11{
		ID: "id-11", DisplayName: "Lifecycle SampleRecord11", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
