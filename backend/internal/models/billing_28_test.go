...
func TestBillingRecord28Validate(t *testing.T) {
	t.Parallel()
	valid := &models.BillingRecord28{
		ID: "id-28", DisplayName: "Sample BillingRecord28", Status: "active", Priority: 10,
	}
...
func TestBillingRecord28Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.BillingRecord28{
		ID: "id-28", DisplayName: "Lifecycle BillingRecord28", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
