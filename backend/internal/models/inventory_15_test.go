...
func TestInventoryRecord15Validate(t *testing.T) {
	t.Parallel()
	valid := &models.InventoryRecord15{
		ID: "id-15", DisplayName: "Sample InventoryRecord15", Status: "active", Priority: 10,
	}
...
func TestInventoryRecord15Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.InventoryRecord15{
		ID: "id-15", DisplayName: "Lifecycle InventoryRecord15", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
