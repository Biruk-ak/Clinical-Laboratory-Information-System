...
func TestNotificationRecord23Validate(t *testing.T) {
	t.Parallel()
	valid := &models.NotificationRecord23{
		ID: "id-23", DisplayName: "Sample NotificationRecord23", Status: "active", Priority: 10,
	}
...
func TestNotificationRecord23Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.NotificationRecord23{
		ID: "id-23", DisplayName: "Lifecycle NotificationRecord23", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
