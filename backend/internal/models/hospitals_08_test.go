...
func TestHospitalRecord08Validate(t *testing.T) {
	t.Parallel()
	valid := &models.HospitalRecord08{
		ID: "id-8", DisplayName: "Sample HospitalRecord08", Status: "active", Priority: 10,
	}
...
func TestHospitalRecord08Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.HospitalRecord08{
		ID: "id-8", DisplayName: "Lifecycle HospitalRecord08", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
