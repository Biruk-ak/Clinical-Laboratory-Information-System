...
func TestNotificationRecord11Validate(t *testing.T) {
	t.Parallel()
	valid := &models.NotificationRecord11{
		ID: "id-11", DisplayName: "Sample NotificationRecord11", Status: "active", Priority: 10,
	}
...
func TestNotificationRecord11Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.NotificationRecord11{
		ID: "id-11", DisplayName: "Lifecycle NotificationRecord11", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
