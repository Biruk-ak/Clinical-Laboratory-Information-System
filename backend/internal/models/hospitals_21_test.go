...
func TestHospitalRecord21Validate(t *testing.T) {
	t.Parallel()
	valid := &models.HospitalRecord21{
		ID: "id-21", DisplayName: "Sample HospitalRecord21", Status: "active", Priority: 10,
	}
...
func TestHospitalRecord21Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.HospitalRecord21{
		ID: "id-21", DisplayName: "Lifecycle HospitalRecord21", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
