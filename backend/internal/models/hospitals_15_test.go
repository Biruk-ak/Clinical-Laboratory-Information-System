...
func TestHospitalRecord15Validate(t *testing.T) {
	t.Parallel()
	valid := &models.HospitalRecord15{
		ID: "id-15", DisplayName: "Sample HospitalRecord15", Status: "active", Priority: 10,
	}
...
func TestHospitalRecord15Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.HospitalRecord15{
		ID: "id-15", DisplayName: "Lifecycle HospitalRecord15", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
