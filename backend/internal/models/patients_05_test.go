...
func TestPatientRecord05Validate(t *testing.T) {
	t.Parallel()
	valid := &models.PatientRecord05{
		ID: "id-5", DisplayName: "Sample PatientRecord05", Status: "active", Priority: 10,
	}
...
func TestPatientRecord05Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.PatientRecord05{
		ID: "id-5", DisplayName: "Lifecycle PatientRecord05", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
