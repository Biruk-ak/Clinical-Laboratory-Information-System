...
func TestAnalyticsRecord09Validate(t *testing.T) {
	t.Parallel()
	valid := &models.AnalyticsRecord09{
		ID: "id-9", DisplayName: "Sample AnalyticsRecord09", Status: "active", Priority: 10,
	}
...
func TestAnalyticsRecord09Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.AnalyticsRecord09{
		ID: "id-9", DisplayName: "Lifecycle AnalyticsRecord09", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
