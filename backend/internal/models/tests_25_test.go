...
func TestLabTestRecord25Validate(t *testing.T) {
	t.Parallel()
	valid := &models.LabTestRecord25{
		ID: "id-25", DisplayName: "Sample LabTestRecord25", Status: "active", Priority: 10,
	}
...
func TestLabTestRecord25Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.LabTestRecord25{
		ID: "id-25", DisplayName: "Lifecycle LabTestRecord25", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
