...
func TestReportRecord18Validate(t *testing.T) {
	t.Parallel()
	valid := &models.ReportRecord18{
		ID: "id-18", DisplayName: "Sample ReportRecord18", Status: "active", Priority: 10,
	}
...
func TestReportRecord18Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.ReportRecord18{
		ID: "id-18", DisplayName: "Lifecycle ReportRecord18", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
