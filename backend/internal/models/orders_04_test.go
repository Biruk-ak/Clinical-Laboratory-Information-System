...
func TestOrderRecord04Validate(t *testing.T) {
	t.Parallel()
	valid := &models.OrderRecord04{
		ID: "id-4", DisplayName: "Sample OrderRecord04", Status: "active", Priority: 10,
	}
...
func TestOrderRecord04Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.OrderRecord04{
		ID: "id-4", DisplayName: "Lifecycle OrderRecord04", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
