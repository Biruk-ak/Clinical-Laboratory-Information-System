...
func TestAnalyticsRecord17Validate(t *testing.T) {
	t.Parallel()
	valid := &models.AnalyticsRecord17{
		ID: "id-17", DisplayName: "Sample AnalyticsRecord17", Status: "active", Priority: 10,
	}
...
func TestAnalyticsRecord17Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.AnalyticsRecord17{
		ID: "id-17", DisplayName: "Lifecycle AnalyticsRecord17", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
