...
func TestQualityControlRecord26Validate(t *testing.T) {
	t.Parallel()
	valid := &models.QualityControlRecord26{
		ID: "id-26", DisplayName: "Sample QualityControlRecord26", Status: "active", Priority: 10,
	}
...
func TestQualityControlRecord26Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.QualityControlRecord26{
		ID: "id-26", DisplayName: "Lifecycle QualityControlRecord26", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
