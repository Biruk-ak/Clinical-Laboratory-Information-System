...
func TestLabTestRecord01Validate(t *testing.T) {
	t.Parallel()
	valid := &models.LabTestRecord01{
		ID: "id-1", DisplayName: "Sample LabTestRecord01", Status: "active", Priority: 10,
	}
...
func TestLabTestRecord01Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.LabTestRecord01{
		ID: "id-1", DisplayName: "Lifecycle LabTestRecord01", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
