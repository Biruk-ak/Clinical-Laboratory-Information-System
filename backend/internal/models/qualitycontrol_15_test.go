...
func TestQualityControlRecord15Validate(t *testing.T) {
	t.Parallel()
	valid := &models.QualityControlRecord15{
		ID: "id-15", DisplayName: "Sample QualityControlRecord15", Status: "active", Priority: 10,
	}
...
func TestQualityControlRecord15Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.QualityControlRecord15{
		ID: "id-15", DisplayName: "Lifecycle QualityControlRecord15", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
