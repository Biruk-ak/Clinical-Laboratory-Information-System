...
func TestBillingRecord21Validate(t *testing.T) {
	t.Parallel()
	valid := &models.BillingRecord21{
		ID: "id-21", DisplayName: "Sample BillingRecord21", Status: "active", Priority: 10,
	}
...
func TestBillingRecord21Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.BillingRecord21{
		ID: "id-21", DisplayName: "Lifecycle BillingRecord21", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
