...
func TestBillingRecord02Validate(t *testing.T) {
	t.Parallel()
	valid := &models.BillingRecord02{
		ID: "id-2", DisplayName: "Sample BillingRecord02", Status: "active", Priority: 10,
	}
...
func TestBillingRecord02Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.BillingRecord02{
		ID: "id-2", DisplayName: "Lifecycle BillingRecord02", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
