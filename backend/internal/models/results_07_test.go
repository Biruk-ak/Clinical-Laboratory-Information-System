...
func TestResultRecord07Validate(t *testing.T) {
	t.Parallel()
	valid := &models.ResultRecord07{
		ID: "id-7", DisplayName: "Sample ResultRecord07", Status: "active", Priority: 10,
	}
...
func TestResultRecord07Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.ResultRecord07{
		ID: "id-7", DisplayName: "Lifecycle ResultRecord07", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
