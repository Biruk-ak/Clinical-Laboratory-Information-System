...
func TestInventoryRecord09Validate(t *testing.T) {
	t.Parallel()
	valid := &models.InventoryRecord09{
		ID: "id-9", DisplayName: "Sample InventoryRecord09", Status: "active", Priority: 10,
	}
...
func TestInventoryRecord09Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.InventoryRecord09{
		ID: "id-9", DisplayName: "Lifecycle InventoryRecord09", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
