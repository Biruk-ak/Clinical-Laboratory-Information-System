...
func TestDoctorRecord07Validate(t *testing.T) {
	t.Parallel()
	valid := &models.DoctorRecord07{
		ID: "id-7", DisplayName: "Sample DoctorRecord07", Status: "active", Priority: 10,
	}
...
func TestDoctorRecord07Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.DoctorRecord07{
		ID: "id-7", DisplayName: "Lifecycle DoctorRecord07", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
