...
func TestHospitalRecord07Validate(t *testing.T) {
	t.Parallel()
	valid := &models.HospitalRecord07{
		ID: "id-7", DisplayName: "Sample HospitalRecord07", Status: "active", Priority: 10,
	}
...
func TestHospitalRecord07Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.HospitalRecord07{
		ID: "id-7", DisplayName: "Lifecycle HospitalRecord07", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
