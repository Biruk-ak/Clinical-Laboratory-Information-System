...
func TestBillingRecord27Validate(t *testing.T) {
	t.Parallel()
	valid := &models.BillingRecord27{
		ID: "id-27", DisplayName: "Sample BillingRecord27", Status: "active", Priority: 10,
	}
...
func TestBillingRecord27Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.BillingRecord27{
		ID: "id-27", DisplayName: "Lifecycle BillingRecord27", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
