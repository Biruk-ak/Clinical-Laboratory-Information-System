...
func TestSampleRecord09Validate(t *testing.T) {
	t.Parallel()
	valid := &models.SampleRecord09{
		ID: "id-9", DisplayName: "Sample SampleRecord09", Status: "active", Priority: 10,
	}
...
func TestSampleRecord09Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.SampleRecord09{
		ID: "id-9", DisplayName: "Lifecycle SampleRecord09", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
