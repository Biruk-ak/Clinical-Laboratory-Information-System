...
func TestAuthRecord09Validate(t *testing.T) {
	t.Parallel()
	valid := &models.AuthRecord09{
		ID: "id-9", DisplayName: "Sample AuthRecord09", Status: "active", Priority: 10,
	}
...
func TestAuthRecord09Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.AuthRecord09{
		ID: "id-9", DisplayName: "Lifecycle AuthRecord09", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
