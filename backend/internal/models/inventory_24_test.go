...
func TestInventoryRecord24Validate(t *testing.T) {
	t.Parallel()
	valid := &models.InventoryRecord24{
		ID: "id-24", DisplayName: "Sample InventoryRecord24", Status: "active", Priority: 10,
	}
...
func TestInventoryRecord24Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.InventoryRecord24{
		ID: "id-24", DisplayName: "Lifecycle InventoryRecord24", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
