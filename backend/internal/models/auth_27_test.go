...
func TestAuthRecord27Validate(t *testing.T) {
	t.Parallel()
	valid := &models.AuthRecord27{
		ID: "id-27", DisplayName: "Sample AuthRecord27", Status: "active", Priority: 10,
	}
...
func TestAuthRecord27Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.AuthRecord27{
		ID: "id-27", DisplayName: "Lifecycle AuthRecord27", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
