...
func TestBillingRecord05Validate(t *testing.T) {
	t.Parallel()
	valid := &models.BillingRecord05{
		ID: "id-5", DisplayName: "Sample BillingRecord05", Status: "active", Priority: 10,
	}
...
func TestBillingRecord05Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.BillingRecord05{
		ID: "id-5", DisplayName: "Lifecycle BillingRecord05", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
