...
func TestSampleRecord14Validate(t *testing.T) {
	t.Parallel()
	valid := &models.SampleRecord14{
		ID: "id-14", DisplayName: "Sample SampleRecord14", Status: "active", Priority: 10,
	}
...
func TestSampleRecord14Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.SampleRecord14{
		ID: "id-14", DisplayName: "Lifecycle SampleRecord14", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
