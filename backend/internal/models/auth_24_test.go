...
func TestAuthRecord24Validate(t *testing.T) {
	t.Parallel()
	valid := &models.AuthRecord24{
		ID: "id-24", DisplayName: "Sample AuthRecord24", Status: "active", Priority: 10,
	}
...
func TestAuthRecord24Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.AuthRecord24{
		ID: "id-24", DisplayName: "Lifecycle AuthRecord24", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
