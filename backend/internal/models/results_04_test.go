...
func TestResultRecord04Validate(t *testing.T) {
	t.Parallel()
	valid := &models.ResultRecord04{
		ID: "id-4", DisplayName: "Sample ResultRecord04", Status: "active", Priority: 10,
	}
...
func TestResultRecord04Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.ResultRecord04{
		ID: "id-4", DisplayName: "Lifecycle ResultRecord04", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
