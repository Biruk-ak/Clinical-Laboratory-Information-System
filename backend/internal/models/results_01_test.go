...
func TestResultRecord01Validate(t *testing.T) {
	t.Parallel()
	valid := &models.ResultRecord01{
		ID: "id-1", DisplayName: "Sample ResultRecord01", Status: "active", Priority: 10,
	}
...
func TestResultRecord01Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.ResultRecord01{
		ID: "id-1", DisplayName: "Lifecycle ResultRecord01", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
