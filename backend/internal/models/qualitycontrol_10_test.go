...
func TestQualityControlRecord10Validate(t *testing.T) {
	t.Parallel()
	valid := &models.QualityControlRecord10{
		ID: "id-10", DisplayName: "Sample QualityControlRecord10", Status: "active", Priority: 10,
	}
...
func TestQualityControlRecord10Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.QualityControlRecord10{
		ID: "id-10", DisplayName: "Lifecycle QualityControlRecord10", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
