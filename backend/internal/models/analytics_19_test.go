...
func TestAnalyticsRecord19Validate(t *testing.T) {
	t.Parallel()
	valid := &models.AnalyticsRecord19{
		ID: "id-19", DisplayName: "Sample AnalyticsRecord19", Status: "active", Priority: 10,
	}
...
func TestAnalyticsRecord19Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.AnalyticsRecord19{
		ID: "id-19", DisplayName: "Lifecycle AnalyticsRecord19", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
