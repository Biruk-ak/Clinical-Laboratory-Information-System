...
func TestQualityControlRecord22Validate(t *testing.T) {
	t.Parallel()
	valid := &models.QualityControlRecord22{
		ID: "id-22", DisplayName: "Sample QualityControlRecord22", Status: "active", Priority: 10,
	}
...
func TestQualityControlRecord22Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.QualityControlRecord22{
		ID: "id-22", DisplayName: "Lifecycle QualityControlRecord22", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
