...
func TestReportRecord23Validate(t *testing.T) {
	t.Parallel()
	valid := &models.ReportRecord23{
		ID: "id-23", DisplayName: "Sample ReportRecord23", Status: "active", Priority: 10,
	}
...
func TestReportRecord23Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.ReportRecord23{
		ID: "id-23", DisplayName: "Lifecycle ReportRecord23", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
