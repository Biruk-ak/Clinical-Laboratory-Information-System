...
func TestAuthRecord10Validate(t *testing.T) {
	t.Parallel()
	valid := &models.AuthRecord10{
		ID: "id-10", DisplayName: "Sample AuthRecord10", Status: "active", Priority: 10,
	}
...
func TestAuthRecord10Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.AuthRecord10{
		ID: "id-10", DisplayName: "Lifecycle AuthRecord10", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
