...
func TestNotificationRecord28Validate(t *testing.T) {
	t.Parallel()
	valid := &models.NotificationRecord28{
		ID: "id-28", DisplayName: "Sample NotificationRecord28", Status: "active", Priority: 10,
	}
...
func TestNotificationRecord28Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.NotificationRecord28{
		ID: "id-28", DisplayName: "Lifecycle NotificationRecord28", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
