...
func TestDoctorRecord10Validate(t *testing.T) {
	t.Parallel()
	valid := &models.DoctorRecord10{
		ID: "id-10", DisplayName: "Sample DoctorRecord10", Status: "active", Priority: 10,
	}
...
func TestDoctorRecord10Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.DoctorRecord10{
		ID: "id-10", DisplayName: "Lifecycle DoctorRecord10", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
