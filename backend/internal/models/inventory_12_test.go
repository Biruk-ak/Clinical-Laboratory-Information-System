...
func TestInventoryRecord12Validate(t *testing.T) {
	t.Parallel()
	valid := &models.InventoryRecord12{
		ID: "id-12", DisplayName: "Sample InventoryRecord12", Status: "active", Priority: 10,
	}
...
func TestInventoryRecord12Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.InventoryRecord12{
		ID: "id-12", DisplayName: "Lifecycle InventoryRecord12", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
