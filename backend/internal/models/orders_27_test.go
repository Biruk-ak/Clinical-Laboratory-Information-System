...
func TestOrderRecord27Validate(t *testing.T) {
	t.Parallel()
	valid := &models.OrderRecord27{
		ID: "id-27", DisplayName: "Sample OrderRecord27", Status: "active", Priority: 10,
	}
...
func TestOrderRecord27Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.OrderRecord27{
		ID: "id-27", DisplayName: "Lifecycle OrderRecord27", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
