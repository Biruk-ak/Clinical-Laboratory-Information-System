...
func TestAuthRecord21Validate(t *testing.T) {
	t.Parallel()
	valid := &models.AuthRecord21{
		ID: "id-21", DisplayName: "Sample AuthRecord21", Status: "active", Priority: 10,
	}
...
func TestAuthRecord21Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.AuthRecord21{
		ID: "id-21", DisplayName: "Lifecycle AuthRecord21", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
