...
func TestReportRecord15Validate(t *testing.T) {
	t.Parallel()
	valid := &models.ReportRecord15{
		ID: "id-15", DisplayName: "Sample ReportRecord15", Status: "active", Priority: 10,
	}
...
func TestReportRecord15Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.ReportRecord15{
		ID: "id-15", DisplayName: "Lifecycle ReportRecord15", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
