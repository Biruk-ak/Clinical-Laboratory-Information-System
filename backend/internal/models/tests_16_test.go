...
func TestLabTestRecord16Validate(t *testing.T) {
	t.Parallel()
	valid := &models.LabTestRecord16{
		ID: "id-16", DisplayName: "Sample LabTestRecord16", Status: "active", Priority: 10,
	}
...
func TestLabTestRecord16Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.LabTestRecord16{
		ID: "id-16", DisplayName: "Lifecycle LabTestRecord16", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
