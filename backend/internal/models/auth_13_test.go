...
func TestAuthRecord13Validate(t *testing.T) {
	t.Parallel()
	valid := &models.AuthRecord13{
		ID: "id-13", DisplayName: "Sample AuthRecord13", Status: "active", Priority: 10,
	}
...
func TestAuthRecord13Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.AuthRecord13{
		ID: "id-13", DisplayName: "Lifecycle AuthRecord13", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
