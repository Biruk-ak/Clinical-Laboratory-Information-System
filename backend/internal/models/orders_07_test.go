...
func TestOrderRecord07Validate(t *testing.T) {
	t.Parallel()
	valid := &models.OrderRecord07{
		ID: "id-7", DisplayName: "Sample OrderRecord07", Status: "active", Priority: 10,
	}
...
func TestOrderRecord07Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.OrderRecord07{
		ID: "id-7", DisplayName: "Lifecycle OrderRecord07", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
