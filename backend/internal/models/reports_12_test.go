...
func TestReportRecord12Validate(t *testing.T) {
	t.Parallel()
	valid := &models.ReportRecord12{
		ID: "id-12", DisplayName: "Sample ReportRecord12", Status: "active", Priority: 10,
	}
...
func TestReportRecord12Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.ReportRecord12{
		ID: "id-12", DisplayName: "Lifecycle ReportRecord12", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
