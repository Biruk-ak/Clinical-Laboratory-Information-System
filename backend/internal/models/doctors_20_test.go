...
func TestDoctorRecord20Validate(t *testing.T) {
	t.Parallel()
	valid := &models.DoctorRecord20{
		ID: "id-20", DisplayName: "Sample DoctorRecord20", Status: "active", Priority: 10,
	}
...
func TestDoctorRecord20Lifecycle(t *testing.T) {
	t.Parallel()
	rec := &models.DoctorRecord20{
		ID: "id-20", DisplayName: "Lifecycle DoctorRecord20", Status: "active", Priority: 1, Version: 1, IsActive: true,
	}
